...
public class Modelrocky<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "rocky"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Rocky = partdefinition.addOrReplaceChild("Rocky", CubeListBuilder.create(),
		...
		PartDefinition LeftBackLeg = Rocky.addOrReplaceChild("LeftBackLeg", CubeListBuilder.create(),
		...
		PartDefinition LeftFrontLeg = Rocky.addOrReplaceChild("LeftFrontLeg", CubeListBuilder.create(),
		...
		PartDefinition RightFrontLeg = Rocky.addOrReplaceChild("RightFrontLeg", CubeListBuilder.create(),
				PartPose.offset(-3.0F, -7.0F, -6.225F));
		...
		PartDefinition MidLeg_r3 = RightFrontMidLeg.addOrReplaceChild("MidLeg_r3",
				CubeListBuilder.create().texOffs(112, 10).addBox(-2.01F, -2.0F, -2.0F, 4.0F, 4.0F, 4.0F,
						new CubeDeformation(0.01F)),
				PartPose.offsetAndRotation(0.0F, 1.75F, 1.0F, 0.5672F, 0.0F, 0.0F));
		...
		PartDefinition LowerLeg_r3 = RightFrontLowerLeg.addOrReplaceChild("LowerLeg_r3",
				CubeListBuilder.create().texOffs(114, 19).addBox(-2.005F, -1.5F, -1.5F, 4.0F, 3.0F, 3.0F,
						new CubeDeformation(0.0091F)),
				PartPose.offsetAndRotation(0.0F, 1.35F, -0.675F, -0.5236F, 0.0F, 0.0F));
