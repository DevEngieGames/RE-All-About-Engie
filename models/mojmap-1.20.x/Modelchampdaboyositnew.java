...
public class Modelchampdaboyositnew<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "champdaboyositnew"), "main");
	private final ModelPart champ;
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition champ = partdefinition.addOrReplaceChild("champ", CubeListBuilder.create(),
		...
		PartDefinition Head = champ.addOrReplaceChild("Head",
				CubeListBuilder.create().texOffs(36, 39)
						...
						.addBox(-4.0F, -6.5F, -8.0F, 8.0F, 8.0F, 8.0F, new CubeDeformation(0.3F)).texOffs(30, 0)
						.addBox(-5.125F, -6.25F, -8.2625F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(2, 0)
						.addBox(3.125F, -6.25F, -8.2625F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(14, 8)
						.addBox(-1.5F, -10.0F, -4.3125F, 3.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(12, 7)
						.addBox(-2.0F, -9.5F, -5.075F, 4.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(10, 6)
						.addBox(-2.5F, -9.0F, -5.85F, 5.0F, 1.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(8, 5)
						.addBox(-3.0F, -8.5F, -6.6375F, 6.0F, 1.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(6, 4)
						.addBox(-3.5F, -8.0F, -7.375F, 7.0F, 1.0F, 7.0F, new CubeDeformation(0.0F)).texOffs(4, 3)
						.addBox(-4.0F, -7.5F, -8.0F, 8.0F, 1.0F, 8.0F, new CubeDeformation(0.0F)).texOffs(2, 2)
						.addBox(-4.5F, -7.0F, -8.5F, 9.0F, 1.0F, 9.0F, new CubeDeformation(0.0F)).texOffs(0, 0)
						.addBox(-5.0F, -6.0F, -9.0F, 10.0F, 2.0F, 10.0F, new CubeDeformation(0.0F)).texOffs(-1, 17)
						.addBox(-2.0F, -1.3F, -9.25F, 4.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(-1, 12)
						.addBox(-2.0F, -1.5F, -9.425F, 4.0F, 2.0F, 2.0F, new CubeDeformation(0.005F)),
				PartPose.offset(0.0F, -12.0F, -3.525F));

		PartDefinition cube_r1 = Head.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(21, 12).addBox(-0.5F, -0.5F, -1.0F, 3.0F, 2.0F, 2.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(1.4535F, -1.0F, -8.4535F, 0.0F, -0.9599F, 0.0F));

		PartDefinition cube_r2 = Head.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(11, 12).addBox(-2.5F, -0.5F, -1.0F, 3.0F, 2.0F, 2.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-1.4714F, -1.0F, -8.4535F, 0.0F, 0.9599F, 0.0F));

		PartDefinition cube_r3 = Head.addOrReplaceChild("cube_r3",
				CubeListBuilder.create().texOffs(31, 13).mirror()
						.addBox(-1.5F, -0.5F, -1.0F, 3.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(-2.0465F, -0.8F, -7.4535F, 0.0F, 0.9599F, 0.0F));

		PartDefinition cube_r4 = Head.addOrReplaceChild("cube_r4",
				CubeListBuilder.create().texOffs(31, 13).addBox(-1.5F, -0.5F, -1.0F, 3.0F, 2.0F, 2.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition tooth_r1 = Head.addOrReplaceChild("tooth_r1",
				CubeListBuilder.create().texOffs(0, 7)
						.addBox(-0.5F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(0, 7)
						.addBox(8.0F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition tooth_r8 = Head.addOrReplaceChild("tooth_r8",
				CubeListBuilder.create().texOffs(0, 7)
						.addBox(-0.5F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(0, 7)
						.addBox(-9.0F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(4.25F, -3.9964F, -0.491F, 0.7854F, 0.0F, 0.0F));

		PartDefinition tooth_r9 = Head.addOrReplaceChild("tooth_r9",
				CubeListBuilder.create().texOffs(0, 7).addBox(-0.5F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition Body = champ.addOrReplaceChild("Body",
				CubeListBuilder.create().texOffs(0, 28)
						.addBox(-5.0F, 0.0F, -4.0F, 10.0F, 16.0F, 8.0F, new CubeDeformation(0.025F)).texOffs(33, 72)
						.addBox(-5.0F, 0.0F, -4.0F, 10.0F, 16.0F, 8.0F, new CubeDeformation(0.125F)),
				PartPose.offsetAndRotation(0.0F, -11.0F, -7.25F, 1.1345F, 0.0F, 0.0F));

		PartDefinition BackFin_r1 = Body.addOrReplaceChild("BackFin_r1",
				CubeListBuilder.create().texOffs(107, 52).addBox(-1.0F, 0.9503F, 2.2318F, 2.0F, 3.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 7.525F, 0.0F, 0.5236F, 0.0F, 0.0F));

		PartDefinition BackFin_r2 = Body.addOrReplaceChild("BackFin_r2",
				CubeListBuilder.create().texOffs(97, 50).addBox(-1.0F, -1.9316F, 3.7227F, 2.0F, 6.0F, 2.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 8.525F, 0.0F, 0.5236F, 0.0F, 0.0F));

		PartDefinition tail = Body.addOrReplaceChild("tail", CubeListBuilder.create(),
				PartPose.offsetAndRotation(0.25F, 35.525F, -18.5F, -1.5708F, 0.0F, 0.0F));
		...
		PartDefinition base2 = base.addOrReplaceChild("base2",
				CubeListBuilder.create().texOffs(107, 33)
						.addBox(-2.75F, -2.775F, 0.0F, 5.0F, 5.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(112, 81)
						.addBox(-2.75F, -2.775F, 0.0F, 5.0F, 5.0F, 3.0F, new CubeDeformation(0.125F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 2.8125F, 0.4363F, 0.0F, 0.0F));

		PartDefinition dorsal_r1 = base2.addOrReplaceChild("dorsal_r1",
				CubeListBuilder.create().texOffs(92, 32).addBox(-1.0F, -2.525F, -1.5F, 2.0F, 5.0F, 3.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.25F, -2.9571F, 3.7604F, -0.7854F, 0.0F, 0.0F));

		PartDefinition mid1 = base2.addOrReplaceChild("mid1",
				CubeListBuilder.create().texOffs(107, 33).addBox(-2.75F, -2.775F, 0.0F, 5.0F, 5.0F, 3.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition sidefin_r1 = mid1a.addOrReplaceChild("sidefin_r1",
				CubeListBuilder.create().texOffs(93, 45).addBox(-1.5F, -0.525F, -1.5F, 3.0F, 1.0F, 3.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition sidefin_r2 = mid1a.addOrReplaceChild("sidefin_r2",
				CubeListBuilder.create().texOffs(92, 40).addBox(-1.5F, -0.525F, -1.5F, 3.0F, 1.0F, 3.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(2.7409F, 1.8339F, 2.433F, 0.0246F, -0.5108F, 0.2081F));

		PartDefinition mid2 = mid1a.addOrReplaceChild("mid2",
				CubeListBuilder.create().texOffs(114, 42).addBox(-2.125F, -2.15F, 0.0F, 4.0F, 4.0F, 3.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 2.8125F, 0.0873F, 0.0F, 0.0F));
		...
		PartDefinition dorsal_r2 = mid2a.addOrReplaceChild("dorsal_r2",
				CubeListBuilder.create().texOffs(94, 16).addBox(-0.5F, -2.025F, -1.0F, 1.0F, 4.0F, 2.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.125F, -2.5821F, 2.3033F, -0.7854F, 0.0F, 0.0F));

		PartDefinition tip = mid2a.addOrReplaceChild("tip",
				CubeListBuilder.create().texOffs(118, 50).addBox(-0.875F, -0.9F, 0.0F, 2.0F, 2.0F, 3.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 2.8125F, 0.1745F, 0.0F, 0.0F));

		PartDefinition tip2 = tip.addOrReplaceChild("tip2",
				CubeListBuilder.create().texOffs(114, 55).addBox(-0.875F, -0.875F, 0.0F, 2.0F, 2.0F, 5.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition RightFrontLeg = partdefinition.addOrReplaceChild("RightFrontLeg", CubeListBuilder.create(),
				PartPose.offset(-3.0F, 17.0F, -6.975F));
		...
		PartDefinition UpperLegLayer2_r1 = RightFrontUpperLeg.addOrReplaceChild("UpperLegLayer2_r1",
		...
		PartDefinition MidLegLayer_r1 = RightFrontMidLeg.addOrReplaceChild("MidLegLayer_r1",
				CubeListBuilder.create().texOffs(112, 65)
						.addBox(-2.01F, -2.0F, -2.0F, 4.0F, 4.0F, 4.0F, new CubeDeformation(0.06F)).texOffs(112, 10)
		...
		PartDefinition LowerLegLayer_r1 = RightFrontLowerLeg.addOrReplaceChild("LowerLegLayer_r1",
				CubeListBuilder.create().texOffs(114, 74)
						.addBox(-2.005F, -1.5F, -1.5F, 4.0F, 3.0F, 3.0F, new CubeDeformation(0.0591F)).texOffs(114, 19)
		...
		PartDefinition RightBackLeg = partdefinition.addOrReplaceChild("RightBackLeg", CubeListBuilder.create(),
				PartPose.offsetAndRotation(-3.0F, 22.15F, 5.75F, -1.3526F, 0.0F, 0.0F));

		PartDefinition RightBackUpperLeg = RightBackLeg.addOrReplaceChild("RightBackUpperLeg", CubeListBuilder.create(),
				PartPose.offset(0.0F, 1.242F, -0.4325F));

		PartDefinition UpperLegLayer2_r3 = RightBackUpperLeg.addOrReplaceChild("UpperLegLayer2_r3",
				CubeListBuilder.create().texOffs(69, 76).mirror()
						.addBox(-2.0F, -2.5F, -2.0F, 4.0F, 5.0F, 4.0F, new CubeDeformation(0.111F)).mirror(false)
						.texOffs(99, 59).mirror()
						.addBox(-2.0F, -2.5F, -2.0F, 4.0F, 5.0F, 4.0F, new CubeDeformation(0.061F)).mirror(false)
		...
		PartDefinition RightBackMidLeg = RightBackUpperLeg.addOrReplaceChild("RightBackMidLeg",
				CubeListBuilder.create(), PartPose.offsetAndRotation(0.0F, 1.233F, -0.6425F, -0.6981F, 0.0F, 0.0F));

		PartDefinition MidLegLayer_r3 = RightBackMidLeg.addOrReplaceChild("MidLegLayer_r3",
				CubeListBuilder.create().texOffs(112, 65).mirror()
						.addBox(-2.01F, -2.0F, -2.0F, 4.0F, 4.0F, 4.0F, new CubeDeformation(0.01F)).mirror(false)
						.texOffs(112, 10).mirror()
						.addBox(-2.01F, -2.0F, -2.0F, 4.0F, 4.0F, 4.0F, new CubeDeformation(0.01F)).mirror(false),
		...
		PartDefinition RightBackLowerLeg = RightBackMidLeg.addOrReplaceChild("RightBackLowerLeg",
				CubeListBuilder.create(), PartPose.offsetAndRotation(0.0F, 1.8F, 1.675F, 1.0472F, 0.0F, 0.0F));

		PartDefinition LowerLegLayer_r3 = RightBackLowerLeg.addOrReplaceChild("LowerLegLayer_r3",
				CubeListBuilder.create().texOffs(114, 74).mirror()
						.addBox(-2.005F, -1.5F, -1.5F, 4.0F, 3.0F, 3.0F, new CubeDeformation(0.0091F)).mirror(false)
						.texOffs(114, 19).mirror()
						.addBox(-2.005F, -1.5F, -1.5F, 4.0F, 3.0F, 3.0F, new CubeDeformation(0.0091F)).mirror(false),
		...
		PartDefinition RightBackFoot = RightBackLowerLeg.addOrReplaceChild("RightBackFoot",
				CubeListBuilder.create().texOffs(112, 26).mirror()
						.addBox(-2.0F, -1.0442F, -3.9999F, 4.0F, 2.0F, 4.0F, new CubeDeformation(0.0081F)).mirror(false)
						.texOffs(124, 36).mirror()
						.addBox(-2.0375F, -0.0442F, -4.4999F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0082F))
						.mirror(false).texOffs(124, 36).mirror()
						.addBox(-1.0125F, -0.0442F, -4.4999F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0082F))
						.mirror(false).texOffs(124, 36).mirror()
						.addBox(0.0125F, -0.0442F, -4.4999F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0082F))
						.mirror(false).texOffs(124, 36).mirror()
						.addBox(1.0375F, -0.0442F, -4.4999F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0082F))
						.mirror(false),
		...
		PartDefinition Toe_r3 = RightBackFoot.addOrReplaceChild("Toe_r3",
				CubeListBuilder.create().texOffs(124, 33).mirror()
						.addBox(-0.5125F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0081F)).mirror(false)
						.texOffs(124, 33).mirror()
						.addBox(-1.5375F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0081F)).mirror(false)
						.texOffs(124, 33).mirror()
						.addBox(-2.5625F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0081F)).mirror(false)
						.texOffs(124, 33).mirror()
						.addBox(-3.5875F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0081F)).mirror(false),
		...
		PartDefinition LeftBackMidLeg = LeftBackUpperLeg.addOrReplaceChild("LeftBackMidLeg", CubeListBuilder.create(),
				PartPose.offsetAndRotation(0.0F, 1.233F, -0.6425F, -0.6981F, 0.0F, 0.0F));

		PartDefinition MidLegLayer_r4 = LeftBackMidLeg.addOrReplaceChild("MidLegLayer_r4",
				CubeListBuilder.create().texOffs(112, 65).mirror()
						.addBox(-2.01F, -2.0F, -2.0F, 4.0F, 4.0F, 4.0F, new CubeDeformation(0.01F)).mirror(false)
						.texOffs(112, 10).mirror()
						.addBox(-2.01F, -2.0F, -2.0F, 4.0F, 4.0F, 4.0F, new CubeDeformation(0.01F)).mirror(false),
		...
		PartDefinition LeftBackLowerLeg = LeftBackMidLeg.addOrReplaceChild("LeftBackLowerLeg", CubeListBuilder.create(),
				PartPose.offsetAndRotation(0.0F, 1.8F, 1.675F, 1.0472F, 0.0F, 0.0F));

		PartDefinition LowerLegLayer_r4 = LeftBackLowerLeg.addOrReplaceChild("LowerLegLayer_r4",
				CubeListBuilder.create().texOffs(114, 74).mirror()
						.addBox(-2.005F, -1.5F, -1.5F, 4.0F, 3.0F, 3.0F, new CubeDeformation(0.0091F)).mirror(false)
						.texOffs(114, 19).mirror()
						.addBox(-2.005F, -1.5F, -1.5F, 4.0F, 3.0F, 3.0F, new CubeDeformation(0.0091F)).mirror(false),
