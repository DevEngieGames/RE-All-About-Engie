...
public class Modelchampdaboyo<T extends Entity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in
	// the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "champdaboyo"), "main");
	...
	public Modelchampdaboyo(ModelPart root) {
		...
		this.leg1 = this.champ.getChild("leg1");
		this.leg2 = this.champ.getChild("leg2");
		this.leg3 = this.champ.getChild("leg3");
		this.leg4 = this.champ.getChild("leg4");
	}
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cube_r1 = Head.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(21, 12).addBox(-0.5F, -0.5F, -1.0F, 3.0F, 2.0F, 2.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(1.4536F, -1.0F, -8.4536F, 0.0F, -0.9599F, 0.0F));

		PartDefinition cube_r2 = Head.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(11, 12).addBox(-2.5F, -0.5F, -1.0F, 3.0F, 2.0F, 2.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-1.4714F, -1.0F, -8.4536F, 0.0F, 0.9599F, 0.0F));
		...
		PartDefinition cube_r3 = Head.addOrReplaceChild("cube_r3",
				...
				PartPose.offsetAndRotation(-2.0464F, -0.8F, -7.4536F, 0.0F, 0.9599F, 0.0F));
		...
		PartDefinition cube_r4 = Head.addOrReplaceChild("cube_r4",
				CubeListBuilder.create().texOffs(31, 13).addBox(-1.5F, -0.5F, -1.0F, 3.0F, 2.0F, 2.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(2.0286F, -0.8F, -7.4536F, 0.0F, -0.9599F, 0.0F));
		...
		PartDefinition tooth_r1 = Head.addOrReplaceChild("tooth_r1",
				...
				PartPose.offsetAndRotation(-4.25F, -3.9964F, -1.4911F, 0.7854F, 0.0F, 0.0F));

		PartDefinition tooth_r2 = Head.addOrReplaceChild("tooth_r2",
				CubeListBuilder.create().texOffs(0, 7)
						.addBox(-0.5F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(0, 7)
						.addBox(8.0F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-4.25F, -3.9964F, -2.4911F, 0.7854F, 0.0F, 0.0F));

		PartDefinition tooth_r3 = Head.addOrReplaceChild("tooth_r3",
				CubeListBuilder.create().texOffs(0, 7)
						.addBox(-0.5F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(0, 7)
						.addBox(8.0F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-4.25F, -3.9964F, -3.4911F, 0.7854F, 0.0F, 0.0F));

		PartDefinition tooth_r4 = Head.addOrReplaceChild("tooth_r4",
				CubeListBuilder.create().texOffs(0, 7)
						.addBox(-0.5F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(0, 7)
						.addBox(8.0F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-4.25F, -3.9964F, -4.4911F, 0.7854F, 0.0F, 0.0F));

		PartDefinition tooth_r5 = Head.addOrReplaceChild("tooth_r5",
				CubeListBuilder.create().texOffs(0, 7)
						.addBox(-0.5F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(0, 7)
						.addBox(8.0F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-4.25F, -3.9964F, -5.4911F, 0.7854F, 0.0F, 0.0F));

		PartDefinition tooth_r6 = Head.addOrReplaceChild("tooth_r6",
				CubeListBuilder.create().texOffs(0, 7)
						.addBox(-0.5F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(0, 7)
						.addBox(8.0F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-4.25F, -3.9964F, -6.4911F, 0.7854F, 0.0F, 0.0F));

		PartDefinition tooth_r7 = Head.addOrReplaceChild("tooth_r7",
				CubeListBuilder.create().texOffs(0, 7)
						.addBox(-0.5F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(0, 7)
						.addBox(8.0F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-4.25F, -3.9964F, -7.4911F, 0.7854F, 0.0F, 0.0F));

		PartDefinition tooth_r8 = Head.addOrReplaceChild("tooth_r8",
				CubeListBuilder.create().texOffs(0, 7)
						.addBox(-0.5F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(0, 7)
						.addBox(-9.0F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(4.25F, -3.9964F, -0.4911F, 0.7854F, 0.0F, 0.0F));
		...
		PartDefinition tooth_r9 = Head.addOrReplaceChild("tooth_r9",
				CubeListBuilder.create().texOffs(0, 7).addBox(-0.5F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-3.5F, -3.9964F, -8.4911F, 0.0F, -1.5708F, -0.7854F));

		PartDefinition tooth_r10 = Head.addOrReplaceChild("tooth_r10",
				CubeListBuilder.create().texOffs(0, 7).addBox(-0.5F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-2.5F, -3.9964F, -8.4911F, 0.0F, -1.5708F, -0.7854F));

		PartDefinition tooth_r11 = Head.addOrReplaceChild("tooth_r11",
				CubeListBuilder.create().texOffs(0, 7).addBox(-0.5F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-1.5F, -3.9964F, -8.4911F, 0.0F, -1.5708F, -0.7854F));

		PartDefinition tooth_r12 = Head.addOrReplaceChild("tooth_r12",
				CubeListBuilder.create().texOffs(0, 7).addBox(-0.5F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.5F, -3.9964F, -8.4911F, 0.0F, -1.5708F, -0.7854F));
		...
		PartDefinition tooth_r17 = Head.addOrReplaceChild("tooth_r17",
				CubeListBuilder.create().texOffs(0, 7).addBox(-0.5F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(2.5F, -3.9964F, 0.0089F, 0.0F, -1.5708F, -0.7854F));

		PartDefinition tooth_r18 = Head.addOrReplaceChild("tooth_r18",
				CubeListBuilder.create().texOffs(0, 7).addBox(-0.5F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(3.5F, -3.9964F, 0.0089F, 0.0F, -1.5708F, -0.7854F));

		PartDefinition tooth_r19 = Head.addOrReplaceChild("tooth_r19",
				CubeListBuilder.create().texOffs(0, 7).addBox(-0.5F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.5F, -3.9964F, 0.0089F, 0.0F, -1.5708F, -0.7854F));

		PartDefinition tooth_r20 = Head.addOrReplaceChild("tooth_r20",
				CubeListBuilder.create().texOffs(0, 7).addBox(-0.5F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(1.5F, -3.9964F, 0.0089F, 0.0F, -1.5708F, -0.7854F));
		...
		PartDefinition leg1 = champ.addOrReplaceChild("leg1", CubeListBuilder.create().texOffs(112, 26)
				.addBox(-2.0F, 5.0F, -2.975F, 4.0F, 2.0F, 4.0F, new CubeDeformation(0.0081F)).texOffs(124, 36)
				.addBox(-2.0375F, 6.0F, -3.475F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0082F)).texOffs(124, 36)
				.addBox(-1.0125F, 6.0F, -3.475F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0082F)).texOffs(124, 36)
				.addBox(0.0125F, 6.0F, -3.475F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0082F)).texOffs(124, 36)
				.addBox(1.0375F, 6.0F, -3.475F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0082F)),
				PartPose.offset(-3.0F, -7.0F, 5.5F));
		...
		PartDefinition leg2 = champ.addOrReplaceChild("leg2", CubeListBuilder.create().texOffs(112, 26)
				.addBox(-2.0F, 5.0F, -2.975F, 4.0F, 2.0F, 4.0F, new CubeDeformation(0.0081F)).texOffs(124, 36)
				.addBox(-2.0375F, 6.0F, -3.475F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0082F)).texOffs(124, 36)
				.addBox(-1.0125F, 6.0F, -3.475F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0082F)).texOffs(124, 36)
				.addBox(0.0125F, 6.0F, -3.475F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0082F)).texOffs(124, 36)
		...
		PartDefinition leg3 = champ.addOrReplaceChild("leg3",
				CubeListBuilder.create().texOffs(99, 22)
						.addBox(-2.0F, 5.0F, -2.75F, 4.0F, 2.0F, 4.0F, new CubeDeformation(0.0081F)).texOffs(124, 39)
						.addBox(-2.0375F, 6.0F, -3.25F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0082F)).texOffs(124, 39)
						.addBox(-1.0125F, 6.0F, -3.25F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0082F)).texOffs(124, 39)
						.addBox(0.0125F, 6.0F, -3.25F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0082F)).texOffs(124, 39)
		...
		PartDefinition leg4 = champ.addOrReplaceChild("leg4",
				CubeListBuilder.create().texOffs(99, 22)
						.addBox(-2.0F, 5.0F, -2.75F, 4.0F, 2.0F, 4.0F, new CubeDeformation(0.0081F)).texOffs(124, 39)
						.addBox(-2.0375F, 6.0F, -3.25F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0082F)).texOffs(124, 39)
						.addBox(-1.0125F, 6.0F, -3.25F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0082F)).texOffs(124, 39)
