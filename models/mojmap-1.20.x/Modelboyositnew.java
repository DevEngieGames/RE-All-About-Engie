...
public class Modelboyositnew<T extends Entity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in
	// the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "boyositnew"), "main");
	...
	public Modelboyositnew(ModelPart root) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Body = partdefinition.addOrReplaceChild("Body",
				CubeListBuilder.create().texOffs(0, 28).addBox(-5.0F, 0.0F, -4.0F, 10.0F, 16.0F, 8.0F,
		...
		PartDefinition UpperLeg_r2 = RightBackUpperLeg.addOrReplaceChild("UpperLeg_r2",
		...
		PartDefinition UpperLeg_r3 = LeftFrontUpperLeg.addOrReplaceChild("UpperLeg_r3",
				CubeListBuilder.create().texOffs(56, 0).addBox(-2.0F, -2.5F, -2.0F, 4.0F, 5.0F, 4.0F,
						new CubeDeformation(0.011F)),
				PartPose.offsetAndRotation(0.0F, 2.5F, -0.3F, -0.2182F, 0.0F, 0.0F));
