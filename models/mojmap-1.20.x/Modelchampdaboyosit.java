...
public class Modelchampdaboyosit<T extends Entity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in
	// the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "champdaboyosit"), "main");
	...
	public Modelchampdaboyosit(ModelPart root) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition tooth_r1 = Head.addOrReplaceChild("tooth_r1",
				...
				PartPose.offsetAndRotation(-4.25F, -3.9965F, -1.4911F, 0.7854F, 0.0F, 0.0F));

		PartDefinition tooth_r2 = Head.addOrReplaceChild("tooth_r2",
				CubeListBuilder.create().texOffs(0, 7)
						.addBox(-0.5F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(0, 7)
						.addBox(8.0F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-4.25F, -3.9965F, -2.491F, 0.7854F, 0.0F, 0.0F));

		PartDefinition tooth_r3 = Head.addOrReplaceChild("tooth_r3",
				CubeListBuilder.create().texOffs(0, 7)
						.addBox(-0.5F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(0, 7)
						.addBox(8.0F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-4.25F, -3.9965F, -3.491F, 0.7854F, 0.0F, 0.0F));

		PartDefinition tooth_r4 = Head.addOrReplaceChild("tooth_r4",
				CubeListBuilder.create().texOffs(0, 7)
						.addBox(-0.5F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(0, 7)
						.addBox(8.0F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-4.25F, -3.9965F, -4.491F, 0.7854F, 0.0F, 0.0F));

		PartDefinition tooth_r5 = Head.addOrReplaceChild("tooth_r5",
				CubeListBuilder.create().texOffs(0, 7)
						.addBox(-0.5F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(0, 7)
						.addBox(8.0F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-4.25F, -3.9965F, -5.491F, 0.7854F, 0.0F, 0.0F));

		PartDefinition tooth_r6 = Head.addOrReplaceChild("tooth_r6",
				CubeListBuilder.create().texOffs(0, 7)
						.addBox(-0.5F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(0, 7)
						.addBox(8.0F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-4.25F, -3.9965F, -6.491F, 0.7854F, 0.0F, 0.0F));

		PartDefinition tooth_r7 = Head.addOrReplaceChild("tooth_r7",
				CubeListBuilder.create().texOffs(0, 7)
						.addBox(-0.5F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(0, 7)
						.addBox(8.0F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-4.25F, -3.9965F, -7.491F, 0.7854F, 0.0F, 0.0F));

		PartDefinition tooth_r8 = Head.addOrReplaceChild("tooth_r8",
				CubeListBuilder.create().texOffs(0, 7)
						.addBox(-0.5F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(0, 7)
						.addBox(-9.0F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(4.25F, -3.9965F, -0.4911F, 0.7854F, 0.0F, 0.0F));
		...
		PartDefinition tooth_r9 = Head.addOrReplaceChild("tooth_r9",
				CubeListBuilder.create().texOffs(0, 7).addBox(-0.5F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-3.5F, -3.9965F, -8.491F, 0.0F, -1.5708F, -0.7854F));

		PartDefinition tooth_r10 = Head.addOrReplaceChild("tooth_r10",
				CubeListBuilder.create().texOffs(0, 7).addBox(-0.5F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-2.5F, -3.9965F, -8.491F, 0.0F, -1.5708F, -0.7854F));

		PartDefinition tooth_r11 = Head.addOrReplaceChild("tooth_r11",
				CubeListBuilder.create().texOffs(0, 7).addBox(-0.5F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-1.5F, -3.9965F, -8.491F, 0.0F, -1.5708F, -0.7854F));

		PartDefinition tooth_r12 = Head.addOrReplaceChild("tooth_r12",
				CubeListBuilder.create().texOffs(0, 7).addBox(-0.5F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.5F, -3.9965F, -8.491F, 0.0F, -1.5708F, -0.7854F));
		...
		PartDefinition tooth_r17 = Head.addOrReplaceChild("tooth_r17",
				CubeListBuilder.create().texOffs(0, 7).addBox(-0.5F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(2.5F, -3.9965F, 0.0089F, 0.0F, -1.5708F, -0.7854F));

		PartDefinition tooth_r18 = Head.addOrReplaceChild("tooth_r18",
				CubeListBuilder.create().texOffs(0, 7).addBox(-0.5F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(3.5F, -3.9965F, 0.0089F, 0.0F, -1.5708F, -0.7854F));

		PartDefinition tooth_r19 = Head.addOrReplaceChild("tooth_r19",
				CubeListBuilder.create().texOffs(0, 7).addBox(-0.5F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.5F, -3.9965F, 0.0089F, 0.0F, -1.5708F, -0.7854F));

		PartDefinition tooth_r20 = Head.addOrReplaceChild("tooth_r20",
				CubeListBuilder.create().texOffs(0, 7).addBox(-0.5F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(1.5F, -3.9965F, 0.0089F, 0.0F, -1.5708F, -0.7854F));
		...
		PartDefinition leg1 = partdefinition.addOrReplaceChild("leg1", CubeListBuilder.create().texOffs(112, 26)
				.addBox(-2.0F, 4.0F, -4.475F, 4.0F, 2.0F, 4.0F, new CubeDeformation(0.0081F)).texOffs(124, 36)
				.addBox(-2.0375F, 5.0F, -4.975F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0082F)).texOffs(124, 36)
				.addBox(-1.0125F, 5.0F, -4.975F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0082F)).texOffs(124, 36)
				.addBox(0.0125F, 5.0F, -4.975F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0082F)).texOffs(124, 36)
		...
		PartDefinition leg3 = partdefinition.addOrReplaceChild("leg3",
				CubeListBuilder.create().texOffs(99, 22)
						.addBox(-2.0F, 4.0F, -4.25F, 4.0F, 2.0F, 4.0F, new CubeDeformation(0.0081F)).texOffs(124, 39)
						.addBox(-2.0375F, 5.0F, -4.75F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0082F)).texOffs(124, 39)
						.addBox(-1.0125F, 5.0F, -4.75F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0082F)).texOffs(124, 39)
						.addBox(0.0125F, 5.0F, -4.75F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0082F)).texOffs(124, 39)
