...
public class Modeltobylayonside<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "tobylayonside"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Head = bone.addOrReplaceChild("Head",
				CubeListBuilder.create().texOffs(36, 39)
						.addBox(-4.0F, -6.5F, -8.0F, 8.0F, 8.0F, 8.0F, new CubeDeformation(0.0F)).texOffs(64, 80)
						...
						.addBox(-4.0F, -6.5F, -8.0F, 8.0F, 8.0F, 8.0F, new CubeDeformation(0.25F)).texOffs(24, 62)
						.addBox(-4.0F, -6.5F, -8.0F, 8.0F, 8.0F, 8.0F, new CubeDeformation(0.3F)).texOffs(0, 0)
						.addBox(-7.25F, -5.675F, -11.0F, 14.0F, 1.0F, 14.0F, new CubeDeformation(0.0F)).texOffs(0, 15)
						.addBox(-6.25F, -6.175F, -10.0F, 12.0F, 1.0F, 12.0F, new CubeDeformation(0.0F)).texOffs(36, 28)
						.addBox(-5.25F, -6.675F, -9.0F, 10.0F, 1.0F, 10.0F, new CubeDeformation(0.0F)).texOffs(64, 13)
						.addBox(-4.25F, -7.175F, -8.0F, 8.0F, 1.0F, 8.0F, new CubeDeformation(0.0F)).texOffs(32, 55)
						.addBox(-3.25F, -7.675F, -7.0F, 6.0F, 1.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(50, 56)
						.addBox(-2.25F, -8.175F, -6.0F, 4.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(36, 32)
		...
		PartDefinition HeadFin_r1 = Head.addOrReplaceChild("HeadFin_r1",
				CubeListBuilder.create().texOffs(0, 73).addBox(-0.25F, -1.0F, 0.0F, 6.0F, 3.0F, 2.0F,
		...
		PartDefinition Body = bone.addOrReplaceChild("Body",
				CubeListBuilder.create().texOffs(0, 28)
						.addBox(-5.0F, -10.5F, -6.0F, 10.0F, 16.0F, 8.0F, new CubeDeformation(0.025F)).texOffs(60, 55)
						.addBox(-5.0F, -10.5F, -6.0F, 10.0F, 16.0F, 8.0F, new CubeDeformation(0.225F)),
		...
		PartDefinition Tail = Body.addOrReplaceChild("Tail", CubeListBuilder.create(),
				PartPose.offsetAndRotation(0.0F, 3.8F, -2.2F, -1.5708F, 0.0F, -0.3752F));

		PartDefinition TailPrimary = Tail.addOrReplaceChild("TailPrimary", CubeListBuilder.create(),
				PartPose.offsetAndRotation(0.0F, -0.5F, 0.75F, 0.0F, 0.0873F, 0.0F));
		...
		PartDefinition BaseLayer_r1 = TailPrimary.addOrReplaceChild("BaseLayer_r1",
				CubeListBuilder.create().texOffs(80, 37)
						.addBox(-2.0F, 0.75F, -0.8F, 4.0F, 5.0F, 4.0F, new CubeDeformation(0.05F)).texOffs(48, 19)
						.addBox(-2.0F, 0.75F, -0.8F, 4.0F, 5.0F, 4.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition TailSecondary = TailPrimary.addOrReplaceChild("TailSecondary", CubeListBuilder.create(),
				PartPose.offsetAndRotation(0.0F, 2.25F, 4.25F, 0.0F, -0.3491F, 0.0F));

		PartDefinition Base_r1 = TailSecondary
				.addOrReplaceChild("Base_r1",
						CubeListBuilder.create().texOffs(0, 17).addBox(-1.5F, -1.3563F, -0.6088F, 3.0F, 5.0F, 3.0F,
								new CubeDeformation(0.0F)),
		...
		PartDefinition Base_r4 = TailTertiary.addOrReplaceChild("Base_r4",
				CubeListBuilder.create().texOffs(88, 0).addBox(-1.0F, -0.3449F, -0.7203F, 2.0F, 5.0F, 2.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition RightFrontLeg = bone.addOrReplaceChild("RightFrontLeg",
				CubeListBuilder.create().texOffs(56, 9)
						.addBox(-2.0F, 4.0F, -4.25F, 4.0F, 2.0F, 4.0F, new CubeDeformation(0.0081F)).texOffs(30, 30)
						.addBox(-2.0375F, 5.0F, -4.75F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0082F)).texOffs(30, 30)
						.addBox(-1.0125F, 5.0F, -4.75F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0082F)).texOffs(30, 30)
						.addBox(0.0125F, 5.0F, -4.75F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0082F)).texOffs(30, 30)
		...
		PartDefinition LowerLeg_r1 = RightFrontLeg.addOrReplaceChild("LowerLeg_r1",
		...
		PartDefinition MidLeg_r1 = RightFrontLeg.addOrReplaceChild("MidLeg_r1",
				CubeListBuilder.create().texOffs(66, 22).addBox(-2.01F, -2.0F, -2.0F, 4.0F, 4.0F, 4.0F,
		...
		PartDefinition UpperLegLayer_r1 = RightFrontLeg.addOrReplaceChild("UpperLegLayer_r1",
				CubeListBuilder.create().texOffs(80, 46)
						.addBox(-2.0F, -2.5F, -2.0F, 4.0F, 5.0F, 4.0F, new CubeDeformation(0.061F)).texOffs(56, 0)
		...
		PartDefinition LowerLeg_r2 = LeftFrontLeg.addOrReplaceChild("LowerLeg_r2",
				CubeListBuilder.create().texOffs(36, 15).addBox(-2.005F, -1.5F, -1.5F, 4.0F, 3.0F, 3.0F,
						new CubeDeformation(0.0091F)),
				PartPose.offsetAndRotation(0.005F, 3.9019F, -0.817F, -0.5236F, 0.0F, 0.0F));

		PartDefinition MidLeg_r2 = LeftFrontLeg.addOrReplaceChild("MidLeg_r2",
				CubeListBuilder.create().texOffs(66, 22).addBox(-2.01F, -2.0F, -2.0F, 4.0F, 4.0F, 4.0F,
						new CubeDeformation(0.01F)),
				PartPose.offsetAndRotation(0.01F, 2.767F, -1.5135F, 0.5672F, 0.0F, 0.0F));
		...
		PartDefinition RightBackLeg = bone.addOrReplaceChild("RightBackLeg",
				CubeListBuilder.create().texOffs(56, 9)
						.addBox(-2.0F, 4.0F, -4.475F, 4.0F, 2.0F, 4.0F, new CubeDeformation(0.0081F)).texOffs(30, 30)
						.addBox(-2.0375F, 5.0F, -4.975F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0082F)).texOffs(30, 30)
						.addBox(-1.0125F, 5.0F, -4.975F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0082F)).texOffs(30, 30)
						.addBox(0.0125F, 5.0F, -4.975F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0082F)).texOffs(30, 30)
		...
		PartDefinition LowerLeg_r3 = RightBackLeg.addOrReplaceChild("LowerLeg_r3",
				CubeListBuilder.create().texOffs(36, 15).addBox(-2.005F, -1.5F, -1.5F, 4.0F, 3.0F, 3.0F,
						new CubeDeformation(0.0091F)),
				PartPose.offsetAndRotation(0.005F, 3.9019F, -1.042F, -0.5236F, 0.0F, 0.0F));

		PartDefinition MidLeg_r3 = RightBackLeg.addOrReplaceChild("MidLeg_r3",
				CubeListBuilder.create().texOffs(66, 22).addBox(-2.01F, -2.0F, -2.0F, 4.0F, 4.0F, 4.0F,
						new CubeDeformation(0.01F)),
		...
		PartDefinition LowerLeg_r4 = LeftBackLeg.addOrReplaceChild("LowerLeg_r4",
				CubeListBuilder.create().texOffs(36, 15).addBox(-2.005F, -1.5F, -1.5F, 4.0F, 3.0F, 3.0F,
						new CubeDeformation(0.0091F)),
				PartPose.offsetAndRotation(0.005F, 3.9019F, -1.042F, -0.5236F, 0.0F, 0.0F));

		PartDefinition MidLeg_r4 = LeftBackLeg.addOrReplaceChild("MidLeg_r4",
				CubeListBuilder.create().texOffs(66, 22).addBox(-2.01F, -2.0F, -2.0F, 4.0F, 4.0F, 4.0F,
						new CubeDeformation(0.01F)),
				PartPose.offsetAndRotation(0.01F, 2.767F, -1.7385F, 0.5672F, 0.0F, 0.0F));
