...
public class Modeltobysitnew<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "tobysitnew"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Body = partdefinition.addOrReplaceChild("Body",
				CubeListBuilder.create().texOffs(0, 28)
						.addBox(-5.0F, 0.0F, -4.0F, 10.0F, 16.0F, 8.0F, new CubeDeformation(0.025F)).texOffs(60, 55)
						.addBox(-5.0F, 0.0F, -4.0F, 10.0F, 16.0F, 8.0F, new CubeDeformation(0.225F)),
		...
		PartDefinition BackFin_r2 = Body
				.addOrReplaceChild("BackFin_r2",
		...
		PartDefinition Tail = Body.addOrReplaceChild("Tail", CubeListBuilder.create(),
				PartPose.offsetAndRotation(0.0F, 14.3F, -0.2F, -1.309F, 0.0F, 0.0F));
		...
		PartDefinition TailSecondary = TailPrimary.addOrReplaceChild("TailSecondary", CubeListBuilder.create(),
				PartPose.offsetAndRotation(0.0F, 2.25F, 4.25F, 0.2618F, 0.0F, 0.0F));
		...
		PartDefinition TailTertiary = TailSecondary.addOrReplaceChild("TailTertiary", CubeListBuilder.create(),
				PartPose.offsetAndRotation(0.0F, 1.5F, 4.5F, 0.288F, 0.0F, 0.0F));
		...
		PartDefinition Head = partdefinition.addOrReplaceChild("Head",
				CubeListBuilder.create().texOffs(36, 39)
						...
						.addBox(-4.0F, -6.5F, -8.0F, 8.0F, 8.0F, 8.0F, new CubeDeformation(0.025F)).texOffs(0, 80)
						...
						.addBox(-4.0F, -6.5F, -8.0F, 8.0F, 8.0F, 8.0F, new CubeDeformation(0.25F)).texOffs(0, 80)
		...
		PartDefinition RightFrontLeg = partdefinition.addOrReplaceChild("RightFrontLeg", CubeListBuilder.create(),
				PartPose.offset(-3.0F, 17.0F, -8.25F));
		...
		PartDefinition RightFrontFoot = RightFrontLowerLeg.addOrReplaceChild("RightFrontFoot",
				CubeListBuilder.create().texOffs(56, 9)
						.addBox(-2.0F, 0.0F, -3.0F, 4.0F, 2.0F, 4.0F, new CubeDeformation(0.0081F)).texOffs(30, 30)
						.addBox(-2.0375F, 1.0F, -3.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0082F)).texOffs(30, 30)
						.addBox(-1.0125F, 1.0F, -3.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0082F)).texOffs(30, 30)
						.addBox(0.0125F, 1.0F, -3.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0082F)).texOffs(30, 30)
		...
		PartDefinition RightBackLeg = partdefinition.addOrReplaceChild("RightBackLeg", CubeListBuilder.create(),
				PartPose.offsetAndRotation(-3.0F, 22.15F, 4.5F, -1.3526F, 0.0F, 0.0F));
		...
		PartDefinition UpperLegLayer_r2 = RightBackUpperLeg.addOrReplaceChild("UpperLegLayer_r2",
				CubeListBuilder.create().texOffs(80, 46).mirror()
		...
		PartDefinition MidLeg_r2 = RightBackMidLeg.addOrReplaceChild("MidLeg_r2",
				CubeListBuilder.create().texOffs(66, 22).mirror()
		...
		PartDefinition LowerLeg_r2 = RightBackLowerLeg.addOrReplaceChild("LowerLeg_r2",
		...
		PartDefinition RightBackFoot = RightBackLowerLeg.addOrReplaceChild("RightBackFoot",
				CubeListBuilder.create().texOffs(56, 9).mirror()
		...
		PartDefinition Toe_r2 = RightBackFoot.addOrReplaceChild("Toe_r2", CubeListBuilder.create().texOffs(36, 29)
				.mirror().addBox(-0.5125F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0081F)).mirror(false)
				...
				.mirror(false), PartPose.offsetAndRotation(1.55F, -0.167F, -3.8035F, -0.6109F, 0.0F, 0.0F));
		...
		PartDefinition Toe_r4 = LeftBackFoot.addOrReplaceChild("Toe_r4", CubeListBuilder.create().texOffs(36, 29)
				.mirror().addBox(-0.5125F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0081F)).mirror(false)
				.texOffs(36, 29).mirror().addBox(-1.5375F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0081F))
				.mirror(false).texOffs(36, 29).mirror()
				.addBox(-2.5625F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0081F)).mirror(false)
