...
public class AntimatterEngiePaxelItem extends Item {
	private static final ToolMaterial TOOL_MATERIAL = new ToolMaterial(BlockTags.INCORRECT_FOR_NETHERITE_TOOL, 11000, 51f, 0, 16, TagKey.create(Registries.ITEM, ResourceLocation.parse("allaboutengie:antimatter_engie_paxel_repair_items")));

	public AntimatterEngiePaxelItem(Item.Properties properties) {
		super(TOOL_MATERIAL.applyToolProperties(properties, BlockTags.MINEABLE_WITH_PICKAXE, 549f, 1.8f)
				.attributes(ItemAttributeModifiers.builder().add(Attributes.ATTACK_DAMAGE, new AttributeModifier(BASE_ATTACK_DAMAGE_ID, 549, AttributeModifier.Operation.ADD_VALUE), EquipmentSlotGroup.MAINHAND)
