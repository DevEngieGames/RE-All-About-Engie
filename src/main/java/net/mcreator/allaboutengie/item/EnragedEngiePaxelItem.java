...
public class EnragedEngiePaxelItem extends Item {
	private static final ToolMaterial TOOL_MATERIAL = new ToolMaterial(BlockTags.INCORRECT_FOR_IRON_TOOL, 1750, 19f, 0, 7, TagKey.create(Registries.ITEM, ResourceLocation.parse("allaboutengie:enraged_engie_paxel_repair_items")));

	public EnragedEngiePaxelItem(Item.Properties properties) {
		super(TOOL_MATERIAL.applyToolProperties(properties, BlockTags.MINEABLE_WITH_PICKAXE, 74f, -2.2f)
				.attributes(ItemAttributeModifiers.builder().add(Attributes.ATTACK_DAMAGE, new AttributeModifier(BASE_ATTACK_DAMAGE_ID, 74, AttributeModifier.Operation.ADD_VALUE), EquipmentSlotGroup.MAINHAND)
