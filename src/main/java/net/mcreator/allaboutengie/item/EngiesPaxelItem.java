...
public class EngiesPaxelItem extends Item {
	private static final ToolMaterial TOOL_MATERIAL = new ToolMaterial(BlockTags.INCORRECT_FOR_NETHERITE_TOOL, 8000, 42f, 0, 14, TagKey.create(Registries.ITEM, ResourceLocation.parse("allaboutengie:engies_paxel_repair_items")));

	public EngiesPaxelItem(Item.Properties properties) {
		super(TOOL_MATERIAL.applyToolProperties(properties, BlockTags.MINEABLE_WITH_PICKAXE, 399f, 0.6f)
	...
	public void appendHoverText(ItemStack itemstack, Item.TooltipContext context, List<Component> list, TooltipFlag flag) {
		...
		list.add(Component.translatable("item.allaboutengie.engies_paxel.description_0"));
	}
}