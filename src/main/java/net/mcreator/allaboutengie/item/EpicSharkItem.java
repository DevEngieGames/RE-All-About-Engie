...
public abstract class EpicSharkItem extends ArmorItem {
	public EpicSharkItem(ArmorItem.Type type, Item.Properties properties) {
	...
	public static class Helmet extends EpicSharkItem {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "allaboutengie:textures/models/armor/epicsharko__layer_1.png";
		}
	}
	...
	public static class Leggings extends EpicSharkItem {
		...
		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "allaboutengie:textures/models/armor/epicsharko__layer_2.png";
		}
	}
