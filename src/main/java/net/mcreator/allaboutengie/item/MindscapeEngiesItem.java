...
public abstract class MindscapeEngiesItem extends ArmorItem {
	public static ArmorMaterial ARMOR_MATERIAL = new ArmorMaterial(550, Map.of(ArmorType.BOOTS, 550, ArmorType.LEGGINGS, 550, ArmorType.CHESTPLATE, 550, ArmorType.HELMET, 550, ArmorType.BODY, 550), 22,
			BuiltInRegistries.SOUND_EVENT.wrapAsHolder(SoundEvents.EMPTY), 10f, 0.9f, TagKey.create(Registries.ITEM, ResourceLocation.parse("allaboutengie:mindscape_engies_repair_items")),
			ResourceKey.create(EquipmentAssets.ROOT_ID, ResourceLocation.parse("allaboutengie:mindscape_engies")));
	...
	public static void registerItemExtensions(RegisterClientExtensionsEvent event) {
		event.registerItem(new IClientItemExtensions() {
			...
			public ResourceLocation getArmorTexture(ItemStack stack, EquipmentClientInfo.LayerType type, EquipmentClientInfo.Layer layer, ResourceLocation _default) {
				return ResourceLocation.parse("allaboutengie:textures/entities/mindscapemanarmorlayer1.png");
			}
		}, AllaboutengieModItems.MINDSCAPE_ENGIES_HELMET.get());
		event.registerItem(new IClientItemExtensions() {
			@Override
			@OnlyIn(Dist.CLIENT)
			public HumanoidModel getHumanoidArmorModel(ItemStack itemStack, EquipmentClientInfo.LayerType layerType, Model original) {
		...
		}, AllaboutengieModItems.MINDSCAPE_ENGIES_CHESTPLATE.get());
		event.registerItem(new IClientItemExtensions() {
			@Override
			@OnlyIn(Dist.CLIENT)
			public HumanoidModel getHumanoidArmorModel(ItemStack itemStack, EquipmentClientInfo.LayerType layerType, Model original) {
			...
			@Override
			public ResourceLocation getArmorTexture(ItemStack stack, EquipmentClientInfo.LayerType type, EquipmentClientInfo.Layer layer, ResourceLocation _default) {
				return ResourceLocation.parse("allaboutengie:textures/entities/mindscapemanarmorlayer2.png");
			}
		}, AllaboutengieModItems.MINDSCAPE_ENGIES_LEGGINGS.get());
		event.registerItem(new IClientItemExtensions() {
			@Override
			@OnlyIn(Dist.CLIENT)
			public HumanoidModel getHumanoidArmorModel(ItemStack itemStack, EquipmentClientInfo.LayerType layerType, Model original) {
		...
		}, AllaboutengieModItems.MINDSCAPE_ENGIES_BOOTS.get());
	}
	...
	public static class Helmet extends MindscapeEngiesItem {
		...
		public void appendHoverText(ItemStack itemstack, Item.TooltipContext context, List<Component> list, TooltipFlag flag) {
			...
			list.add(Component.translatable("item.allaboutengie.mindscape_engies_helmet.description_0"));
		}
	}
	...
	public static class Chestplate extends MindscapeEngiesItem {
		...
		public void appendHoverText(ItemStack itemstack, Item.TooltipContext context, List<Component> list, TooltipFlag flag) {
			super.appendHoverText(itemstack, context, list, flag);
			list.add(Component.translatable("item.allaboutengie.mindscape_engies_chestplate.description_0"));
		}
	}
	...
	public static class Leggings extends MindscapeEngiesItem {
		...
		public void appendHoverText(ItemStack itemstack, Item.TooltipContext context, List<Component> list, TooltipFlag flag) {
			super.appendHoverText(itemstack, context, list, flag);
			list.add(Component.translatable("item.allaboutengie.mindscape_engies_leggings.description_0"));
		}
	}
	...
	public static class Boots extends MindscapeEngiesItem {
		...
		public void appendHoverText(ItemStack itemstack, Item.TooltipContext context, List<Component> list, TooltipFlag flag) {
			super.appendHoverText(itemstack, context, list, flag);
			list.add(Component.translatable("item.allaboutengie.mindscape_engies_boots.description_0"));
		}
	}
}