...
public abstract class MindscapeEngiesItem extends ArmorItem {
	public MindscapeEngiesItem(ArmorItem.Type type, Item.Properties properties) {
		super(new ArmorMaterial() {
			...
			public Ingredient getRepairIngredient() {
				return Ingredient.of(new ItemStack(AllaboutengieModItems.ANGRY_ENGIE_ESSENCE.get()), new ItemStack(AllaboutengieModItems.ENRAGED_ENGIE_ESSENCE.get()), new ItemStack(AllaboutengieModItems.OUTRAGED_ENGIE_ESSENCE.get()),
						new ItemStack(AllaboutengieModItems.BIBLICALLY_ACCURATE_ENGIE_ESSENCE.get()), new ItemStack(AllaboutengieModItems.MONSTROSITY_ENGIE_ESSENCE.get()), new ItemStack(AllaboutengieModItems.ENRAGED_COIN.get()),
						...
						new ItemStack(AllaboutengieModItems.ENGIE_COIN.get()));
			}

			@Override
			public String getName() {
				return "mindscape_engies";
			}
	...
	public static class Helmet extends MindscapeEngiesItem {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "allaboutengie:textures/entities/mindscapemanarmorlayer1.png";
		}
	}
	...
	public static class Leggings extends MindscapeEngiesItem {
		...
		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "allaboutengie:textures/entities/mindscapemanarmorlayer2.png";
		}
	}
