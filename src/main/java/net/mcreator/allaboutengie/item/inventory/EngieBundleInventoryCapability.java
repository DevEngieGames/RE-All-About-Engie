...
@EventBusSubscriber
public class EngieBundleInventoryCapability extends ComponentItemHandler {
	@SubscribeEvent
	...
	public EngieBundleInventoryCapability(MutableDataComponentHolder parent) {
	...
	public boolean isItemValid(int slot, @Nonnull ItemStack stack) {
		return stack.getItem() != AllaboutengieModItems.ENGIE_BUNDLE.get();
	}
