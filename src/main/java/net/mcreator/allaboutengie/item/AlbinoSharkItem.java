...
public abstract class AlbinoSharkItem extends ArmorItem {
	public AlbinoSharkItem(ArmorItem.Type type, Item.Properties properties) {
	...
	public static class Helmet extends AlbinoSharkItem {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "allaboutengie:textures/models/armor/albinosharko__layer_1.png";
		}
	}
	...
	public static class Leggings extends AlbinoSharkItem {
		...
		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "allaboutengie:textures/models/armor/albinosharko__layer_2.png";
		}
	}
