...
public class MonstrosityEngiePaxelItem extends Item {
	private static final ToolMaterial TOOL_MATERIAL = new ToolMaterial(BlockTags.INCORRECT_FOR_DIAMOND_TOOL, 2500, 30f, 0, 10, TagKey.create(Registries.ITEM, ResourceLocation.parse("allaboutengie:monstrosity_engie_paxel_repair_items")));

	public MonstrosityEngiePaxelItem(Item.Properties properties) {
		super(TOOL_MATERIAL.applyToolProperties(properties, BlockTags.MINEABLE_WITH_PICKAXE, 149f, -1f)
				.attributes(ItemAttributeModifiers.builder().add(Attributes.ATTACK_DAMAGE, new AttributeModifier(BASE_ATTACK_DAMAGE_ID, 149, AttributeModifier.Operation.ADD_VALUE), EquipmentSlotGroup.MAINHAND)
