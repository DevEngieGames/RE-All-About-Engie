...
public class AntimatterBiblicallyAccurateEngiePaxelItem extends Item {
	private static final ToolMaterial TOOL_MATERIAL = new ToolMaterial(BlockTags.INCORRECT_FOR_NETHERITE_TOOL, 15000, 63f, 0, 20,
			TagKey.create(Registries.ITEM, ResourceLocation.parse("allaboutengie:antimatter_biblically_accurate_engie_paxel_repair_items")));

	public AntimatterBiblicallyAccurateEngiePaxelItem(Item.Properties properties) {
		super(TOOL_MATERIAL.applyToolProperties(properties, BlockTags.MINEABLE_WITH_PICKAXE, 749f, 3.4f)
				.attributes(ItemAttributeModifiers.builder().add(Attributes.ATTACK_DAMAGE, new AttributeModifier(BASE_ATTACK_DAMAGE_ID, 749, AttributeModifier.Operation.ADD_VALUE), EquipmentSlotGroup.MAINHAND)
