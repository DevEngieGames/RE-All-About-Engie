...
public class EngiePaxelItem extends Item {
	private static final ToolMaterial TOOL_MATERIAL = new ToolMaterial(BlockTags.INCORRECT_FOR_STONE_TOOL, 750, 12f, 0, 5, TagKey.create(Registries.ITEM, ResourceLocation.parse("allaboutengie:engie_paxel_repair_items")));

	public EngiePaxelItem(Item.Properties properties) {
		super(TOOL_MATERIAL.applyToolProperties(properties, BlockTags.MINEABLE_WITH_PICKAXE, 34f, -3f)
				.attributes(ItemAttributeModifiers.builder().add(Attributes.ATTACK_DAMAGE, new AttributeModifier(BASE_ATTACK_DAMAGE_ID, 34, AttributeModifier.Operation.ADD_VALUE), EquipmentSlotGroup.MAINHAND)
