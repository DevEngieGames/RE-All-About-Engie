...
public abstract class DoomsDaysItem extends ArmorItem {
	public static ArmorMaterial ARMOR_MATERIAL = new ArmorMaterial(350, Map.of(ArmorType.BOOTS, 350, ArmorType.LEGGINGS, 350, ArmorType.CHESTPLATE, 350, ArmorType.HELMET, 350, ArmorType.BODY, 350), 15,
			BuiltInRegistries.SOUND_EVENT.wrapAsHolder(SoundEvents.EMPTY), 8f, 0.5f, TagKey.create(Registries.ITEM, ResourceLocation.parse("allaboutengie:dooms_days_repair_items")),
			ResourceKey.create(EquipmentAssets.ROOT_ID, ResourceLocation.parse("allaboutengie:dooms_days")));
	...
	public static void registerItemExtensions(RegisterClientExtensionsEvent event) {
		...
		}, AllaboutengieModItems.DOOMS_DAYS_HELMET.get());
		event.registerItem(new IClientItemExtensions() {
			@Override
			@OnlyIn(Dist.CLIENT)
			public HumanoidModel getHumanoidArmorModel(ItemStack itemStack, EquipmentClientInfo.LayerType layerType, Model original) {
		...
		}, AllaboutengieModItems.DOOMS_DAYS_CHESTPLATE.get());
		event.registerItem(new IClientItemExtensions() {
			@Override
			@OnlyIn(Dist.CLIENT)
			public HumanoidModel getHumanoidArmorModel(ItemStack itemStack, EquipmentClientInfo.LayerType layerType, Model original) {
			...
			@Override
			public ResourceLocation getArmorTexture(ItemStack stack, EquipmentClientInfo.LayerType type, EquipmentClientInfo.Layer layer, ResourceLocation _default) {
				return ResourceLocation.parse("allaboutengie:textures/entities/doomsdayarmorlayer2.png");
			}
		}, AllaboutengieModItems.DOOMS_DAYS_LEGGINGS.get());
		event.registerItem(new IClientItemExtensions() {
			@Override
			@OnlyIn(Dist.CLIENT)
			public HumanoidModel getHumanoidArmorModel(ItemStack itemStack, EquipmentClientInfo.LayerType layerType, Model original) {
		...
		}, AllaboutengieModItems.DOOMS_DAYS_BOOTS.get());
	}

	private DoomsDaysItem(ArmorType type, Item.Properties properties) {
		super(ARMOR_MATERIAL, type, properties);
	}

	public static class Helmet extends DoomsDaysItem {
		...
		public void appendHoverText(ItemStack itemstack, Item.TooltipContext context, List<Component> list, TooltipFlag flag) {
			...
			list.add(Component.translatable("item.allaboutengie.dooms_days_helmet.description_0"));
		}
	}

	public static class Chestplate extends DoomsDaysItem {
		...
		public void appendHoverText(ItemStack itemstack, Item.TooltipContext context, List<Component> list, TooltipFlag flag) {
			super.appendHoverText(itemstack, context, list, flag);
			list.add(Component.translatable("item.allaboutengie.dooms_days_chestplate.description_0"));
		}
	}

	public static class Leggings extends DoomsDaysItem {
		...
		public void appendHoverText(ItemStack itemstack, Item.TooltipContext context, List<Component> list, TooltipFlag flag) {
			super.appendHoverText(itemstack, context, list, flag);
			list.add(Component.translatable("item.allaboutengie.dooms_days_leggings.description_0"));
		}
	}

	public static class Boots extends DoomsDaysItem {
		...
		public void appendHoverText(ItemStack itemstack, Item.TooltipContext context, List<Component> list, TooltipFlag flag) {
			super.appendHoverText(itemstack, context, list, flag);
			list.add(Component.translatable("item.allaboutengie.dooms_days_boots.description_0"));
		}
	}
}