...
public class CosmicEngieGamesAxeItem extends AxeItem {
	private static final ToolMaterial TOOL_MATERIAL = new ToolMaterial(BlockTags.INCORRECT_FOR_NETHERITE_TOOL, 22000, 84f, 0, 22, TagKey.create(Registries.ITEM, ResourceLocation.parse("allaboutengie:cosmic_engie_games_axe_repair_items")));

	public CosmicEngieGamesAxeItem(Item.Properties properties) {
		super(TOOL_MATERIAL, 1099f, 6.2f, properties.fireResistant());
	}
