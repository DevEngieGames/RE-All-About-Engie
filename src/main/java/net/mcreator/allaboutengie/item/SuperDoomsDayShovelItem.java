...
public class SuperDoomsDayShovelItem extends ShovelItem {
	private static final ToolMaterial TOOL_MATERIAL = new ToolMaterial(BlockTags.INCORRECT_FOR_NETHERITE_TOOL, 6000, 36f, 0, 12, TagKey.create(Registries.ITEM, ResourceLocation.parse("allaboutengie:super_dooms_day_shovel_repair_items")));
