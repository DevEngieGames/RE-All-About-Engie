...
public class BiblicallyAccurateEngieScytheItem extends SwordItem {
	private static final ToolMaterial TOOL_MATERIAL = new ToolMaterial(BlockTags.INCORRECT_FOR_NETHERITE_TOOL, 7392, 10f, 0, 15, TagKey.create(Registries.ITEM, ResourceLocation.parse("allaboutengie:biblically_accurate_engie_scythe_repair_items")));

	public BiblicallyAccurateEngieScytheItem(Item.Properties properties) {
		super(TOOL_MATERIAL, 1847f, -2.75f, properties);
	}
