...
public class AngryEngiePaxelItem extends Item {
	private static final ToolMaterial TOOL_MATERIAL = new ToolMaterial(BlockTags.INCORRECT_FOR_STONE_TOOL, 1000, 16f, 0, 6, TagKey.create(Registries.ITEM, ResourceLocation.parse("allaboutengie:angry_engie_paxel_repair_items")));

	public AngryEngiePaxelItem(Item.Properties properties) {
		super(TOOL_MATERIAL.applyToolProperties(properties, BlockTags.MINEABLE_WITH_PICKAXE, 49f, -2.6f)
