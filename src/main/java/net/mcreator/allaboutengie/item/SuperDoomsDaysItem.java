...
public abstract class SuperDoomsDaysItem extends ArmorItem {
	public static ArmorMaterial ARMOR_MATERIAL = new ArmorMaterial(400, Map.of(ArmorType.BOOTS, 400, ArmorType.LEGGINGS, 400, ArmorType.CHESTPLATE, 400, ArmorType.HELMET, 400, ArmorType.BODY, 400), 15,
			BuiltInRegistries.SOUND_EVENT.wrapAsHolder(SoundEvents.EMPTY), 9f, 0.6f, TagKey.create(Registries.ITEM, ResourceLocation.parse("allaboutengie:super_dooms_days_repair_items")),
			ResourceKey.create(EquipmentAssets.ROOT_ID, ResourceLocation.parse("allaboutengie:super_dooms_days")));
	...
	public static void registerItemExtensions(RegisterClientExtensionsEvent event) {
		event.registerItem(new IClientItemExtensions() {
			...
			public ResourceLocation getArmorTexture(ItemStack stack, EquipmentClientInfo.LayerType type, EquipmentClientInfo.Layer layer, ResourceLocation _default) {
				return ResourceLocation.parse("allaboutengie:textures/entities/superdoomsdayarmorlayer1.png");
			}
		}, AllaboutengieModItems.SUPER_DOOMS_DAYS_HELMET.get());
		event.registerItem(new IClientItemExtensions() {
			@Override
			@OnlyIn(Dist.CLIENT)
			public HumanoidModel getHumanoidArmorModel(ItemStack itemStack, EquipmentClientInfo.LayerType layerType, Model original) {
		...
		}, AllaboutengieModItems.SUPER_DOOMS_DAYS_CHESTPLATE.get());
		event.registerItem(new IClientItemExtensions() {
			@Override
			@OnlyIn(Dist.CLIENT)
			public HumanoidModel getHumanoidArmorModel(ItemStack itemStack, EquipmentClientInfo.LayerType layerType, Model original) {
			...
			@Override
			public ResourceLocation getArmorTexture(ItemStack stack, EquipmentClientInfo.LayerType type, EquipmentClientInfo.Layer layer, ResourceLocation _default) {
				return ResourceLocation.parse("allaboutengie:textures/entities/superdoomsdayarmorlayer2.png");
			}
		}, AllaboutengieModItems.SUPER_DOOMS_DAYS_LEGGINGS.get());
		event.registerItem(new IClientItemExtensions() {
			@Override
			@OnlyIn(Dist.CLIENT)
			public HumanoidModel getHumanoidArmorModel(ItemStack itemStack, EquipmentClientInfo.LayerType layerType, Model original) {
		...
		}, AllaboutengieModItems.SUPER_DOOMS_DAYS_BOOTS.get());
	}

	private SuperDoomsDaysItem(ArmorType type, Item.Properties properties) {
		super(ARMOR_MATERIAL, type, properties);
	}

	public static class Helmet extends SuperDoomsDaysItem {
		...
		public void appendHoverText(ItemStack itemstack, Item.TooltipContext context, List<Component> list, TooltipFlag flag) {
			...
			list.add(Component.translatable("item.allaboutengie.super_dooms_days_helmet.description_0"));
		}
	}

	public static class Chestplate extends SuperDoomsDaysItem {
		...
		public void appendHoverText(ItemStack itemstack, Item.TooltipContext context, List<Component> list, TooltipFlag flag) {
			super.appendHoverText(itemstack, context, list, flag);
			list.add(Component.translatable("item.allaboutengie.super_dooms_days_chestplate.description_0"));
		}
	}

	public static class Leggings extends SuperDoomsDaysItem {
		...
		public void appendHoverText(ItemStack itemstack, Item.TooltipContext context, List<Component> list, TooltipFlag flag) {
			super.appendHoverText(itemstack, context, list, flag);
			list.add(Component.translatable("item.allaboutengie.super_dooms_days_leggings.description_0"));
		}
	}

	public static class Boots extends SuperDoomsDaysItem {
		...
		public void appendHoverText(ItemStack itemstack, Item.TooltipContext context, List<Component> list, TooltipFlag flag) {
			super.appendHoverText(itemstack, context, list, flag);
			list.add(Component.translatable("item.allaboutengie.super_dooms_days_boots.description_0"));
		}
	}
}