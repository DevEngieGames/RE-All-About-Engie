...
public abstract class SuperDoomsDaysItem extends ArmorItem {
	public SuperDoomsDaysItem(ArmorItem.Type type, Item.Properties properties) {
		super(new ArmorMaterial() {
			@Override
			public int getDurabilityForType(ArmorItem.Type type) {
				return new int[]{13, 15, 16, 11}[type.getSlot().getIndex()] * 450;
			}

			@Override
			public int getDefenseForType(ArmorItem.Type type) {
				return new int[]{450, 450, 450, 450}[type.getSlot().getIndex()];
			}
	...
	public static class Helmet extends SuperDoomsDaysItem {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "allaboutengie:textures/entities/superdoomsdayarmorlayer1.png";
		}
	}
	...
	public static class Leggings extends SuperDoomsDaysItem {
		...
		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "allaboutengie:textures/entities/superdoomsdayarmorlayer2.png";
		}
	}
