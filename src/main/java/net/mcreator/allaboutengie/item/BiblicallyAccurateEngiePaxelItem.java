...
public class BiblicallyAccurateEngiePaxelItem extends Item {
	private static final ToolMaterial TOOL_MATERIAL = new ToolMaterial(BlockTags.INCORRECT_FOR_DIAMOND_TOOL, 2250, 27f, 0, 9, TagKey.create(Registries.ITEM, ResourceLocation.parse("allaboutengie:biblically_accurate_engie_paxel_repair_items")));

	public BiblicallyAccurateEngiePaxelItem(Item.Properties properties) {
		super(TOOL_MATERIAL.applyToolProperties(properties, BlockTags.MINEABLE_WITH_PICKAXE, 124f, -1.4f)
