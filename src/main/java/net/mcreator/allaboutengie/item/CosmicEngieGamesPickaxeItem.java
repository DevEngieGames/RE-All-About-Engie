...
public class CosmicEngieGamesPickaxeItem extends PickaxeItem {
	private static final ToolMaterial TOOL_MATERIAL = new ToolMaterial(BlockTags.INCORRECT_FOR_NETHERITE_TOOL, 22000, 84f, 0, 22, TagKey.create(Registries.ITEM, ResourceLocation.parse("allaboutengie:cosmic_engie_games_pickaxe_repair_items")));
