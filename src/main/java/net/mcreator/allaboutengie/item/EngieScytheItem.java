...
public class EngieScytheItem extends SwordItem {
	private static final ToolMaterial TOOL_MATERIAL = new ToolMaterial(BlockTags.INCORRECT_FOR_STONE_TOOL, 32000, 4f, 0, 22, TagKey.create(Registries.ITEM, ResourceLocation.parse("allaboutengie:engie_scythe_repair_items")));
