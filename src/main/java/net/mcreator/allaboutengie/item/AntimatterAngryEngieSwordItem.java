...
public class AntimatterAngryEngieSwordItem extends SwordItem {
	private static final ToolMaterial TOOL_MATERIAL = new ToolMaterial(BlockTags.INCORRECT_FOR_STONE_TOOL, 12000, 54f, 0, 17, TagKey.create(Registries.ITEM, ResourceLocation.parse("allaboutengie:antimatter_angry_engie_sword_repair_items")));
