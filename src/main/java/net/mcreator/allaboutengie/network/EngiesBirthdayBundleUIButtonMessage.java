...
public class EngiesBirthdayBundleUIButtonMessage {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		HashMap guistate = EngiesBirthdayBundleUIMenu.guistate;
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		AllaboutengieMod.addNetworkMessage(EngiesBirthdayBundleUIButtonMessage.class, EngiesBirthdayBundleUIButtonMessage::buffer, EngiesBirthdayBundleUIButtonMessage::new, EngiesBirthdayBundleUIButtonMessage::handler);
	}
}
