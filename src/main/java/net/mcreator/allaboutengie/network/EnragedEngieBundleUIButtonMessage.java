...
import net.mcreator.allaboutengie.procedures.EnragedEngieBundleNameChangeProcedure;
...
public record EnragedEngieBundleUIButtonMessage(int buttonID, int x, int y, int z) implements CustomPacketPayload {
	...
	public static final Type<EnragedEngieBundleUIButtonMessage> TYPE = new Type<>(ResourceLocation.fromNamespaceAndPath(AllaboutengieMod.MODID, "enraged_engie_bundle_ui_buttons"));
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		AllaboutengieMod.addNetworkMessage(EnragedEngieBundleUIButtonMessage.TYPE, EnragedEngieBundleUIButtonMessage.STREAM_CODEC, EnragedEngieBundleUIButtonMessage::handleData);
	}
}