...
public class MetalChestUIMenu extends AbstractContainerMenu implements AllaboutengieModMenus.MenuAccessor {
	public final Map<String, Object> menuState = new HashMap<>() {
		@Override
		public Object put(String key, Object value) {
			if (!this.containsKey(key) && this.size() >= 112)
				return null;
	...
	public MetalChestUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		...
		this.customSlots.put(0, this.addSlot(new SlotItemHandler(internal, 0, 5, 6) {
			...
			private int x = MetalChestUIMenu.this.x;
			private int y = MetalChestUIMenu.this.y;
		}));
