...
public class EnragedEngieBundleUIMenu extends AbstractContainerMenu implements AllaboutengieModMenus.MenuAccessor {
	public final Map<String, Object> menuState = new HashMap<>() {
		@Override
		public Object put(String key, Object value) {
			if (!this.containsKey(key) && this.size() >= 73)
				return null;
	...
	public EnragedEngieBundleUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		...
		this.customSlots.put(0, this.addSlot(new SlotItemHandler(internal, 0, 10, 46) {
			...
			private int x = EnragedEngieBundleUIMenu.this.x;
			private int y = EnragedEngieBundleUIMenu.this.y;
		}));
