...
public class OutragedEngieBundleUIMenu extends AbstractContainerMenu implements AllaboutengieModMenus.MenuAccessor {
	public final Map<String, Object> menuState = new HashMap<>() {
		@Override
		public Object put(String key, Object value) {
			if (!this.containsKey(key) && this.size() >= 83)
				return null;
	...
	public OutragedEngieBundleUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		...
		this.customSlots.put(0, this.addSlot(new SlotItemHandler(internal, 0, 7, 46) {
			...
			private int x = OutragedEngieBundleUIMenu.this.x;
			private int y = OutragedEngieBundleUIMenu.this.y;
		}));
