...
public class BirthdayBundleForYoungestUIMenu extends AbstractContainerMenu implements AllaboutengieModMenus.MenuAccessor {
	...
	public BirthdayBundleForYoungestUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		...
		this.customSlots.put(0, this.addSlot(new SlotItemHandler(internal, 0, 12, 41) {
			...
			private int x = BirthdayBundleForYoungestUIMenu.this.x;
			private int y = BirthdayBundleForYoungestUIMenu.this.y;
		}));
