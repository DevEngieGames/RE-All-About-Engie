...
public class EnragedTNT8Entity extends Monster {
	public EnragedTNT8Entity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.ENRAGED_TNT_8.get(), world);
	}

	public EnragedTNT8Entity(EntityType<EnragedTNT8Entity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 15;
		setNoAi(false);
	...
	public SoundEvent getHurtSound(DamageSource ds) {
		return ForgeRegistries.SOUND_EVENTS.getValue(ResourceLocation.parse("entity.zombie.step"));
	}
