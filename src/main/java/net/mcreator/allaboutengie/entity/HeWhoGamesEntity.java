...
import net.mcreator.allaboutengie.procedures.HeWhoGamesOnEntityTickUpdateProcedure;
import net.mcreator.allaboutengie.procedures.HeWhoGamesNaturalEntitySpawningConditionProcedure;
...
public class HeWhoGamesEntity extends PathfinderMob {
	public HeWhoGamesEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.HE_WHO_GAMES.get(), world);
	}
