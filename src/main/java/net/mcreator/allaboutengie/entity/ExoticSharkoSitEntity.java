...
import net.mcreator.allaboutengie.procedures.ExoticSitRCProcedure;
import net.mcreator.allaboutengie.init.AllaboutengieModEntities;

public class ExoticSharkoSitEntity extends PathfinderMob {
	public final AnimationState animationState0 = new AnimationState();

	public ExoticSharkoSitEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.EXOTIC_SHARKO_SIT.get(), world);
	}

	public ExoticSharkoSitEntity(EntityType<ExoticSharkoSitEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
	...
	public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
		...
		ExoticSitRCProcedure.execute(world, x, y, z, entity, sourceentity);
		return retval;
	}
