...
public class EnragedNormal9Entity extends Monster {
	public EnragedNormal9Entity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.ENRAGED_NORMAL_9.get(), world);
	}

	public EnragedNormal9Entity(EntityType<EnragedNormal9Entity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 15;
		setNoAi(false);
