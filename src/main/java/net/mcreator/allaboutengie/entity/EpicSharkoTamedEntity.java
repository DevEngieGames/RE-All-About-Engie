...
public class EpicSharkoTamedEntity extends PathfinderMob {
	public EpicSharkoTamedEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.EPIC_SHARKO_TAMED.get(), world);
	}

	public EpicSharkoTamedEntity(EntityType<EpicSharkoTamedEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
	...
	public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
		...
		EpicSharkoTameRCProcedure.execute(world, x, y, z, entity, sourceentity);
		return retval;
	}
