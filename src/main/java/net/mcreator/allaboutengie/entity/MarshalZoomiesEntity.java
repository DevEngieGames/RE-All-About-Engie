...
public class MarshalZoomiesEntity extends PathfinderMob {
	public final AnimationState animationState0 = new AnimationState();

	public MarshalZoomiesEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.MARSHAL_ZOOMIES.get(), world);
	}

	public MarshalZoomiesEntity(EntityType<MarshalZoomiesEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
