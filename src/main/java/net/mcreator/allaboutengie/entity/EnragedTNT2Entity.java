...
public class EnragedTNT2Entity extends Monster {
	public EnragedTNT2Entity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.ENRAGED_TNT_2.get(), world);
	}

	public EnragedTNT2Entity(EntityType<EnragedTNT2Entity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 15;
		setNoAi(false);
