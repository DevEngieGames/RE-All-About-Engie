...
import net.mcreator.allaboutengie.procedures.SharkoTameRC2Procedure;
...
public class SharkoLayEntity extends PathfinderMob {
	...
	public SharkoLayEntity(EntityType<SharkoLayEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	...
	public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
		...
		SharkoTameRC2Procedure.execute(world, x, y, z, entity, sourceentity);
		return retval;
	}
