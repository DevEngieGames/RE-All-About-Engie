...
import net.mcreator.allaboutengie.procedures.ExoticTameRCProcedure;
...
public class ExoticSharkoTamedEntity extends PathfinderMob {
	...
	public ExoticSharkoTamedEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.EXOTIC_SHARKO_TAMED.get(), world);
	}
	...
	public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
		...
		ExoticTameRCProcedure.execute(world, x, y, z, entity, sourceentity);
		return retval;
	}
