...
public class Bothan2netSleepEntity extends PathfinderMob {
	...
	public Bothan2netSleepEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.BOTHAN_2NET_SLEEP.get(), world);
	}

	public Bothan2netSleepEntity(EntityType<Bothan2netSleepEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
