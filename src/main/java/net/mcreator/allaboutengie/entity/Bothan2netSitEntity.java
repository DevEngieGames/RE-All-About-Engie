...
public class Bothan2netSitEntity extends PathfinderMob {
	public final AnimationState animationState0 = new AnimationState();

	public Bothan2netSitEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.BOTHAN_2NET_SIT.get(), world);
	}

	public Bothan2netSitEntity(EntityType<Bothan2netSitEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
