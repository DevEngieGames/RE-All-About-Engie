...
public class AlbinoSharkoSleepEntity extends PathfinderMob {
	public final AnimationState animationState0 = new AnimationState();

	public AlbinoSharkoSleepEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.ALBINO_SHARKO_SLEEP.get(), world);
	}

	public AlbinoSharkoSleepEntity(EntityType<AlbinoSharkoSleepEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
