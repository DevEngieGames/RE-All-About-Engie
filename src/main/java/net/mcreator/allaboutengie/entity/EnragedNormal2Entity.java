...
public class EnragedNormal2Entity extends Monster {
	public EnragedNormal2Entity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.ENRAGED_NORMAL_2.get(), world);
	}

	public EnragedNormal2Entity(EntityType<EnragedNormal2Entity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 15;
		setNoAi(false);
