...
public class EnragedNormal8Entity extends Monster {
	public EnragedNormal8Entity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.ENRAGED_NORMAL_8.get(), world);
	}

	public EnragedNormal8Entity(EntityType<EnragedNormal8Entity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 15;
		setNoAi(false);
