...
import net.mcreator.allaboutengie.procedures.AtlasRCProcedure;
import net.mcreator.allaboutengie.init.AllaboutengieModEntities;

public class AtlasEntity extends PathfinderMob {
	public final AnimationState animationState0 = new AnimationState();

	public AtlasEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.ATLAS.get(), world);
	}
	...
	public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
		...
		AtlasRCProcedure.execute(world, x, y, z, entity, sourceentity);
		return retval;
	}
