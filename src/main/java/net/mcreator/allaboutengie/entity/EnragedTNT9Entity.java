...
public class EnragedTNT9Entity extends Monster {
	public EnragedTNT9Entity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.ENRAGED_TNT_9.get(), world);
	}

	public EnragedTNT9Entity(EntityType<EnragedTNT9Entity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 15;
		setNoAi(false);
