...
import net.mcreator.allaboutengie.procedures.EngieRareSharkoAprilFoolsTameRCProcedure;
import net.mcreator.allaboutengie.init.AllaboutengieModEntities;

public class EngieSharkoRareTamedAprilFoolsEntity extends PathfinderMob {
	public EngieSharkoRareTamedAprilFoolsEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.ENGIE_SHARKO_RARE_TAMED_APRIL_FOOLS.get(), world);
	}

	public EngieSharkoRareTamedAprilFoolsEntity(EntityType<EngieSharkoRareTamedAprilFoolsEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
	...
	public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
		...
		EngieRareSharkoAprilFoolsTameRCProcedure.execute(world, x, y, z, entity, sourceentity);
		return retval;
	}
