...
import net.mcreator.allaboutengie.procedures.CosmoRCProcedure;
import net.mcreator.allaboutengie.init.AllaboutengieModEntities;

public class CosmoEntity extends PathfinderMob {
	public final AnimationState animationState0 = new AnimationState();

	public CosmoEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.COSMO.get(), world);
	}

	public CosmoEntity(EntityType<CosmoEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
	...
	public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
		...
		CosmoRCProcedure.execute(world, x, y, z, entity, sourceentity);
		return retval;
	}
