...
public class ExoticSharkoSleepEntity extends PathfinderMob {
	public final AnimationState animationState0 = new AnimationState();

	public ExoticSharkoSleepEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.EXOTIC_SHARKO_SLEEP.get(), world);
	}

	public ExoticSharkoSleepEntity(EntityType<ExoticSharkoSleepEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
