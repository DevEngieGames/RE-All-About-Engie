...
public class Bothan2netZoomiesEntity extends PathfinderMob {
	public final AnimationState animationState0 = new AnimationState();

	public Bothan2netZoomiesEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.BOTHAN_2NET_ZOOMIES.get(), world);
	}

	public Bothan2netZoomiesEntity(EntityType<Bothan2netZoomiesEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
