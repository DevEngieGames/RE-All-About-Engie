...
public class EnragedNormal5Entity extends Monster {
	public EnragedNormal5Entity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.ENRAGED_NORMAL_5.get(), world);
	}

	public EnragedNormal5Entity(EntityType<EnragedNormal5Entity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 15;
		setNoAi(false);
