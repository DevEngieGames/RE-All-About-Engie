...
import net.mcreator.allaboutengie.procedures.SharkoSitRCProcedure;
...
public class SharkoSitEntity extends PathfinderMob {
	public final AnimationState animationState0 = new AnimationState();

	public SharkoSitEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.SHARKO_SIT.get(), world);
	}

	public SharkoSitEntity(EntityType<SharkoSitEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
	...
	public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
		...
		SharkoSitRCProcedure.execute(world, x, y, z, entity, sourceentity);
		return retval;
	}
