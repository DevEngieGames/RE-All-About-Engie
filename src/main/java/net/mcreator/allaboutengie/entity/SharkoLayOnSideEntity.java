...
import net.mcreator.allaboutengie.procedures.SharkoLayOnSideRCProcedure;
...
public class SharkoLayOnSideEntity extends PathfinderMob {
	public final AnimationState animationState0 = new AnimationState();

	public SharkoLayOnSideEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.SHARKO_LAY_ON_SIDE.get(), world);
	}

	public SharkoLayOnSideEntity(EntityType<SharkoLayOnSideEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
	...
	public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
		...
		SharkoLayOnSideRCProcedure.execute(world, x, y, z, entity, sourceentity);
		return retval;
	}
