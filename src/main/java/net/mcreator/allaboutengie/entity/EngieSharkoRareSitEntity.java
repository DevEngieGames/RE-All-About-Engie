...
import net.mcreator.allaboutengie.procedures.EngieRareSitRCProcedure;
import net.mcreator.allaboutengie.init.AllaboutengieModEntities;

public class EngieSharkoRareSitEntity extends PathfinderMob {
	public final AnimationState animationState0 = new AnimationState();

	public EngieSharkoRareSitEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.ENGIE_SHARKO_RARE_SIT.get(), world);
	}

	public EngieSharkoRareSitEntity(EntityType<EngieSharkoRareSitEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
	...
	public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
		...
		EngieRareSitRCProcedure.execute(world, x, y, z, entity, sourceentity);
		return retval;
	}
