...
import net.mcreator.allaboutengie.procedures.SharkoTameRCProcedure;
...
public class SharkTamedEntity extends PathfinderMob {
	public final AnimationState animationState0 = new AnimationState();

	public SharkTamedEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.SHARKO_TAMED.get(), world);
	}

	public SharkTamedEntity(EntityType<SharkTamedEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
	...
	public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
		...
		SharkoTameRCProcedure.execute(world, x, y, z, entity, sourceentity);
		return retval;
	}
