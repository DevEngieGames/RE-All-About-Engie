...
public class EngieSharkoRare2SitEntity extends PathfinderMob {
	public final AnimationState animationState0 = new AnimationState();

	public EngieSharkoRare2SitEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.TIGER_SHARKO_SIT.get(), world);
	}

	public EngieSharkoRare2SitEntity(EntityType<EngieSharkoRare2SitEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
	...
	public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
		...
		EngieRare2LayRCProcedure.execute(world, x, y, z, entity, sourceentity);
		return retval;
	}
