...
public class RareSharkoSleepEntity extends PathfinderMob {
	public final AnimationState animationState0 = new AnimationState();

	public RareSharkoSleepEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.RARE_SHARKO_SLEEP.get(), world);
	}

	public RareSharkoSleepEntity(EntityType<RareSharkoSleepEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
