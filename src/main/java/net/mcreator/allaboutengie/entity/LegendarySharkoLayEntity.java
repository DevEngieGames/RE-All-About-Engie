...
import net.mcreator.allaboutengie.procedures.LegendaryTameRC2Procedure;

public class LegendarySharkoLayEntity extends PathfinderMob {
	public final AnimationState animationState0 = new AnimationState();

	public LegendarySharkoLayEntity(EntityType<LegendarySharkoLayEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	...
	public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
		...
		LegendaryTameRC2Procedure.execute(world, x, y, z, entity, sourceentity);
		return retval;
	}
