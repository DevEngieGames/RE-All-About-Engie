...
public class Bothan2netZoomiesTiredEntity extends PathfinderMob {
	public final AnimationState animationState0 = new AnimationState();

	public Bothan2netZoomiesTiredEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.BOTHAN_2NET_ZOOMIES_TIRED.get(), world);
	}

	public Bothan2netZoomiesTiredEntity(EntityType<Bothan2netZoomiesTiredEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
