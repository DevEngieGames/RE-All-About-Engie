...
import net.mcreator.allaboutengie.procedures.SharkoChanceForLayOnSideProcedure;
import net.mcreator.allaboutengie.procedures.FinneganLayRCProcedure;
import net.mcreator.allaboutengie.init.AllaboutengieModEntities;

public class FinneganLayEntity extends PathfinderMob {
	public final AnimationState animationState0 = new AnimationState();

	public FinneganLayEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.FINNEGAN_LAY.get(), world);
	}

	public FinneganLayEntity(EntityType<FinneganLayEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
		setCustomName(Component.literal("Finnegan"));
	...
	public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
		...
		FinneganLayRCProcedure.execute(world, x, y, z, entity, sourceentity);
		return retval;
	}
