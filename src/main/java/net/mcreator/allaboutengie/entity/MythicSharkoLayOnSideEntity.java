...
import net.mcreator.allaboutengie.procedures.MythicLayOnSideRCProcedure;
import net.mcreator.allaboutengie.init.AllaboutengieModEntities;

public class MythicSharkoLayOnSideEntity extends PathfinderMob {
	public final AnimationState animationState0 = new AnimationState();

	public MythicSharkoLayOnSideEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.MYTHIC_SHARKO_LAY_ON_SIDE.get(), world);
	}

	public MythicSharkoLayOnSideEntity(EntityType<MythicSharkoLayOnSideEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
	...
	public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
		...
		MythicLayOnSideRCProcedure.execute(world, x, y, z, entity, sourceentity);
		return retval;
	}
