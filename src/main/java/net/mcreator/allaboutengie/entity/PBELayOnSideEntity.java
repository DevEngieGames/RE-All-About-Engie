...
import net.mcreator.allaboutengie.procedures.PBELayOnSideRCProcedure;
import net.mcreator.allaboutengie.init.AllaboutengieModEntities;

public class PBELayOnSideEntity extends PathfinderMob {
	public final AnimationState animationState0 = new AnimationState();

	public PBELayOnSideEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.PBE_LAY_ON_SIDE.get(), world);
	}

	public PBELayOnSideEntity(EntityType<PBELayOnSideEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
	...
	public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
		...
		PBELayOnSideRCProcedure.execute(world, x, y, z, entity, sourceentity);
		return retval;
	}
