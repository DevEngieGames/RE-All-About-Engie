...
import net.mcreator.allaboutengie.procedures.MythicTameRCProcedure;
...
public class MythicSharkoTamedEntity extends PathfinderMob {
	...
	public MythicSharkoTamedEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.MYTHIC_SHARKO_TAMED.get(), world);
	}
	...
	public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
		...
		MythicTameRCProcedure.execute(world, x, y, z, entity, sourceentity);
		return retval;
	}
