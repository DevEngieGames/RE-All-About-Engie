...
public class EngieSharkoTamedZoomiesTiredEntity extends PathfinderMob {
	public EngieSharkoTamedZoomiesTiredEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.ENGIE_SHARKO_TAMED_ZOOMIES_TIRED.get(), world);
	}

	public EngieSharkoTamedZoomiesTiredEntity(EntityType<EngieSharkoTamedZoomiesTiredEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
