...
public class EnragedSpeed4Entity extends Monster {
	public EnragedSpeed4Entity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.ENRAGED_SPEED_4.get(), world);
	}

	public EnragedSpeed4Entity(EntityType<EnragedSpeed4Entity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 15;
		setNoAi(false);
