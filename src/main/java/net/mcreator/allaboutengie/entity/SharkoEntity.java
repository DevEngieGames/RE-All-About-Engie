...
import net.mcreator.allaboutengie.procedures.SharkoRCTameProcedure;
...
public class SharkoEntity extends PathfinderMob {
	...
	public SharkoEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.SHARKO.get(), world);
	}
	...
	public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
		...
		SharkoRCTameProcedure.execute(world, x, y, z, entity, sourceentity);
		return retval;
	}
	...
	public static void init() {
		SpawnPlacements.register(AllaboutengieModEntities.SHARKO.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
			int x = pos.getX();
			int y = pos.getY();
			int z = pos.getZ();
