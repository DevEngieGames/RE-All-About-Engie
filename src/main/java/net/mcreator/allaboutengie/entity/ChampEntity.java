...
import net.mcreator.allaboutengie.procedures.ChampRCProcedure;
import net.mcreator.allaboutengie.init.AllaboutengieModEntities;

public class ChampEntity extends PathfinderMob {
	public final AnimationState animationState0 = new AnimationState();

	public ChampEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.CHAMP.get(), world);
	}

	public ChampEntity(EntityType<ChampEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
	...
	public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
		...
		ChampRCProcedure.execute(world, x, y, z, entity, sourceentity);
		return retval;
	}
