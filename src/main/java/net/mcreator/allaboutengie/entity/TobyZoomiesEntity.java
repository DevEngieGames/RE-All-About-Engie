...
public class TobyZoomiesEntity extends PathfinderMob {
	public final AnimationState animationState0 = new AnimationState();

	public TobyZoomiesEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.TOBY_ZOOMIES.get(), world);
	}

	public TobyZoomiesEntity(EntityType<TobyZoomiesEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
