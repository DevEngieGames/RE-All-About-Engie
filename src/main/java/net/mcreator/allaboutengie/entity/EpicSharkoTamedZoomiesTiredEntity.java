...
public class EpicSharkoTamedZoomiesTiredEntity extends PathfinderMob {
	public EpicSharkoTamedZoomiesTiredEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.EPIC_SHARKO_TAMED_ZOOMIES_TIRED.get(), world);
	}

	public EpicSharkoTamedZoomiesTiredEntity(EntityType<EpicSharkoTamedZoomiesTiredEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
