...
public class ExoticSharkoTamedZoomiesTiredEntity extends PathfinderMob {
	public ExoticSharkoTamedZoomiesTiredEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.EXOTIC_SHARKO_TAMED_ZOOMIES_TIRED.get(), world);
	}

	public ExoticSharkoTamedZoomiesTiredEntity(EntityType<ExoticSharkoTamedZoomiesTiredEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
