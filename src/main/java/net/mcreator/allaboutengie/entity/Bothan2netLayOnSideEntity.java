...
import net.mcreator.allaboutengie.procedures.Bothan2netLayOnSideRCProcedure;
import net.mcreator.allaboutengie.init.AllaboutengieModEntities;

public class Bothan2netLayOnSideEntity extends PathfinderMob {
	public final AnimationState animationState0 = new AnimationState();

	public Bothan2netLayOnSideEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.BOTHAN_2NET_LAY_ON_SIDE.get(), world);
	}

	public Bothan2netLayOnSideEntity(EntityType<Bothan2netLayOnSideEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
	...
	public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
		...
		Bothan2netLayOnSideRCProcedure.execute(entity);
		return retval;
	}
