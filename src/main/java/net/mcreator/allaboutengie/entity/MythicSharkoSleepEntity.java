...
public class MythicSharkoSleepEntity extends PathfinderMob {
	...
	public MythicSharkoSleepEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.MYTHIC_SHARKO_SLEEP.get(), world);
	}

	public MythicSharkoSleepEntity(EntityType<MythicSharkoSleepEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
