...
import net.mcreator.allaboutengie.procedures.RockyRCProcedure;
import net.mcreator.allaboutengie.procedures.RockyOnTickUpdateProcedure;
import net.mcreator.allaboutengie.init.AllaboutengieModEntities;

public class RockyEntity extends PathfinderMob {
	public final AnimationState animationState0 = new AnimationState();

	public RockyEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.ROCKY.get(), world);
	}
	...
	public RockyEntity(EntityType<RockyEntity> type, Level world) {
		...
		xpReward = 0;
		setNoAi(false);
		setCustomName(Component.literal("Rocky"));
	...
	public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
		...
		RockyRCProcedure.execute(world, x, y, z, entity, sourceentity);
		return retval;
	}
	...
	public void baseTick() {
		super.baseTick();
		RockyOnTickUpdateProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
	}
