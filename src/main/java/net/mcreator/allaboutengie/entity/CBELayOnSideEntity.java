...
import net.mcreator.allaboutengie.procedures.CBELayOnSideRCProcedure;
import net.mcreator.allaboutengie.init.AllaboutengieModEntities;

public class CBELayOnSideEntity extends PathfinderMob {
	public final AnimationState animationState0 = new AnimationState();

	public CBELayOnSideEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.CBE_LAY_ON_SIDE.get(), world);
	}

	public CBELayOnSideEntity(EntityType<CBELayOnSideEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
	...
	public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
		...
		CBELayOnSideRCProcedure.execute(world, x, y, z, entity, sourceentity);
		return retval;
	}
