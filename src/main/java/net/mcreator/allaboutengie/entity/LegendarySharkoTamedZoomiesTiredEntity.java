...
public class LegendarySharkoTamedZoomiesTiredEntity extends PathfinderMob {
	public LegendarySharkoTamedZoomiesTiredEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.LEGENDARY_SHARKO_TAMED_ZOOMIES_TIRED.get(), world);
	}

	public LegendarySharkoTamedZoomiesTiredEntity(EntityType<LegendarySharkoTamedZoomiesTiredEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
