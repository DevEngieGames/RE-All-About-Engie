...
import net.mcreator.allaboutengie.procedures.TonyLayRCProcedure;
...
public class TonyLayEntity extends PathfinderMob {
	public final AnimationState animationState0 = new AnimationState();

	public TonyLayEntity(EntityType<TonyLayEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	...
	public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
		...
		TonyLayRCProcedure.execute(world, x, y, z, entity, sourceentity);
		return retval;
	}
