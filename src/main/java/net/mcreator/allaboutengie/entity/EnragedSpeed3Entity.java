...
public class EnragedSpeed3Entity extends Monster {
	public EnragedSpeed3Entity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.ENRAGED_SPEED_3.get(), world);
	}

	public EnragedSpeed3Entity(EntityType<EnragedSpeed3Entity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 15;
		setNoAi(false);
