...
public class ThrowbackBloodyEngieEntity extends Monster {
	public ThrowbackBloodyEngieEntity(EntityType<ThrowbackBloodyEngieEntity> type, Level world) {
		super(type, world);
		xpReward = 10;
		setNoAi(false);
	}
	...
	protected void registerGoals() {
		...
		this.targetSelector.addGoal(5, new NearestAttackableTargetGoal(this, Monster.class, true, false) {
			...
			public boolean canUse() {
				double x = ThrowbackBloodyEngieEntity.this.getX();
				double y = ThrowbackBloodyEngieEntity.this.getY();
				double z = ThrowbackBloodyEngieEntity.this.getZ();
				Entity entity = ThrowbackBloodyEngieEntity.this;
				Level world = ThrowbackBloodyEngieEntity.this.level();
	...
	protected void dropCustomDeathLoot(ServerLevel serverLevel, DamageSource source, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(serverLevel, new ItemStack(AllaboutengieModItems.BLOOD_INGOT.get()));
	}
	...
	public static void init(RegisterSpawnPlacementsEvent event) {
		event.register(AllaboutengieModEntities.THROWBACK_BLOODY_ENGIE.get(), SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
			int x = pos.getX();
			int y = pos.getY();
			int z = pos.getZ();
