...
import net.mcreator.allaboutengie.procedures.EpicSharkoAprilFoolsTameRCProcedure;
import net.mcreator.allaboutengie.init.AllaboutengieModEntities;

public class EpicSharkoTamedAprilFoolsEntity extends PathfinderMob {
	public EpicSharkoTamedAprilFoolsEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.EPIC_SHARKO_TAMED_APRIL_FOOLS.get(), world);
	}

	public EpicSharkoTamedAprilFoolsEntity(EntityType<EpicSharkoTamedAprilFoolsEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
	...
	public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
		...
		EpicSharkoAprilFoolsTameRCProcedure.execute(world, x, y, z, entity, sourceentity);
		return retval;
	}
