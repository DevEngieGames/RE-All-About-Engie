...
import net.mcreator.allaboutengie.procedures.BigEngieRareTameRCProcedure;
import net.mcreator.allaboutengie.init.AllaboutengieModEntities;

public class BigEngieSharkoRareTamedEntity extends PathfinderMob {
	public final AnimationState animationState0 = new AnimationState();

	public BigEngieSharkoRareTamedEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.BIG_ENGIE_SHARKO_RARE_TAMED.get(), world);
	}

	public BigEngieSharkoRareTamedEntity(EntityType<BigEngieSharkoRareTamedEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
	...
	public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
		...
		BigEngieRareTameRCProcedure.execute(world, x, y, z, entity, sourceentity);
		return retval;
	}
