...
public class EngieSharkoRare2TamedAprilFoolsEntity extends PathfinderMob {
	public EngieSharkoRare2TamedAprilFoolsEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.ENGIE_SHARKO_RARE_2_TAMED_APRIL_FOOLS.get(), world);
	}

	public EngieSharkoRare2TamedAprilFoolsEntity(EntityType<EngieSharkoRare2TamedAprilFoolsEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
