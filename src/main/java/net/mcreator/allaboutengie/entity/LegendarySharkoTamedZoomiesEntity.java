...
public class LegendarySharkoTamedZoomiesEntity extends PathfinderMob {
	public final AnimationState animationState0 = new AnimationState();

	public LegendarySharkoTamedZoomiesEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.LEGENDARY_SHARKO_TAMED_ZOOMIES.get(), world);
	}

	public LegendarySharkoTamedZoomiesEntity(EntityType<LegendarySharkoTamedZoomiesEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
