...
import net.mcreator.allaboutengie.procedures.PBERCProcedure;
import net.mcreator.allaboutengie.init.AllaboutengieModEntities;

public class PBEEntity extends PathfinderMob {
	public final AnimationState animationState0 = new AnimationState();

	public PBEEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.PBE.get(), world);
	}

	public PBEEntity(EntityType<PBEEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
