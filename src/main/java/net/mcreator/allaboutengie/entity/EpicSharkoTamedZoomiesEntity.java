...
public class EpicSharkoTamedZoomiesEntity extends PathfinderMob {
	public final AnimationState animationState0 = new AnimationState();

	public EpicSharkoTamedZoomiesEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.EPIC_SHARKO_TAMED_ZOOMIES.get(), world);
	}

	public EpicSharkoTamedZoomiesEntity(EntityType<EpicSharkoTamedZoomiesEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
