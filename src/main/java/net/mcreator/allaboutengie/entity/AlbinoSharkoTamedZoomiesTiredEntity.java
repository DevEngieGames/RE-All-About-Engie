...
public class AlbinoSharkoTamedZoomiesTiredEntity extends PathfinderMob {
	public AlbinoSharkoTamedZoomiesTiredEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.ALBINO_SHARKO_TAMED_ZOOMIES_TIRED.get(), world);
	}

	public AlbinoSharkoTamedZoomiesTiredEntity(EntityType<AlbinoSharkoTamedZoomiesTiredEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
