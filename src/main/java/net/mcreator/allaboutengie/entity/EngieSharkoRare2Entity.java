...
public class EngieSharkoRare2Entity extends PathfinderMob {
	...
	public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
		...
		EngieRare2RCTameProcedure.execute(world, x, y, z, entity, sourceentity);
		return retval;
	}
	...
	public static void init(RegisterSpawnPlacementsEvent event) {
		event.register(AllaboutengieModEntities.TIGER_SHARKO.get(), SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
			int x = pos.getX();
			int y = pos.getY();
			int z = pos.getZ();
