...
import net.mcreator.allaboutengie.procedures.EpicSharkoTameRC2Procedure;

public class EpicSharkoLayEntity extends PathfinderMob {
	public final AnimationState animationState0 = new AnimationState();

	public EpicSharkoLayEntity(EntityType<EpicSharkoLayEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	...
	public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
		...
		EpicSharkoTameRC2Procedure.execute(world, x, y, z, entity, sourceentity);
		return retval;
	}
