...
import net.mcreator.allaboutengie.procedures.TonyRCProcedure;
...
public class TonyEntity extends PathfinderMob {
	public final AnimationState animationState0 = new AnimationState();

	public TonyEntity(EntityType<TonyEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	...
	public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
		...
		TonyRCProcedure.execute(world, x, y, z, entity, sourceentity);
		return retval;
	}
