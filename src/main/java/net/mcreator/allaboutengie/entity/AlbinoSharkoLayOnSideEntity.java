...
import net.mcreator.allaboutengie.procedures.AlbinoLayOnSideRCProcedure;
import net.mcreator.allaboutengie.init.AllaboutengieModEntities;

public class AlbinoSharkoLayOnSideEntity extends PathfinderMob {
	public final AnimationState animationState0 = new AnimationState();

	public AlbinoSharkoLayOnSideEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.ALBINO_SHARKO_LAY_ON_SIDE.get(), world);
	}

	public AlbinoSharkoLayOnSideEntity(EntityType<AlbinoSharkoLayOnSideEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
	...
	public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
		...
		AlbinoLayOnSideRCProcedure.execute(world, x, y, z, entity, sourceentity);
		return retval;
	}
