...
public class AtlasZoomiesEntity extends PathfinderMob {
	public final AnimationState animationState0 = new AnimationState();

	public AtlasZoomiesEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.ATLAS_ZOOMIES.get(), world);
	}

	public AtlasZoomiesEntity(EntityType<AtlasZoomiesEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
		setCustomName(Component.literal("Atlas"));
