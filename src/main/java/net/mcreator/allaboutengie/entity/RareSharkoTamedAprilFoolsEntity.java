...
import net.mcreator.allaboutengie.procedures.RareSharkoAprilFoolsTameRCProcedure;
import net.mcreator.allaboutengie.init.AllaboutengieModEntities;

public class RareSharkoTamedAprilFoolsEntity extends PathfinderMob {
	public RareSharkoTamedAprilFoolsEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.RARE_SHARKO_TAMED_APRIL_FOOLS.get(), world);
	}

	public RareSharkoTamedAprilFoolsEntity(EntityType<RareSharkoTamedAprilFoolsEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
	...
	public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
		...
		RareSharkoAprilFoolsTameRCProcedure.execute(world, x, y, z, entity, sourceentity);
		return retval;
	}
