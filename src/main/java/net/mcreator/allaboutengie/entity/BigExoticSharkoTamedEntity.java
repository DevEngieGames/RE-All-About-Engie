...
import net.mcreator.allaboutengie.procedures.BigExoticTameRCProcedure;
import net.mcreator.allaboutengie.init.AllaboutengieModEntities;

public class BigExoticSharkoTamedEntity extends PathfinderMob {
	public final AnimationState animationState0 = new AnimationState();

	public BigExoticSharkoTamedEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.BIG_EXOTIC_SHARKO_TAMED.get(), world);
	}

	public BigExoticSharkoTamedEntity(EntityType<BigExoticSharkoTamedEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
	...
	public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
		...
		BigExoticTameRCProcedure.execute(world, x, y, z, entity, sourceentity);
		return retval;
	}
