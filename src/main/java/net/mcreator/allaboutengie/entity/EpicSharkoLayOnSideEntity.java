...
import net.mcreator.allaboutengie.procedures.EpicSharkoLayOnSideRCProcedure;
import net.mcreator.allaboutengie.init.AllaboutengieModEntities;

public class EpicSharkoLayOnSideEntity extends PathfinderMob {
	public final AnimationState animationState0 = new AnimationState();

	public EpicSharkoLayOnSideEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.EPIC_SHARKO_LAY_ON_SIDE.get(), world);
	}

	public EpicSharkoLayOnSideEntity(EntityType<EpicSharkoLayOnSideEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
	...
	public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
		...
		EpicSharkoLayOnSideRCProcedure.execute(world, x, y, z, entity, sourceentity);
		return retval;
	}
