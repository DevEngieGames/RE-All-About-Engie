...
import net.mcreator.allaboutengie.procedures.AlbinoSharkoAprilFoolsTameRCProcedure;
import net.mcreator.allaboutengie.init.AllaboutengieModEntities;

public class AlbinoSharkoTamedAprilFoolsEntity extends PathfinderMob {
	public AlbinoSharkoTamedAprilFoolsEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.ALBINO_SHARKO_TAMED_APRIL_FOOLS.get(), world);
	}

	public AlbinoSharkoTamedAprilFoolsEntity(EntityType<AlbinoSharkoTamedAprilFoolsEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
	...
	public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
		...
		AlbinoSharkoAprilFoolsTameRCProcedure.execute(world, x, y, z, entity, sourceentity);
		return retval;
	}
