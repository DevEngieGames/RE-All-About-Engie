...
public class PBEZoomiesEntity extends PathfinderMob {
	public final AnimationState animationState0 = new AnimationState();

	public PBEZoomiesEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.PBE_ZOOMIES.get(), world);
	}

	public PBEZoomiesEntity(EntityType<PBEZoomiesEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
