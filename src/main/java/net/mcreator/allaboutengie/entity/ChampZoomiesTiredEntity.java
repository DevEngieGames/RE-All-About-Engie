...
public class ChampZoomiesTiredEntity extends PathfinderMob {
	public final AnimationState animationState0 = new AnimationState();

	public ChampZoomiesTiredEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.CHAMP_ZOOMIES_TIRED.get(), world);
	}

	public ChampZoomiesTiredEntity(EntityType<ChampZoomiesTiredEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
