...
import net.mcreator.allaboutengie.procedures.MythicSitRCProcedure;
import net.mcreator.allaboutengie.init.AllaboutengieModEntities;

public class MythicSharkoSitEntity extends PathfinderMob {
	public final AnimationState animationState0 = new AnimationState();

	public MythicSharkoSitEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.MYTHIC_SHARKO_SIT.get(), world);
	}

	public MythicSharkoSitEntity(EntityType<MythicSharkoSitEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
	...
	public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
		...
		MythicSitRCProcedure.execute(world, x, y, z, entity, sourceentity);
		return retval;
	}
