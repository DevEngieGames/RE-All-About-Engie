...
import net.mcreator.allaboutengie.procedures.BigAlbinoTameRCProcedure;
import net.mcreator.allaboutengie.init.AllaboutengieModEntities;

public class BigAlbinoSharkoTamedEntity extends PathfinderMob {
	public final AnimationState animationState0 = new AnimationState();

	public BigAlbinoSharkoTamedEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.BIG_ALBINO_SHARKO_TAMED.get(), world);
	}

	public BigAlbinoSharkoTamedEntity(EntityType<BigAlbinoSharkoTamedEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
	...
	public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
		...
		BigAlbinoTameRCProcedure.execute(world, x, y, z, entity, sourceentity);
		return retval;
	}
