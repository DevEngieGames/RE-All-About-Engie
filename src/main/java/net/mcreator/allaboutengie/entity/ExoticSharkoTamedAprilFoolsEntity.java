...
import net.mcreator.allaboutengie.procedures.ExoticSharkoAprilFoolsTameRCProcedure;
import net.mcreator.allaboutengie.init.AllaboutengieModEntities;

public class ExoticSharkoTamedAprilFoolsEntity extends PathfinderMob {
	public ExoticSharkoTamedAprilFoolsEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.EXOTIC_SHARKO_TAMED_APRIL_FOOLS.get(), world);
	}

	public ExoticSharkoTamedAprilFoolsEntity(EntityType<ExoticSharkoTamedAprilFoolsEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
	...
	public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
		...
		ExoticSharkoAprilFoolsTameRCProcedure.execute(world, x, y, z, entity, sourceentity);
		return retval;
	}
