...
public class EnragedSpeed9Entity extends Monster {
	public EnragedSpeed9Entity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.ENRAGED_SPEED_9.get(), world);
	}

	public EnragedSpeed9Entity(EntityType<EnragedSpeed9Entity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 15;
		setNoAi(false);
