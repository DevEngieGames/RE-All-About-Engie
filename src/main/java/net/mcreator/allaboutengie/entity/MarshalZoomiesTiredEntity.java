...
public class MarshalZoomiesTiredEntity extends PathfinderMob {
	public final AnimationState animationState0 = new AnimationState();

	public MarshalZoomiesTiredEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.MARSHAL_ZOOMIES_TIRED.get(), world);
	}

	public MarshalZoomiesTiredEntity(EntityType<MarshalZoomiesTiredEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
