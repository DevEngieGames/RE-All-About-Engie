...
public class EnragedSpeed6Entity extends Monster {
	public EnragedSpeed6Entity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.ENRAGED_SPEED_6.get(), world);
	}

	public EnragedSpeed6Entity(EntityType<EnragedSpeed6Entity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 15;
		setNoAi(false);
