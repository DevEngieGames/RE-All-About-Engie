...
public class EnragedEngieStyle3Entity extends Monster {
	public EnragedEngieStyle3Entity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.ENRAGED_ENGIE_STYLE_3.get(), world);
	}

	public EnragedEngieStyle3Entity(EntityType<EnragedEngieStyle3Entity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 25;
		setNoAi(false);
	...
	protected void registerGoals() {
		...
		this.targetSelector.addGoal(5, new NearestAttackableTargetGoal(this, Monster.class, true, false) {
			...
			public boolean canUse() {
				double x = EnragedEngieStyle3Entity.this.getX();
				double y = EnragedEngieStyle3Entity.this.getY();
				double z = EnragedEngieStyle3Entity.this.getZ();
				Entity entity = EnragedEngieStyle3Entity.this;
				Level world = EnragedEngieStyle3Entity.this.level();
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(AllaboutengieModItems.ENRAGED_ENGIE_ESSENCE.get()));
	}
	...
	public static void init() {
		SpawnPlacements.register(AllaboutengieModEntities.ENRAGED_ENGIE_STYLE_3.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
			int x = pos.getX();
			int y = pos.getY();
			int z = pos.getZ();
