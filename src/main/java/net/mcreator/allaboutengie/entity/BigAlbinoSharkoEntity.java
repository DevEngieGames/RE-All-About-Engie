...
import net.mcreator.allaboutengie.procedures.BigAlbinoRCTameProcedure;
...
public class BigAlbinoSharkoEntity extends PathfinderMob {
	...
	public BigAlbinoSharkoEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.BIG_ALBINO_SHARKO.get(), world);
	}
	...
	public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
		...
		BigAlbinoRCTameProcedure.execute(world, x, y, z, entity, sourceentity);
		return retval;
	}
