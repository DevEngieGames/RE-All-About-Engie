...
public class EnragedEngieColdSeasonEntity extends Monster {
	public EnragedEngieColdSeasonEntity(EntityType<EnragedEngieColdSeasonEntity> type, Level world) {
		super(type, world);
		xpReward = 25;
		setNoAi(false);
	}
	...
	protected void registerGoals() {
		...
		this.targetSelector.addGoal(5, new NearestAttackableTargetGoal(this, Monster.class, true, false) {
			...
			public boolean canUse() {
				double x = EnragedEngieColdSeasonEntity.this.getX();
				double y = EnragedEngieColdSeasonEntity.this.getY();
				double z = EnragedEngieColdSeasonEntity.this.getZ();
				Entity entity = EnragedEngieColdSeasonEntity.this;
				Level world = EnragedEngieColdSeasonEntity.this.level();
