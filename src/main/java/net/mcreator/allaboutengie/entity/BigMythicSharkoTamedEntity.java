...
import net.mcreator.allaboutengie.procedures.BigMythicTameRCProcedure;
import net.mcreator.allaboutengie.init.AllaboutengieModEntities;

public class BigMythicSharkoTamedEntity extends PathfinderMob {
	public final AnimationState animationState0 = new AnimationState();

	public BigMythicSharkoTamedEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.BIG_MYTHIC_SHARKO_TAMED.get(), world);
	}

	public BigMythicSharkoTamedEntity(EntityType<BigMythicSharkoTamedEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
	...
	public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
		...
		BigMythicTameRCProcedure.execute(world, x, y, z, entity, sourceentity);
		return retval;
	}
