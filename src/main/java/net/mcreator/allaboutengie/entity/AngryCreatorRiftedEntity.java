...
public class AngryCreatorRiftedEntity extends Monster {
	public AngryCreatorRiftedEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.ANGRY_CREATOR_RIFTED.get(), world);
	}

	public AngryCreatorRiftedEntity(EntityType<AngryCreatorRiftedEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 25;
		setNoAi(false);
	...
	protected void registerGoals() {
		...
		this.targetSelector.addGoal(5, new NearestAttackableTargetGoal(this, Monster.class, true, false) {
			...
			public boolean canUse() {
				double x = AngryCreatorRiftedEntity.this.getX();
				double y = AngryCreatorRiftedEntity.this.getY();
				double z = AngryCreatorRiftedEntity.this.getZ();
				Entity entity = AngryCreatorRiftedEntity.this;
				Level world = AngryCreatorRiftedEntity.this.level();
