...
import net.mcreator.allaboutengie.procedures.SharkoTamedZoomTimerProcedure;
import net.mcreator.allaboutengie.procedures.SharkoKilledByPlayersCountUpProcedure;
import net.mcreator.allaboutengie.init.AllaboutengieModEntities;

public class EngieSharkoRareTamedZoomiesEntity extends PathfinderMob {
	public final AnimationState animationState0 = new AnimationState();

	public EngieSharkoRareTamedZoomiesEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.ENGIE_SHARKO_RARE_TAMED_ZOOMIES.get(), world);
	}

	public EngieSharkoRareTamedZoomiesEntity(EntityType<EngieSharkoRareTamedZoomiesEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
	...
	public void baseTick() {
		super.baseTick();
		SharkoTamedZoomTimerProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
	}
	...
	public static AttributeSupplier.Builder createAttributes() {
		...
		builder = builder.add(Attributes.ARMOR, 27.5);
