...
public class BigRareSharkoLayEntity extends PathfinderMob {
	public final AnimationState animationState0 = new AnimationState();

	public BigRareSharkoLayEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.BIG_RARE_SHARKO_LAY.get(), world);
	}

	public BigRareSharkoLayEntity(EntityType<BigRareSharkoLayEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
