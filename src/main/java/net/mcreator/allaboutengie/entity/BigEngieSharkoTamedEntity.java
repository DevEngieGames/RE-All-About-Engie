...
import net.mcreator.allaboutengie.procedures.BigEngieTameRCProcedure;
import net.mcreator.allaboutengie.init.AllaboutengieModEntities;

public class BigEngieSharkoTamedEntity extends PathfinderMob {
	public final AnimationState animationState0 = new AnimationState();

	public BigEngieSharkoTamedEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.BIG_ENGIE_SHARKO_TAMED.get(), world);
	}

	public BigEngieSharkoTamedEntity(EntityType<BigEngieSharkoTamedEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
	...
	public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
		...
		BigEngieTameRCProcedure.execute(world, x, y, z, entity, sourceentity);
		return retval;
	}
