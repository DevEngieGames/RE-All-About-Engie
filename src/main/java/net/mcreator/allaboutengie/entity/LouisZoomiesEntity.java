...
public class LouisZoomiesEntity extends PathfinderMob {
	public final AnimationState animationState0 = new AnimationState();

	public LouisZoomiesEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.LOUIS_ZOOMIES.get(), world);
	}

	public LouisZoomiesEntity(EntityType<LouisZoomiesEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
