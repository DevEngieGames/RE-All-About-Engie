...
import net.mcreator.allaboutengie.procedures.AlbinoTameRCProcedure;
...
public class AlbinoSharkoTamedEntity extends PathfinderMob {
	...
	public AlbinoSharkoTamedEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.ALBINO_SHARKO_TAMED.get(), world);
	}
	...
	public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
		...
		AlbinoTameRCProcedure.execute(world, x, y, z, entity, sourceentity);
		return retval;
	}
