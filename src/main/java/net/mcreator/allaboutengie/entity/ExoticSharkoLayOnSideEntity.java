...
import net.mcreator.allaboutengie.procedures.ExoticLayOnSideRCProcedure;
import net.mcreator.allaboutengie.init.AllaboutengieModEntities;

public class ExoticSharkoLayOnSideEntity extends PathfinderMob {
	public final AnimationState animationState0 = new AnimationState();

	public ExoticSharkoLayOnSideEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.EXOTIC_SHARKO_LAY_ON_SIDE.get(), world);
	}

	public ExoticSharkoLayOnSideEntity(EntityType<ExoticSharkoLayOnSideEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
	...
	public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
		...
		ExoticLayOnSideRCProcedure.execute(world, x, y, z, entity, sourceentity);
		return retval;
	}
