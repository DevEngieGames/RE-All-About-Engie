...
public class EnragedEngieOldRiftedEntity extends Monster {
	public EnragedEngieOldRiftedEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.ENRAGED_ENGIE_OLD_RIFTED.get(), world);
	}

	public EnragedEngieOldRiftedEntity(EntityType<EnragedEngieOldRiftedEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 25;
		setNoAi(false);
	...
	protected void registerGoals() {
		...
		this.targetSelector.addGoal(5, new NearestAttackableTargetGoal(this, Monster.class, true, false) {
			...
			public boolean canUse() {
				double x = EnragedEngieOldRiftedEntity.this.getX();
				double y = EnragedEngieOldRiftedEntity.this.getY();
				double z = EnragedEngieOldRiftedEntity.this.getZ();
				Entity entity = EnragedEngieOldRiftedEntity.this;
				Level world = EnragedEngieOldRiftedEntity.this.level();
