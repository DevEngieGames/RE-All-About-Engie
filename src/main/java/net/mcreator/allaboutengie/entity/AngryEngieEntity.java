...
public class AngryEngieEntity extends Monster {
	public AngryEngieEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.ANGRY_ENGIE.get(), world);
	}
	...
	protected void registerGoals() {
		...
		this.targetSelector.addGoal(5, new NearestAttackableTargetGoal(this, Monster.class, true, false) {
			...
			public boolean canUse() {
				double x = AngryEngieEntity.this.getX();
				double y = AngryEngieEntity.this.getY();
				double z = AngryEngieEntity.this.getZ();
				Entity entity = AngryEngieEntity.this;
				Level world = AngryEngieEntity.this.level();
	...
	public static void init() {
		SpawnPlacements.register(AllaboutengieModEntities.ANGRY_ENGIE.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
			int x = pos.getX();
			int y = pos.getY();
			int z = pos.getZ();
