...
public class EnragedTNT5Entity extends Monster {
	public EnragedTNT5Entity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.ENRAGED_TNT_5.get(), world);
	}

	public EnragedTNT5Entity(EntityType<EnragedTNT5Entity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 15;
		setNoAi(false);
