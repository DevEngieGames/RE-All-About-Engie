...
public class EnragedTNT3Entity extends Monster {
	public EnragedTNT3Entity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.ENRAGED_TNT_3.get(), world);
	}

	public EnragedTNT3Entity(EntityType<EnragedTNT3Entity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 15;
		setNoAi(false);
