...
import net.mcreator.allaboutengie.procedures.DoomsDayHostileEntityDiesProcedure;
...
public class DoomsDayHostileEntity extends Monster {
	public DoomsDayHostileEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.DOOMS_DAY_HOSTILE.get(), world);
	}
	...
	public static void init() {
		SpawnPlacements.register(AllaboutengieModEntities.DOOMS_DAY_HOSTILE.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
			int x = pos.getX();
			int y = pos.getY();
			int z = pos.getZ();
