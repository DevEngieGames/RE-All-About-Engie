...
public class PBEZoomiesTiredEntity extends PathfinderMob {
	public final AnimationState animationState0 = new AnimationState();

	public PBEZoomiesTiredEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.PBE_ZOOMIES_TIRED.get(), world);
	}

	public PBEZoomiesTiredEntity(EntityType<PBEZoomiesTiredEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
