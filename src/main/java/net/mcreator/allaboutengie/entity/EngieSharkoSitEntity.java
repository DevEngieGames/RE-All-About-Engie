...
import net.mcreator.allaboutengie.procedures.EngieSitRCProcedure;
import net.mcreator.allaboutengie.init.AllaboutengieModEntities;

public class EngieSharkoSitEntity extends PathfinderMob {
	public final AnimationState animationState0 = new AnimationState();

	public EngieSharkoSitEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.ENGIE_SHARKO_SIT.get(), world);
	}

	public EngieSharkoSitEntity(EntityType<EngieSharkoSitEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
	...
	public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
		...
		EngieSitRCProcedure.execute(world, x, y, z, entity, sourceentity);
		return retval;
	}
