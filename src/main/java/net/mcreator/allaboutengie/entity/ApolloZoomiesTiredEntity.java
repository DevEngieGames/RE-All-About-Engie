...
public class ApolloZoomiesTiredEntity extends PathfinderMob {
	public ApolloZoomiesTiredEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.APOLLO_ZOOMIES_TIRED.get(), world);
	}

	public ApolloZoomiesTiredEntity(EntityType<ApolloZoomiesTiredEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
