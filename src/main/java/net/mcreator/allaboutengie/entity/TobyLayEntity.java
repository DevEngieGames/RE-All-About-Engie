...
public class TobyLayEntity extends PathfinderMob {
	...
	public TobyLayEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.TOBY_LAY.get(), world);
	}

	public TobyLayEntity(EntityType<TobyLayEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
