...
public class EpicSharkoSleepEntity extends PathfinderMob {
	public final AnimationState animationState0 = new AnimationState();

	public EpicSharkoSleepEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.EPIC_SHARKO_SLEEP.get(), world);
	}

	public EpicSharkoSleepEntity(EntityType<EpicSharkoSleepEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
