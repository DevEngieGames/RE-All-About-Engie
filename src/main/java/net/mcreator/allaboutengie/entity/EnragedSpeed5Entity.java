...
public class EnragedSpeed5Entity extends Monster {
	public EnragedSpeed5Entity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.ENRAGED_SPEED_5.get(), world);
	}

	public EnragedSpeed5Entity(EntityType<EnragedSpeed5Entity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 15;
		setNoAi(false);
