...
public class AngryCreatorEntity extends Monster {
	...
	public static void init() {
		SpawnPlacements.register(AllaboutengieModEntities.OUTRAGED_ENGIE.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
			int x = pos.getX();
			int y = pos.getY();
			int z = pos.getZ();
