...
import net.mcreator.allaboutengie.procedures.EngieRareLayOnSideRCProcedure;
import net.mcreator.allaboutengie.init.AllaboutengieModEntities;

public class EngieSharkoRareLayOnSideEntity extends PathfinderMob {
	public final AnimationState animationState0 = new AnimationState();

	public EngieSharkoRareLayOnSideEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.ENGIE_SHARKO_RARE_LAY_ON_SIDE.get(), world);
	}

	public EngieSharkoRareLayOnSideEntity(EntityType<EngieSharkoRareLayOnSideEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
	...
	public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
		...
		EngieRareLayOnSideRCProcedure.execute(world, x, y, z, entity, sourceentity);
		return retval;
	}
