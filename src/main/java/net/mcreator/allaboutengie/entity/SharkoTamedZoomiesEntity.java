...
public class SharkoTamedZoomiesEntity extends PathfinderMob {
	public final AnimationState animationState0 = new AnimationState();

	public SharkoTamedZoomiesEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.SHARKO_TAMED_ZOOMIES.get(), world);
	}

	public SharkoTamedZoomiesEntity(EntityType<SharkoTamedZoomiesEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
