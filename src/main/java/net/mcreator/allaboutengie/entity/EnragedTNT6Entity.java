...
public class EnragedTNT6Entity extends Monster {
	public EnragedTNT6Entity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.ENRAGED_TNT_6.get(), world);
	}

	public EnragedTNT6Entity(EntityType<EnragedTNT6Entity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 15;
		setNoAi(false);
