...
public class CreatorEntity extends PathfinderMob {
	public CreatorEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.CREATOR.get(), world);
	}
	...
	public static void init() {
		SpawnPlacements.register(AllaboutengieModEntities.CREATOR.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
