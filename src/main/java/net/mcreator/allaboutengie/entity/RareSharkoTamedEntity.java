...
import net.mcreator.allaboutengie.procedures.RareTameRCProcedure;
...
public class RareSharkoTamedEntity extends PathfinderMob {
	...
	public RareSharkoTamedEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.RARE_SHARKO_TAMED.get(), world);
	}
	...
	public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
		...
		RareTameRCProcedure.execute(world, x, y, z, entity, sourceentity);
		return retval;
	}
