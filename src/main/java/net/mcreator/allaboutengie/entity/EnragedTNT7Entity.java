...
public class EnragedTNT7Entity extends Monster {
	public EnragedTNT7Entity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.ENRAGED_TNT_7.get(), world);
	}

	public EnragedTNT7Entity(EntityType<EnragedTNT7Entity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 15;
		setNoAi(false);
