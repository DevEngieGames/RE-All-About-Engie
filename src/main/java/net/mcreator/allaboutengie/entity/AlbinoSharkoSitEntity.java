...
import net.mcreator.allaboutengie.procedures.AlbinoSitRCProcedure;
import net.mcreator.allaboutengie.init.AllaboutengieModEntities;

public class AlbinoSharkoSitEntity extends PathfinderMob {
	public final AnimationState animationState0 = new AnimationState();

	public AlbinoSharkoSitEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.ALBINO_SHARKO_SIT.get(), world);
	}

	public AlbinoSharkoSitEntity(EntityType<AlbinoSharkoSitEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
	...
	public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
		...
		AlbinoSitRCProcedure.execute(world, x, y, z, entity, sourceentity);
		return retval;
	}
