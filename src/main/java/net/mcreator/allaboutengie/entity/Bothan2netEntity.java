...
import net.mcreator.allaboutengie.procedures.Bothan2netRCProcedure;
import net.mcreator.allaboutengie.init.AllaboutengieModEntities;

public class Bothan2netEntity extends PathfinderMob {
	public final AnimationState animationState0 = new AnimationState();

	public Bothan2netEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.BOTHAN_2NET.get(), world);
	}

	public Bothan2netEntity(EntityType<Bothan2netEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
	...
	public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
		...
		Bothan2netRCProcedure.execute(entity);
		return retval;
	}
