...
import net.mcreator.allaboutengie.procedures.BuddyLayOnSideRCProcedure;
import net.mcreator.allaboutengie.init.AllaboutengieModEntities;

public class BuddyLayOnSideEntity extends PathfinderMob {
	public final AnimationState animationState0 = new AnimationState();

	public BuddyLayOnSideEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.BUDDY_LAY_ON_SIDE.get(), world);
	}

	public BuddyLayOnSideEntity(EntityType<BuddyLayOnSideEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
	...
	public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
		...
		BuddyLayOnSideRCProcedure.execute(world, x, y, z, entity, sourceentity);
		return retval;
	}
