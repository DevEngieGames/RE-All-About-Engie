...
public class FinneganZoomiesTiredEntity extends PathfinderMob {
	public final AnimationState animationState0 = new AnimationState();

	public FinneganZoomiesTiredEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.FINNEGAN_ZOOMIES_TIRED.get(), world);
	}

	public FinneganZoomiesTiredEntity(EntityType<FinneganZoomiesTiredEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
