...
import net.mcreator.allaboutengie.procedures.ChampLayOnSideRCProcedure;
import net.mcreator.allaboutengie.init.AllaboutengieModEntities;

public class ChampLayOnSideEntity extends PathfinderMob {
	public final AnimationState animationState0 = new AnimationState();

	public ChampLayOnSideEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.CHAMP_LAY_ON_SIDE.get(), world);
	}

	public ChampLayOnSideEntity(EntityType<ChampLayOnSideEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
	...
	public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
		...
		ChampLayOnSideRCProcedure.execute(world, x, y, z, entity, sourceentity);
		return retval;
	}
