...
public class EnragedNormal7Entity extends Monster {
	public EnragedNormal7Entity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.ENRAGED_NORMAL_7.get(), world);
	}

	public EnragedNormal7Entity(EntityType<EnragedNormal7Entity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 15;
		setNoAi(false);
