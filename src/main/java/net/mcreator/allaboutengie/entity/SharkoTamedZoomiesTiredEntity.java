...
public class SharkoTamedZoomiesTiredEntity extends PathfinderMob {
	public SharkoTamedZoomiesTiredEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.SHARKO_TAMED_ZOOMIES_TIRED.get(), world);
	}

	public SharkoTamedZoomiesTiredEntity(EntityType<SharkoTamedZoomiesTiredEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
