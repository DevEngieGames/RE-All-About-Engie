...
import net.mcreator.allaboutengie.procedures.TigerLayRCProcedure;
...
public class TigerLayEntity extends PathfinderMob {
	public final AnimationState animationState0 = new AnimationState();

	public TigerLayEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.TIGER_LAY.get(), world);
	}

	public TigerLayEntity(EntityType<TigerLayEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
