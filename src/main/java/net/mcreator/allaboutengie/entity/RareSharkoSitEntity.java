...
import net.mcreator.allaboutengie.procedures.RareSitRCProcedure;
import net.mcreator.allaboutengie.init.AllaboutengieModEntities;

public class RareSharkoSitEntity extends PathfinderMob {
	public final AnimationState animationState0 = new AnimationState();

	public RareSharkoSitEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.RARE_SHARKO_SIT.get(), world);
	}

	public RareSharkoSitEntity(EntityType<RareSharkoSitEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
	...
	public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
		...
		RareSitRCProcedure.execute(world, x, y, z, entity, sourceentity);
		return retval;
	}
