...
import net.mcreator.allaboutengie.procedures.BigRareTameRCProcedure;
import net.mcreator.allaboutengie.init.AllaboutengieModEntities;

public class BigRareSharkoTamedEntity extends PathfinderMob {
	public final AnimationState animationState0 = new AnimationState();

	public BigRareSharkoTamedEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.BIG_RARE_SHARKO_TAMED.get(), world);
	}

	public BigRareSharkoTamedEntity(EntityType<BigRareSharkoTamedEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
	...
	public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
		...
		BigRareTameRCProcedure.execute(world, x, y, z, entity, sourceentity);
		return retval;
	}
