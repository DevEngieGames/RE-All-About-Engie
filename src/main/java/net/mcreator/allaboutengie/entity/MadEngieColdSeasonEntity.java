...
public class MadEngieColdSeasonEntity extends Monster {
	public MadEngieColdSeasonEntity(EntityType<MadEngieColdSeasonEntity> type, Level world) {
		super(type, world);
		xpReward = 10;
		setNoAi(false);
	}
	...
	protected void registerGoals() {
		...
		this.targetSelector.addGoal(5, new NearestAttackableTargetGoal(this, Monster.class, true, false) {
			...
			public boolean canUse() {
				double x = MadEngieColdSeasonEntity.this.getX();
				double y = MadEngieColdSeasonEntity.this.getY();
				double z = MadEngieColdSeasonEntity.this.getZ();
				Entity entity = MadEngieColdSeasonEntity.this;
				Level world = MadEngieColdSeasonEntity.this.level();
