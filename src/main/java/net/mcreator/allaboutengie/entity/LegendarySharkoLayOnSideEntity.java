...
import net.mcreator.allaboutengie.procedures.LegendaryLayOnSideRCProcedure;
import net.mcreator.allaboutengie.init.AllaboutengieModEntities;

public class LegendarySharkoLayOnSideEntity extends PathfinderMob {
	public final AnimationState animationState0 = new AnimationState();

	public LegendarySharkoLayOnSideEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.LEGENDARY_SHARKO_LAY_ON_SIDE.get(), world);
	}

	public LegendarySharkoLayOnSideEntity(EntityType<LegendarySharkoLayOnSideEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
	...
	public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
		...
		LegendaryLayOnSideRCProcedure.execute(world, x, y, z, entity, sourceentity);
		return retval;
	}
