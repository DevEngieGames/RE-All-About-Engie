...
import net.mcreator.allaboutengie.procedures.CBELayRCProcedure;
import net.mcreator.allaboutengie.init.AllaboutengieModEntities;

public class CBELayEntity extends PathfinderMob {
	public final AnimationState animationState0 = new AnimationState();

	public CBELayEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.CBE_LAY.get(), world);
	}

	public CBELayEntity(EntityType<CBELayEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
