...
public class EnragedEngieSharkoEntity extends Monster {
	...
	public static void init(RegisterSpawnPlacementsEvent event) {
		event.register(AllaboutengieModEntities.ENRAGED_ENGIE_SHARKO.get(), SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
			int x = pos.getX();
			int y = pos.getY();
			int z = pos.getZ();
