...
public class TigerZoomiesEntity extends PathfinderMob {
	public final AnimationState animationState0 = new AnimationState();

	public TigerZoomiesEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.TIGER_ZOOMIES.get(), world);
	}

	public TigerZoomiesEntity(EntityType<TigerZoomiesEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
		setCustomName(Component.literal("Tiger"));
