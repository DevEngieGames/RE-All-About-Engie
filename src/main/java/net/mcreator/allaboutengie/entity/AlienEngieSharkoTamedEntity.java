...
import net.mcreator.allaboutengie.procedures.AlienEngieSharkoTameRCProcedure;
import net.mcreator.allaboutengie.init.AllaboutengieModEntities;

public class AlienEngieSharkoTamedEntity extends PathfinderMob {
	public final AnimationState animationState0 = new AnimationState();

	public AlienEngieSharkoTamedEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.ALIEN_ENGIE_SHARKO_TAMED.get(), world);
	}

	public AlienEngieSharkoTamedEntity(EntityType<AlienEngieSharkoTamedEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
	...
	public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
		...
		AlienEngieSharkoTameRCProcedure.execute(world, x, y, z, entity, sourceentity);
		return retval;
	}
