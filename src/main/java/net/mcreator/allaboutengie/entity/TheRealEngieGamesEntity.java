...
import net.mcreator.allaboutengie.procedures.TheRealEngieGamesOnInitialEntitySpawnProcedure;
...
public class TheRealEngieGamesEntity extends PathfinderMob {
	public TheRealEngieGamesEntity(EntityType<TheRealEngieGamesEntity> type, Level world) {
		...
		this.setItemSlot(EquipmentSlot.CHEST, new ItemStack(AllaboutengieModItems.THE_REAL_ENGIE_GAMESS_CHESTPLATE.get()));
	...
	public SpawnGroupData finalizeSpawn(ServerLevelAccessor world, DifficultyInstance difficulty, EntitySpawnReason reason, @Nullable SpawnGroupData livingdata) {
		...
		TheRealEngieGamesOnInitialEntitySpawnProcedure.execute(world, this);
		return retval;
	}
	...
	public static void init(RegisterSpawnPlacementsEvent event) {
		event.register(AllaboutengieModEntities.THE_REAL_ENGIE_GAMES.get(), SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
