...
public class TheRealEngieGamesEntity extends PathfinderMob {
	public TheRealEngieGamesEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.THE_REAL_ENGIE_GAMES.get(), world);
	}
	...
	public static void init() {
		SpawnPlacements.register(AllaboutengieModEntities.THE_REAL_ENGIE_GAMES.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
