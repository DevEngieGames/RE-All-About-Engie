...
import net.mcreator.allaboutengie.procedures.TigerLayOnSideRCProcedure;
...
public class TigerLayOnSideEntity extends PathfinderMob {
	public final AnimationState animationState0 = new AnimationState();

	public TigerLayOnSideEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.TIGER_LAY_ON_SIDE.get(), world);
	}

	public TigerLayOnSideEntity(EntityType<TigerLayOnSideEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
	...
	public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
		...
		TigerLayOnSideRCProcedure.execute(world, x, y, z, entity, sourceentity);
		return retval;
	}
