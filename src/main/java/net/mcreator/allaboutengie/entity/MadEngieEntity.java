...
public class MadEngieEntity extends Monster {
	public MadEngieEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.MAD_ENGIE.get(), world);
	}
	...
	public static void init() {
		SpawnPlacements.register(AllaboutengieModEntities.MAD_ENGIE.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
			int x = pos.getX();
			int y = pos.getY();
			int z = pos.getZ();
