...
import net.mcreator.allaboutengie.procedures.TobyLayOnSideRCProcedure;
...
public class TobyLayOnSideEntity extends PathfinderMob {
	public final AnimationState animationState0 = new AnimationState();

	public TobyLayOnSideEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.TOBY_LAY_ON_SIDE.get(), world);
	}

	public TobyLayOnSideEntity(EntityType<TobyLayOnSideEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
	...
	public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
		...
		TobyLayOnSideRCProcedure.execute(world, x, y, z, entity, sourceentity);
		return retval;
	}
