...
public class EnragedNormal3Entity extends Monster {
	public EnragedNormal3Entity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.ENRAGED_NORMAL_3.get(), world);
	}

	public EnragedNormal3Entity(EntityType<EnragedNormal3Entity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 15;
		setNoAi(false);
