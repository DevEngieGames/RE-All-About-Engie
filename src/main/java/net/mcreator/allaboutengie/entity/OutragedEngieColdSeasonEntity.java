...
public class OutragedEngieColdSeasonEntity extends Monster {
	public OutragedEngieColdSeasonEntity(EntityType<OutragedEngieColdSeasonEntity> type, Level world) {
		super(type, world);
		xpReward = 35;
		setNoAi(false);
	}
	...
	protected void registerGoals() {
		...
		this.targetSelector.addGoal(5, new NearestAttackableTargetGoal(this, Monster.class, true, false) {
			...
			public boolean canUse() {
				double x = OutragedEngieColdSeasonEntity.this.getX();
				double y = OutragedEngieColdSeasonEntity.this.getY();
				double z = OutragedEngieColdSeasonEntity.this.getZ();
				Entity entity = OutragedEngieColdSeasonEntity.this;
				Level world = OutragedEngieColdSeasonEntity.this.level();
