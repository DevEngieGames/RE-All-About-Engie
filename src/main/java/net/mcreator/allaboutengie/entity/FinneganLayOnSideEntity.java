...
import net.mcreator.allaboutengie.procedures.FinneganLayOnSideRCProcedure;
import net.mcreator.allaboutengie.init.AllaboutengieModEntities;

public class FinneganLayOnSideEntity extends PathfinderMob {
	public final AnimationState animationState0 = new AnimationState();

	public FinneganLayOnSideEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.FINNEGAN_LAY_ON_SIDE.get(), world);
	}

	public FinneganLayOnSideEntity(EntityType<FinneganLayOnSideEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
	...
	public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
		...
		FinneganLayOnSideRCProcedure.execute(world, x, y, z, entity, sourceentity);
		return retval;
	}
