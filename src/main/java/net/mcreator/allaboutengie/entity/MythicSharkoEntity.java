...
public class MythicSharkoEntity extends PathfinderMob {
	...
	public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
		...
		MythicRCTameProcedure.execute(world, x, y, z, entity, sourceentity);
		return retval;
	}
	...
	public static void init() {
		SpawnPlacements.register(AllaboutengieModEntities.MYTHIC_SHARKO.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
			int x = pos.getX();
			int y = pos.getY();
			int z = pos.getZ();
