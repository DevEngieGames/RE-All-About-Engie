...
import net.mcreator.allaboutengie.procedures.BigLegendaryTameRCProcedure;
import net.mcreator.allaboutengie.init.AllaboutengieModEntities;

public class BigLegendarySharkoTamedEntity extends PathfinderMob {
	public final AnimationState animationState0 = new AnimationState();

	public BigLegendarySharkoTamedEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.BIG_LEGENDARY_SHARKO_TAMED.get(), world);
	}

	public BigLegendarySharkoTamedEntity(EntityType<BigLegendarySharkoTamedEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
	...
	public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
		...
		BigLegendaryTameRCProcedure.execute(world, x, y, z, entity, sourceentity);
		return retval;
	}
