...
import net.mcreator.allaboutengie.procedures.MarshalLayOnSideRCProcedure;
import net.mcreator.allaboutengie.init.AllaboutengieModEntities;

public class MarshalLayOnSideEntity extends PathfinderMob {
	public final AnimationState animationState0 = new AnimationState();

	public MarshalLayOnSideEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.MARSHAL_LAY_ON_SIDE.get(), world);
	}

	public MarshalLayOnSideEntity(EntityType<MarshalLayOnSideEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
	...
	public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
		...
		MarshalLayOnSideRCProcedure.execute(world, x, y, z, entity, sourceentity);
		return retval;
	}
