...
import net.mcreator.allaboutengie.procedures.MarshalLayRCProcedure;
import net.mcreator.allaboutengie.init.AllaboutengieModEntities;

public class MarshalLayEntity extends PathfinderMob {
	public final AnimationState animationState0 = new AnimationState();

	public MarshalLayEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.MARSHAL_LAY.get(), world);
	}

	public MarshalLayEntity(EntityType<MarshalLayEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
