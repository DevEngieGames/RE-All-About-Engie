...
public class AtlasLayEntity extends PathfinderMob {
	public final AnimationState animationState0 = new AnimationState();

	public AtlasLayEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.ATLAS_LAY.get(), world);
	}

	public AtlasLayEntity(EntityType<AtlasLayEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
