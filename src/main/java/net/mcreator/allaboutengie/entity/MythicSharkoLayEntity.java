...
import net.mcreator.allaboutengie.procedures.MythicLayRCProcedure;
import net.mcreator.allaboutengie.init.AllaboutengieModEntities;

public class MythicSharkoLayEntity extends PathfinderMob {
	public final AnimationState animationState0 = new AnimationState();

	public MythicSharkoLayEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.MYTHIC_SHARKO_LAY.get(), world);
	}

	public MythicSharkoLayEntity(EntityType<MythicSharkoLayEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
