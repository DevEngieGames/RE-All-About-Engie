...
public class EnragedSpeed8Entity extends Monster {
	public EnragedSpeed8Entity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.ENRAGED_SPEED_8.get(), world);
	}

	public EnragedSpeed8Entity(EntityType<EnragedSpeed8Entity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 15;
		setNoAi(false);
