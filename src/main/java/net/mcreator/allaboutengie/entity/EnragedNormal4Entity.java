...
public class EnragedNormal4Entity extends Monster {
	public EnragedNormal4Entity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.ENRAGED_NORMAL_4.get(), world);
	}

	public EnragedNormal4Entity(EntityType<EnragedNormal4Entity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 15;
		setNoAi(false);
