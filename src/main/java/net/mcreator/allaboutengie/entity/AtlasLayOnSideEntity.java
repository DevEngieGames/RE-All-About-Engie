...
import net.mcreator.allaboutengie.procedures.AtlasLayOnSideRCProcedure;
import net.mcreator.allaboutengie.init.AllaboutengieModEntities;

public class AtlasLayOnSideEntity extends PathfinderMob {
	public final AnimationState animationState0 = new AnimationState();

	public AtlasLayOnSideEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.ATLAS_LAY_ON_SIDE.get(), world);
	}

	public AtlasLayOnSideEntity(EntityType<AtlasLayOnSideEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
	...
	public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
		...
		AtlasLayOnSideRCProcedure.execute(world, x, y, z, entity, sourceentity);
		return retval;
	}
