...
public class LegendarySharkoSleepEntity extends PathfinderMob {
	public final AnimationState animationState0 = new AnimationState();

	public LegendarySharkoSleepEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.LEGENDARY_SHARKO_SLEEP.get(), world);
	}

	public LegendarySharkoSleepEntity(EntityType<LegendarySharkoSleepEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
