...
import net.mcreator.allaboutengie.procedures.ApolloLayOnSideRCProcedure;
import net.mcreator.allaboutengie.init.AllaboutengieModEntities;

public class ApolloLayOnSideEntity extends PathfinderMob {
	public final AnimationState animationState0 = new AnimationState();

	public ApolloLayOnSideEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.APOLLO_LAY_ON_SIDE.get(), world);
	}

	public ApolloLayOnSideEntity(EntityType<ApolloLayOnSideEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
	...
	public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
		...
		ApolloLayOnSideRCProcedure.execute(world, x, y, z, entity, sourceentity);
		return retval;
	}
