...
public class BiblicallyAccurateEngieColdSeasonEntity extends PathfinderMob {
	public BiblicallyAccurateEngieColdSeasonEntity(EntityType<BiblicallyAccurateEngieColdSeasonEntity> type, Level world) {
		super(type, world);
		xpReward = 60;
		setNoAi(false);
	}
