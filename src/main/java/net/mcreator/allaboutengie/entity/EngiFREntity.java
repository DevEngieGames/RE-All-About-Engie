...
public class EngiFREntity extends PathfinderMob {
	public EngiFREntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.ENGI_FR.get(), world);
	}

	public EngiFREntity(EntityType<EngiFREntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 10;
		setNoAi(false);
	...
	public static void init() {
		SpawnPlacements.register(AllaboutengieModEntities.ENGI_FR.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
