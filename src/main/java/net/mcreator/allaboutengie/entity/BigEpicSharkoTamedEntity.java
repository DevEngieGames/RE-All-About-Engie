...
import net.mcreator.allaboutengie.procedures.BigEpicSharkoTameRCProcedure;
import net.mcreator.allaboutengie.init.AllaboutengieModEntities;

public class BigEpicSharkoTamedEntity extends PathfinderMob {
	public final AnimationState animationState0 = new AnimationState();

	public BigEpicSharkoTamedEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.BIG_EPIC_SHARKO_TAMED.get(), world);
	}

	public BigEpicSharkoTamedEntity(EntityType<BigEpicSharkoTamedEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
	...
	public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
		...
		BigEpicSharkoTameRCProcedure.execute(world, x, y, z, entity, sourceentity);
		return retval;
	}
