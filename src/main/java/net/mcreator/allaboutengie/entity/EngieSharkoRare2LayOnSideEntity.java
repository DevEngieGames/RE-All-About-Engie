...
import net.mcreator.allaboutengie.procedures.EngieRare2LayOnSideRCProcedure;
import net.mcreator.allaboutengie.init.AllaboutengieModEntities;

public class EngieSharkoRare2LayOnSideEntity extends PathfinderMob {
	public final AnimationState animationState0 = new AnimationState();

	public EngieSharkoRare2LayOnSideEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.TIGER_SHARKO_LAY_ON_SIDE.get(), world);
	}

	public EngieSharkoRare2LayOnSideEntity(EntityType<EngieSharkoRare2LayOnSideEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
	...
	public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
		...
		EngieRare2LayOnSideRCProcedure.execute(world, x, y, z, entity, sourceentity);
		return retval;
	}
