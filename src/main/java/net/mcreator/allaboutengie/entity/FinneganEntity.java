...
import net.mcreator.allaboutengie.procedures.FinneganRCProcedure;
import net.mcreator.allaboutengie.init.AllaboutengieModEntities;

public class FinneganEntity extends PathfinderMob {
	public final AnimationState animationState0 = new AnimationState();

	public FinneganEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.FINNEGAN.get(), world);
	}

	public FinneganEntity(EntityType<FinneganEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
	...
	public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
		...
		FinneganRCProcedure.execute(world, x, y, z, entity, sourceentity);
		return retval;
	}
