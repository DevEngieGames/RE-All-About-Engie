...
import net.mcreator.allaboutengie.procedures.MythicSharkoAprilFoolsTameRCProcedure;
import net.mcreator.allaboutengie.init.AllaboutengieModEntities;

public class MythicSharkoTamedAprilFoolsEntity extends PathfinderMob {
	public MythicSharkoTamedAprilFoolsEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.MYTHIC_SHARKO_TAMED_APRIL_FOOLS.get(), world);
	}

	public MythicSharkoTamedAprilFoolsEntity(EntityType<MythicSharkoTamedAprilFoolsEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
	...
	public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
		...
		MythicSharkoAprilFoolsTameRCProcedure.execute(world, x, y, z, entity, sourceentity);
		return retval;
	}
