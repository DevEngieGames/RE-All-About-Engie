...
import net.mcreator.allaboutengie.procedures.SharkoAprilFoolsTameRCProcedure;
import net.mcreator.allaboutengie.procedures.SharkTamedOnEntityTickUpdateProcedure;
import net.mcreator.allaboutengie.init.AllaboutengieModEntities;

public class SharkoTamedAprilFoolsEntity extends PathfinderMob {
	public SharkoTamedAprilFoolsEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.SHARKO_TAMED_APRIL_FOOLS.get(), world);
	}

	public SharkoTamedAprilFoolsEntity(EntityType<SharkoTamedAprilFoolsEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
	...
	public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
		...
		SharkoAprilFoolsTameRCProcedure.execute(world, x, y, z, entity, sourceentity);
		return retval;
	}
