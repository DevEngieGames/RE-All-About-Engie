...
public class MarshalSleepEntity extends PathfinderMob {
	public final AnimationState animationState0 = new AnimationState();

	public MarshalSleepEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.MARSHAL_SLEEP.get(), world);
	}

	public MarshalSleepEntity(EntityType<MarshalSleepEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
