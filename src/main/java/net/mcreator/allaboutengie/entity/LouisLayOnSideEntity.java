...
import net.mcreator.allaboutengie.procedures.LouisLayOnSideRCProcedure;
import net.mcreator.allaboutengie.init.AllaboutengieModEntities;

public class LouisLayOnSideEntity extends PathfinderMob {
	public final AnimationState animationState0 = new AnimationState();

	public LouisLayOnSideEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.LOUIS_LAY_ON_SIDE.get(), world);
	}

	public LouisLayOnSideEntity(EntityType<LouisLayOnSideEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
	...
	public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
		...
		LouisLayOnSideRCProcedure.execute(world, x, y, z, entity, sourceentity);
		return retval;
	}
