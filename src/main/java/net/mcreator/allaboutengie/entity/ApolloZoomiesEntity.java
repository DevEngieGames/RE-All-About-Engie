...
public class ApolloZoomiesEntity extends PathfinderMob {
	public final AnimationState animationState0 = new AnimationState();

	public ApolloZoomiesEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.APOLLO_ZOOMIES.get(), world);
	}

	public ApolloZoomiesEntity(EntityType<ApolloZoomiesEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
