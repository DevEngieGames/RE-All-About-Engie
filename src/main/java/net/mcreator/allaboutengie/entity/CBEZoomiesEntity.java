...
public class CBEZoomiesEntity extends PathfinderMob {
	public final AnimationState animationState0 = new AnimationState();

	public CBEZoomiesEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.CBE_ZOOMIES.get(), world);
	}

	public CBEZoomiesEntity(EntityType<CBEZoomiesEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
