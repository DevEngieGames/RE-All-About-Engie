...
import net.mcreator.allaboutengie.procedures.LegendarySharkoAprilFoolsTameRCProcedure;
import net.mcreator.allaboutengie.init.AllaboutengieModEntities;

public class LegendarySharkoTamedAprilFoolsEntity extends PathfinderMob {
	public LegendarySharkoTamedAprilFoolsEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.LEGENDARY_SHARKO_TAMED_APRIL_FOOLS.get(), world);
	}

	public LegendarySharkoTamedAprilFoolsEntity(EntityType<LegendarySharkoTamedAprilFoolsEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
	...
	public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
		...
		LegendarySharkoAprilFoolsTameRCProcedure.execute(world, x, y, z, entity, sourceentity);
		return retval;
	}
