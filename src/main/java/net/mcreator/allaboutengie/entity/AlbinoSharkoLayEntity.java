...
import net.mcreator.allaboutengie.procedures.AlbinoLayRCProcedure;
import net.mcreator.allaboutengie.init.AllaboutengieModEntities;

public class AlbinoSharkoLayEntity extends PathfinderMob {
	public final AnimationState animationState0 = new AnimationState();

	public AlbinoSharkoLayEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.ALBINO_SHARKO_LAY.get(), world);
	}

	public AlbinoSharkoLayEntity(EntityType<AlbinoSharkoLayEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
