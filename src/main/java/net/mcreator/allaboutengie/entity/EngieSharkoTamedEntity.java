...
import net.mcreator.allaboutengie.procedures.EngieTameRCProcedure;
...
public class EngieSharkoTamedEntity extends PathfinderMob {
	...
	public EngieSharkoTamedEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.ENGIE_SHARKO_TAMED.get(), world);
	}
	...
	public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
		...
		EngieTameRCProcedure.execute(world, x, y, z, entity, sourceentity);
		return retval;
	}
