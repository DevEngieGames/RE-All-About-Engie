...
public class ChampZoomiesEntity extends PathfinderMob {
	public final AnimationState animationState0 = new AnimationState();

	public ChampZoomiesEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.CHAMP_ZOOMIES.get(), world);
	}

	public ChampZoomiesEntity(EntityType<ChampZoomiesEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
