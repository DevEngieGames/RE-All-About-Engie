...
public class AtlasZoomiesTiredEntity extends PathfinderMob {
	public AtlasZoomiesTiredEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.ATLAS_ZOOMIES_TIRED.get(), world);
	}

	public AtlasZoomiesTiredEntity(EntityType<AtlasZoomiesTiredEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
