...
import net.mcreator.allaboutengie.procedures.RareLayOnSideRCProcedure;
import net.mcreator.allaboutengie.init.AllaboutengieModEntities;

public class RareSharkoLayOnSideEntity extends PathfinderMob {
	public final AnimationState animationState0 = new AnimationState();

	public RareSharkoLayOnSideEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.RARE_SHARKO_LAY_ON_SIDE.get(), world);
	}

	public RareSharkoLayOnSideEntity(EntityType<RareSharkoLayOnSideEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
	...
	public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
		...
		RareLayOnSideRCProcedure.execute(world, x, y, z, entity, sourceentity);
		return retval;
	}
