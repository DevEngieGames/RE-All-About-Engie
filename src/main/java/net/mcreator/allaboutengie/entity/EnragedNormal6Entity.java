...
public class EnragedNormal6Entity extends Monster {
	public EnragedNormal6Entity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.ENRAGED_NORMAL_6.get(), world);
	}

	public EnragedNormal6Entity(EntityType<EnragedNormal6Entity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 15;
		setNoAi(false);
