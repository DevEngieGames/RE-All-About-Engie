...
public class AlbinoSharkoTamedZoomiesEntity extends PathfinderMob {
	public final AnimationState animationState0 = new AnimationState();

	public AlbinoSharkoTamedZoomiesEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.ALBINO_SHARKO_TAMED_ZOOMIES.get(), world);
	}

	public AlbinoSharkoTamedZoomiesEntity(EntityType<AlbinoSharkoTamedZoomiesEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
