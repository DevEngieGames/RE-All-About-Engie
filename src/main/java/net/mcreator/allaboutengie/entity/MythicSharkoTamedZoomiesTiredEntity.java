...
public class MythicSharkoTamedZoomiesTiredEntity extends PathfinderMob {
	public MythicSharkoTamedZoomiesTiredEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.MYTHIC_SHARKO_TAMED_ZOOMIES_TIRED.get(), world);
	}

	public MythicSharkoTamedZoomiesTiredEntity(EntityType<MythicSharkoTamedZoomiesTiredEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
