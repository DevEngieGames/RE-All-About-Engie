...
import net.mcreator.allaboutengie.procedures.CBERCProcedure;
import net.mcreator.allaboutengie.init.AllaboutengieModEntities;

public class CBEEntity extends PathfinderMob {
	public final AnimationState animationState0 = new AnimationState();

	public CBEEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.CBE.get(), world);
	}

	public CBEEntity(EntityType<CBEEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
	...
	public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
		...
		CBERCProcedure.execute(world, x, y, z, entity, sourceentity);
		return retval;
	}
