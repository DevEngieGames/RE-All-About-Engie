...
public class RockySleepEntity extends PathfinderMob {
	public final AnimationState animationState0 = new AnimationState();

	public RockySleepEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.ROCKY_SLEEP.get(), world);
	}

	public RockySleepEntity(EntityType<RockySleepEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
