...
public class EngieSharkoRareTamedZoomiesTiredEntity extends PathfinderMob {
	public EngieSharkoRareTamedZoomiesTiredEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.ENGIE_SHARKO_RARE_TAMED_ZOOMIES_TIRED.get(), world);
	}

	public EngieSharkoRareTamedZoomiesTiredEntity(EntityType<EngieSharkoRareTamedZoomiesTiredEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
