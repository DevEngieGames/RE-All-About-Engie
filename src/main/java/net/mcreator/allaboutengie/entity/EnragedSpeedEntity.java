...
public class EnragedSpeedEntity extends Monster {
	public EnragedSpeedEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.ENRAGED_SPEED.get(), world);
	}
	...
	public static void init() {
		SpawnPlacements.register(AllaboutengieModEntities.ENRAGED_SPEED.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
			int x = pos.getX();
			int y = pos.getY();
			int z = pos.getZ();
