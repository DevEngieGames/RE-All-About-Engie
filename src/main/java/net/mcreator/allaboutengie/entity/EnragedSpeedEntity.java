...
public class EnragedSpeedEntity extends Monster {
	public EnragedSpeedEntity(EntityType<EnragedSpeedEntity> type, Level world) {
		super(type, world);
		xpReward = 15;
		setNoAi(false);
	}
	...
	public static void init(RegisterSpawnPlacementsEvent event) {
		event.register(AllaboutengieModEntities.ENRAGED_SPEED.get(), SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
			int x = pos.getX();
			int y = pos.getY();
			int z = pos.getZ();
