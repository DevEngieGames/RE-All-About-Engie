...
import net.mcreator.allaboutengie.procedures.RockyLayRCProcedure;
import net.mcreator.allaboutengie.init.AllaboutengieModEntities;

public class RockyLayEntity extends PathfinderMob {
	public final AnimationState animationState0 = new AnimationState();

	public RockyLayEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.ROCKY_LAY.get(), world);
	}

	public RockyLayEntity(EntityType<RockyLayEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
	...
	public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
		...
		RockyLayRCProcedure.execute(world, x, y, z, entity, sourceentity);
		return retval;
	}
