...
public class BuddyZoomiesTiredEntity extends PathfinderMob {
	public BuddyZoomiesTiredEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.BUDDY_ZOOMIES_TIRED.get(), world);
	}

	public BuddyZoomiesTiredEntity(EntityType<BuddyZoomiesTiredEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
