...
import net.mcreator.allaboutengie.procedures.BigSharkoTameRCProcedure;
import net.mcreator.allaboutengie.init.AllaboutengieModEntities;

public class BigSharkoTamedEntity extends PathfinderMob {
	public final AnimationState animationState0 = new AnimationState();

	public BigSharkoTamedEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.BIG_SHARKO_TAMED.get(), world);
	}

	public BigSharkoTamedEntity(EntityType<BigSharkoTamedEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
	...
	public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
		...
		BigSharkoTameRCProcedure.execute(world, x, y, z, entity, sourceentity);
		return retval;
	}
