...
public class BigSharkoLayEntity extends PathfinderMob {
	public final AnimationState animationState0 = new AnimationState();

	public BigSharkoLayEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.BIG_SHARKO_LAY.get(), world);
	}

	public BigSharkoLayEntity(EntityType<BigSharkoLayEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
