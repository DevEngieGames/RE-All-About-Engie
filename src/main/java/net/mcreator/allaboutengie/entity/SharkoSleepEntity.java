...
public class SharkoSleepEntity extends PathfinderMob {
	public final AnimationState animationState0 = new AnimationState();

	public SharkoSleepEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.SHARKO_SLEEP.get(), world);
	}

	public SharkoSleepEntity(EntityType<SharkoSleepEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
