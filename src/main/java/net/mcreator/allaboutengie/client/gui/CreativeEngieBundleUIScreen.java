...
public class CreativeEngieBundleUIScreen extends AbstractContainerScreen<CreativeEngieBundleUIMenu> {
	private final static HashMap<String, Object> guistate = CreativeEngieBundleUIMenu.guistate;
	...
	private static final ResourceLocation texture = new ResourceLocation("allaboutengie:textures/screens/creative_engie_bundle_ui.png");
	...
	protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
		guiGraphics.drawString(this.font,
				...
				CreativeEngieBundleDisplayNameCheckProcedure.execute(entity), 5, 225, -12829636, false);
	}
	...
	public void init() {
		...
		ChangeBundleName = new EditBox(this.font, this.leftPos + 287, this.topPos + 134, 118, 18, Component.translatable("gui.allaboutengie.creative_engie_bundle_ui.ChangeBundleName")) {
			...
			public void insertText(String text) {
				...
				if (getValue().isEmpty())
					setSuggestion(Component.translatable("gui.allaboutengie.creative_engie_bundle_ui.ChangeBundleName").getString());
				else
					setSuggestion(null);
			}
		...
		ChangeBundleName.setSuggestion(Component.translatable("gui.allaboutengie.creative_engie_bundle_ui.ChangeBundleName").getString());
