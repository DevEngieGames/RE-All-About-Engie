...
public class MonstrosityEngieBundleUIScreen extends AbstractContainerScreen<MonstrosityEngieBundleUIMenu> implements AllaboutengieModScreens.ScreenAccessor {
	...
	private static final ResourceLocation texture = ResourceLocation.parse("allaboutengie:textures/screens/monstrosity_engie_bundle_ui.png");
	...
	protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
		guiGraphics.drawString(this.font, MonstrosityEngieBundleDisplayNameCheckProcedure.execute(entity), 5, 29, -12829636, false);
	}
