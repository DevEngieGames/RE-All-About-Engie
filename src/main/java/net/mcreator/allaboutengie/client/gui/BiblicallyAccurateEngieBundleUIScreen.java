...
public class BiblicallyAccurateEngieBundleUIScreen extends AbstractContainerScreen<BiblicallyAccurateEngieBundleUIMenu> {
	private final static HashMap<String, Object> guistate = BiblicallyAccurateEngieBundleUIMenu.guistate;
	...
	private static final ResourceLocation texture = new ResourceLocation("allaboutengie:textures/screens/biblically_accurate_engie_bundle_ui.png");
	...
	protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
		guiGraphics.drawString(this.font,
				...
				BiblicallyAccurateEngieBundleDisplayNameCheckProcedure.execute(entity), 5, 29, -12829636, false);
	}
	...
	public void init() {
		...
		ChangeBundleName.setSuggestion(Component.translatable("gui.allaboutengie.biblically_accurate_engie_bundle_ui.ChangeBundleName").getString());
