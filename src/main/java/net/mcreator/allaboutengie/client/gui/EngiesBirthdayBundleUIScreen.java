...
public class EngiesBirthdayBundleUIScreen extends AbstractContainerScreen<EngiesBirthdayBundleUIMenu> {
	private final static HashMap<String, Object> guistate = EngiesBirthdayBundleUIMenu.guistate;
	...
	private static final ResourceLocation texture = new ResourceLocation("allaboutengie:textures/screens/engies_birthday_bundle_ui.png");
	...
	public void init() {
		...
		ChangeBundleName = new EditBox(this.font, this.leftPos + 6, this.topPos + 6, 118, 18, Component.translatable("gui.allaboutengie.engies_birthday_bundle_ui.ChangeBundleName")) {
			...
			public void insertText(String text) {
				...
				if (getValue().isEmpty())
					setSuggestion(Component.translatable("gui.allaboutengie.engies_birthday_bundle_ui.ChangeBundleName").getString());
				else
					setSuggestion(null);
			}
		...
		ChangeBundleName.setSuggestion(Component.translatable("gui.allaboutengie.engies_birthday_bundle_ui.ChangeBundleName").getString());
		...
		button_set_name = Button.builder(Component.translatable("gui.allaboutengie.engies_birthday_bundle_ui.button_set_name"), e -> {
			if (true) {
				AllaboutengieMod.PACKET_HANDLER.sendToServer(new EngiesBirthdayBundleUIButtonMessage(0, x, y, z));
