...
public class DoomsDayTradeUIScreen extends AbstractContainerScreen<DoomsDayTradeUIMenu> implements AllaboutengieModScreens.ScreenAccessor {
	...
	public void render(GuiGraphics guiGraphics, int mouseX, int mouseY, float partialTicks) {
		...
		if (mouseX > leftPos + 68 && mouseX < leftPos + 92 && mouseY > topPos + 4 && mouseY < topPos + 28) {
	...
	public void init() {
		...
		scythetrade = new Checkbox(this.leftPos + 70, this.topPos + 6, 20, 20, Component.translatable("gui.allaboutengie.dooms_day_trade_ui.scythetrade"), false) {
			@Override
			public void onPress() {
				super.onPress();
		...
		bantrade = new Checkbox(this.leftPos + 98, this.topPos + 6, 20, 20, Component.translatable("gui.allaboutengie.dooms_day_trade_ui.bantrade"), false) {
			@Override
			public void onPress() {
				super.onPress();
				if (!menuStateUpdateActive)
