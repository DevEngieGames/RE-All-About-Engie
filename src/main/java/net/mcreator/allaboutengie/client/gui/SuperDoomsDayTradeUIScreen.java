...
public class SuperDoomsDayTradeUIScreen extends AbstractContainerScreen<SuperDoomsDayTradeUIMenu> {
	private final static HashMap<String, Object> guistate = SuperDoomsDayTradeUIMenu.guistate;
