...
public class MetalBundleUIScreen extends AbstractContainerScreen<MetalBundleUIMenu> {
	private final static HashMap<String, Object> guistate = MetalBundleUIMenu.guistate;
	...
	protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
		guiGraphics.drawString(this.font,
				...
				BundleDisplayNameCheckProcedure.execute(entity), 5, 28, -12829636, false);
	}
	...
	public void init() {
		...
		ChangeBundleName.setSuggestion(Component.translatable("gui.allaboutengie.engie_bundle_ui.ChangeBundleName").getString());
