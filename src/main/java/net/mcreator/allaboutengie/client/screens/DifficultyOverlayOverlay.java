	...
	public static void eventHandler(RenderGuiEvent.Pre event) {
		...
		if (true) {
			if (Difficulty0ReturnTrueCheckProcedure.execute(world)) {
				event.getGuiGraphics().blit(ResourceLocation.parse("allaboutengie:textures/screens/diff0icon.png"), w - 126, 0, 0, 0, 126, 104, 126, 104);
			}
			if (Difficulty1ReturnTrueCheckProcedure.execute(world)) {
				event.getGuiGraphics().blit(ResourceLocation.parse("allaboutengie:textures/screens/diff1icon.png"), w - 126, 0, 0, 0, 126, 104, 126, 104);
			}
			if (Difficulty2ReturnTrueCheckProcedure.execute(world)) {
				event.getGuiGraphics().blit(ResourceLocation.parse("allaboutengie:textures/screens/diff2icon.png"), w - 126, 0, 0, 0, 126, 104, 126, 104);
			}
			if (Difficulty3ReturnTrueCheckProcedure.execute(world)) {
				event.getGuiGraphics().blit(ResourceLocation.parse("allaboutengie:textures/screens/madengiedifficon.png"), w - 126, 0, 0, 0, 126, 104, 126, 104);
			}
			if (Difficulty4ReturnTrueCheckProcedure.execute(world)) {
				event.getGuiGraphics().blit(ResourceLocation.parse("allaboutengie:textures/screens/angryengiedifficon.png"), w - 126, 0, 0, 0, 126, 104, 126, 104);
			}
			if (Difficulty5ReturnTrueCheckProcedure.execute(world)) {
				event.getGuiGraphics().blit(ResourceLocation.parse("allaboutengie:textures/screens/enragedengiedifficon.png"), w - 126, 0, 0, 0, 126, 104, 126, 104);
			}
			if (Difficulty6ReturnTrueCheckProcedure.execute(world)) {
				event.getGuiGraphics().blit(ResourceLocation.parse("allaboutengie:textures/screens/outragedengiedifficon.png"), w - 126, 0, 0, 0, 126, 104, 126, 104);
			}
			if (Difficulty7ReturnTrueCheckProcedure.execute(world)) {
				event.getGuiGraphics().blit(ResourceLocation.parse("allaboutengie:textures/screens/biblicallyaccurateengiedifficon.png"), w - 126, 0, 0, 0, 126, 104, 126, 104);
			}
			if (Difficulty8ReturnTrueCheckProcedure.execute(world)) {
				event.getGuiGraphics().blit(ResourceLocation.parse("allaboutengie:textures/screens/monstrosityengiedifficon.png"), w - 126, 0, 0, 0, 126, 104, 126, 104);
			}
			if (Difficulty9ReturnTrueCheckProcedure.execute(world)) {
				event.getGuiGraphics().blit(ResourceLocation.parse("allaboutengie:textures/screens/doomsdayengiedifficon.png"), w - 126, 0, 0, 0, 126, 104, 126, 104);
			}
			if (Difficulty10ReturnTrueCheckProcedure.execute(world)) {
				event.getGuiGraphics().blit(ResourceLocation.parse("allaboutengie:textures/screens/superdoomsdayengiedifficon.png"), w - 126, 0, 0, 0, 126, 104, 126, 104);
			}
			if (Difficulty11ReturnTrueCheckProcedure.execute(world)) {
				event.getGuiGraphics().blit(ResourceLocation.parse("allaboutengie:textures/screens/theendengiedifficon.png"), w - 126, 0, 0, 0, 126, 104, 126, 104);
			}
			if (Difficulty12ReturnTrueCheckProcedure.execute(world)) {
				event.getGuiGraphics().blit(ResourceLocation.parse("allaboutengie:textures/screens/engiedifficon.png"), w - 126, 0, 0, 0, 126, 104, 126, 104);
			}
			if (Difficulty13ReturnTrueCheckProcedure.execute(world)) {
				event.getGuiGraphics().blit(ResourceLocation.parse("allaboutengie:textures/screens/mindscapeengiedifficon.png"), w - 126, 0, 0, 0, 126, 104, 126, 104);
			}
			if (Difficulty15ReturnTrueCheckProcedure.execute(world)) {
				event.getGuiGraphics().blit(ResourceLocation.parse("allaboutengie:textures/screens/insanityengiedifficon.png"), w - 126, 0, 0, 0, 126, 104, 126, 104);
			}
			if (Difficulty20ReturnTrueCheckProcedure.execute(world)) {
				event.getGuiGraphics().blit(ResourceLocation.parse("allaboutengie:textures/screens/pureinsanityengiedifficon.png"), w - 126, 0, 0, 0, 126, 104, 126, 104);
			}
			if (Difficulty525ReturnTrueCheckProcedure.execute(world)) {
				event.getGuiGraphics().blit(ResourceLocation.parse("allaboutengie:textures/screens/engiegamesdifficon.png"), w - 126, 0, 0, 0, 126, 104, 126, 104);
			}
			if (Difficulty690ReturnTrueCheckProcedure.execute(world)) {
				event.getGuiGraphics().blit(ResourceLocation.parse("allaboutengie:textures/screens/wormholedifficon.png"), w - 126, 0, 0, 0, 126, 104, 126, 104);
			}
			if (Difficulty525000ReturnTrueCheckProcedure.execute(world)) {
				event.getGuiGraphics().blit(ResourceLocation.parse("allaboutengie:textures/screens/sufferdifficon.png"), w - 126, 0, 0, 0, 126, 104, 126, 104);
			}
		}
