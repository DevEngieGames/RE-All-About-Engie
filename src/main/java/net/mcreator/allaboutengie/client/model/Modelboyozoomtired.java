...
public class Modelboyozoomtired<T extends Entity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in
	// the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath("allaboutengie", "modelboyozoomtired"), "main");
	...
	public Modelboyozoomtired(ModelPart root) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Head = bone.addOrReplaceChild("Head",
				...
				PartPose.offsetAndRotation(0.0F, -12.0F, -6.0F, 0.0F, -0.0349F, 0.0F));
		...
		PartDefinition Main_r1 = Hat.addOrReplaceChild("Main_r1",
				...
				PartPose.offsetAndRotation(-2.75F, -6.6F, -4.0F, -0.0175F, 0.0315F, -0.5237F));
