...
public class Modelbigboyo extends EntityModel<LivingEntityRenderState> {
	// This layer location should be baked with EntityRendererProvider.Context in
	// the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath("allaboutengie", "modelbigboyo"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition TailSecondary = TailPrimary.addOrReplaceChild("TailSecondary", CubeListBuilder.create(), PartPose.offset(0.0F, 4.5F, 8.5F));
		...
		PartDefinition Head = partdefinition.addOrReplaceChild("Head",
				CubeListBuilder.create().texOffs(72, 78).addBox(-8.0F, -13.0F, -16.0F, 16.0F, 16.0F, 16.0F, new CubeDeformation(0.0F)).texOffs(128, 160).addBox(-7.975F, -12.975F, -16.0F, 16.0F, 16.0F, 16.0F, new CubeDeformation(0.05F))
						.texOffs(64, 160).addBox(-7.925F, -12.925F, -16.0F, 16.0F, 16.0F, 16.0F, new CubeDeformation(0.15F)).texOffs(0, 160).addBox(-7.9F, -12.9F, -16.0F, 16.0F, 16.0F, 16.0F, new CubeDeformation(0.2F)).texOffs(0, 104)
						.addBox(-8.0F, -12.75F, -16.0F, 16.0F, 16.0F, 16.0F, new CubeDeformation(0.5F)).texOffs(60, 126).addBox(-7.95F, -12.7F, -16.0F, 16.0F, 16.0F, 16.0F, new CubeDeformation(0.6F)).texOffs(0, 0)
		...
		PartDefinition leg1 = partdefinition.addOrReplaceChild("leg1",
				CubeListBuilder.create().texOffs(112, 18).mirror().addBox(-3.9919F, 10.0081F, -5.9581F, 8.0F, 4.0F, 8.0F, new CubeDeformation(0.0162F)).mirror(false).texOffs(60, 60).mirror()
						.addBox(-4.0668F, 12.0082F, -6.9582F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0164F)).mirror(false).texOffs(60, 60).mirror().addBox(-2.0168F, 12.0082F, -6.9582F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0164F)).mirror(false)
						.texOffs(60, 60).mirror().addBox(0.0332F, 12.0082F, -6.9582F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0164F)).mirror(false).texOffs(60, 60).mirror()
		...
		PartDefinition Toe_r1 = leg1.addOrReplaceChild("Toe_r1",
				CubeListBuilder.create().texOffs(72, 58).mirror().addBox(-1.0169F, -0.9919F, -1.0081F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0162F)).mirror(false).texOffs(72, 58).mirror()
						.addBox(-3.0669F, -0.9919F, -1.0081F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0162F)).mirror(false).texOffs(72, 58).mirror().addBox(-5.1169F, -0.9919F, -1.0081F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0162F)).mirror(false)
						.texOffs(72, 58).mirror().addBox(-7.1669F, -0.9919F, -1.0081F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0162F)).mirror(false),
				PartPose.offsetAndRotation(3.1F, 11.7544F, -5.5573F, -0.6109F, 0.0F, 0.0F));
		PartDefinition LowerLeg_r1 = leg1.addOrReplaceChild("LowerLeg_r1", CubeListBuilder.create().texOffs(72, 30).mirror().addBox(-4.0009F, -2.9909F, -3.0091F, 8.0F, 6.0F, 6.0F, new CubeDeformation(0.0182F)).mirror(false),
				PartPose.offsetAndRotation(0.01F, 9.8038F, 0.916F, -0.5236F, 0.0F, 0.0F));
		PartDefinition MidLeg_r1 = leg1.addOrReplaceChild("MidLeg_r1", CubeListBuilder.create().texOffs(160, 44).mirror().addBox(-4.01F, -3.99F, -4.01F, 8.0F, 8.0F, 8.0F, new CubeDeformation(0.02F)).mirror(false),
				PartPose.offsetAndRotation(0.02F, 7.5339F, -0.477F, 0.5672F, 0.0F, 0.0F));
		PartDefinition UpperLeg_r1 = leg1.addOrReplaceChild("UpperLeg_r1", CubeListBuilder.create().texOffs(112, 0).mirror().addBox(-3.989F, -4.989F, -4.011F, 8.0F, 10.0F, 8.0F, new CubeDeformation(0.022F)).mirror(false),
		...
		PartDefinition leg2 = partdefinition.addOrReplaceChild("leg2",
				CubeListBuilder.create().texOffs(112, 18).addBox(-3.9919F, 10.0081F, -5.9581F, 8.0F, 4.0F, 8.0F, new CubeDeformation(0.0162F)).texOffs(60, 60).addBox(-4.0668F, 12.0082F, -6.9582F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0164F))
						.texOffs(60, 60).addBox(-2.0168F, 12.0082F, -6.9582F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0164F)).texOffs(60, 60).addBox(0.0332F, 12.0082F, -6.9582F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0164F)).texOffs(60, 60)
		...
		PartDefinition Toe_r2 = leg2.addOrReplaceChild("Toe_r2",
				...
				PartPose.offsetAndRotation(3.1F, 11.7544F, -5.5573F, -0.6109F, 0.0F, 0.0F));
		PartDefinition LowerLeg_r2 = leg2.addOrReplaceChild("LowerLeg_r2", CubeListBuilder.create().texOffs(72, 30).addBox(-4.0009F, -2.9909F, -3.0091F, 8.0F, 6.0F, 6.0F, new CubeDeformation(0.0182F)),
				PartPose.offsetAndRotation(0.01F, 9.8038F, 0.916F, -0.5236F, 0.0F, 0.0F));
		PartDefinition MidLeg_r2 = leg2.addOrReplaceChild("MidLeg_r2", CubeListBuilder.create().texOffs(160, 44).addBox(-4.01F, -3.99F, -4.01F, 8.0F, 8.0F, 8.0F, new CubeDeformation(0.02F)),
				PartPose.offsetAndRotation(0.02F, 7.5339F, -0.477F, 0.5672F, 0.0F, 0.0F));
		PartDefinition UpperLeg_r2 = leg2.addOrReplaceChild("UpperLeg_r2", CubeListBuilder.create().texOffs(112, 0).addBox(-3.989F, -4.989F, -4.011F, 8.0F, 10.0F, 8.0F, new CubeDeformation(0.022F)),
				PartPose.offsetAndRotation(0.0F, 2.2841F, -1.0151F, -0.2182F, 0.0F, 0.0F));
		PartDefinition leg3 = partdefinition.addOrReplaceChild("leg3",
				CubeListBuilder.create().texOffs(112, 18).mirror().addBox(-3.9919F, 10.0081F, -5.5081F, 8.0F, 4.0F, 8.0F, new CubeDeformation(0.0162F)).mirror(false).texOffs(60, 60).mirror()
						.addBox(-4.0668F, 12.0082F, -6.5082F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0164F)).mirror(false).texOffs(60, 60).mirror().addBox(-2.0168F, 12.0082F, -6.5082F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0164F)).mirror(false)
						.texOffs(60, 60).mirror().addBox(0.0332F, 12.0082F, -6.5082F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0164F)).mirror(false).texOffs(60, 60).mirror()
		...
		PartDefinition LowerLeg_r3 = leg3.addOrReplaceChild("LowerLeg_r3", CubeListBuilder.create().texOffs(72, 30).mirror().addBox(-4.0009F, -2.9909F, -3.0091F, 8.0F, 6.0F, 6.0F, new CubeDeformation(0.0182F)).mirror(false),
				PartPose.offsetAndRotation(0.01F, 9.8038F, 1.366F, -0.5236F, 0.0F, 0.0F));
		PartDefinition MidLeg_r3 = leg3.addOrReplaceChild("MidLeg_r3", CubeListBuilder.create().texOffs(160, 44).mirror().addBox(-4.01F, -3.99F, -4.01F, 8.0F, 8.0F, 8.0F, new CubeDeformation(0.02F)).mirror(false),
				PartPose.offsetAndRotation(0.02F, 7.5339F, -0.027F, 0.5672F, 0.0F, 0.0F));
		PartDefinition UpperLeg_r3 = leg3.addOrReplaceChild("UpperLeg_r3", CubeListBuilder.create().texOffs(112, 0).mirror().addBox(-3.989F, -4.989F, -4.011F, 8.0F, 10.0F, 8.0F, new CubeDeformation(0.022F)).mirror(false),
		...
		PartDefinition leg4 = partdefinition.addOrReplaceChild("leg4",
				CubeListBuilder.create().texOffs(112, 18).addBox(-3.9919F, 10.0081F, -5.5081F, 8.0F, 4.0F, 8.0F, new CubeDeformation(0.0162F)).texOffs(60, 60).addBox(-4.0668F, 12.0082F, -6.5082F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0164F))
						.texOffs(60, 60).addBox(-2.0168F, 12.0082F, -6.5082F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0164F)).texOffs(60, 60).addBox(0.0332F, 12.0082F, -6.5082F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0164F)).texOffs(60, 60)
		...
		PartDefinition Toe_r4 = leg4.addOrReplaceChild("Toe_r4",
				CubeListBuilder.create().texOffs(72, 58).addBox(-1.0169F, -0.9919F, -1.0081F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0162F)).texOffs(72, 58).addBox(-3.0669F, -0.9919F, -1.0081F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0162F))
						.texOffs(72, 58).addBox(-5.1169F, -0.9919F, -1.0081F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0162F)).texOffs(72, 58).addBox(-7.1669F, -0.9919F, -1.0081F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0162F)),
				PartPose.offsetAndRotation(3.1F, 11.7544F, -5.1073F, -0.6109F, 0.0F, 0.0F));
		PartDefinition LowerLeg_r4 = leg4.addOrReplaceChild("LowerLeg_r4", CubeListBuilder.create().texOffs(72, 30).addBox(-4.0009F, -2.9909F, -3.0091F, 8.0F, 6.0F, 6.0F, new CubeDeformation(0.0182F)),
				PartPose.offsetAndRotation(0.01F, 9.8038F, 1.366F, -0.5236F, 0.0F, 0.0F));
		PartDefinition MidLeg_r4 = leg4.addOrReplaceChild("MidLeg_r4", CubeListBuilder.create().texOffs(160, 44).addBox(-4.01F, -3.99F, -4.01F, 8.0F, 8.0F, 8.0F, new CubeDeformation(0.02F)),
				PartPose.offsetAndRotation(0.02F, 7.5339F, -0.027F, 0.5672F, 0.0F, 0.0F));
		PartDefinition UpperLeg_r4 = leg4.addOrReplaceChild("UpperLeg_r4", CubeListBuilder.create().texOffs(112, 0).addBox(-3.989F, -4.989F, -4.011F, 8.0F, 10.0F, 8.0F, new CubeDeformation(0.022F)),
				PartPose.offsetAndRotation(0.0F, 2.2841F, -0.5651F, -0.2182F, 0.0F, 0.0F));
