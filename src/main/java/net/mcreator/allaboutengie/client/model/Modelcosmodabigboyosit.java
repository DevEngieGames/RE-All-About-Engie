...
public class Modelcosmodabigboyosit extends EntityModel<LivingEntityRenderState> {
	// This layer location should be baked with EntityRendererProvider.Context in
	// the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath("allaboutengie", "modelcosmodabigboyosit"), "main");
	...
	public Modelcosmodabigboyosit(ModelPart root) {
		super(root);
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Body = partdefinition.addOrReplaceChild("Body",
				CubeListBuilder.create().texOffs(0, 56).addBox(-9.975F, -20.975F, -12.025F, 20.0F, 32.0F, 16.0F, new CubeDeformation(0.025F)).texOffs(66, 144).addBox(-9.875F, -20.875F, -12.125F, 20.0F, 32.0F, 16.0F, new CubeDeformation(0.25F)),
				PartPose.offsetAndRotation(0.0F, 11.4F, 4.0F, 1.5708F, 0.0F, 0.0F));
		...
		PartDefinition mid1 = base2.addOrReplaceChild("mid1", CubeListBuilder.create().texOffs(214, 66).addBox(-5.5F, -5.5F, 0.0F, 10.0F, 10.0F, 6.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 5.625F, 0.0903F, -0.2608F, -0.0233F));
		PartDefinition mid1a = mid1.addOrReplaceChild("mid1a", CubeListBuilder.create().texOffs(214, 66).addBox(-5.5F, -5.5F, 0.0F, 10.0F, 10.0F, 6.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 5.625F, 0.0903F, -0.2608F, -0.0233F));
		...
		PartDefinition sidefin_r2 = mid1a.addOrReplaceChild("sidefin_r2", CubeListBuilder.create().texOffs(184, 80).addBox(-3.0F, -1.0F, -3.0F, 6.0F, 2.0F, 6.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(5.4819F, 3.6679F, 4.866F, 0.0246F, -0.5108F, 0.2081F));
		PartDefinition mid2 = mid1a.addOrReplaceChild("mid2", CubeListBuilder.create().texOffs(228, 84).addBox(-4.25F, -4.25F, 0.0F, 8.0F, 8.0F, 6.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 5.625F, 0.0903F, -0.2608F, -0.0233F));
		PartDefinition mid2a = mid2.addOrReplaceChild("mid2a", CubeListBuilder.create().texOffs(228, 84).addBox(-4.25F, -4.25F, 0.0F, 8.0F, 8.0F, 6.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 5.625F, -0.0903F, -0.2608F, 0.0233F));
		...
		PartDefinition tip = mid2a.addOrReplaceChild("tip", CubeListBuilder.create().texOffs(236, 100).addBox(-1.75F, -1.75F, 0.0F, 4.0F, 4.0F, 6.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 5.625F, -0.0903F, -0.2608F, 0.0233F));
		PartDefinition tip2 = tip.addOrReplaceChild("tip2", CubeListBuilder.create().texOffs(236, 112).addBox(-1.75F, -1.75F, 0.0F, 4.0F, 4.0F, 6.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 5.625F, 0.346F, -0.2608F, 0.0233F));
		...
		PartDefinition Head = partdefinition.addOrReplaceChild("Head",
				CubeListBuilder.create().texOffs(72, 78).addBox(-8.0F, -13.0F, -16.0F, 16.0F, 16.0F, 16.0F, new CubeDeformation(0.0F)).texOffs(128, 110).addBox(-8.0F, -13.0F, -16.0F, 16.0F, 16.0F, 16.0F, new CubeDeformation(0.05F)).texOffs(111, 0)
				...
				PartPose.offset(0.0F, 13.4F, -12.0F));
		...
		PartDefinition leg1 = partdefinition.addOrReplaceChild("leg1",
				CubeListBuilder.create().texOffs(224, 52).addBox(-3.9919F, 8.0081F, -8.9581F, 8.0F, 4.0F, 8.0F, new CubeDeformation(0.0081F)).texOffs(248, 72).addBox(-4.0668F, 10.0082F, -9.9582F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0164F))
						.texOffs(248, 72).addBox(-2.0168F, 10.0082F, -9.9582F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0164F)).texOffs(248, 72).addBox(0.0332F, 10.0082F, -9.9582F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0164F)).texOffs(248, 72)
		...
		PartDefinition leg3 = partdefinition.addOrReplaceChild("leg3",
				CubeListBuilder.create().texOffs(224, 52).addBox(-3.9919F, 8.0081F, -8.5081F, 8.0F, 4.0F, 8.0F, new CubeDeformation(0.0081F)).texOffs(248, 72).addBox(-4.0668F, 10.0082F, -9.5082F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0164F))
						.texOffs(248, 72).addBox(-2.0168F, 10.0082F, -9.5082F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0164F)).texOffs(248, 72).addBox(0.0332F, 10.0082F, -9.5082F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0164F)).texOffs(248, 72)
						.addBox(2.0832F, 10.0082F, -9.5082F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0164F)),
				PartPose.offsetAndRotation(-6.0F, 12.0F, -10.0F, 0.0F, 0.5585F, 0.0F));
