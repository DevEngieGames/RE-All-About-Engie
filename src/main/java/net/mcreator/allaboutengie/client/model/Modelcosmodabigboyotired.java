...
public class Modelcosmodabigboyotired<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("allaboutengie", "modelcosmodabigboyotired"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition root = partdefinition.addOrReplaceChild("root", CubeListBuilder.create(), PartPose.offsetAndRotation(-17.0F, 15.0F, 0.0F, 0.0F, 0.0F, 1.5708F));
