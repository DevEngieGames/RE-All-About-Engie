...
public class Modelengiedaboyo extends EntityModel<LivingEntityRenderState> {
	// This layer location should be baked with EntityRendererProvider.Context in
	// the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath("allaboutengie", "modelengiedaboyo"), "main");
	...
	public Modelengiedaboyo(ModelPart root) {
		super(root);
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition leg1 = partdefinition.addOrReplaceChild("leg1", CubeListBuilder.create().texOffs(112, 26).addBox(-2.0F, 5.0F, -2.975F, 4.0F, 2.0F, 4.0F, new CubeDeformation(0.0081F)), PartPose.offset(-3.0F, 17.0F, 5.5F));
		PartDefinition Toe_r1 = leg1.addOrReplaceChild("Toe_r1",
				...
				PartPose.offsetAndRotation(1.55F, 6.5F, -2.975F, 0.0F, 0.0F, 0.0F));
		...
		PartDefinition leg2 = partdefinition.addOrReplaceChild("leg2", CubeListBuilder.create().texOffs(112, 26).addBox(-2.0F, 5.0F, -2.975F, 4.0F, 2.0F, 4.0F, new CubeDeformation(0.0081F)), PartPose.offset(3.0F, 17.0F, 5.5F));
