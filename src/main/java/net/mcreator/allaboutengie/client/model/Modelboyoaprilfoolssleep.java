...
public class Modelboyoaprilfoolssleep extends EntityModel<LivingEntityRenderState> {
	// This layer location should be baked with EntityRendererProvider.Context in
	// the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath("allaboutengie", "modelboyoaprilfoolssleep"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition bone = partdefinition.addOrReplaceChild("bone", CubeListBuilder.create(), PartPose.offsetAndRotation(-8.5F, 20.0F, 0.0F, 0.0F, 0.0F, 1.5708F));
		...
		PartDefinition Tail = Body.addOrReplaceChild("Tail", CubeListBuilder.create(), PartPose.offsetAndRotation(0.0F, 8.0F, 1.0F, 0.0F, 0.0F, -0.2618F));
		PartDefinition tail_r1 = Tail.addOrReplaceChild("tail_r1", CubeListBuilder.create().texOffs(0, 69).addBox(-1.5F, -15.5852F, 5.147F, 3.0F, 3.0F, 8.0F, new CubeDeformation(0.3F)),
		...
		PartDefinition backfinsb_r1 = Tail.addOrReplaceChild("backfinsb_r1", CubeListBuilder.create().texOffs(0, 60).addBox(-0.5F, -2.0852F, 6.1471F, 1.0F, 1.0F, 7.0F, new CubeDeformation(0.0F)).texOffs(68, 0)
		...
		PartDefinition leg1 = bone.addOrReplaceChild("leg1", CubeListBuilder.create().texOffs(63, 69).mirror().addBox(-2.0F, 0.0F, -2.0F, 4.0F, 7.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false).texOffs(47, 69).mirror()
				.addBox(-2.0F, 0.0F, -2.0F, 4.0F, 7.0F, 4.0F, new CubeDeformation(0.1F)).mirror(false), PartPose.offsetAndRotation(-3.0F, -7.0F, 5.5F, -0.1298F, -0.017F, -0.4352F));
		...
		PartDefinition leg3 = bone.addOrReplaceChild("leg3", CubeListBuilder.create().texOffs(63, 69).mirror().addBox(-2.0F, 0.0F, -2.0F, 4.0F, 7.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false).texOffs(47, 69).mirror()
				.addBox(-2.0F, 0.0F, -2.0F, 4.0F, 7.0F, 4.0F, new CubeDeformation(0.1F)).mirror(false), PartPose.offsetAndRotation(-3.0F, -7.0F, -6.5F, 0.3442F, 0.0594F, -0.3387F));
