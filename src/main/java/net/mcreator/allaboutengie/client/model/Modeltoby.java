...
public class Modeltoby extends EntityModel<LivingEntityRenderState> {
	// This layer location should be baked with EntityRendererProvider.Context in
	// the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath("allaboutengie", "modeltoby"), "main");
	...
	public Modeltoby(ModelPart root) {
		super(root);
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Base_r1 = TailSecondary.addOrReplaceChild("Base_r1", CubeListBuilder.create().texOffs(0, 17).addBox(-1.5F, -1.3563F, -0.6088F, 3.0F, 5.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.25F, -2.0F, 1.309F, 0.0F, 0.0F));
		...
		PartDefinition Base_r2 = TailTertiary.addOrReplaceChild("Base_r2",
				...
				PartPose.offsetAndRotation(0.0F, -0.5F, 1.25F, 1.1345F, 0.0F, 0.0F));
		PartDefinition Base_r3 = TailTertiary.addOrReplaceChild("Base_r3",
				...
				PartPose.offsetAndRotation(0.0F, -1.5F, 1.25F, -0.8727F, 0.0F, 0.0F));
		PartDefinition Base_r4 = TailTertiary.addOrReplaceChild("Base_r4", CubeListBuilder.create().texOffs(88, 0).addBox(-1.0F, -0.3449F, -0.7203F, 2.0F, 5.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -0.75F, -2.75F, 1.4835F, 0.0F, 0.0F));
		...
		PartDefinition MidLeg_r1 = leg1.addOrReplaceChild("MidLeg_r1", CubeListBuilder.create().texOffs(66, 22).addBox(-2.01F, -2.0F, -2.0F, 4.0F, 4.0F, 4.0F, new CubeDeformation(0.01F)),
				PartPose.offsetAndRotation(0.01F, 2.767F, -1.7385F, 0.5672F, 0.0F, 0.0F));
		PartDefinition UpperLegLayer_r1 = leg1.addOrReplaceChild("UpperLegLayer_r1",
		...
		PartDefinition LowerLeg_r2 = leg2.addOrReplaceChild("LowerLeg_r2", CubeListBuilder.create().texOffs(36, 15).addBox(-2.005F, -1.5F, -1.5F, 4.0F, 3.0F, 3.0F, new CubeDeformation(0.0091F)),
				PartPose.offsetAndRotation(0.005F, 3.9019F, -1.042F, -0.5236F, 0.0F, 0.0F));
		PartDefinition MidLeg_r2 = leg2.addOrReplaceChild("MidLeg_r2", CubeListBuilder.create().texOffs(66, 22).addBox(-2.01F, -2.0F, -2.0F, 4.0F, 4.0F, 4.0F, new CubeDeformation(0.01F)),
				PartPose.offsetAndRotation(0.01F, 2.767F, -1.7385F, 0.5672F, 0.0F, 0.0F));
		PartDefinition UpperLegLayer_r2 = leg2.addOrReplaceChild("UpperLegLayer_r2",
				CubeListBuilder.create().texOffs(80, 46).addBox(-2.0F, -2.5F, -2.0F, 4.0F, 5.0F, 4.0F, new CubeDeformation(0.061F)).texOffs(56, 0).addBox(-2.0F, -2.5F, -2.0F, 4.0F, 5.0F, 4.0F, new CubeDeformation(0.011F)),
				PartPose.offsetAndRotation(0.0F, 0.142F, -2.0075F, -0.2182F, 0.0F, 0.0F));
		...
		PartDefinition MidLeg_r3 = leg3.addOrReplaceChild("MidLeg_r3", CubeListBuilder.create().texOffs(66, 22).addBox(-2.01F, -2.0F, -2.0F, 4.0F, 4.0F, 4.0F, new CubeDeformation(0.01F)),
				PartPose.offsetAndRotation(0.01F, 2.767F, -1.5135F, 0.5672F, 0.0F, 0.0F));
		PartDefinition UpperLegLayer_r3 = leg3.addOrReplaceChild("UpperLegLayer_r3",
				CubeListBuilder.create().texOffs(80, 46).addBox(-2.0F, -2.5F, -2.0F, 4.0F, 5.0F, 4.0F, new CubeDeformation(0.061F)).texOffs(56, 0).addBox(-2.0F, -2.5F, -2.0F, 4.0F, 5.0F, 4.0F, new CubeDeformation(0.011F)),
		...
		PartDefinition LowerLeg_r4 = leg4.addOrReplaceChild("LowerLeg_r4", CubeListBuilder.create().texOffs(36, 15).addBox(-2.005F, -1.5F, -1.5F, 4.0F, 3.0F, 3.0F, new CubeDeformation(0.0091F)),
				PartPose.offsetAndRotation(0.005F, 3.9019F, -0.817F, -0.5236F, 0.0F, 0.0F));
		PartDefinition MidLeg_r4 = leg4.addOrReplaceChild("MidLeg_r4", CubeListBuilder.create().texOffs(66, 22).addBox(-2.01F, -2.0F, -2.0F, 4.0F, 4.0F, 4.0F, new CubeDeformation(0.01F)),
				PartPose.offsetAndRotation(0.01F, 2.767F, -1.5135F, 0.5672F, 0.0F, 0.0F));
		PartDefinition UpperLegLayer_r4 = leg4.addOrReplaceChild("UpperLegLayer_r4",
				CubeListBuilder.create().texOffs(80, 46).addBox(-2.0F, -2.5F, -2.0F, 4.0F, 5.0F, 4.0F, new CubeDeformation(0.061F)).texOffs(56, 0).addBox(-2.0F, -2.5F, -2.0F, 4.0F, 5.0F, 4.0F, new CubeDeformation(0.011F)),
				PartPose.offsetAndRotation(0.0F, 0.142F, -1.7825F, -0.2182F, 0.0F, 0.0F));
