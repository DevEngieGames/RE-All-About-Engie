...
public class Modelalienengiesharkotamed extends EntityModel<LivingEntityRenderState> {
	// This layer location should be baked with EntityRendererProvider.Context in
	// the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath("allaboutengie", "modelalienengiesharkotamed"), "main");
	...
	public Modelalienengiesharkotamed(ModelPart root) {
		super(root);
