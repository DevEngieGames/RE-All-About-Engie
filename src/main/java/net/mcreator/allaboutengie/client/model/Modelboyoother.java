...
public class Modelboyoother extends EntityModel<LivingEntityRenderState> {
	// This layer location should be baked with EntityRendererProvider.Context in
	// the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath("allaboutengie", "modelboyoother"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Tail = Body.addOrReplaceChild("Tail", CubeListBuilder.create(), PartPose.offsetAndRotation(0.0F, 3.8F, -2.2F, -1.5708F, 0.0F, 0.0F));
		...
		PartDefinition TailSecondary = TailPrimary.addOrReplaceChild("TailSecondary", CubeListBuilder.create(), PartPose.offset(0.0F, 2.25F, 4.25F));
		...
		PartDefinition Head = partdefinition.addOrReplaceChild("Head",
				CubeListBuilder.create().texOffs(36, 39).addBox(-4.0F, -6.5F, -8.0F, 8.0F, 8.0F, 8.0F, new CubeDeformation(0.0F)).texOffs(40, 45).addBox(-2.3F, -2.8F, -8.1F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(40, 45)
						.addBox(1.3F, -2.8F, -8.1F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(64, 80).addBox(-4.0F, -6.5F, -8.0F, 8.0F, 8.0F, 8.0F, new CubeDeformation(0.025F)).texOffs(32, 80)
		...
		PartDefinition leg1 = partdefinition.addOrReplaceChild("leg1",
				CubeListBuilder.create().texOffs(56, 9).addBox(-2.0F, 5.0F, -2.975F, 4.0F, 2.0F, 4.0F, new CubeDeformation(0.0081F)).texOffs(30, 30).addBox(-2.0375F, 6.0F, -3.475F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0082F)).texOffs(30, 30)
						.addBox(-1.0125F, 6.0F, -3.475F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0082F)).texOffs(30, 30).addBox(0.0125F, 6.0F, -3.475F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0082F)).texOffs(30, 30)
		...
		PartDefinition leg2 = partdefinition.addOrReplaceChild("leg2", CubeListBuilder.create().texOffs(56, 9).mirror().addBox(-2.0F, 5.0F, -2.975F, 4.0F, 2.0F, 4.0F, new CubeDeformation(0.0081F)).mirror(false).texOffs(30, 30).mirror()
				.addBox(-2.0375F, 6.0F, -3.475F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0082F)).mirror(false).texOffs(30, 30).mirror().addBox(-1.0125F, 6.0F, -3.475F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0082F)).mirror(false).texOffs(30, 30)
				.mirror().addBox(0.0125F, 6.0F, -3.475F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0082F)).mirror(false).texOffs(30, 30).mirror().addBox(1.0375F, 6.0F, -3.475F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0082F)).mirror(false),
				PartPose.offset(3.0F, 17.0F, 5.5F));
		PartDefinition Toe_r2 = leg2.addOrReplaceChild("Toe_r2",
				...
				PartPose.offsetAndRotation(1.55F, 5.8772F, -2.7786F, -0.6109F, 0.0F, 0.0F));
		PartDefinition LowerLeg_r2 = leg2.addOrReplaceChild("LowerLeg_r2", CubeListBuilder.create().texOffs(36, 15).mirror().addBox(-2.005F, -1.5F, -1.5F, 4.0F, 3.0F, 3.0F, new CubeDeformation(0.0091F)).mirror(false),
				PartPose.offsetAndRotation(0.005F, 4.9019F, 0.458F, -0.5236F, 0.0F, 0.0F));
		PartDefinition MidLeg_r2 = leg2.addOrReplaceChild("MidLeg_r2", CubeListBuilder.create().texOffs(80, 22).mirror().addBox(-2.01F, -2.0F, -2.0F, 4.0F, 4.0F, 4.0F, new CubeDeformation(0.01F)).mirror(false),
				PartPose.offsetAndRotation(0.01F, 3.767F, -0.2385F, 0.5672F, 0.0F, 0.0F));
		PartDefinition UpperLeg_r2 = leg2.addOrReplaceChild("UpperLeg_r2", CubeListBuilder.create().texOffs(56, 0).mirror().addBox(-2.0F, -2.5F, -2.0F, 4.0F, 5.0F, 4.0F, new CubeDeformation(0.011F)).mirror(false),
				PartPose.offsetAndRotation(0.0F, 1.142F, -0.5075F, -0.2182F, 0.0F, 0.0F));
		PartDefinition leg3 = partdefinition.addOrReplaceChild("leg3",
				CubeListBuilder.create().texOffs(56, 9).addBox(-2.0F, 5.0F, -2.75F, 4.0F, 2.0F, 4.0F, new CubeDeformation(0.0081F)).texOffs(30, 30).addBox(-2.0375F, 6.0F, -3.25F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0082F)).texOffs(30, 30)
						.addBox(-1.0125F, 6.0F, -3.25F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0082F)).texOffs(30, 30).addBox(0.0125F, 6.0F, -3.25F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0082F)).texOffs(30, 30)
		...
		PartDefinition leg4 = partdefinition.addOrReplaceChild("leg4", CubeListBuilder.create().texOffs(56, 9).mirror().addBox(-2.0F, 5.0F, -2.75F, 4.0F, 2.0F, 4.0F, new CubeDeformation(0.0081F)).mirror(false).texOffs(30, 30).mirror()
				.addBox(-2.0375F, 6.0F, -3.25F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0082F)).mirror(false).texOffs(30, 30).mirror().addBox(-1.0125F, 6.0F, -3.25F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0082F)).mirror(false).texOffs(30, 30)
				.mirror().addBox(0.0125F, 6.0F, -3.25F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0082F)).mirror(false).texOffs(30, 30).mirror().addBox(1.0375F, 6.0F, -3.25F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0082F)).mirror(false),
				PartPose.offset(3.0F, 17.0F, -6.5F));
		PartDefinition Toe_r4 = leg4.addOrReplaceChild("Toe_r4",
				CubeListBuilder.create().texOffs(36, 29).mirror().addBox(-0.5125F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0081F)).mirror(false).texOffs(36, 29).mirror()
						...
						.texOffs(36, 29).mirror().addBox(-3.5875F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0081F)).mirror(false),
				PartPose.offsetAndRotation(1.55F, 5.8772F, -2.5536F, -0.6109F, 0.0F, 0.0F));
		PartDefinition LowerLeg_r4 = leg4.addOrReplaceChild("LowerLeg_r4", CubeListBuilder.create().texOffs(36, 15).mirror().addBox(-2.005F, -1.5F, -1.5F, 4.0F, 3.0F, 3.0F, new CubeDeformation(0.0091F)).mirror(false),
				PartPose.offsetAndRotation(0.005F, 4.9019F, 0.683F, -0.5236F, 0.0F, 0.0F));
		PartDefinition MidLeg_r4 = leg4.addOrReplaceChild("MidLeg_r4", CubeListBuilder.create().texOffs(80, 22).mirror().addBox(-2.01F, -2.0F, -2.0F, 4.0F, 4.0F, 4.0F, new CubeDeformation(0.01F)).mirror(false),
				PartPose.offsetAndRotation(0.01F, 3.767F, -0.0135F, 0.5672F, 0.0F, 0.0F));
		PartDefinition UpperLeg_r4 = leg4.addOrReplaceChild("UpperLeg_r4", CubeListBuilder.create().texOffs(56, 0).mirror().addBox(-2.0F, -2.5F, -2.0F, 4.0F, 5.0F, 4.0F, new CubeDeformation(0.011F)).mirror(false),
				PartPose.offsetAndRotation(0.0F, 1.142F, -0.2825F, -0.2182F, 0.0F, 0.0F));
