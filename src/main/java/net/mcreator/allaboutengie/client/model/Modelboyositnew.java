...
public class Modelboyositnew extends EntityModel<LivingEntityRenderState> {
	// This layer location should be baked with EntityRendererProvider.Context in
	// the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath("allaboutengie", "modelboyositnew"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Body = partdefinition.addOrReplaceChild("Body", CubeListBuilder.create().texOffs(0, 28).addBox(-5.0F, 0.0F, -4.0F, 10.0F, 16.0F, 8.0F, new CubeDeformation(0.025F)),
		...
		PartDefinition UpperLeg_r2 = RightBackUpperLeg.addOrReplaceChild("UpperLeg_r2", CubeListBuilder.create().texOffs(56, 0).mirror().addBox(-2.0F, -2.5F, -2.0F, 4.0F, 5.0F, 4.0F, new CubeDeformation(0.011F)).mirror(false),
		...
		PartDefinition MidLeg_r2 = RightBackMidLeg.addOrReplaceChild("MidLeg_r2", CubeListBuilder.create().texOffs(80, 22).mirror().addBox(-2.01F, -2.0F, -2.0F, 4.0F, 4.0F, 4.0F, new CubeDeformation(0.01F)).mirror(false),
		...
		PartDefinition UpperLeg_r3 = LeftFrontUpperLeg.addOrReplaceChild("UpperLeg_r3", CubeListBuilder.create().texOffs(56, 0).addBox(-2.0F, -2.5F, -2.0F, 4.0F, 5.0F, 4.0F, new CubeDeformation(0.011F)),
				PartPose.offsetAndRotation(0.0F, 2.5F, -0.3F, -0.2182F, 0.0F, 0.0F));
		...
		PartDefinition MidLeg_r3 = LeftFrontMidLeg.addOrReplaceChild("MidLeg_r3", CubeListBuilder.create().texOffs(80, 22).addBox(-2.01F, -2.0F, -2.0F, 4.0F, 4.0F, 4.0F, new CubeDeformation(0.01F)),
				PartPose.offsetAndRotation(0.0F, 1.75F, 1.0F, 0.5672F, 0.0F, 0.0F));
		...
		PartDefinition UpperLeg_r4 = LeftBackUpperLeg.addOrReplaceChild("UpperLeg_r4", CubeListBuilder.create().texOffs(56, 0).mirror().addBox(-2.0F, -2.5F, -2.0F, 4.0F, 5.0F, 4.0F, new CubeDeformation(0.011F)).mirror(false),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -0.2182F, 0.0F, 0.0F));
		...
		PartDefinition MidLeg_r4 = LeftBackMidLeg.addOrReplaceChild("MidLeg_r4", CubeListBuilder.create().texOffs(80, 22).mirror().addBox(-2.01F, -2.0F, -2.0F, 4.0F, 4.0F, 4.0F, new CubeDeformation(0.01F)).mirror(false),
				PartPose.offsetAndRotation(0.01F, 1.642F, 1.1365F, 0.5672F, 0.0F, 0.0F));
