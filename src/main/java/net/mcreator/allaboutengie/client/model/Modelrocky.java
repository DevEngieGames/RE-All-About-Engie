...
public class Modelrocky extends EntityModel<LivingEntityRenderState> {
	// This layer location should be baked with EntityRendererProvider.Context in
	// the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath("allaboutengie", "modelrocky"), "main");
	...
	public Modelrocky(ModelPart root) {
		super(root);
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Body = Rocky.addOrReplaceChild("Body",
				...
				PartPose.offsetAndRotation(-0.1F, -13.0F, 2.475F, 1.5533F, -0.0003F, -0.0175F));
		...
		PartDefinition UpperLegLayer2_r1 = LeftBackUpperLeg
				.addOrReplaceChild(
		...
		PartDefinition MidLeg_r1 = LeftBackMidLeg.addOrReplaceChild("MidLeg_r1", CubeListBuilder.create().texOffs(112, 10).addBox(-2.01F, -2.0F, -2.0F, 4.0F, 4.0F, 4.0F, new CubeDeformation(0.01F)),
		...
		PartDefinition LowerLeg_r1 = LeftBackLowerLeg.addOrReplaceChild("LowerLeg_r1", CubeListBuilder.create().texOffs(114, 19).addBox(-2.005F, -1.5F, -1.5F, 4.0F, 3.0F, 3.0F, new CubeDeformation(0.0091F)),
		...
		PartDefinition UpperLegLayer2_r3 = RightFrontUpperLeg
				.addOrReplaceChild(
		...
		PartDefinition MidLeg_r3 = RightFrontMidLeg.addOrReplaceChild("MidLeg_r3", CubeListBuilder.create().texOffs(112, 10).addBox(-2.01F, -2.0F, -2.0F, 4.0F, 4.0F, 4.0F, new CubeDeformation(0.01F)),
				PartPose.offsetAndRotation(0.0F, 1.75F, 1.0F, 0.5672F, 0.0F, 0.0F));
		...
		PartDefinition LowerLeg_r3 = RightFrontLowerLeg.addOrReplaceChild("LowerLeg_r3", CubeListBuilder.create().texOffs(114, 19).addBox(-2.005F, -1.5F, -1.5F, 4.0F, 3.0F, 3.0F, new CubeDeformation(0.0091F)),
				PartPose.offsetAndRotation(0.0F, 1.35F, -0.675F, -0.5236F, 0.0F, 0.0F));
