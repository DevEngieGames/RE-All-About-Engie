...
public class MythicSharkoSitRenderer extends MobRenderer<MythicSharkoSitEntity, LivingEntityRenderState, Modelboyositnew> {
	private MythicSharkoSitEntity entity = null;
	...
	@Override
	public void extractRenderState(MythicSharkoSitEntity entity, LivingEntityRenderState state, float partialTicks) {
	...
	private static final class AnimatedModel extends Modelboyositnew {
		...
		public void setEntity(MythicSharkoSitEntity entity) {
			this.entity = entity;
		}
