...
public class LouisSitRenderer extends MobRenderer<LouisSitEntity, LivingEntityRenderState, Modeltobysitnew> {
	private LouisSitEntity entity = null;
	...
	@Override
	public void extractRenderState(LouisSitEntity entity, LivingEntityRenderState state, float partialTicks) {
	...
	private static final class AnimatedModel extends Modeltobysitnew {
		...
		public void setEntity(LouisSitEntity entity) {
			this.entity = entity;
		}
