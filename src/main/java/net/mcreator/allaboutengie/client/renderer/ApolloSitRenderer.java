...
public class ApolloSitRenderer extends MobRenderer<ApolloSitEntity, LivingEntityRenderState, Modeltobysitnew> {
	private ApolloSitEntity entity = null;
	...
	@Override
	public void extractRenderState(ApolloSitEntity entity, LivingEntityRenderState state, float partialTicks) {
	...
	private static final class AnimatedModel extends Modeltobysitnew {
		...
		public void setEntity(ApolloSitEntity entity) {
			this.entity = entity;
		}
