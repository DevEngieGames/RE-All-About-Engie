...
public class EngieSharkoRareTamedZoomiesRenderer extends MobRenderer<EngieSharkoRareTamedZoomiesEntity, LivingEntityRenderState, Modelboyozooms> {
	private EngieSharkoRareTamedZoomiesEntity entity = null;
	...
	@Override
	public void extractRenderState(EngieSharkoRareTamedZoomiesEntity entity, LivingEntityRenderState state, float partialTicks) {
	...
	public ResourceLocation getTextureLocation(LivingEntityRenderState state) {
		return ResourceLocation.parse("allaboutengie:textures/entities/rareengiesharkonewtamedzoom.png");
	}
	...
	private static final class AnimatedModel extends Modelboyozooms {
		...
		public void setEntity(EngieSharkoRareTamedZoomiesEntity entity) {
			this.entity = entity;
		}
