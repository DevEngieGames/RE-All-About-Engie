...
public class BigEpicSharkoSleepRenderer extends MobRenderer<BigEpicSharkoSleepEntity, LivingEntityRenderState, Modelbigboyotired> {
	private BigEpicSharkoSleepEntity entity = null;
	...
	@Override
	public void extractRenderState(BigEpicSharkoSleepEntity entity, LivingEntityRenderState state, float partialTicks) {
	...
	private static final class AnimatedModel extends Modelbigboyotired {
		...
		public void setEntity(BigEpicSharkoSleepEntity entity) {
			this.entity = entity;
		}
