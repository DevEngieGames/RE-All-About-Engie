...
public class BigEpicSharkoRenderer extends MobRenderer<BigEpicSharkoEntity, LivingEntityRenderState, Modelbigboyo> {
	private BigEpicSharkoEntity entity = null;
	...
	@Override
	public void extractRenderState(BigEpicSharkoEntity entity, LivingEntityRenderState state, float partialTicks) {
	...
	private static final class AnimatedModel extends Modelbigboyo {
		...
		public void setEntity(BigEpicSharkoEntity entity) {
			this.entity = entity;
		}
