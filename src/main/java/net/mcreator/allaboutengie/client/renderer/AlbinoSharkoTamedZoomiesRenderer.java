...
public class AlbinoSharkoTamedZoomiesRenderer extends MobRenderer<AlbinoSharkoTamedZoomiesEntity, LivingEntityRenderState, Modelboyozooms> {
	private AlbinoSharkoTamedZoomiesEntity entity = null;
	...
	@Override
	public void extractRenderState(AlbinoSharkoTamedZoomiesEntity entity, LivingEntityRenderState state, float partialTicks) {
	...
	private static final class AnimatedModel extends Modelboyozooms {
		...
		public void setEntity(AlbinoSharkoTamedZoomiesEntity entity) {
			this.entity = entity;
		}
