...
public class AlbinoSharkoTamedZoomiesRenderer extends MobRenderer<AlbinoSharkoTamedZoomiesEntity, Modelboyozooms<AlbinoSharkoTamedZoomiesEntity>> {
	...
	private static final class AnimatedModel extends Modelboyozooms<AlbinoSharkoTamedZoomiesEntity> {
		...
		private final HierarchicalModel animator = new HierarchicalModel<AlbinoSharkoTamedZoomiesEntity>() {
			@Override
			...
			@Override
			public void setupAnim(AlbinoSharkoTamedZoomiesEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
