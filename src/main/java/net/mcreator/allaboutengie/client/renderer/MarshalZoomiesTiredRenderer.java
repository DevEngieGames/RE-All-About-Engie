...
public class MarshalZoomiesTiredRenderer extends MobRenderer<MarshalZoomiesTiredEntity, LivingEntityRenderState, Modeltobyzoomtired> {
	private MarshalZoomiesTiredEntity entity = null;
	...
	@Override
	public void extractRenderState(MarshalZoomiesTiredEntity entity, LivingEntityRenderState state, float partialTicks) {
	...
	public ResourceLocation getTextureLocation(LivingEntityRenderState state) {
		return ResourceLocation.parse("allaboutengie:textures/entities/marshalzoomtired.png");
	}
	...
	private static final class AnimatedModel extends Modeltobyzoomtired {
		...
		public void setEntity(MarshalZoomiesTiredEntity entity) {
			this.entity = entity;
		}
