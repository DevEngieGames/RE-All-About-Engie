...
public class BigExoticSharkoRenderer extends MobRenderer<BigExoticSharkoEntity, LivingEntityRenderState, Modelboyo> {
	private BigExoticSharkoEntity entity = null;
	...
	@Override
	public void extractRenderState(BigExoticSharkoEntity entity, LivingEntityRenderState state, float partialTicks) {
	...
	private static final class AnimatedModel extends Modelboyo {
		...
		public void setEntity(BigExoticSharkoEntity entity) {
			this.entity = entity;
		}
