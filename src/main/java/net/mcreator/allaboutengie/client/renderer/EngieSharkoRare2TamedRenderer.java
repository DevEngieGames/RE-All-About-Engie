...
public class EngieSharkoRare2TamedRenderer extends MobRenderer<EngieSharkoRare2TamedEntity, LivingEntityRenderState, Modelboyo> {
	private EngieSharkoRare2TamedEntity entity = null;
	...
	@Override
	public void extractRenderState(EngieSharkoRare2TamedEntity entity, LivingEntityRenderState state, float partialTicks) {
	...
	private static final class AnimatedModel extends Modelboyo {
		...
		public void setEntity(EngieSharkoRare2TamedEntity entity) {
			this.entity = entity;
		}
