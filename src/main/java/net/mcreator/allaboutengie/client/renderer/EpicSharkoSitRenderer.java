...
public class EpicSharkoSitRenderer extends MobRenderer<EpicSharkoSitEntity, LivingEntityRenderState, Modelboyositnew> {
	private EpicSharkoSitEntity entity = null;
	...
	@Override
	public void extractRenderState(EpicSharkoSitEntity entity, LivingEntityRenderState state, float partialTicks) {
	...
	private static final class AnimatedModel extends Modelboyositnew {
		...
		public void setEntity(EpicSharkoSitEntity entity) {
			this.entity = entity;
		}
