...
public class ThrowbackCreatorRenderer extends HumanoidMobRenderer<ThrowbackCreatorEntity, HumanoidRenderState, HumanoidModel<HumanoidRenderState>> {
	private ThrowbackCreatorEntity entity = null;
	...
	@Override
	public void extractRenderState(ThrowbackCreatorEntity entity, HumanoidRenderState state, float partialTicks) {
