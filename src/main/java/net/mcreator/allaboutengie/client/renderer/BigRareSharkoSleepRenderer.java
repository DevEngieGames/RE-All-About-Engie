...
public class BigRareSharkoSleepRenderer extends MobRenderer<BigRareSharkoSleepEntity, LivingEntityRenderState, Modelbigboyotired> {
	private BigRareSharkoSleepEntity entity = null;
	...
	@Override
	public void extractRenderState(BigRareSharkoSleepEntity entity, LivingEntityRenderState state, float partialTicks) {
	...
	private static final class AnimatedModel extends Modelbigboyotired {
		...
		public void setEntity(BigRareSharkoSleepEntity entity) {
			this.entity = entity;
		}
