...
public class FinneganLayRenderer extends MobRenderer<FinneganLayEntity, LivingEntityRenderState, Modelboyosit> {
	private FinneganLayEntity entity = null;
	...
	@Override
	public void extractRenderState(FinneganLayEntity entity, LivingEntityRenderState state, float partialTicks) {
	...
	private static final class AnimatedModel extends Modelboyosit {
		...
		public void setEntity(FinneganLayEntity entity) {
			this.entity = entity;
		}
