...
public class AlbinoSharkoLayAprilFoolsRenderer extends MobRenderer<AlbinoSharkoLayAprilFoolsEntity, LivingEntityRenderState, Modelboyoaprilfoolssit> {
	private AlbinoSharkoLayAprilFoolsEntity entity = null;
	...
	@Override
	public void extractRenderState(AlbinoSharkoLayAprilFoolsEntity entity, LivingEntityRenderState state, float partialTicks) {
