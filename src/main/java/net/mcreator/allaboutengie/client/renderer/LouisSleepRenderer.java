...
public class LouisSleepRenderer extends MobRenderer<LouisSleepEntity, Modeltobytired<LouisSleepEntity>> {
	...
	public ResourceLocation getTextureLocation(LouisSleepEntity entity) {
		return ResourceLocation.parse("allaboutengie:textures/entities/louistired.png");
	}

	private static final class AnimatedModel extends Modeltobytired<LouisSleepEntity> {
		private final ModelPart root;
		private final HierarchicalModel animator = new HierarchicalModel<LouisSleepEntity>() {
			@Override
			...
			@Override
			public void setupAnim(LouisSleepEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
