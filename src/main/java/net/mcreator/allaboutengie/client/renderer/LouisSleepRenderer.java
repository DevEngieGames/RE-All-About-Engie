...
public class LouisSleepRenderer extends MobRenderer<LouisSleepEntity, LivingEntityRenderState, Modeltobytired> {
	private LouisSleepEntity entity = null;
	...
	@Override
	public void extractRenderState(LouisSleepEntity entity, LivingEntityRenderState state, float partialTicks) {
	...
	private static final class AnimatedModel extends Modeltobytired {
		...
		public void setEntity(LouisSleepEntity entity) {
			this.entity = entity;
		}
