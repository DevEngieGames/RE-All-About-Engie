...
public class BigRareSharkoLayRenderer extends MobRenderer<BigRareSharkoLayEntity, LivingEntityRenderState, Modelbigboyosit> {
	private BigRareSharkoLayEntity entity = null;
	...
	@Override
	public void extractRenderState(BigRareSharkoLayEntity entity, LivingEntityRenderState state, float partialTicks) {
	...
	private static final class AnimatedModel extends Modelbigboyosit {
		...
		public void setEntity(BigRareSharkoLayEntity entity) {
			this.entity = entity;
		}
