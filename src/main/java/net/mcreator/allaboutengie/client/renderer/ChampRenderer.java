...
public class ChampRenderer extends MobRenderer<ChampEntity, LivingEntityRenderState, Modelchampdaboyo> {
	private ChampEntity entity = null;
	...
	@Override
	public void extractRenderState(ChampEntity entity, LivingEntityRenderState state, float partialTicks) {
	...
	private static final class AnimatedModel extends Modelchampdaboyo {
		private ChampEntity entity = null;
		...
		public void setEntity(ChampEntity entity) {
			this.entity = entity;
		}
