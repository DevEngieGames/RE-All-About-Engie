...
public class LouisZoomiesRenderer extends MobRenderer<LouisZoomiesEntity, LivingEntityRenderState, Modeltobyzooms> {
	private LouisZoomiesEntity entity = null;
	...
	@Override
	public void extractRenderState(LouisZoomiesEntity entity, LivingEntityRenderState state, float partialTicks) {
	...
	public ResourceLocation getTextureLocation(LivingEntityRenderState state) {
		return ResourceLocation.parse("allaboutengie:textures/entities/louiszoom.png");
	}
	...
	private static final class AnimatedModel extends Modeltobyzooms {
		...
		public void setEntity(LouisZoomiesEntity entity) {
			this.entity = entity;
		}
