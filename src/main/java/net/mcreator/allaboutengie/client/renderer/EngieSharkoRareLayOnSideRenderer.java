...
public class EngieSharkoRareLayOnSideRenderer extends MobRenderer<EngieSharkoRareLayOnSideEntity, LivingEntityRenderState, Modelboyolayonside> {
	private EngieSharkoRareLayOnSideEntity entity = null;
	...
	@Override
	public void extractRenderState(EngieSharkoRareLayOnSideEntity entity, LivingEntityRenderState state, float partialTicks) {
	...
	private static final class AnimatedModel extends Modelboyolayonside {
		...
		public void setEntity(EngieSharkoRareLayOnSideEntity entity) {
			this.entity = entity;
		}
