...
public class MythicSharkoTamedZoomiesRenderer extends MobRenderer<MythicSharkoTamedZoomiesEntity, Modelboyozooms<MythicSharkoTamedZoomiesEntity>> {
	...
	public ResourceLocation getTextureLocation(MythicSharkoTamedZoomiesEntity entity) {
		return new ResourceLocation("allaboutengie:textures/entities/mythicsharkonewtamedzoom.png");
	}

	private static final class AnimatedModel extends Modelboyozooms<MythicSharkoTamedZoomiesEntity> {
		private final ModelPart root;
		private final HierarchicalModel animator = new HierarchicalModel<MythicSharkoTamedZoomiesEntity>() {
			@Override
			...
			@Override
			public void setupAnim(MythicSharkoTamedZoomiesEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
