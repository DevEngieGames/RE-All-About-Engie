...
public class SharkoTamedZoomiesRenderer extends MobRenderer<SharkoTamedZoomiesEntity, LivingEntityRenderState, Modelboyozooms> {
	private SharkoTamedZoomiesEntity entity = null;
	...
	@Override
	public void extractRenderState(SharkoTamedZoomiesEntity entity, LivingEntityRenderState state, float partialTicks) {
	...
	public ResourceLocation getTextureLocation(LivingEntityRenderState state) {
		return ResourceLocation.parse("allaboutengie:textures/entities/sharkonewtamedzoom.png");
	}
	...
	private static final class AnimatedModel extends Modelboyozooms {
		...
		public void setEntity(SharkoTamedZoomiesEntity entity) {
			this.entity = entity;
		}
