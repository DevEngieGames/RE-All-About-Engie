...
public class SharkoLayRenderer extends MobRenderer<SharkoLayEntity, Modelboyosit<SharkoLayEntity>> {
	...
	private static final class AnimatedModel extends Modelboyosit<SharkoLayEntity> {
		private final ModelPart root;
		private final HierarchicalModel animator = new HierarchicalModel<SharkoLayEntity>() {
			@Override
			...
			@Override
			public void setupAnim(SharkoLayEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
