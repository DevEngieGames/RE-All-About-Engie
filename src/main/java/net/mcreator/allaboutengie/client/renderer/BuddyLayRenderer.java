...
public class BuddyLayRenderer extends MobRenderer<BuddyLayEntity, LivingEntityRenderState, Modeltobysit> {
	private BuddyLayEntity entity = null;
	...
	@Override
	public void extractRenderState(BuddyLayEntity entity, LivingEntityRenderState state, float partialTicks) {
	...
	private static final class AnimatedModel extends Modeltobysit {
		...
		public void setEntity(BuddyLayEntity entity) {
			this.entity = entity;
		}
