...
public class EpicSharkoTamedZoomiesRenderer extends MobRenderer<EpicSharkoTamedZoomiesEntity, LivingEntityRenderState, Modelboyozooms> {
	private EpicSharkoTamedZoomiesEntity entity = null;
	...
	@Override
	public void extractRenderState(EpicSharkoTamedZoomiesEntity entity, LivingEntityRenderState state, float partialTicks) {
	...
	public ResourceLocation getTextureLocation(LivingEntityRenderState state) {
		return ResourceLocation.parse("allaboutengie:textures/entities/epicsharkonewtamedzoom.png");
	}
	...
	private static final class AnimatedModel extends Modelboyozooms {
		...
		public void setEntity(EpicSharkoTamedZoomiesEntity entity) {
			this.entity = entity;
		}
