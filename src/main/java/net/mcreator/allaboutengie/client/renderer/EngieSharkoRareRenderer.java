...
public class EngieSharkoRareRenderer extends MobRenderer<EngieSharkoRareEntity, LivingEntityRenderState, Modelboyo> {
	private EngieSharkoRareEntity entity = null;
	...
	@Override
	public void extractRenderState(EngieSharkoRareEntity entity, LivingEntityRenderState state, float partialTicks) {
	...
	public ResourceLocation getTextureLocation(LivingEntityRenderState state) {
		return ResourceLocation.parse("allaboutengie:textures/entities/rareengiesharkonew.png");
	}
	...
	private static final class AnimatedModel extends Modelboyo {
		...
		public void setEntity(EngieSharkoRareEntity entity) {
			this.entity = entity;
		}
