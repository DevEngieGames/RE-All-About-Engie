...
public class EngieSharkoRare2LayRenderer extends MobRenderer<EngieSharkoRare2LayEntity, LivingEntityRenderState, Modelboyosit> {
	private EngieSharkoRare2LayEntity entity = null;
	...
	@Override
	public void extractRenderState(EngieSharkoRare2LayEntity entity, LivingEntityRenderState state, float partialTicks) {
	...
	private static final class AnimatedModel extends Modelboyosit {
		...
		public void setEntity(EngieSharkoRare2LayEntity entity) {
			this.entity = entity;
		}
