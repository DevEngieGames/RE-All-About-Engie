...
public class BuddySitRenderer extends MobRenderer<BuddySitEntity, LivingEntityRenderState, Modeltobysitnew> {
	private BuddySitEntity entity = null;
	...
	@Override
	public void extractRenderState(BuddySitEntity entity, LivingEntityRenderState state, float partialTicks) {
	...
	private static final class AnimatedModel extends Modeltobysitnew {
		...
		public void setEntity(BuddySitEntity entity) {
			this.entity = entity;
		}
