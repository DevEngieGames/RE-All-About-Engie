...
public class MadEngieOldRiftedRenderer extends HumanoidMobRenderer<MadEngieOldRiftedEntity, HumanoidRenderState, HumanoidModel<HumanoidRenderState>> {
	private MadEngieOldRiftedEntity entity = null;
	...
	@Override
	public void extractRenderState(MadEngieOldRiftedEntity entity, HumanoidRenderState state, float partialTicks) {
