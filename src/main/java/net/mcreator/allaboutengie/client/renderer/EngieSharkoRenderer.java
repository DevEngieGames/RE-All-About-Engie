...
public class EngieSharkoRenderer extends MobRenderer<EngieSharkoEntity, LivingEntityRenderState, Modelboyo> {
	private EngieSharkoEntity entity = null;
	...
	@Override
	public void extractRenderState(EngieSharkoEntity entity, LivingEntityRenderState state, float partialTicks) {
	...
	public ResourceLocation getTextureLocation(LivingEntityRenderState state) {
		return ResourceLocation.parse("allaboutengie:textures/entities/engiesharkonew.png");
	}
	...
	private static final class AnimatedModel extends Modelboyo {
		...
		public void setEntity(EngieSharkoEntity entity) {
			this.entity = entity;
		}
