...
public class TobySleepRenderer extends MobRenderer<TobySleepEntity, LivingEntityRenderState, Modeltobytired> {
	private TobySleepEntity entity = null;
	...
	@Override
	public void extractRenderState(TobySleepEntity entity, LivingEntityRenderState state, float partialTicks) {
	...
	public ResourceLocation getTextureLocation(LivingEntityRenderState state) {
		return ResourceLocation.parse("allaboutengie:textures/entities/tobytired.png");
	}
	...
	private static final class AnimatedModel extends Modeltobytired {
		...
		public void setEntity(TobySleepEntity entity) {
			this.entity = entity;
		}
