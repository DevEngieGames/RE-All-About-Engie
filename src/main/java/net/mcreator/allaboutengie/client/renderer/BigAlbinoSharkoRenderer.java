...
public class BigAlbinoSharkoRenderer extends MobRenderer<BigAlbinoSharkoEntity, LivingEntityRenderState, Modelbigboyo> {
	private BigAlbinoSharkoEntity entity = null;
	...
	@Override
	public void extractRenderState(BigAlbinoSharkoEntity entity, LivingEntityRenderState state, float partialTicks) {
	...
	private static final class AnimatedModel extends Modelbigboyo {
		...
		public void setEntity(BigAlbinoSharkoEntity entity) {
			this.entity = entity;
		}
