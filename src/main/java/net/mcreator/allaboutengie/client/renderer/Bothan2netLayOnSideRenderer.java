...
public class Bothan2netLayOnSideRenderer extends MobRenderer<Bothan2netLayOnSideEntity, LivingEntityRenderState, Modeltobylayonside> {
	private Bothan2netLayOnSideEntity entity = null;
	...
	@Override
	public void extractRenderState(Bothan2netLayOnSideEntity entity, LivingEntityRenderState state, float partialTicks) {
	...
	private static final class AnimatedModel extends Modeltobylayonside {
		...
		public void setEntity(Bothan2netLayOnSideEntity entity) {
			this.entity = entity;
		}
