...
public class BigEngieSharkoSleepRenderer extends MobRenderer<BigEngieSharkoSleepEntity, LivingEntityRenderState, Modelbigboyotired> {
	private BigEngieSharkoSleepEntity entity = null;
	...
	@Override
	public void extractRenderState(BigEngieSharkoSleepEntity entity, LivingEntityRenderState state, float partialTicks) {
	...
	private static final class AnimatedModel extends Modelbigboyotired {
		...
		public void setEntity(BigEngieSharkoSleepEntity entity) {
			this.entity = entity;
		}
