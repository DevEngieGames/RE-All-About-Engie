...
public class BigSharkoSleepRenderer extends MobRenderer<BigSharkoSleepEntity, LivingEntityRenderState, Modelbigboyotired> {
	private BigSharkoSleepEntity entity = null;
	...
	@Override
	public void extractRenderState(BigSharkoSleepEntity entity, LivingEntityRenderState state, float partialTicks) {
	...
	public ResourceLocation getTextureLocation(LivingEntityRenderState state) {
		return ResourceLocation.parse("allaboutengie:textures/entities/bigsharkonewtamedtired.png");
	}
	...
	private static final class AnimatedModel extends Modelbigboyotired {
		...
		public void setEntity(BigSharkoSleepEntity entity) {
			this.entity = entity;
		}
