...
public class TigerLayRenderer extends MobRenderer<TigerLayEntity, Modeltobysit<TigerLayEntity>> {
	...
	private static final class AnimatedModel extends Modeltobysit<TigerLayEntity> {
		private final ModelPart root;
		private final HierarchicalModel animator = new HierarchicalModel<TigerLayEntity>() {
			@Override
			...
			@Override
			public void setupAnim(TigerLayEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
