...
public class PBEZoomiesTiredRenderer extends MobRenderer<PBEZoomiesTiredEntity, LivingEntityRenderState, Modelengiedaboyotired> {
	private PBEZoomiesTiredEntity entity = null;
	...
	@Override
	public void extractRenderState(PBEZoomiesTiredEntity entity, LivingEntityRenderState state, float partialTicks) {
	...
	private static final class AnimatedModel extends Modelengiedaboyotired {
		...
		public void setEntity(PBEZoomiesTiredEntity entity) {
			this.entity = entity;
		}
