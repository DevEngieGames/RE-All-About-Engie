...
public class FinneganSleepRenderer extends MobRenderer<FinneganSleepEntity, Modelboyotired<FinneganSleepEntity>> {
	...
	private static final class AnimatedModel extends Modelboyotired<FinneganSleepEntity> {
		private final ModelPart root;
		private final HierarchicalModel animator = new HierarchicalModel<FinneganSleepEntity>() {
			@Override
			...
			@Override
			public void setupAnim(FinneganSleepEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
