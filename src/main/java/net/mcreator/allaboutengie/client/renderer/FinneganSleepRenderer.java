...
public class FinneganSleepRenderer extends MobRenderer<FinneganSleepEntity, LivingEntityRenderState, Modelboyotired> {
	private FinneganSleepEntity entity = null;
	...
	@Override
	public void extractRenderState(FinneganSleepEntity entity, LivingEntityRenderState state, float partialTicks) {
	...
	public ResourceLocation getTextureLocation(LivingEntityRenderState state) {
		return ResourceLocation.parse("allaboutengie:textures/entities/rareengiesharkonewtamedfoxtired.png");
	}
	...
	private static final class AnimatedModel extends Modelboyotired {
		...
		public void setEntity(FinneganSleepEntity entity) {
			this.entity = entity;
		}
