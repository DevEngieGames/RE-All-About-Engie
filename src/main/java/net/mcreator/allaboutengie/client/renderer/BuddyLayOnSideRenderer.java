...
public class BuddyLayOnSideRenderer extends MobRenderer<BuddyLayOnSideEntity, LivingEntityRenderState, Modeltobylayonside> {
	private BuddyLayOnSideEntity entity = null;
	...
	@Override
	public void extractRenderState(BuddyLayOnSideEntity entity, LivingEntityRenderState state, float partialTicks) {
	...
	private static final class AnimatedModel extends Modeltobylayonside {
		...
		public void setEntity(BuddyLayOnSideEntity entity) {
			this.entity = entity;
		}
