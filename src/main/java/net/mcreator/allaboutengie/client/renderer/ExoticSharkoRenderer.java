...
public class ExoticSharkoRenderer extends MobRenderer<ExoticSharkoEntity, LivingEntityRenderState, Modelboyo> {
	private ExoticSharkoEntity entity = null;
	...
	@Override
	public void extractRenderState(ExoticSharkoEntity entity, LivingEntityRenderState state, float partialTicks) {
	...
	private static final class AnimatedModel extends Modelboyo {
		...
		public void setEntity(ExoticSharkoEntity entity) {
			this.entity = entity;
		}
