...
public class EngieSharkoRare2TamedZoomiesRenderer extends MobRenderer<EngieSharkoRare2TamedZoomiesEntity, LivingEntityRenderState, Modelboyozooms> {
	private EngieSharkoRare2TamedZoomiesEntity entity = null;
	...
	@Override
	public void extractRenderState(EngieSharkoRare2TamedZoomiesEntity entity, LivingEntityRenderState state, float partialTicks) {
	...
	public ResourceLocation getTextureLocation(LivingEntityRenderState state) {
		return ResourceLocation.parse("allaboutengie:textures/entities/rareengiesharko2newtamedzoom.png");
	}
	...
	private static final class AnimatedModel extends Modelboyozooms {
		...
		public void setEntity(EngieSharkoRare2TamedZoomiesEntity entity) {
			this.entity = entity;
		}
