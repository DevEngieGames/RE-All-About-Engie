...
public class EngieSharkoRare2TamedZoomiesRenderer extends MobRenderer<EngieSharkoRare2TamedZoomiesEntity, Modelboyozooms<EngieSharkoRare2TamedZoomiesEntity>> {
	...
	private static final class AnimatedModel extends Modelboyozooms<EngieSharkoRare2TamedZoomiesEntity> {
		private final ModelPart root;
		private final HierarchicalModel animator = new HierarchicalModel<EngieSharkoRare2TamedZoomiesEntity>() {
			@Override
			...
			@Override
			public void setupAnim(EngieSharkoRare2TamedZoomiesEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
