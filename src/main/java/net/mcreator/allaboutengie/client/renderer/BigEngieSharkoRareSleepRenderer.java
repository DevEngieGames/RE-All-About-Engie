...
public class BigEngieSharkoRareSleepRenderer extends MobRenderer<BigEngieSharkoRareSleepEntity, LivingEntityRenderState, Modelbigboyotired> {
	private BigEngieSharkoRareSleepEntity entity = null;
	...
	@Override
	public void extractRenderState(BigEngieSharkoRareSleepEntity entity, LivingEntityRenderState state, float partialTicks) {
	...
	public ResourceLocation getTextureLocation(LivingEntityRenderState state) {
		return ResourceLocation.parse("allaboutengie:textures/entities/bigrareengiesharkonewtamedtired.png");
	}
	...
	private static final class AnimatedModel extends Modelbigboyotired {
		...
		public void setEntity(BigEngieSharkoRareSleepEntity entity) {
			this.entity = entity;
		}
