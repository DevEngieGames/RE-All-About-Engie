...
public class ChampSitRenderer extends MobRenderer<ChampSitEntity, LivingEntityRenderState, Modelchampdaboyositnew> {
	private ChampSitEntity entity = null;
	...
	@Override
	public void extractRenderState(ChampSitEntity entity, LivingEntityRenderState state, float partialTicks) {
	...
	private static final class AnimatedModel extends Modelchampdaboyositnew {
		private ChampSitEntity entity = null;
		...
		public void setEntity(ChampSitEntity entity) {
			this.entity = entity;
		}
