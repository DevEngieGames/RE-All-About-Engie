...
public class CosmoLayRenderer extends MobRenderer<CosmoLayEntity, LivingEntityRenderState, Modelcosmodabigboyosit> {
	private CosmoLayEntity entity = null;
	...
	@Override
	public void extractRenderState(CosmoLayEntity entity, LivingEntityRenderState state, float partialTicks) {
	...
	private static final class AnimatedModel extends Modelcosmodabigboyosit {
		private CosmoLayEntity entity = null;
		...
		public void setEntity(CosmoLayEntity entity) {
			this.entity = entity;
		}
