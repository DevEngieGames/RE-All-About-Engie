...
public class RareSharkoRenderer extends MobRenderer<RareSharkoEntity, Modelboyo<RareSharkoEntity>> {
	...
	public ResourceLocation getTextureLocation(RareSharkoEntity entity) {
		return ResourceLocation.parse("allaboutengie:textures/entities/raresharkonew.png");
	}

	private static final class AnimatedModel extends Modelboyo<RareSharkoEntity> {
		private final ModelPart root;
		private final HierarchicalModel animator = new HierarchicalModel<RareSharkoEntity>() {
			@Override
			...
			@Override
			public void setupAnim(RareSharkoEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
