...
public class BigEpicSharkoTamedRenderer extends MobRenderer<BigEpicSharkoTamedEntity, LivingEntityRenderState, Modelbigboyo> {
	private BigEpicSharkoTamedEntity entity = null;
	...
	@Override
	public void extractRenderState(BigEpicSharkoTamedEntity entity, LivingEntityRenderState state, float partialTicks) {
	...
	private static final class AnimatedModel extends Modelbigboyo {
		...
		public void setEntity(BigEpicSharkoTamedEntity entity) {
			this.entity = entity;
		}
