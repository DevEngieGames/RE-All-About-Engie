...
public class BigRareSharkoTamedRenderer extends MobRenderer<BigRareSharkoTamedEntity, LivingEntityRenderState, Modelbigboyo> {
	private BigRareSharkoTamedEntity entity = null;
	...
	@Override
	public void extractRenderState(BigRareSharkoTamedEntity entity, LivingEntityRenderState state, float partialTicks) {
	...
	public ResourceLocation getTextureLocation(LivingEntityRenderState state) {
		return ResourceLocation.parse("allaboutengie:textures/entities/bigraresharkonewtamed.png");
	}
	...
	private static final class AnimatedModel extends Modelbigboyo {
		...
		public void setEntity(BigRareSharkoTamedEntity entity) {
			this.entity = entity;
		}
