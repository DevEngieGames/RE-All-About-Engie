...
public class LouisLayOnSideRenderer extends MobRenderer<LouisLayOnSideEntity, LivingEntityRenderState, Modeltobylayonside> {
	private LouisLayOnSideEntity entity = null;
	...
	@Override
	public void extractRenderState(LouisLayOnSideEntity entity, LivingEntityRenderState state, float partialTicks) {
	...
	private static final class AnimatedModel extends Modeltobylayonside {
		...
		public void setEntity(LouisLayOnSideEntity entity) {
			this.entity = entity;
		}
