...
public class BuddyRenderer extends MobRenderer<BuddyEntity, LivingEntityRenderState, Modeltoby> {
	private BuddyEntity entity = null;
	...
	@Override
	public void extractRenderState(BuddyEntity entity, LivingEntityRenderState state, float partialTicks) {
	...
	private static final class AnimatedModel extends Modeltoby {
		...
		public void setEntity(BuddyEntity entity) {
			this.entity = entity;
		}
