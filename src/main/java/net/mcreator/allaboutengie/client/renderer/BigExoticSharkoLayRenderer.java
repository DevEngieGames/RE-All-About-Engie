...
public class BigExoticSharkoLayRenderer extends MobRenderer<BigExoticSharkoLayEntity, LivingEntityRenderState, Modelbigboyosit> {
	private BigExoticSharkoLayEntity entity = null;
	...
	@Override
	public void extractRenderState(BigExoticSharkoLayEntity entity, LivingEntityRenderState state, float partialTicks) {
	...
	private static final class AnimatedModel extends Modelbigboyosit {
		...
		public void setEntity(BigExoticSharkoLayEntity entity) {
			this.entity = entity;
		}
