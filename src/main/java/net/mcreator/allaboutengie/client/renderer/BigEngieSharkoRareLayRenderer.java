...
public class BigEngieSharkoRareLayRenderer extends MobRenderer<BigEngieSharkoRareLayEntity, LivingEntityRenderState, Modelbigboyosit> {
	private BigEngieSharkoRareLayEntity entity = null;
	...
	@Override
	public void extractRenderState(BigEngieSharkoRareLayEntity entity, LivingEntityRenderState state, float partialTicks) {
	...
	private static final class AnimatedModel extends Modelbigboyosit {
		...
		public void setEntity(BigEngieSharkoRareLayEntity entity) {
			this.entity = entity;
		}
