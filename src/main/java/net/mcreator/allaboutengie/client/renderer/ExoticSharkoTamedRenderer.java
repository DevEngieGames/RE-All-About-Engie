...
public class ExoticSharkoTamedRenderer extends MobRenderer<ExoticSharkoTamedEntity, LivingEntityRenderState, Modelboyo> {
	private ExoticSharkoTamedEntity entity = null;
	...
	@Override
	public void extractRenderState(ExoticSharkoTamedEntity entity, LivingEntityRenderState state, float partialTicks) {
	...
	private static final class AnimatedModel extends Modelboyo {
		...
		public void setEntity(ExoticSharkoTamedEntity entity) {
			this.entity = entity;
		}
