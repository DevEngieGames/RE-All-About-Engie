...
public class ExoticSharkoTamedRenderer extends MobRenderer<ExoticSharkoTamedEntity, Modelboyo<ExoticSharkoTamedEntity>> {
	...
	private static final class AnimatedModel extends Modelboyo<ExoticSharkoTamedEntity> {
		private final ModelPart root;
		private final HierarchicalModel animator = new HierarchicalModel<ExoticSharkoTamedEntity>() {
			@Override
			...
			@Override
			public void setupAnim(ExoticSharkoTamedEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
