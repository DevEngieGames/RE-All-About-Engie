...
public class RareSharkoSleepRenderer extends MobRenderer<RareSharkoSleepEntity, LivingEntityRenderState, Modelboyotired> {
	private RareSharkoSleepEntity entity = null;
	...
	@Override
	public void extractRenderState(RareSharkoSleepEntity entity, LivingEntityRenderState state, float partialTicks) {
	...
	private static final class AnimatedModel extends Modelboyotired {
		...
		public void setEntity(RareSharkoSleepEntity entity) {
			this.entity = entity;
		}
