...
public class BigMythicSharkoLayRenderer extends MobRenderer<BigMythicSharkoLayEntity, LivingEntityRenderState, Modelbigboyosit> {
	private BigMythicSharkoLayEntity entity = null;
	...
	@Override
	public void extractRenderState(BigMythicSharkoLayEntity entity, LivingEntityRenderState state, float partialTicks) {
	...
	private static final class AnimatedModel extends Modelbigboyosit {
		...
		public void setEntity(BigMythicSharkoLayEntity entity) {
			this.entity = entity;
		}
