...
public class Bothan2netRenderer extends MobRenderer<Bothan2netEntity, LivingEntityRenderState, Modeltoby> {
	private Bothan2netEntity entity = null;
	...
	@Override
	public void extractRenderState(Bothan2netEntity entity, LivingEntityRenderState state, float partialTicks) {
	...
	private static final class AnimatedModel extends Modeltoby {
		...
		public void setEntity(Bothan2netEntity entity) {
			this.entity = entity;
		}
