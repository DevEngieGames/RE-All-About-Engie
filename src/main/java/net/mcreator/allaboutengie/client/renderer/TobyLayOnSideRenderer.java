...
public class TobyLayOnSideRenderer extends MobRenderer<TobyLayOnSideEntity, LivingEntityRenderState, Modeltobylayonside> {
	private TobyLayOnSideEntity entity = null;
	...
	@Override
	public void extractRenderState(TobyLayOnSideEntity entity, LivingEntityRenderState state, float partialTicks) {
	...
	private static final class AnimatedModel extends Modeltobylayonside {
		...
		public void setEntity(TobyLayOnSideEntity entity) {
			this.entity = entity;
		}
