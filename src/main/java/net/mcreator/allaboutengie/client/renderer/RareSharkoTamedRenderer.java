...
public class RareSharkoTamedRenderer extends MobRenderer<RareSharkoTamedEntity, LivingEntityRenderState, Modelboyo> {
	private RareSharkoTamedEntity entity = null;
	...
	@Override
	public void extractRenderState(RareSharkoTamedEntity entity, LivingEntityRenderState state, float partialTicks) {
	...
	private static final class AnimatedModel extends Modelboyo {
		...
		public void setEntity(RareSharkoTamedEntity entity) {
			this.entity = entity;
		}
