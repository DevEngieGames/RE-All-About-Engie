...
public class TigerSleepRenderer extends MobRenderer<TigerSleepEntity, Modeltobytired<TigerSleepEntity>> {
	...
	private static final class AnimatedModel extends Modeltobytired<TigerSleepEntity> {
		private final ModelPart root;
		private final HierarchicalModel animator = new HierarchicalModel<TigerSleepEntity>() {
			@Override
			...
			@Override
			public void setupAnim(TigerSleepEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
