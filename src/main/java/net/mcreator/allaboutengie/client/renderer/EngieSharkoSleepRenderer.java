...
public class EngieSharkoSleepRenderer extends MobRenderer<EngieSharkoSleepEntity, LivingEntityRenderState, Modelboyotired> {
	private EngieSharkoSleepEntity entity = null;
	...
	@Override
	public void extractRenderState(EngieSharkoSleepEntity entity, LivingEntityRenderState state, float partialTicks) {
	...
	private static final class AnimatedModel extends Modelboyotired {
		...
		public void setEntity(EngieSharkoSleepEntity entity) {
			this.entity = entity;
		}
