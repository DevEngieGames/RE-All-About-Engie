...
public class EngieSharkoRareTamedZoomiesTiredRenderer extends MobRenderer<EngieSharkoRareTamedZoomiesTiredEntity, LivingEntityRenderState, Modelboyozoomtired> {
	private EngieSharkoRareTamedZoomiesTiredEntity entity = null;
	...
	@Override
	public void extractRenderState(EngieSharkoRareTamedZoomiesTiredEntity entity, LivingEntityRenderState state, float partialTicks) {
