...
public class EngieSharkoRare2ZoomiesTiredRenderer extends MobRenderer<EngieSharkoRare2ZoomiesTiredEntity, LivingEntityRenderState, Modelboyozoomtired> {
	private EngieSharkoRare2ZoomiesTiredEntity entity = null;
	...
	@Override
	public void extractRenderState(EngieSharkoRare2ZoomiesTiredEntity entity, LivingEntityRenderState state, float partialTicks) {
	...
	private static final class AnimatedModel extends Modelboyozoomtired {
		...
		public void setEntity(EngieSharkoRare2ZoomiesTiredEntity entity) {
			this.entity = entity;
		}
