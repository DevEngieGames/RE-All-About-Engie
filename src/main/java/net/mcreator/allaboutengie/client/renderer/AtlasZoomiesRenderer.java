...
public class AtlasZoomiesRenderer extends MobRenderer<AtlasZoomiesEntity, Modeltobyzooms<AtlasZoomiesEntity>> {
	...
	private static final class AnimatedModel extends Modeltobyzooms<AtlasZoomiesEntity> {
		...
		private final HierarchicalModel animator = new HierarchicalModel<AtlasZoomiesEntity>() {
			@Override
			...
			@Override
			public void setupAnim(AtlasZoomiesEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
