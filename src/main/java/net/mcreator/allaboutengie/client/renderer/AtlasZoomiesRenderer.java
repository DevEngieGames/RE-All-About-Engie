...
public class AtlasZoomiesRenderer extends MobRenderer<AtlasZoomiesEntity, LivingEntityRenderState, Modeltobyzooms> {
	private AtlasZoomiesEntity entity = null;
	...
	@Override
	public void extractRenderState(AtlasZoomiesEntity entity, LivingEntityRenderState state, float partialTicks) {
	...
	private static final class AnimatedModel extends Modeltobyzooms {
		...
		public void setEntity(AtlasZoomiesEntity entity) {
			this.entity = entity;
		}
