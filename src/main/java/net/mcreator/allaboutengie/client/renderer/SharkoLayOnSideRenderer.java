...
public class SharkoLayOnSideRenderer extends MobRenderer<SharkoLayOnSideEntity, LivingEntityRenderState, Modelboyolayonside> {
	private SharkoLayOnSideEntity entity = null;
	...
	@Override
	public void extractRenderState(SharkoLayOnSideEntity entity, LivingEntityRenderState state, float partialTicks) {
	...
	private static final class AnimatedModel extends Modelboyolayonside {
		...
		public void setEntity(SharkoLayOnSideEntity entity) {
			this.entity = entity;
		}
