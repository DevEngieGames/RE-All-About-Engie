...
public class EngieSharkoTamedZoomiesRenderer extends MobRenderer<EngieSharkoTamedZoomiesEntity, LivingEntityRenderState, Modelboyozooms> {
	private EngieSharkoTamedZoomiesEntity entity = null;
	...
	@Override
	public void extractRenderState(EngieSharkoTamedZoomiesEntity entity, LivingEntityRenderState state, float partialTicks) {
	...
	public ResourceLocation getTextureLocation(LivingEntityRenderState state) {
		return ResourceLocation.parse("allaboutengie:textures/entities/engiesharkonewtamedzoom.png");
	}
	...
	private static final class AnimatedModel extends Modelboyozooms {
		...
		public void setEntity(EngieSharkoTamedZoomiesEntity entity) {
			this.entity = entity;
		}
