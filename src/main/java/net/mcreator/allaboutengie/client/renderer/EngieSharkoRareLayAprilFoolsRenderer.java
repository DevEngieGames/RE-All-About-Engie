...
public class EngieSharkoRareLayAprilFoolsRenderer extends MobRenderer<EngieSharkoRareLayAprilFoolsEntity, LivingEntityRenderState, Modelboyoaprilfoolssit> {
	private EngieSharkoRareLayAprilFoolsEntity entity = null;
	...
	@Override
	public void extractRenderState(EngieSharkoRareLayAprilFoolsEntity entity, LivingEntityRenderState state, float partialTicks) {
