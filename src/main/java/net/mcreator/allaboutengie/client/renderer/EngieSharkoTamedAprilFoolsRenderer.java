...
public class EngieSharkoTamedAprilFoolsRenderer extends MobRenderer<EngieSharkoTamedAprilFoolsEntity, LivingEntityRenderState, Modelboyoaprilfools> {
	private EngieSharkoTamedAprilFoolsEntity entity = null;
	...
	@Override
	public void extractRenderState(EngieSharkoTamedAprilFoolsEntity entity, LivingEntityRenderState state, float partialTicks) {
