...
public class AlienEngieSharkoTamedRenderer extends MobRenderer<AlienEngieSharkoTamedEntity, LivingEntityRenderState, Modelalienengiesharkotamed> {
	private AlienEngieSharkoTamedEntity entity = null;
	...
	@Override
	public void extractRenderState(AlienEngieSharkoTamedEntity entity, LivingEntityRenderState state, float partialTicks) {
	...
	private static final class AnimatedModel extends Modelalienengiesharkotamed {
		private AlienEngieSharkoTamedEntity entity = null;
		...
		public void setEntity(AlienEngieSharkoTamedEntity entity) {
			this.entity = entity;
		}
