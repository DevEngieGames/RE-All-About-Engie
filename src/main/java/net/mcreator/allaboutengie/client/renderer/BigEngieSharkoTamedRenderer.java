...
public class BigEngieSharkoTamedRenderer extends MobRenderer<BigEngieSharkoTamedEntity, LivingEntityRenderState, Modelbigboyo> {
	private BigEngieSharkoTamedEntity entity = null;
	...
	@Override
	public void extractRenderState(BigEngieSharkoTamedEntity entity, LivingEntityRenderState state, float partialTicks) {
	...
	private static final class AnimatedModel extends Modelbigboyo {
		...
		public void setEntity(BigEngieSharkoTamedEntity entity) {
			this.entity = entity;
		}
