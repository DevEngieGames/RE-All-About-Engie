...
public class BigLegendarySharkoRenderer extends MobRenderer<BigLegendarySharkoEntity, Modelbigboyo<BigLegendarySharkoEntity>> {
	...
	private static final class AnimatedModel extends Modelbigboyo<BigLegendarySharkoEntity> {
		private final ModelPart root;
		private final HierarchicalModel animator = new HierarchicalModel<BigLegendarySharkoEntity>() {
			@Override
			...
			@Override
			public void setupAnim(BigLegendarySharkoEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
