...
public class BigLegendarySharkoRenderer extends MobRenderer<BigLegendarySharkoEntity, LivingEntityRenderState, Modelbigboyo> {
	private BigLegendarySharkoEntity entity = null;
	...
	@Override
	public void extractRenderState(BigLegendarySharkoEntity entity, LivingEntityRenderState state, float partialTicks) {
	...
	public ResourceLocation getTextureLocation(LivingEntityRenderState state) {
		return ResourceLocation.parse("allaboutengie:textures/entities/biglegendarysharkonew.png");
	}
	...
	private static final class AnimatedModel extends Modelbigboyo {
		...
		public void setEntity(BigLegendarySharkoEntity entity) {
			this.entity = entity;
		}
