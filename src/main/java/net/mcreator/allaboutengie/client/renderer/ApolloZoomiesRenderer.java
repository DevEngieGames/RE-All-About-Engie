...
public class ApolloZoomiesRenderer extends MobRenderer<ApolloZoomiesEntity, LivingEntityRenderState, Modeltobyzooms> {
	private ApolloZoomiesEntity entity = null;
	...
	@Override
	public void extractRenderState(ApolloZoomiesEntity entity, LivingEntityRenderState state, float partialTicks) {
	...
	public ResourceLocation getTextureLocation(LivingEntityRenderState state) {
		return ResourceLocation.parse("allaboutengie:textures/entities/apollozoom.png");
	}
	...
	private static final class AnimatedModel extends Modeltobyzooms {
		...
		public void setEntity(ApolloZoomiesEntity entity) {
			this.entity = entity;
		}
