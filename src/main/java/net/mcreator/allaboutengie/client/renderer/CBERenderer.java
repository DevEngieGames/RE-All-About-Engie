...
public class CBERenderer extends MobRenderer<CBEEntity, LivingEntityRenderState, Modelengiedaboyo> {
	private CBEEntity entity = null;
	...
	@Override
	public void extractRenderState(CBEEntity entity, LivingEntityRenderState state, float partialTicks) {
	...
	private static final class AnimatedModel extends Modelengiedaboyo {
		...
		public void setEntity(CBEEntity entity) {
			this.entity = entity;
		}
