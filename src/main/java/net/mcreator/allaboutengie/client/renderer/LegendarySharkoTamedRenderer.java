...
public class LegendarySharkoTamedRenderer extends MobRenderer<LegendarySharkoTamedEntity, LivingEntityRenderState, Modelboyo> {
	private LegendarySharkoTamedEntity entity = null;
	...
	@Override
	public void extractRenderState(LegendarySharkoTamedEntity entity, LivingEntityRenderState state, float partialTicks) {
	...
	private static final class AnimatedModel extends Modelboyo {
		...
		public void setEntity(LegendarySharkoTamedEntity entity) {
			this.entity = entity;
		}
