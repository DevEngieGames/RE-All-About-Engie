...
public class LegendarySharkoTamedRenderer extends MobRenderer<LegendarySharkoTamedEntity, Modelboyo<LegendarySharkoTamedEntity>> {
	...
	private static final class AnimatedModel extends Modelboyo<LegendarySharkoTamedEntity> {
		private final ModelPart root;
		private final HierarchicalModel animator = new HierarchicalModel<LegendarySharkoTamedEntity>() {
			@Override
			...
			@Override
			public void setupAnim(LegendarySharkoTamedEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
