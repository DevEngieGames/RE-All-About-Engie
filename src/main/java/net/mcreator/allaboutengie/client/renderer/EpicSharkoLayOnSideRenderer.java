...
public class EpicSharkoLayOnSideRenderer extends MobRenderer<EpicSharkoLayOnSideEntity, LivingEntityRenderState, Modelboyolayonside> {
	private EpicSharkoLayOnSideEntity entity = null;
	...
	@Override
	public void extractRenderState(EpicSharkoLayOnSideEntity entity, LivingEntityRenderState state, float partialTicks) {
	...
	private static final class AnimatedModel extends Modelboyolayonside {
		...
		public void setEntity(EpicSharkoLayOnSideEntity entity) {
			this.entity = entity;
		}
