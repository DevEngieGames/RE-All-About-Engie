...
public class BigExoticSharkoSleepRenderer extends MobRenderer<BigExoticSharkoSleepEntity, Modelbigboyotired<BigExoticSharkoSleepEntity>> {
	...
	private static final class AnimatedModel extends Modelbigboyotired<BigExoticSharkoSleepEntity> {
		private final ModelPart root;
		private final HierarchicalModel animator = new HierarchicalModel<BigExoticSharkoSleepEntity>() {
			@Override
			...
			@Override
			public void setupAnim(BigExoticSharkoSleepEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
