...
public class FinneganRenderer extends MobRenderer<FinneganEntity, Modelboyo<FinneganEntity>> {
	...
	private static final class AnimatedModel extends Modelboyo<FinneganEntity> {
		private final ModelPart root;
		private final HierarchicalModel animator = new HierarchicalModel<FinneganEntity>() {
			@Override
			...
			@Override
			public void setupAnim(FinneganEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
