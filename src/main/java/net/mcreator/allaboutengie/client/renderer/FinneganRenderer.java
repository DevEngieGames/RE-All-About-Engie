...
public class FinneganRenderer extends MobRenderer<FinneganEntity, LivingEntityRenderState, Modelboyo> {
	private FinneganEntity entity = null;
	...
	@Override
	public void extractRenderState(FinneganEntity entity, LivingEntityRenderState state, float partialTicks) {
	...
	private static final class AnimatedModel extends Modelboyo {
		...
		public void setEntity(FinneganEntity entity) {
			this.entity = entity;
		}
