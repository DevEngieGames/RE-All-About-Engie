...
public class RareSharkoSitRenderer extends MobRenderer<RareSharkoSitEntity, LivingEntityRenderState, Modelboyositnew> {
	private RareSharkoSitEntity entity = null;
	...
	@Override
	public void extractRenderState(RareSharkoSitEntity entity, LivingEntityRenderState state, float partialTicks) {
	...
	private static final class AnimatedModel extends Modelboyositnew {
		...
		public void setEntity(RareSharkoSitEntity entity) {
			this.entity = entity;
		}
