...
public class AlbinoSharkoLayRenderer extends MobRenderer<AlbinoSharkoLayEntity, Modelboyosit<AlbinoSharkoLayEntity>> {
	...
	private static final class AnimatedModel extends Modelboyosit<AlbinoSharkoLayEntity> {
		private final ModelPart root;
		private final HierarchicalModel animator = new HierarchicalModel<AlbinoSharkoLayEntity>() {
			@Override
			...
			@Override
			public void setupAnim(AlbinoSharkoLayEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
