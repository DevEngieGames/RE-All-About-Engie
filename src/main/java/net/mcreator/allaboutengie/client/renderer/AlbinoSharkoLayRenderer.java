...
public class AlbinoSharkoLayRenderer extends MobRenderer<AlbinoSharkoLayEntity, LivingEntityRenderState, Modelboyosit> {
	private AlbinoSharkoLayEntity entity = null;
	...
	@Override
	public void extractRenderState(AlbinoSharkoLayEntity entity, LivingEntityRenderState state, float partialTicks) {
	...
	private static final class AnimatedModel extends Modelboyosit {
		...
		public void setEntity(AlbinoSharkoLayEntity entity) {
			this.entity = entity;
		}
