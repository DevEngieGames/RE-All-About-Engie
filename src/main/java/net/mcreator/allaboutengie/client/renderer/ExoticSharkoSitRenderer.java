...
public class ExoticSharkoSitRenderer extends MobRenderer<ExoticSharkoSitEntity, LivingEntityRenderState, Modelboyositnew> {
	private ExoticSharkoSitEntity entity = null;
	...
	@Override
	public void extractRenderState(ExoticSharkoSitEntity entity, LivingEntityRenderState state, float partialTicks) {
	...
	private static final class AnimatedModel extends Modelboyositnew {
		...
		public void setEntity(ExoticSharkoSitEntity entity) {
			this.entity = entity;
		}
