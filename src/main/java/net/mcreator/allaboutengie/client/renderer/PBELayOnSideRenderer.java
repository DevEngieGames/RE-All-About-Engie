...
public class PBELayOnSideRenderer extends MobRenderer<PBELayOnSideEntity, LivingEntityRenderState, Modelengiedaboyolayonside> {
	private PBELayOnSideEntity entity = null;
	...
	@Override
	public void extractRenderState(PBELayOnSideEntity entity, LivingEntityRenderState state, float partialTicks) {
	...
	private static final class AnimatedModel extends Modelengiedaboyolayonside {
		...
		public void setEntity(PBELayOnSideEntity entity) {
			this.entity = entity;
		}
