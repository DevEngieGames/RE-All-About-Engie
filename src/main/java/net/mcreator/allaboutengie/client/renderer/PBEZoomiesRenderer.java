...
public class PBEZoomiesRenderer extends MobRenderer<PBEZoomiesEntity, LivingEntityRenderState, Modelengiedaboyozoom> {
	private PBEZoomiesEntity entity = null;
	...
	@Override
	public void extractRenderState(PBEZoomiesEntity entity, LivingEntityRenderState state, float partialTicks) {
	...
	public ResourceLocation getTextureLocation(LivingEntityRenderState state) {
		return ResourceLocation.parse("allaboutengie:textures/entities/engiedasharko2zoom.png");
	}
	...
	private static final class AnimatedModel extends Modelengiedaboyozoom {
		...
		public void setEntity(PBEZoomiesEntity entity) {
			this.entity = entity;
		}
