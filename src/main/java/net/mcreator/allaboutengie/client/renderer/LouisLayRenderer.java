...
public class LouisLayRenderer extends MobRenderer<LouisLayEntity, Modeltobysit<LouisLayEntity>> {
	...
	private static final class AnimatedModel extends Modeltobysit<LouisLayEntity> {
		private final ModelPart root;
		private final HierarchicalModel animator = new HierarchicalModel<LouisLayEntity>() {
			@Override
			...
			@Override
			public void setupAnim(LouisLayEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
