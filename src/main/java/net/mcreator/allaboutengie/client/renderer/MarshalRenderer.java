...
public class MarshalRenderer extends MobRenderer<MarshalEntity, Modeltoby<MarshalEntity>> {
	...
	private static final class AnimatedModel extends Modeltoby<MarshalEntity> {
		private final ModelPart root;
		private final HierarchicalModel animator = new HierarchicalModel<MarshalEntity>() {
			@Override
			...
			@Override
			public void setupAnim(MarshalEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
