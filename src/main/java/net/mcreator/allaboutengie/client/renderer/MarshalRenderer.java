...
public class MarshalRenderer extends MobRenderer<MarshalEntity, LivingEntityRenderState, Modeltoby> {
	private MarshalEntity entity = null;
	...
	@Override
	public void extractRenderState(MarshalEntity entity, LivingEntityRenderState state, float partialTicks) {
	...
	private static final class AnimatedModel extends Modeltoby {
		...
		public void setEntity(MarshalEntity entity) {
			this.entity = entity;
		}
