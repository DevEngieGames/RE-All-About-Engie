...
public class EngieSharkoRareTamedRenderer extends MobRenderer<EngieSharkoRareTamedEntity, LivingEntityRenderState, Modelboyo> {
	private EngieSharkoRareTamedEntity entity = null;
	...
	@Override
	public void extractRenderState(EngieSharkoRareTamedEntity entity, LivingEntityRenderState state, float partialTicks) {
	...
	private static final class AnimatedModel extends Modelboyo {
		...
		public void setEntity(EngieSharkoRareTamedEntity entity) {
			this.entity = entity;
		}
