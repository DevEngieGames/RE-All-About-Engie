...
public class MarshalLayOnSideRenderer extends MobRenderer<MarshalLayOnSideEntity, LivingEntityRenderState, Modeltobylayonside> {
	private MarshalLayOnSideEntity entity = null;
	...
	@Override
	public void extractRenderState(MarshalLayOnSideEntity entity, LivingEntityRenderState state, float partialTicks) {
	...
	private static final class AnimatedModel extends Modeltobylayonside {
		...
		public void setEntity(MarshalLayOnSideEntity entity) {
			this.entity = entity;
		}
