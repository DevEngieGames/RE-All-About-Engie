...
public class AlbinoSharkoRenderer extends MobRenderer<AlbinoSharkoEntity, LivingEntityRenderState, Modelboyo> {
	private AlbinoSharkoEntity entity = null;
	...
	@Override
	public void extractRenderState(AlbinoSharkoEntity entity, LivingEntityRenderState state, float partialTicks) {
	...
	public ResourceLocation getTextureLocation(LivingEntityRenderState state) {
		return ResourceLocation.parse("allaboutengie:textures/entities/albinosharkonew.png");
	}
	...
	private static final class AnimatedModel extends Modelboyo {
		...
		public void setEntity(AlbinoSharkoEntity entity) {
			this.entity = entity;
		}
