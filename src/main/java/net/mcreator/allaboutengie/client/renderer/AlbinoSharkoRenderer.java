...
public class AlbinoSharkoRenderer extends MobRenderer<AlbinoSharkoEntity, Modelboyo<AlbinoSharkoEntity>> {
	...
	private static final class AnimatedModel extends Modelboyo<AlbinoSharkoEntity> {
		private final ModelPart root;
		private final HierarchicalModel animator = new HierarchicalModel<AlbinoSharkoEntity>() {
			@Override
			...
			@Override
			public void setupAnim(AlbinoSharkoEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
