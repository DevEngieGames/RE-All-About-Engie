...
public class RareSharkoLayOnSideRenderer extends MobRenderer<RareSharkoLayOnSideEntity, LivingEntityRenderState, Modelboyolayonside> {
	private RareSharkoLayOnSideEntity entity = null;
	...
	@Override
	public void extractRenderState(RareSharkoLayOnSideEntity entity, LivingEntityRenderState state, float partialTicks) {
	...
	private static final class AnimatedModel extends Modelboyolayonside {
		...
		public void setEntity(RareSharkoLayOnSideEntity entity) {
			this.entity = entity;
		}
