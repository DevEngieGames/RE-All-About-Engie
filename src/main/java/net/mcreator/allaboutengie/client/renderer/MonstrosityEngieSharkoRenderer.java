...
public class MonstrosityEngieSharkoRenderer extends MobRenderer<MonstrosityEngieSharkoEntity, LivingEntityRenderState, Modelboyoother> {
	private MonstrosityEngieSharkoEntity entity = null;
	...
	@Override
	public void extractRenderState(MonstrosityEngieSharkoEntity entity, LivingEntityRenderState state, float partialTicks) {
