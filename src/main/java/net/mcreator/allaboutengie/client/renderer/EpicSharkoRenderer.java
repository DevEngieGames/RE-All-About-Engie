...
public class EpicSharkoRenderer extends MobRenderer<EpicSharkoEntity, Modelboyo<EpicSharkoEntity>> {
	...
	public ResourceLocation getTextureLocation(EpicSharkoEntity entity) {
		return ResourceLocation.parse("allaboutengie:textures/entities/epicsharkonew.png");
	}

	private static final class AnimatedModel extends Modelboyo<EpicSharkoEntity> {
		private final ModelPart root;
		private final HierarchicalModel animator = new HierarchicalModel<EpicSharkoEntity>() {
			@Override
			...
			@Override
			public void setupAnim(EpicSharkoEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
