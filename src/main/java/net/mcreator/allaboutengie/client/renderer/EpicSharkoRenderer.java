...
public class EpicSharkoRenderer extends MobRenderer<EpicSharkoEntity, LivingEntityRenderState, Modelboyo> {
	private EpicSharkoEntity entity = null;
	...
	@Override
	public void extractRenderState(EpicSharkoEntity entity, LivingEntityRenderState state, float partialTicks) {
	...
	private static final class AnimatedModel extends Modelboyo {
		...
		public void setEntity(EpicSharkoEntity entity) {
			this.entity = entity;
		}
