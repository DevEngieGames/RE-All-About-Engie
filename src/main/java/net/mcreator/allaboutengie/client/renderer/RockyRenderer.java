...
public class RockyRenderer extends MobRenderer<RockyEntity, LivingEntityRenderState, Modelrocky> {
	private RockyEntity entity = null;
	...
	@Override
	public void extractRenderState(RockyEntity entity, LivingEntityRenderState state, float partialTicks) {
	...
	private static final class AnimatedModel extends Modelrocky {
		private RockyEntity entity = null;
		...
		public void setEntity(RockyEntity entity) {
			this.entity = entity;
		}
