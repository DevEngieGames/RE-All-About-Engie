...
public class EpicSharkoLayRenderer extends MobRenderer<EpicSharkoLayEntity, Modelboyosit<EpicSharkoLayEntity>> {
	...
	private static final class AnimatedModel extends Modelboyosit<EpicSharkoLayEntity> {
