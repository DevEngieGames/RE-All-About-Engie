...
public class EpicSharkoLayRenderer extends MobRenderer<EpicSharkoLayEntity, LivingEntityRenderState, Modelboyosit> {
	private EpicSharkoLayEntity entity = null;
	...
	@Override
	public void extractRenderState(EpicSharkoLayEntity entity, LivingEntityRenderState state, float partialTicks) {
	...
	private static final class AnimatedModel extends Modelboyosit {
		...
		public void setEntity(EpicSharkoLayEntity entity) {
			this.entity = entity;
		}
