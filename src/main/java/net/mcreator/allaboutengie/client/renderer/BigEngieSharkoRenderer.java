...
public class BigEngieSharkoRenderer extends MobRenderer<BigEngieSharkoEntity, LivingEntityRenderState, Modelbigboyo> {
	private BigEngieSharkoEntity entity = null;
	...
	@Override
	public void extractRenderState(BigEngieSharkoEntity entity, LivingEntityRenderState state, float partialTicks) {
	...
	private static final class AnimatedModel extends Modelbigboyo {
		...
		public void setEntity(BigEngieSharkoEntity entity) {
			this.entity = entity;
		}
