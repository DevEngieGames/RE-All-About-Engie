...
public class SharkoRenderer extends MobRenderer<SharkoEntity, LivingEntityRenderState, Modelboyo> {
	private SharkoEntity entity = null;
	...
	@Override
	public void extractRenderState(SharkoEntity entity, LivingEntityRenderState state, float partialTicks) {
	...
	private static final class AnimatedModel extends Modelboyo {
		...
		public void setEntity(SharkoEntity entity) {
			this.entity = entity;
		}
