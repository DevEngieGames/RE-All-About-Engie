...
public class SharkoRenderer extends MobRenderer<SharkoEntity, Modelboyo<SharkoEntity>> {
	...
	private static final class AnimatedModel extends Modelboyo<SharkoEntity> {
		private final ModelPart root;
		private final HierarchicalModel animator = new HierarchicalModel<SharkoEntity>() {
			@Override
			...
			@Override
			public void setupAnim(SharkoEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
