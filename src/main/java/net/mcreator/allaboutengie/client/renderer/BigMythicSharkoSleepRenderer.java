...
public class BigMythicSharkoSleepRenderer extends MobRenderer<BigMythicSharkoSleepEntity, Modelbigboyotired<BigMythicSharkoSleepEntity>> {
	...
	private static final class AnimatedModel extends Modelbigboyotired<BigMythicSharkoSleepEntity> {
		private final ModelPart root;
		private final HierarchicalModel animator = new HierarchicalModel<BigMythicSharkoSleepEntity>() {
			@Override
			...
			@Override
			public void setupAnim(BigMythicSharkoSleepEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
