...
public class EnragedNormal2Renderer extends MobRenderer<EnragedNormal2Entity, LivingEntityRenderState, Modelenragedzombie> {
	private EnragedNormal2Entity entity = null;
	...
	@Override
	public void extractRenderState(EnragedNormal2Entity entity, LivingEntityRenderState state, float partialTicks) {
