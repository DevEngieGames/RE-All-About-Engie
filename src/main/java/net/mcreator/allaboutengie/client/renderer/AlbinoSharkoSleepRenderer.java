...
public class AlbinoSharkoSleepRenderer extends MobRenderer<AlbinoSharkoSleepEntity, LivingEntityRenderState, Modelboyotired> {
	private AlbinoSharkoSleepEntity entity = null;
	...
	@Override
	public void extractRenderState(AlbinoSharkoSleepEntity entity, LivingEntityRenderState state, float partialTicks) {
	...
	public ResourceLocation getTextureLocation(LivingEntityRenderState state) {
		return ResourceLocation.parse("allaboutengie:textures/entities/albinosharkonewtamedtired.png");
	}
	...
	private static final class AnimatedModel extends Modelboyotired {
		...
		public void setEntity(AlbinoSharkoSleepEntity entity) {
			this.entity = entity;
		}
