...
public class EngieSharkoRareLayRenderer extends MobRenderer<EngieSharkoRareLayEntity, LivingEntityRenderState, Modelboyosit> {
	private EngieSharkoRareLayEntity entity = null;
	...
	@Override
	public void extractRenderState(EngieSharkoRareLayEntity entity, LivingEntityRenderState state, float partialTicks) {
	...
	private static final class AnimatedModel extends Modelboyosit {
		...
		public void setEntity(EngieSharkoRareLayEntity entity) {
			this.entity = entity;
		}
