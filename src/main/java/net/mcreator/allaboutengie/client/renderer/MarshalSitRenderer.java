...
public class MarshalSitRenderer extends MobRenderer<MarshalSitEntity, LivingEntityRenderState, Modeltobysitnew> {
	private MarshalSitEntity entity = null;
	...
	@Override
	public void extractRenderState(MarshalSitEntity entity, LivingEntityRenderState state, float partialTicks) {
	...
	private static final class AnimatedModel extends Modeltobysitnew {
		...
		public void setEntity(MarshalSitEntity entity) {
			this.entity = entity;
		}
