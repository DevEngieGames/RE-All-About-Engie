...
public class LegendarySharkoTamedZoomiesRenderer extends MobRenderer<LegendarySharkoTamedZoomiesEntity, LivingEntityRenderState, Modelboyozooms> {
	private LegendarySharkoTamedZoomiesEntity entity = null;
	...
	@Override
	public void extractRenderState(LegendarySharkoTamedZoomiesEntity entity, LivingEntityRenderState state, float partialTicks) {
	...
	private static final class AnimatedModel extends Modelboyozooms {
		...
		public void setEntity(LegendarySharkoTamedZoomiesEntity entity) {
			this.entity = entity;
		}
