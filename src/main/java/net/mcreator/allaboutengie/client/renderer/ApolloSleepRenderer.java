...
public class ApolloSleepRenderer extends MobRenderer<ApolloSleepEntity, Modeltobytired<ApolloSleepEntity>> {
	...
	private static final class AnimatedModel extends Modeltobytired<ApolloSleepEntity> {
		private final ModelPart root;
		private final HierarchicalModel animator = new HierarchicalModel<ApolloSleepEntity>() {
			@Override
			...
			@Override
			public void setupAnim(ApolloSleepEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
