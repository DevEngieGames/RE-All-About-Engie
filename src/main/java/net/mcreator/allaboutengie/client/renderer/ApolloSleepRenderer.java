...
public class ApolloSleepRenderer extends MobRenderer<ApolloSleepEntity, LivingEntityRenderState, Modeltobytired> {
	private ApolloSleepEntity entity = null;
	...
	@Override
	public void extractRenderState(ApolloSleepEntity entity, LivingEntityRenderState state, float partialTicks) {
	...
	public ResourceLocation getTextureLocation(LivingEntityRenderState state) {
		return ResourceLocation.parse("allaboutengie:textures/entities/apollotired.png");
	}
	...
	private static final class AnimatedModel extends Modeltobytired {
		...
		public void setEntity(ApolloSleepEntity entity) {
			this.entity = entity;
		}
