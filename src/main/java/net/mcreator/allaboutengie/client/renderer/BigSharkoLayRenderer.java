...
public class BigSharkoLayRenderer extends MobRenderer<BigSharkoLayEntity, LivingEntityRenderState, Modelbigboyosit> {
	private BigSharkoLayEntity entity = null;
	...
	@Override
	public void extractRenderState(BigSharkoLayEntity entity, LivingEntityRenderState state, float partialTicks) {
	...
	private static final class AnimatedModel extends Modelbigboyosit {
		...
		public void setEntity(BigSharkoLayEntity entity) {
			this.entity = entity;
		}
