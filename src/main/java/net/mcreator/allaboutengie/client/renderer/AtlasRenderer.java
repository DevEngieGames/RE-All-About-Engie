...
public class AtlasRenderer extends MobRenderer<AtlasEntity, Modeltoby<AtlasEntity>> {
	...
	@Override
	public ResourceLocation getTextureLocation(AtlasEntity entity) {
		return new ResourceLocation("allaboutengie:textures/entities/atlas.png");
	}

	private static final class AnimatedModel extends Modeltoby<AtlasEntity> {
		private final ModelPart root;
		private final HierarchicalModel animator = new HierarchicalModel<AtlasEntity>() {
			@Override
			...
			@Override
			public void setupAnim(AtlasEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
