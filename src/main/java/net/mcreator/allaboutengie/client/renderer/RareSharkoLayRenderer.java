...
public class RareSharkoLayRenderer extends MobRenderer<RareSharkoLayEntity, LivingEntityRenderState, Modelboyosit> {
	private RareSharkoLayEntity entity = null;
	...
	@Override
	public void extractRenderState(RareSharkoLayEntity entity, LivingEntityRenderState state, float partialTicks) {
	...
	private static final class AnimatedModel extends Modelboyosit {
		...
		public void setEntity(RareSharkoLayEntity entity) {
			this.entity = entity;
		}
