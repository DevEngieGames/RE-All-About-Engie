...
public class MythicSharkoRenderer extends MobRenderer<MythicSharkoEntity, LivingEntityRenderState, Modelboyo> {
	private MythicSharkoEntity entity = null;
	...
	@Override
	public void extractRenderState(MythicSharkoEntity entity, LivingEntityRenderState state, float partialTicks) {
	...
	private static final class AnimatedModel extends Modelboyo {
		...
		public void setEntity(MythicSharkoEntity entity) {
			this.entity = entity;
		}
