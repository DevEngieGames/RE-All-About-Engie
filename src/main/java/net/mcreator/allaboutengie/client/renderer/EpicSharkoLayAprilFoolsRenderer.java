...
public class EpicSharkoLayAprilFoolsRenderer extends MobRenderer<EpicSharkoLayAprilFoolsEntity, LivingEntityRenderState, Modelboyoaprilfoolssit> {
	private EpicSharkoLayAprilFoolsEntity entity = null;
	...
	@Override
	public void extractRenderState(EpicSharkoLayAprilFoolsEntity entity, LivingEntityRenderState state, float partialTicks) {
