...
public class RareSharkoTamedZoomiesRenderer extends MobRenderer<RareSharkoTamedZoomiesEntity, LivingEntityRenderState, Modelboyozooms> {
	private RareSharkoTamedZoomiesEntity entity = null;
	...
	@Override
	public void extractRenderState(RareSharkoTamedZoomiesEntity entity, LivingEntityRenderState state, float partialTicks) {
	...
	private static final class AnimatedModel extends Modelboyozooms {
		...
		public void setEntity(RareSharkoTamedZoomiesEntity entity) {
			this.entity = entity;
		}
