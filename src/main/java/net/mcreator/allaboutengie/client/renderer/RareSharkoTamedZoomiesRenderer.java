...
public class RareSharkoTamedZoomiesRenderer extends MobRenderer<RareSharkoTamedZoomiesEntity, Modelboyozooms<RareSharkoTamedZoomiesEntity>> {
	...
	private static final class AnimatedModel extends Modelboyozooms<RareSharkoTamedZoomiesEntity> {
		...
		private final HierarchicalModel animator = new HierarchicalModel<RareSharkoTamedZoomiesEntity>() {
			@Override
			...
			@Override
			public void setupAnim(RareSharkoTamedZoomiesEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
