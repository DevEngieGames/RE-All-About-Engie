...
public class TigerSitRenderer extends MobRenderer<TigerSitEntity, LivingEntityRenderState, Modeltobysitnew> {
	private TigerSitEntity entity = null;
	...
	@Override
	public void extractRenderState(TigerSitEntity entity, LivingEntityRenderState state, float partialTicks) {
	...
	private static final class AnimatedModel extends Modeltobysitnew {
		...
		public void setEntity(TigerSitEntity entity) {
			this.entity = entity;
		}
