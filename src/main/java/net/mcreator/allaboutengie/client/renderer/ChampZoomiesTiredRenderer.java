...
public class ChampZoomiesTiredRenderer extends MobRenderer<ChampZoomiesTiredEntity, LivingEntityRenderState, Modelchampdaboyotired> {
	private ChampZoomiesTiredEntity entity = null;
	...
	@Override
	public void extractRenderState(ChampZoomiesTiredEntity entity, LivingEntityRenderState state, float partialTicks) {
	...
	private static final class AnimatedModel extends Modelchampdaboyotired {
		...
		public void setEntity(ChampZoomiesTiredEntity entity) {
			this.entity = entity;
		}
