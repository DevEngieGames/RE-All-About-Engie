...
public class AlbinoSharkoTamedRenderer extends MobRenderer<AlbinoSharkoTamedEntity, LivingEntityRenderState, Modelboyo> {
	private AlbinoSharkoTamedEntity entity = null;
	...
	@Override
	public void extractRenderState(AlbinoSharkoTamedEntity entity, LivingEntityRenderState state, float partialTicks) {
	...
	private static final class AnimatedModel extends Modelboyo {
		...
		public void setEntity(AlbinoSharkoTamedEntity entity) {
			this.entity = entity;
		}
