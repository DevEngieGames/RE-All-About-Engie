...
public class ExoticSharkoLayRenderer extends MobRenderer<ExoticSharkoLayEntity, LivingEntityRenderState, Modelboyosit> {
	private ExoticSharkoLayEntity entity = null;
	...
	@Override
	public void extractRenderState(ExoticSharkoLayEntity entity, LivingEntityRenderState state, float partialTicks) {
	...
	private static final class AnimatedModel extends Modelboyosit {
		...
		public void setEntity(ExoticSharkoLayEntity entity) {
			this.entity = entity;
		}
