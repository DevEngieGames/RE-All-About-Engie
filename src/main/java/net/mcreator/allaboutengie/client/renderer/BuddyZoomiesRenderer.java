...
public class BuddyZoomiesRenderer extends MobRenderer<BuddyZoomiesEntity, LivingEntityRenderState, Modeltobyzooms> {
	private BuddyZoomiesEntity entity = null;
	...
	@Override
	public void extractRenderState(BuddyZoomiesEntity entity, LivingEntityRenderState state, float partialTicks) {
	...
	private static final class AnimatedModel extends Modeltobyzooms {
		...
		public void setEntity(BuddyZoomiesEntity entity) {
			this.entity = entity;
		}
