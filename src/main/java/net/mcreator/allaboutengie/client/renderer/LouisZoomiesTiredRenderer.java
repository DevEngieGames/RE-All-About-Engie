...
public class LouisZoomiesTiredRenderer extends MobRenderer<LouisZoomiesTiredEntity, LivingEntityRenderState, Modeltobyzoomtired> {
	private LouisZoomiesTiredEntity entity = null;
	...
	@Override
	public void extractRenderState(LouisZoomiesTiredEntity entity, LivingEntityRenderState state, float partialTicks) {
	...
	public ResourceLocation getTextureLocation(LivingEntityRenderState state) {
		return ResourceLocation.parse("allaboutengie:textures/entities/louiszoomtired.png");
	}
	...
	private static final class AnimatedModel extends Modeltobyzoomtired {
		...
		public void setEntity(LouisZoomiesTiredEntity entity) {
			this.entity = entity;
		}
