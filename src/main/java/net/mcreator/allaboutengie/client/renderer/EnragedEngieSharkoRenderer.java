...
public class EnragedEngieSharkoRenderer extends MobRenderer<EnragedEngieSharkoEntity, LivingEntityRenderState, Modelboyoother> {
	private EnragedEngieSharkoEntity entity = null;
	...
	@Override
	public void extractRenderState(EnragedEngieSharkoEntity entity, LivingEntityRenderState state, float partialTicks) {
