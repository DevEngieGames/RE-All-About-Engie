...
public class EngieSharkoRareSitRenderer extends MobRenderer<EngieSharkoRareSitEntity, LivingEntityRenderState, Modelboyositnew> {
	private EngieSharkoRareSitEntity entity = null;
	...
	@Override
	public void extractRenderState(EngieSharkoRareSitEntity entity, LivingEntityRenderState state, float partialTicks) {
	...
	private static final class AnimatedModel extends Modelboyositnew {
		...
		public void setEntity(EngieSharkoRareSitEntity entity) {
			this.entity = entity;
		}
