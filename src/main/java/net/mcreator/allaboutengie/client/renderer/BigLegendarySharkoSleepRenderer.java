...
public class BigLegendarySharkoSleepRenderer extends MobRenderer<BigLegendarySharkoSleepEntity, Modelbigboyotired<BigLegendarySharkoSleepEntity>> {
	...
	private static final class AnimatedModel extends Modelbigboyotired<BigLegendarySharkoSleepEntity> {
		private final ModelPart root;
		private final HierarchicalModel animator = new HierarchicalModel<BigLegendarySharkoSleepEntity>() {
			@Override
			...
			@Override
			public void setupAnim(BigLegendarySharkoSleepEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
