...
public class BigLegendarySharkoSleepRenderer extends MobRenderer<BigLegendarySharkoSleepEntity, LivingEntityRenderState, Modelbigboyotired> {
	private BigLegendarySharkoSleepEntity entity = null;
	...
	@Override
	public void extractRenderState(BigLegendarySharkoSleepEntity entity, LivingEntityRenderState state, float partialTicks) {
	...
	public ResourceLocation getTextureLocation(LivingEntityRenderState state) {
		return ResourceLocation.parse("allaboutengie:textures/entities/biglegendarysharkonewtamedtired.png");
	}
	...
	private static final class AnimatedModel extends Modelbigboyotired {
		...
		public void setEntity(BigLegendarySharkoSleepEntity entity) {
			this.entity = entity;
		}
