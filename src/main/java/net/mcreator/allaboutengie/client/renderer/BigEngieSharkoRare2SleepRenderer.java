...
public class BigEngieSharkoRare2SleepRenderer extends MobRenderer<BigEngieSharkoRare2SleepEntity, LivingEntityRenderState, Modelbigboyotired> {
	private BigEngieSharkoRare2SleepEntity entity = null;
	...
	@Override
	public void extractRenderState(BigEngieSharkoRare2SleepEntity entity, LivingEntityRenderState state, float partialTicks) {
	...
	public ResourceLocation getTextureLocation(LivingEntityRenderState state) {
		return ResourceLocation.parse("allaboutengie:textures/entities/bigrareengiesharko2newtamedtired.png");
	}
	...
	private static final class AnimatedModel extends Modelbigboyotired {
		...
		public void setEntity(BigEngieSharkoRare2SleepEntity entity) {
			this.entity = entity;
		}
