...
public class BigEngieSharkoRare2SleepRenderer extends MobRenderer<BigEngieSharkoRare2SleepEntity, Modelbigboyotired<BigEngieSharkoRare2SleepEntity>> {
	...
	private static final class AnimatedModel extends Modelbigboyotired<BigEngieSharkoRare2SleepEntity> {
		private final ModelPart root;
		private final HierarchicalModel animator = new HierarchicalModel<BigEngieSharkoRare2SleepEntity>() {
			@Override
			...
			@Override
			public void setupAnim(BigEngieSharkoRare2SleepEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
