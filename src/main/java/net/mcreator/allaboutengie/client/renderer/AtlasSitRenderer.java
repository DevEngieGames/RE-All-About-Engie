...
public class AtlasSitRenderer extends MobRenderer<AtlasSitEntity, LivingEntityRenderState, Modeltobysitnew> {
	private AtlasSitEntity entity = null;
	...
	@Override
	public void extractRenderState(AtlasSitEntity entity, LivingEntityRenderState state, float partialTicks) {
	...
	private static final class AnimatedModel extends Modeltobysitnew {
		...
		public void setEntity(AtlasSitEntity entity) {
			this.entity = entity;
		}
