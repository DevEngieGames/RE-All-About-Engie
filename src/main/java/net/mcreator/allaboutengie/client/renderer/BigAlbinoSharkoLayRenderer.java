...
public class BigAlbinoSharkoLayRenderer extends MobRenderer<BigAlbinoSharkoLayEntity, LivingEntityRenderState, Modelbigboyosit> {
	private BigAlbinoSharkoLayEntity entity = null;
	...
	@Override
	public void extractRenderState(BigAlbinoSharkoLayEntity entity, LivingEntityRenderState state, float partialTicks) {
	...
	private static final class AnimatedModel extends Modelbigboyosit {
		...
		public void setEntity(BigAlbinoSharkoLayEntity entity) {
			this.entity = entity;
		}
