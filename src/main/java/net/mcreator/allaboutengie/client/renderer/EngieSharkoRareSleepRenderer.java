...
public class EngieSharkoRareSleepRenderer extends MobRenderer<EngieSharkoRareSleepEntity, LivingEntityRenderState, Modelboyotired> {
	private EngieSharkoRareSleepEntity entity = null;
	...
	@Override
	public void extractRenderState(EngieSharkoRareSleepEntity entity, LivingEntityRenderState state, float partialTicks) {
	...
	public ResourceLocation getTextureLocation(LivingEntityRenderState state) {
		return ResourceLocation.parse("allaboutengie:textures/entities/rareengiesharkonewtamedtired.png");
	}
	...
	private static final class AnimatedModel extends Modelboyotired {
		...
		public void setEntity(EngieSharkoRareSleepEntity entity) {
			this.entity = entity;
		}
