...
public class BigEngieSharkoRareTamedRenderer extends MobRenderer<BigEngieSharkoRareTamedEntity, LivingEntityRenderState, Modelbigboyo> {
	private BigEngieSharkoRareTamedEntity entity = null;
	...
	@Override
	public void extractRenderState(BigEngieSharkoRareTamedEntity entity, LivingEntityRenderState state, float partialTicks) {
	...
	private static final class AnimatedModel extends Modelbigboyo {
		...
		public void setEntity(BigEngieSharkoRareTamedEntity entity) {
			this.entity = entity;
		}
