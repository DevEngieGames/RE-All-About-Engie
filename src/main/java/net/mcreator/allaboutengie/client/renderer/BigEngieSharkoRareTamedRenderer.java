...
public class BigEngieSharkoRareTamedRenderer extends MobRenderer<BigEngieSharkoRareTamedEntity, Modelbigboyo<BigEngieSharkoRareTamedEntity>> {
	...
	private static final class AnimatedModel extends Modelbigboyo<BigEngieSharkoRareTamedEntity> {
		private final ModelPart root;
		private final HierarchicalModel animator = new HierarchicalModel<BigEngieSharkoRareTamedEntity>() {
			@Override
			...
			@Override
			public void setupAnim(BigEngieSharkoRareTamedEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
