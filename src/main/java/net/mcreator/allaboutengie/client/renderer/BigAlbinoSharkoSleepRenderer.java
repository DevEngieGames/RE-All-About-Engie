...
public class BigAlbinoSharkoSleepRenderer extends MobRenderer<BigAlbinoSharkoSleepEntity, LivingEntityRenderState, Modelbigboyotired> {
	private BigAlbinoSharkoSleepEntity entity = null;
	...
	@Override
	public void extractRenderState(BigAlbinoSharkoSleepEntity entity, LivingEntityRenderState state, float partialTicks) {
	...
	private static final class AnimatedModel extends Modelbigboyotired {
		...
		public void setEntity(BigAlbinoSharkoSleepEntity entity) {
			this.entity = entity;
		}
