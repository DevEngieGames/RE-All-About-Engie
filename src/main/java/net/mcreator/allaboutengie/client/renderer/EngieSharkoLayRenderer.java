...
public class EngieSharkoLayRenderer extends MobRenderer<EngieSharkoLayEntity, Modelboyosit<EngieSharkoLayEntity>> {
	...
	private static final class AnimatedModel extends Modelboyosit<EngieSharkoLayEntity> {
		private final ModelPart root;
		private final HierarchicalModel animator = new HierarchicalModel<EngieSharkoLayEntity>() {
			@Override
			...
			@Override
			public void setupAnim(EngieSharkoLayEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
