...
public class EngieSharkoLayRenderer extends MobRenderer<EngieSharkoLayEntity, LivingEntityRenderState, Modelboyosit> {
	private EngieSharkoLayEntity entity = null;
	...
	@Override
	public void extractRenderState(EngieSharkoLayEntity entity, LivingEntityRenderState state, float partialTicks) {
	...
	private static final class AnimatedModel extends Modelboyosit {
		...
		public void setEntity(EngieSharkoLayEntity entity) {
			this.entity = entity;
		}
