...
public class ApolloZoomiesTiredRenderer extends MobRenderer<ApolloZoomiesTiredEntity, Modeltobyzoomtired<ApolloZoomiesTiredEntity>> {
	public ApolloZoomiesTiredRenderer(EntityRendererProvider.Context context) {
		super(context, new Modeltobyzoomtired<ApolloZoomiesTiredEntity>(context.bakeLayer(Modeltobyzoomtired.LAYER_LOCATION)), 0.5f);
	}
