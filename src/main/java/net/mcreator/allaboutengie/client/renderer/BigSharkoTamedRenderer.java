...
public class BigSharkoTamedRenderer extends MobRenderer<BigSharkoTamedEntity, LivingEntityRenderState, Modelbigboyo> {
	private BigSharkoTamedEntity entity = null;
	...
	@Override
	public void extractRenderState(BigSharkoTamedEntity entity, LivingEntityRenderState state, float partialTicks) {
	...
	public ResourceLocation getTextureLocation(LivingEntityRenderState state) {
		return ResourceLocation.parse("allaboutengie:textures/entities/bigsharkonewtamed.png");
	}
	...
	private static final class AnimatedModel extends Modelbigboyo {
		...
		public void setEntity(BigSharkoTamedEntity entity) {
			this.entity = entity;
		}
