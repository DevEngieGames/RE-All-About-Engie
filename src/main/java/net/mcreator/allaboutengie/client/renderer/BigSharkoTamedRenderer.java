...
public class BigSharkoTamedRenderer extends MobRenderer<BigSharkoTamedEntity, Modelbigboyo<BigSharkoTamedEntity>> {
	...
	private static final class AnimatedModel extends Modelbigboyo<BigSharkoTamedEntity> {
		private final ModelPart root;
		private final HierarchicalModel animator = new HierarchicalModel<BigSharkoTamedEntity>() {
			@Override
			...
			@Override
			public void setupAnim(BigSharkoTamedEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
