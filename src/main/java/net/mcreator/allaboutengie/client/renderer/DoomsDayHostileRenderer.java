...
public class DoomsDayHostileRenderer extends HumanoidMobRenderer<DoomsDayHostileEntity, HumanoidRenderState, HumanoidModel<HumanoidRenderState>> {
	private DoomsDayHostileEntity entity = null;
	...
	@Override
	public void extractRenderState(DoomsDayHostileEntity entity, HumanoidRenderState state, float partialTicks) {
