...
public class BigSharkoRenderer extends MobRenderer<BigSharkoEntity, LivingEntityRenderState, Modelbigboyo> {
	private BigSharkoEntity entity = null;
	...
	@Override
	public void extractRenderState(BigSharkoEntity entity, LivingEntityRenderState state, float partialTicks) {
	...
	private static final class AnimatedModel extends Modelbigboyo {
		...
		public void setEntity(BigSharkoEntity entity) {
			this.entity = entity;
		}
