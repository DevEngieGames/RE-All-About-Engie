...
public class BigSharkoRenderer extends MobRenderer<BigSharkoEntity, Modelbigboyo<BigSharkoEntity>> {
	...
	public ResourceLocation getTextureLocation(BigSharkoEntity entity) {
		return ResourceLocation.parse("allaboutengie:textures/entities/sharkonew.png");
	}

	private static final class AnimatedModel extends Modelbigboyo<BigSharkoEntity> {
		private final ModelPart root;
		private final HierarchicalModel animator = new HierarchicalModel<BigSharkoEntity>() {
			@Override
			...
			@Override
			public void setupAnim(BigSharkoEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
