...
public class BigAlbinoSharkoTamedRenderer extends MobRenderer<BigAlbinoSharkoTamedEntity, LivingEntityRenderState, Modelbigboyo> {
	private BigAlbinoSharkoTamedEntity entity = null;
	...
	@Override
	public void extractRenderState(BigAlbinoSharkoTamedEntity entity, LivingEntityRenderState state, float partialTicks) {
	...
	private static final class AnimatedModel extends Modelbigboyo {
		...
		public void setEntity(BigAlbinoSharkoTamedEntity entity) {
			this.entity = entity;
		}
