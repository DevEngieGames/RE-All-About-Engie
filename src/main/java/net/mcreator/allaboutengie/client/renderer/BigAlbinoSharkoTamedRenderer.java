...
public class BigAlbinoSharkoTamedRenderer extends MobRenderer<BigAlbinoSharkoTamedEntity, Modelbigboyo<BigAlbinoSharkoTamedEntity>> {
	...
	private static final class AnimatedModel extends Modelbigboyo<BigAlbinoSharkoTamedEntity> {
		private final ModelPart root;
		private final HierarchicalModel animator = new HierarchicalModel<BigAlbinoSharkoTamedEntity>() {
			@Override
			...
			@Override
			public void setupAnim(BigAlbinoSharkoTamedEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
