...
public class TobyZoomiesTiredRenderer extends MobRenderer<TobyZoomiesTiredEntity, Modeltobyzoomtired<TobyZoomiesTiredEntity>> {
	...
	private static final class AnimatedModel extends Modeltobyzoomtired<TobyZoomiesTiredEntity> {
		private final ModelPart root;
		private final HierarchicalModel animator = new HierarchicalModel<TobyZoomiesTiredEntity>() {
			@Override
			...
			@Override
			public void setupAnim(TobyZoomiesTiredEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
