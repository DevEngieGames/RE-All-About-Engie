...
public class TobyZoomiesTiredRenderer extends MobRenderer<TobyZoomiesTiredEntity, LivingEntityRenderState, Modeltobyzoomtired> {
	private TobyZoomiesTiredEntity entity = null;
	...
	@Override
	public void extractRenderState(TobyZoomiesTiredEntity entity, LivingEntityRenderState state, float partialTicks) {
	...
	public ResourceLocation getTextureLocation(LivingEntityRenderState state) {
		return ResourceLocation.parse("allaboutengie:textures/entities/tobyzoomtired.png");
	}
	...
	private static final class AnimatedModel extends Modeltobyzoomtired {
		...
		public void setEntity(TobyZoomiesTiredEntity entity) {
			this.entity = entity;
		}
