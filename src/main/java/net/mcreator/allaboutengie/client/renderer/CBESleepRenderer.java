...
public class CBESleepRenderer extends MobRenderer<CBESleepEntity, Modelengiedaboyotired<CBESleepEntity>> {
	...
	private static final class AnimatedModel extends Modelengiedaboyotired<CBESleepEntity> {
		private final ModelPart root;
		private final HierarchicalModel animator = new HierarchicalModel<CBESleepEntity>() {
			@Override
			...
			@Override
			public void setupAnim(CBESleepEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
