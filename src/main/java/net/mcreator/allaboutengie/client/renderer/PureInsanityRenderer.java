...
public class PureInsanityRenderer extends MobRenderer<PureInsanityEntity, LivingEntityRenderState, ModelEngieGames> {
	private PureInsanityEntity entity = null;
	...
	@Override
	public void extractRenderState(PureInsanityEntity entity, LivingEntityRenderState state, float partialTicks) {
