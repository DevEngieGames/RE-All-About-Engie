...
public class PBESleepRenderer extends MobRenderer<PBESleepEntity, LivingEntityRenderState, Modelengiedaboyotired> {
	private PBESleepEntity entity = null;
	...
	@Override
	public void extractRenderState(PBESleepEntity entity, LivingEntityRenderState state, float partialTicks) {
	...
	private static final class AnimatedModel extends Modelengiedaboyotired {
		...
		public void setEntity(PBESleepEntity entity) {
			this.entity = entity;
		}
