...
public class PBESleepRenderer extends MobRenderer<PBESleepEntity, Modelengiedaboyotired<PBESleepEntity>> {
	...
	private static final class AnimatedModel extends Modelengiedaboyotired<PBESleepEntity> {
		...
		private final HierarchicalModel animator = new HierarchicalModel<PBESleepEntity>() {
			@Override
			...
			@Override
			public void setupAnim(PBESleepEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
