...
public class AtlasLayRenderer extends MobRenderer<AtlasLayEntity, Modeltobysit<AtlasLayEntity>> {
	...
	private static final class AnimatedModel extends Modeltobysit<AtlasLayEntity> {
		private final ModelPart root;
		private final HierarchicalModel animator = new HierarchicalModel<AtlasLayEntity>() {
			@Override
			...
			@Override
			public void setupAnim(AtlasLayEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
