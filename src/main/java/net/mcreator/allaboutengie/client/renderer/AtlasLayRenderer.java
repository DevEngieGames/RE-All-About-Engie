...
public class AtlasLayRenderer extends MobRenderer<AtlasLayEntity, LivingEntityRenderState, Modeltobysit> {
	private AtlasLayEntity entity = null;
	...
	@Override
	public void extractRenderState(AtlasLayEntity entity, LivingEntityRenderState state, float partialTicks) {
	...
	private static final class AnimatedModel extends Modeltobysit {
		...
		public void setEntity(AtlasLayEntity entity) {
			this.entity = entity;
		}
