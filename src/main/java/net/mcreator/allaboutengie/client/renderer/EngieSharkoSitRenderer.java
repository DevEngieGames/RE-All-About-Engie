...
public class EngieSharkoSitRenderer extends MobRenderer<EngieSharkoSitEntity, LivingEntityRenderState, Modelboyositnew> {
	private EngieSharkoSitEntity entity = null;
	...
	@Override
	public void extractRenderState(EngieSharkoSitEntity entity, LivingEntityRenderState state, float partialTicks) {
	...
	private static final class AnimatedModel extends Modelboyositnew {
		...
		public void setEntity(EngieSharkoSitEntity entity) {
			this.entity = entity;
		}
