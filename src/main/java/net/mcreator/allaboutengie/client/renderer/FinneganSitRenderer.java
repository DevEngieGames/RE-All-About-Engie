...
public class FinneganSitRenderer extends MobRenderer<FinneganSitEntity, LivingEntityRenderState, Modelboyositnew> {
	private FinneganSitEntity entity = null;
	...
	@Override
	public void extractRenderState(FinneganSitEntity entity, LivingEntityRenderState state, float partialTicks) {
	...
	private static final class AnimatedModel extends Modelboyositnew {
		...
		public void setEntity(FinneganSitEntity entity) {
			this.entity = entity;
		}
