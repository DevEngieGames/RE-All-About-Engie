...
public class LegendarySharkoSitRenderer extends MobRenderer<LegendarySharkoSitEntity, LivingEntityRenderState, Modelboyositnew> {
	private LegendarySharkoSitEntity entity = null;
	...
	@Override
	public void extractRenderState(LegendarySharkoSitEntity entity, LivingEntityRenderState state, float partialTicks) {
	...
	private static final class AnimatedModel extends Modelboyositnew {
		...
		public void setEntity(LegendarySharkoSitEntity entity) {
			this.entity = entity;
		}
