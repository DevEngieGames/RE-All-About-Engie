...
public class LegendarySharkoSitRenderer extends MobRenderer<LegendarySharkoSitEntity, Modelboyositnew<LegendarySharkoSitEntity>> {
	...
	private static final class AnimatedModel extends Modelboyositnew<LegendarySharkoSitEntity> {
