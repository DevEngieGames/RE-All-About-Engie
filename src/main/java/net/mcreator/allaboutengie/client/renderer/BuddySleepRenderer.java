...
public class BuddySleepRenderer extends MobRenderer<BuddySleepEntity, LivingEntityRenderState, Modeltobytired> {
	private BuddySleepEntity entity = null;
	...
	@Override
	public void extractRenderState(BuddySleepEntity entity, LivingEntityRenderState state, float partialTicks) {
	...
	private static final class AnimatedModel extends Modeltobytired {
		...
		public void setEntity(BuddySleepEntity entity) {
			this.entity = entity;
		}
