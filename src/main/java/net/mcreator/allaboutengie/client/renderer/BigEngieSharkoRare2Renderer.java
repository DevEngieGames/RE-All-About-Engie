...
public class BigEngieSharkoRare2Renderer extends MobRenderer<BigEngieSharkoRare2Entity, LivingEntityRenderState, Modelbigboyo> {
	private BigEngieSharkoRare2Entity entity = null;
	...
	@Override
	public void extractRenderState(BigEngieSharkoRare2Entity entity, LivingEntityRenderState state, float partialTicks) {
	...
	private static final class AnimatedModel extends Modelbigboyo {
		...
		public void setEntity(BigEngieSharkoRare2Entity entity) {
			this.entity = entity;
		}
