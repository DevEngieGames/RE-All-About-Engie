...
public class AtlasLayOnSideRenderer extends MobRenderer<AtlasLayOnSideEntity, LivingEntityRenderState, Modeltobylayonside> {
	private AtlasLayOnSideEntity entity = null;
	...
	@Override
	public void extractRenderState(AtlasLayOnSideEntity entity, LivingEntityRenderState state, float partialTicks) {
	...
	private static final class AnimatedModel extends Modeltobylayonside {
		...
		public void setEntity(AtlasLayOnSideEntity entity) {
			this.entity = entity;
		}
