...
public class MarshalZoomiesRenderer extends MobRenderer<MarshalZoomiesEntity, Modeltoby<MarshalZoomiesEntity>> {
	...
	private static final class AnimatedModel extends Modeltoby<MarshalZoomiesEntity> {
		private final ModelPart root;
		private final HierarchicalModel animator = new HierarchicalModel<MarshalZoomiesEntity>() {
			@Override
			...
			@Override
			public void setupAnim(MarshalZoomiesEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
