...
public class MarshalZoomiesRenderer extends MobRenderer<MarshalZoomiesEntity, LivingEntityRenderState, Modeltobyzooms> {
	private MarshalZoomiesEntity entity = null;
	...
	@Override
	public void extractRenderState(MarshalZoomiesEntity entity, LivingEntityRenderState state, float partialTicks) {
	...
	public ResourceLocation getTextureLocation(LivingEntityRenderState state) {
		return ResourceLocation.parse("allaboutengie:textures/entities/marshalzoom.png");
	}
	...
	private static final class AnimatedModel extends Modeltobyzooms {
		...
		public void setEntity(MarshalZoomiesEntity entity) {
			this.entity = entity;
		}
