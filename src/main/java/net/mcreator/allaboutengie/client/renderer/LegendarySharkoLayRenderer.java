...
public class LegendarySharkoLayRenderer extends MobRenderer<LegendarySharkoLayEntity, LivingEntityRenderState, Modelboyosit> {
	private LegendarySharkoLayEntity entity = null;
	...
	@Override
	public void extractRenderState(LegendarySharkoLayEntity entity, LivingEntityRenderState state, float partialTicks) {
	...
	private static final class AnimatedModel extends Modelboyosit {
		...
		public void setEntity(LegendarySharkoLayEntity entity) {
			this.entity = entity;
		}
