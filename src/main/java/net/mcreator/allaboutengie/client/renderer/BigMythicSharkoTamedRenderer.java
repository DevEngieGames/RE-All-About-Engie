...
public class BigMythicSharkoTamedRenderer extends MobRenderer<BigMythicSharkoTamedEntity, LivingEntityRenderState, Modelbigboyo> {
	private BigMythicSharkoTamedEntity entity = null;
	...
	@Override
	public void extractRenderState(BigMythicSharkoTamedEntity entity, LivingEntityRenderState state, float partialTicks) {
	...
	public ResourceLocation getTextureLocation(LivingEntityRenderState state) {
		return ResourceLocation.parse("allaboutengie:textures/entities/bigmythicsharkonewtamed.png");
	}
	...
	private static final class AnimatedModel extends Modelbigboyo {
		...
		public void setEntity(BigMythicSharkoTamedEntity entity) {
			this.entity = entity;
		}
