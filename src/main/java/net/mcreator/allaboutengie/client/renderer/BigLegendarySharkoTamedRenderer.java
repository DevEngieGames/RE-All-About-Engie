...
public class BigLegendarySharkoTamedRenderer extends MobRenderer<BigLegendarySharkoTamedEntity, LivingEntityRenderState, Modelbigboyo> {
	private BigLegendarySharkoTamedEntity entity = null;
	...
	@Override
	public void extractRenderState(BigLegendarySharkoTamedEntity entity, LivingEntityRenderState state, float partialTicks) {
	...
	private static final class AnimatedModel extends Modelbigboyo {
		...
		public void setEntity(BigLegendarySharkoTamedEntity entity) {
			this.entity = entity;
		}
