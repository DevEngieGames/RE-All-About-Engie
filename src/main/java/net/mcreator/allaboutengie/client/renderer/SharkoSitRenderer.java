...
public class SharkoSitRenderer extends MobRenderer<SharkoSitEntity, LivingEntityRenderState, Modelboyositnew> {
	private SharkoSitEntity entity = null;
	...
	@Override
	public void extractRenderState(SharkoSitEntity entity, LivingEntityRenderState state, float partialTicks) {
	...
	private static final class AnimatedModel extends Modelboyositnew {
		...
		public void setEntity(SharkoSitEntity entity) {
			this.entity = entity;
		}
