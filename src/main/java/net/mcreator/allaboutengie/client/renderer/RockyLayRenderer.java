...
public class RockyLayRenderer extends MobRenderer<RockyLayEntity, LivingEntityRenderState, Modelrockylay> {
	private RockyLayEntity entity = null;
	...
	@Override
	public void extractRenderState(RockyLayEntity entity, LivingEntityRenderState state, float partialTicks) {
	...
	private static final class AnimatedModel extends Modelrockylay {
		private RockyLayEntity entity = null;
		...
		public void setEntity(RockyLayEntity entity) {
			this.entity = entity;
		}
