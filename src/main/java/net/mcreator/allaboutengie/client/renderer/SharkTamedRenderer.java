...
public class SharkTamedRenderer extends MobRenderer<SharkTamedEntity, Modelboyo<SharkTamedEntity>> {
	...
	private static final class AnimatedModel extends Modelboyo<SharkTamedEntity> {
		private final ModelPart root;
		private final HierarchicalModel animator = new HierarchicalModel<SharkTamedEntity>() {
			@Override
			...
			@Override
			public void setupAnim(SharkTamedEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
