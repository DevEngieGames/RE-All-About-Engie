...
public class SharkTamedRenderer extends MobRenderer<SharkTamedEntity, LivingEntityRenderState, Modelboyo> {
	private SharkTamedEntity entity = null;
	...
	@Override
	public void extractRenderState(SharkTamedEntity entity, LivingEntityRenderState state, float partialTicks) {
	...
	private static final class AnimatedModel extends Modelboyo {
		...
		public void setEntity(SharkTamedEntity entity) {
			this.entity = entity;
		}
