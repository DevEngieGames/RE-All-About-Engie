...
public class LegendarySharkoLayAprilFoolsRenderer extends MobRenderer<LegendarySharkoLayAprilFoolsEntity, LivingEntityRenderState, Modelboyoaprilfoolssit> {
	private LegendarySharkoLayAprilFoolsEntity entity = null;
	...
	@Override
	public void extractRenderState(LegendarySharkoLayAprilFoolsEntity entity, LivingEntityRenderState state, float partialTicks) {
