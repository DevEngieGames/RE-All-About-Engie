...
public class BigExoticSharkoTamedRenderer extends MobRenderer<BigExoticSharkoTamedEntity, Modelbigboyo<BigExoticSharkoTamedEntity>> {
	...
	private static final class AnimatedModel extends Modelbigboyo<BigExoticSharkoTamedEntity> {
		private final ModelPart root;
		private final HierarchicalModel animator = new HierarchicalModel<BigExoticSharkoTamedEntity>() {
			@Override
			...
			@Override
			public void setupAnim(BigExoticSharkoTamedEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
