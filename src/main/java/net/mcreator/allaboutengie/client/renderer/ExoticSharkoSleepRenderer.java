...
public class ExoticSharkoSleepRenderer extends MobRenderer<ExoticSharkoSleepEntity, Modelboyotired<ExoticSharkoSleepEntity>> {
	...
	private static final class AnimatedModel extends Modelboyotired<ExoticSharkoSleepEntity> {
		private final ModelPart root;
		private final HierarchicalModel animator = new HierarchicalModel<ExoticSharkoSleepEntity>() {
			@Override
			...
			@Override
			public void setupAnim(ExoticSharkoSleepEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
