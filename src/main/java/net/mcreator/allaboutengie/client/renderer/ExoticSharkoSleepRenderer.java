...
public class ExoticSharkoSleepRenderer extends MobRenderer<ExoticSharkoSleepEntity, LivingEntityRenderState, Modelboyotired> {
	private ExoticSharkoSleepEntity entity = null;
	...
	@Override
	public void extractRenderState(ExoticSharkoSleepEntity entity, LivingEntityRenderState state, float partialTicks) {
	...
	public ResourceLocation getTextureLocation(LivingEntityRenderState state) {
		return ResourceLocation.parse("allaboutengie:textures/entities/exoticsharkonewtamedtired.png");
	}
	...
	private static final class AnimatedModel extends Modelboyotired {
		...
		public void setEntity(ExoticSharkoSleepEntity entity) {
			this.entity = entity;
		}
