...
public class LouisRenderer extends MobRenderer<LouisEntity, LivingEntityRenderState, Modeltoby> {
	private LouisEntity entity = null;
	...
	@Override
	public void extractRenderState(LouisEntity entity, LivingEntityRenderState state, float partialTicks) {
	...
	private static final class AnimatedModel extends Modeltoby {
		...
		public void setEntity(LouisEntity entity) {
			this.entity = entity;
		}
