...
public class SharkoSleepRenderer extends MobRenderer<SharkoSleepEntity, LivingEntityRenderState, Modelboyotired> {
	private SharkoSleepEntity entity = null;
	...
	@Override
	public void extractRenderState(SharkoSleepEntity entity, LivingEntityRenderState state, float partialTicks) {
	...
	public ResourceLocation getTextureLocation(LivingEntityRenderState state) {
		return ResourceLocation.parse("allaboutengie:textures/entities/sharkonewtamedtired.png");
	}
	...
	private static final class AnimatedModel extends Modelboyotired {
		...
		public void setEntity(SharkoSleepEntity entity) {
			this.entity = entity;
		}
