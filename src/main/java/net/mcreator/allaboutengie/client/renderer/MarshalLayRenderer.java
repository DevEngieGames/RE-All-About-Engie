...
public class MarshalLayRenderer extends MobRenderer<MarshalLayEntity, LivingEntityRenderState, Modeltobysit> {
	private MarshalLayEntity entity = null;
	...
	@Override
	public void extractRenderState(MarshalLayEntity entity, LivingEntityRenderState state, float partialTicks) {
	...
	private static final class AnimatedModel extends Modeltobysit {
		...
		public void setEntity(MarshalLayEntity entity) {
			this.entity = entity;
		}
