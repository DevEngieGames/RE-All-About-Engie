...
public class MythicSharkoLayRenderer extends MobRenderer<MythicSharkoLayEntity, LivingEntityRenderState, Modelboyosit> {
	private MythicSharkoLayEntity entity = null;
	...
	@Override
	public void extractRenderState(MythicSharkoLayEntity entity, LivingEntityRenderState state, float partialTicks) {
	...
	private static final class AnimatedModel extends Modelboyosit {
		...
		public void setEntity(MythicSharkoLayEntity entity) {
			this.entity = entity;
		}
