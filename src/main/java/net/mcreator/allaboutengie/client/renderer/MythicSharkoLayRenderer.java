...
public class MythicSharkoLayRenderer extends MobRenderer<MythicSharkoLayEntity, Modelboyosit<MythicSharkoLayEntity>> {
	...
	private static final class AnimatedModel extends Modelboyosit<MythicSharkoLayEntity> {
		private final ModelPart root;
		private final HierarchicalModel animator = new HierarchicalModel<MythicSharkoLayEntity>() {
			@Override
			...
			@Override
			public void setupAnim(MythicSharkoLayEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
