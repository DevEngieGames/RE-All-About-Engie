...
public class LegendarySharkoSleepRenderer extends MobRenderer<LegendarySharkoSleepEntity, Modelboyotired<LegendarySharkoSleepEntity>> {
	...
	private static final class AnimatedModel extends Modelboyotired<LegendarySharkoSleepEntity> {
		private final ModelPart root;
		private final HierarchicalModel animator = new HierarchicalModel<LegendarySharkoSleepEntity>() {
			@Override
			...
			@Override
			public void setupAnim(LegendarySharkoSleepEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
