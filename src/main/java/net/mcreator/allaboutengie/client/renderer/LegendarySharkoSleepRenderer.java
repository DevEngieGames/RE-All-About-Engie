...
public class LegendarySharkoSleepRenderer extends MobRenderer<LegendarySharkoSleepEntity, LivingEntityRenderState, Modelboyotired> {
	private LegendarySharkoSleepEntity entity = null;
	...
	@Override
	public void extractRenderState(LegendarySharkoSleepEntity entity, LivingEntityRenderState state, float partialTicks) {
	...
	private static final class AnimatedModel extends Modelboyotired {
		...
		public void setEntity(LegendarySharkoSleepEntity entity) {
			this.entity = entity;
		}
