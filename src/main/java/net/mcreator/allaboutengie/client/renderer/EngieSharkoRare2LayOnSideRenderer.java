...
public class EngieSharkoRare2LayOnSideRenderer extends MobRenderer<EngieSharkoRare2LayOnSideEntity, LivingEntityRenderState, Modelboyolayonside> {
	private EngieSharkoRare2LayOnSideEntity entity = null;
	...
	@Override
	public void extractRenderState(EngieSharkoRare2LayOnSideEntity entity, LivingEntityRenderState state, float partialTicks) {
	...
	private static final class AnimatedModel extends Modelboyolayonside {
		...
		public void setEntity(EngieSharkoRare2LayOnSideEntity entity) {
			this.entity = entity;
		}
