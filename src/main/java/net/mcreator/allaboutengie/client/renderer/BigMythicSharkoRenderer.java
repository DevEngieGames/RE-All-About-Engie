...
public class BigMythicSharkoRenderer extends MobRenderer<BigMythicSharkoEntity, LivingEntityRenderState, Modelbigboyo> {
	private BigMythicSharkoEntity entity = null;
	...
	@Override
	public void extractRenderState(BigMythicSharkoEntity entity, LivingEntityRenderState state, float partialTicks) {
	...
	public ResourceLocation getTextureLocation(LivingEntityRenderState state) {
		return ResourceLocation.parse("allaboutengie:textures/entities/mythicsharkonew.png");
	}
	...
	private static final class AnimatedModel extends Modelbigboyo {
		...
		public void setEntity(BigMythicSharkoEntity entity) {
			this.entity = entity;
		}
