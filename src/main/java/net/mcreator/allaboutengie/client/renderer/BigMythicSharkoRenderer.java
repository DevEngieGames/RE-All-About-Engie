...
public class BigMythicSharkoRenderer extends MobRenderer<BigMythicSharkoEntity, Modelbigboyo<BigMythicSharkoEntity>> {
	...
	private static final class AnimatedModel extends Modelbigboyo<BigMythicSharkoEntity> {
		private final ModelPart root;
		private final HierarchicalModel animator = new HierarchicalModel<BigMythicSharkoEntity>() {
			@Override
			...
			@Override
			public void setupAnim(BigMythicSharkoEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
