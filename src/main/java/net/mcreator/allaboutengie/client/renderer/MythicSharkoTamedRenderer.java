...
public class MythicSharkoTamedRenderer extends MobRenderer<MythicSharkoTamedEntity, Modelboyo<MythicSharkoTamedEntity>> {
	...
	private static final class AnimatedModel extends Modelboyo<MythicSharkoTamedEntity> {
		private final ModelPart root;
		private final HierarchicalModel animator = new HierarchicalModel<MythicSharkoTamedEntity>() {
			@Override
			...
			@Override
			public void setupAnim(MythicSharkoTamedEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
