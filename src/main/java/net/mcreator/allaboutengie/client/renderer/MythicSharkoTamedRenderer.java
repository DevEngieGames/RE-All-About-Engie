...
public class MythicSharkoTamedRenderer extends MobRenderer<MythicSharkoTamedEntity, LivingEntityRenderState, Modelboyo> {
	private MythicSharkoTamedEntity entity = null;
	...
	@Override
	public void extractRenderState(MythicSharkoTamedEntity entity, LivingEntityRenderState state, float partialTicks) {
	...
	private static final class AnimatedModel extends Modelboyo {
		...
		public void setEntity(MythicSharkoTamedEntity entity) {
			this.entity = entity;
		}
