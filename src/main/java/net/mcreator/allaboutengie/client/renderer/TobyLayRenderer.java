...
public class TobyLayRenderer extends MobRenderer<TobyLayEntity, LivingEntityRenderState, Modeltobysit> {
	private TobyLayEntity entity = null;
	...
	@Override
	public void extractRenderState(TobyLayEntity entity, LivingEntityRenderState state, float partialTicks) {
	...
	private static final class AnimatedModel extends Modeltobysit {
		...
		public void setEntity(TobyLayEntity entity) {
			this.entity = entity;
		}
