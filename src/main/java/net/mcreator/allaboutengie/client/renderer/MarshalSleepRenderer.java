...
public class MarshalSleepRenderer extends MobRenderer<MarshalSleepEntity, LivingEntityRenderState, Modeltobytired> {
	private MarshalSleepEntity entity = null;
	...
	@Override
	public void extractRenderState(MarshalSleepEntity entity, LivingEntityRenderState state, float partialTicks) {
	...
	private static final class AnimatedModel extends Modeltobytired {
		...
		public void setEntity(MarshalSleepEntity entity) {
			this.entity = entity;
		}
