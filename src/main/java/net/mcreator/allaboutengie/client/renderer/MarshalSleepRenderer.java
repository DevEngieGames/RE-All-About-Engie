...
public class MarshalSleepRenderer extends MobRenderer<MarshalSleepEntity, Modeltobytired<MarshalSleepEntity>> {
	...
	public ResourceLocation getTextureLocation(MarshalSleepEntity entity) {
		return ResourceLocation.parse("allaboutengie:textures/entities/marshaltired.png");
	}

	private static final class AnimatedModel extends Modeltobytired<MarshalSleepEntity> {
		private final ModelPart root;
		private final HierarchicalModel animator = new HierarchicalModel<MarshalSleepEntity>() {
			@Override
			...
			@Override
			public void setupAnim(MarshalSleepEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
