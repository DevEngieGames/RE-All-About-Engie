...
public class AlbinoSharkoLayOnSideRenderer extends MobRenderer<AlbinoSharkoLayOnSideEntity, LivingEntityRenderState, Modelboyolayonside> {
	private AlbinoSharkoLayOnSideEntity entity = null;
	...
	@Override
	public void extractRenderState(AlbinoSharkoLayOnSideEntity entity, LivingEntityRenderState state, float partialTicks) {
	...
	private static final class AnimatedModel extends Modelboyolayonside {
		...
		public void setEntity(AlbinoSharkoLayOnSideEntity entity) {
			this.entity = entity;
		}
