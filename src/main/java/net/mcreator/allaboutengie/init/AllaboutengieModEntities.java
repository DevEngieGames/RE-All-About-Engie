...
public class AllaboutengieModEntities {
	...
	public static final RegistryObject<EntityType<EngieSharkoRare2TamedZoomiesEntity>> TIGER_SHARKO_TAMED_ZOOMIES = register("tiger_sharko_tamed_zoomies",
			EntityType.Builder.<EngieSharkoRare2TamedZoomiesEntity>of(EngieSharkoRare2TamedZoomiesEntity::new, MobCategory.CREATURE).setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3)
					...
					.sized(0.7f, 0.9f));
	public static final RegistryObject<EntityType<EngieSharkoRare2ZoomiesTiredEntity>> TIGER_SHARKO_ZOOMIES_TIRED = register("tiger_sharko_zoomies_tired",
	...
	public static final RegistryObject<EntityType<FinneganZoomiesTiredEntity>> FINNEGAN_ZOOMIES_TIRED = register("finnegan_zoomies_tired",
			EntityType.Builder.<FinneganZoomiesTiredEntity>of(FinneganZoomiesTiredEntity::new, MobCategory.CREATURE).setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3)
					...
					.sized(0.7f, 0.6f));
	public static final RegistryObject<EntityType<ChampEntity>> CHAMP = register("champ",
			EntityType.Builder.<ChampEntity>of(ChampEntity::new, MobCategory.CREATURE).setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(ChampEntity::new)

					.sized(0.7f, 0.9f));
	public static final RegistryObject<EntityType<ChampLayEntity>> CHAMP_LAY = register("champ_lay",
			EntityType.Builder.<ChampLayEntity>of(ChampLayEntity::new, MobCategory.CREATURE).setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(ChampLayEntity::new)

					.sized(0.7f, 0.6f));
	public static final RegistryObject<EntityType<ChampSleepEntity>> CHAMP_SLEEP = register("champ_sleep",
			EntityType.Builder.<ChampSleepEntity>of(ChampSleepEntity::new, MobCategory.CREATURE).setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(ChampSleepEntity::new)

					.sized(0.7f, 0.6f));
	public static final RegistryObject<EntityType<ChampZoomiesEntity>> CHAMP_ZOOMIES = register("champ_zoomies",
			EntityType.Builder.<ChampZoomiesEntity>of(ChampZoomiesEntity::new, MobCategory.CREATURE).setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(ChampZoomiesEntity::new)

					.sized(0.6f, 0.9f));
	public static final RegistryObject<EntityType<ChampZoomiesTiredEntity>> CHAMP_ZOOMIES_TIRED = register("champ_zoomies_tired",
			EntityType.Builder.<ChampZoomiesTiredEntity>of(ChampZoomiesTiredEntity::new, MobCategory.CREATURE).setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(ChampZoomiesTiredEntity::new)

					.sized(0.6f, 1.8f));
	public static final RegistryObject<EntityType<SharkoSitEntity>> SHARKO_SIT = register("sharko_sit",
			EntityType.Builder.<SharkoSitEntity>of(SharkoSitEntity::new, MobCategory.CREATURE).setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(SharkoSitEntity::new)

					.sized(0.7f, 0.9f));
	public static final RegistryObject<EntityType<AlbinoSharkoSitEntity>> ALBINO_SHARKO_SIT = register("albino_sharko_sit",
			EntityType.Builder.<AlbinoSharkoSitEntity>of(AlbinoSharkoSitEntity::new, MobCategory.CREATURE).setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(AlbinoSharkoSitEntity::new)

					.sized(0.7f, 0.9f));
	public static final RegistryObject<EntityType<RareSharkoSitEntity>> RARE_SHARKO_SIT = register("rare_sharko_sit",
			EntityType.Builder.<RareSharkoSitEntity>of(RareSharkoSitEntity::new, MobCategory.CREATURE).setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(RareSharkoSitEntity::new)

					.sized(0.7f, 0.9f));
	public static final RegistryObject<EntityType<LegendarySharkoSitEntity>> LEGENDARY_SHARKO_SIT = register("legendary_sharko_sit",
			EntityType.Builder.<LegendarySharkoSitEntity>of(LegendarySharkoSitEntity::new, MobCategory.CREATURE).setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(LegendarySharkoSitEntity::new)

					.sized(0.7f, 0.9f));
	public static final RegistryObject<EntityType<MythicSharkoSitEntity>> MYTHIC_SHARKO_SIT = register("mythic_sharko_sit",
			EntityType.Builder.<MythicSharkoSitEntity>of(MythicSharkoSitEntity::new, MobCategory.CREATURE).setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(MythicSharkoSitEntity::new)

					.sized(0.7f, 0.9f));
	public static final RegistryObject<EntityType<ExoticSharkoSitEntity>> EXOTIC_SHARKO_SIT = register("exotic_sharko_sit",
			EntityType.Builder.<ExoticSharkoSitEntity>of(ExoticSharkoSitEntity::new, MobCategory.CREATURE).setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(ExoticSharkoSitEntity::new)

					.sized(0.7f, 0.9f));
	public static final RegistryObject<EntityType<EngieSharkoSitEntity>> ENGIE_SHARKO_SIT = register("engie_sharko_sit",
			EntityType.Builder.<EngieSharkoSitEntity>of(EngieSharkoSitEntity::new, MobCategory.CREATURE).setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(EngieSharkoSitEntity::new)

					.sized(0.7f, 0.9f));
	public static final RegistryObject<EntityType<EngieSharkoRareSitEntity>> ENGIE_SHARKO_RARE_SIT = register("engie_sharko_rare_sit",
			EntityType.Builder.<EngieSharkoRareSitEntity>of(EngieSharkoRareSitEntity::new, MobCategory.CREATURE).setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(EngieSharkoRareSitEntity::new)

					.sized(0.7f, 0.9f));
	public static final RegistryObject<EntityType<EngieSharkoRare2SitEntity>> TIGER_SHARKO_SIT = register("tiger_sharko_sit",
			EntityType.Builder.<EngieSharkoRare2SitEntity>of(EngieSharkoRare2SitEntity::new, MobCategory.CREATURE).setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(EngieSharkoRare2SitEntity::new)

					.sized(0.7f, 0.9f));
	public static final RegistryObject<EntityType<TobySitEntity>> TOBY_SIT = register("toby_sit",
			EntityType.Builder.<TobySitEntity>of(TobySitEntity::new, MobCategory.CREATURE).setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(TobySitEntity::new)
	...
	public static final RegistryObject<EntityType<TigerSitEntity>> TIGER_SIT = register("tiger_sit",
			EntityType.Builder.<TigerSitEntity>of(TigerSitEntity::new, MobCategory.CREATURE).setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(TigerSitEntity::new)
					...
					.sized(0.7f, 0.9f));
	public static final RegistryObject<EntityType<LouisSitEntity>> LOUIS_SIT = register("louis_sit",
			EntityType.Builder.<LouisSitEntity>of(LouisSitEntity::new, MobCategory.CREATURE).setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(LouisSitEntity::new)

					.sized(0.7f, 0.9f));
	public static final RegistryObject<EntityType<BuddySitEntity>> BUDDY_SIT = register("buddy_sit",
			EntityType.Builder.<BuddySitEntity>of(BuddySitEntity::new, MobCategory.CREATURE).setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(BuddySitEntity::new)

					.sized(0.7f, 0.9f));
	public static final RegistryObject<EntityType<ApolloSitEntity>> APOLLO_SIT = register("apollo_sit",
			EntityType.Builder.<ApolloSitEntity>of(ApolloSitEntity::new, MobCategory.CREATURE).setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(ApolloSitEntity::new)

					.sized(0.7f, 0.9f));
	public static final RegistryObject<EntityType<AtlasSitEntity>> ATLAS_SIT = register("atlas_sit",
			EntityType.Builder.<AtlasSitEntity>of(AtlasSitEntity::new, MobCategory.CREATURE).setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(AtlasSitEntity::new)

					.sized(0.7f, 0.9f));
	public static final RegistryObject<EntityType<CBESitEntity>> CBE_SIT = register("cbe_sit",
			EntityType.Builder.<CBESitEntity>of(CBESitEntity::new, MobCategory.CREATURE).setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CBESitEntity::new)

					.sized(0.7f, 0.9f));
	public static final RegistryObject<EntityType<PBESitEntity>> PBE_SIT = register("pbe_sit",
			EntityType.Builder.<PBESitEntity>of(PBESitEntity::new, MobCategory.CREATURE).setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(PBESitEntity::new)

					.sized(0.7f, 0.9f));
	public static final RegistryObject<EntityType<Bothan2netSitEntity>> BOTHAN_2NET_SIT = register("bothan_2net_sit",
			EntityType.Builder.<Bothan2netSitEntity>of(Bothan2netSitEntity::new, MobCategory.CREATURE).setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(Bothan2netSitEntity::new)

					.sized(0.7f, 0.9f));
	public static final RegistryObject<EntityType<EpicSharkoSitEntity>> EPIC_SHARKO_SIT = register("epic_sharko_sit",
			EntityType.Builder.<EpicSharkoSitEntity>of(EpicSharkoSitEntity::new, MobCategory.CREATURE).setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(EpicSharkoSitEntity::new)

					.sized(0.7f, 0.9f));
	public static final RegistryObject<EntityType<FinneganSitEntity>> FINNEGAN_SIT = register("finnegan_sit",
			EntityType.Builder.<FinneganSitEntity>of(FinneganSitEntity::new, MobCategory.CREATURE).setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(FinneganSitEntity::new)

					.sized(0.7f, 0.9f));
	public static final RegistryObject<EntityType<ChampSitEntity>> CHAMP_SIT = register("champ_sit",
			EntityType.Builder.<ChampSitEntity>of(ChampSitEntity::new, MobCategory.CREATURE).setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(ChampSitEntity::new)

					.sized(0.7f, 0.9f));
	public static final RegistryObject<EntityType<SharkoLayOnSideEntity>> SHARKO_LAY_ON_SIDE = register("sharko_lay_on_side",
			EntityType.Builder.<SharkoLayOnSideEntity>of(SharkoLayOnSideEntity::new, MobCategory.CREATURE).setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(SharkoLayOnSideEntity::new)

					.sized(0.7f, 0.6f));
	public static final RegistryObject<EntityType<AlbinoSharkoLayOnSideEntity>> ALBINO_SHARKO_LAY_ON_SIDE = register("albino_sharko_lay_on_side",
			EntityType.Builder.<AlbinoSharkoLayOnSideEntity>of(AlbinoSharkoLayOnSideEntity::new, MobCategory.CREATURE).setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3)
					.setCustomClientFactory(AlbinoSharkoLayOnSideEntity::new)

					.sized(0.7f, 0.6f));
	public static final RegistryObject<EntityType<RareSharkoLayOnSideEntity>> RARE_SHARKO_LAY_ON_SIDE = register("rare_sharko_lay_on_side",
			EntityType.Builder.<RareSharkoLayOnSideEntity>of(RareSharkoLayOnSideEntity::new, MobCategory.CREATURE).setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(RareSharkoLayOnSideEntity::new)

					.sized(0.7f, 0.6f));
	public static final RegistryObject<EntityType<LegendarySharkoLayOnSideEntity>> LEGENDARY_SHARKO_LAY_ON_SIDE = register("legendary_sharko_lay_on_side",
			EntityType.Builder.<LegendarySharkoLayOnSideEntity>of(LegendarySharkoLayOnSideEntity::new, MobCategory.CREATURE).setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3)
					.setCustomClientFactory(LegendarySharkoLayOnSideEntity::new)

					.sized(0.7f, 0.6f));
	public static final RegistryObject<EntityType<MythicSharkoLayOnSideEntity>> MYTHIC_SHARKO_LAY_ON_SIDE = register("mythic_sharko_lay_on_side",
			EntityType.Builder.<MythicSharkoLayOnSideEntity>of(MythicSharkoLayOnSideEntity::new, MobCategory.CREATURE).setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3)
					.setCustomClientFactory(MythicSharkoLayOnSideEntity::new)

					.sized(0.7f, 0.6f));
	public static final RegistryObject<EntityType<ExoticSharkoLayOnSideEntity>> EXOTIC_SHARKO_LAY_ON_SIDE = register("exotic_sharko_lay_on_side",
			EntityType.Builder.<ExoticSharkoLayOnSideEntity>of(ExoticSharkoLayOnSideEntity::new, MobCategory.CREATURE).setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3)
					.setCustomClientFactory(ExoticSharkoLayOnSideEntity::new)

					.sized(0.7f, 0.6f));
	public static final RegistryObject<EntityType<EngieSharkoLayOnSideEntity>> ENGIE_SHARKO_LAY_ON_SIDE = register("engie_sharko_lay_on_side",
			EntityType.Builder.<EngieSharkoLayOnSideEntity>of(EngieSharkoLayOnSideEntity::new, MobCategory.CREATURE).setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3)
					.setCustomClientFactory(EngieSharkoLayOnSideEntity::new)

					.sized(0.7f, 0.6f));
	public static final RegistryObject<EntityType<EngieSharkoRareLayOnSideEntity>> ENGIE_SHARKO_RARE_LAY_ON_SIDE = register("engie_sharko_rare_lay_on_side",
			EntityType.Builder.<EngieSharkoRareLayOnSideEntity>of(EngieSharkoRareLayOnSideEntity::new, MobCategory.CREATURE).setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3)
					.setCustomClientFactory(EngieSharkoRareLayOnSideEntity::new)

					.sized(0.7f, 0.6f));
	public static final RegistryObject<EntityType<EngieSharkoRare2LayOnSideEntity>> TIGER_SHARKO_LAY_ON_SIDE = register("tiger_sharko_lay_on_side",
			EntityType.Builder.<EngieSharkoRare2LayOnSideEntity>of(EngieSharkoRare2LayOnSideEntity::new, MobCategory.CREATURE).setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3)
					.setCustomClientFactory(EngieSharkoRare2LayOnSideEntity::new)

					.sized(0.7f, 0.6f));
	public static final RegistryObject<EntityType<EpicSharkoLayOnSideEntity>> EPIC_SHARKO_LAY_ON_SIDE = register("epic_sharko_lay_on_side",
			EntityType.Builder.<EpicSharkoLayOnSideEntity>of(EpicSharkoLayOnSideEntity::new, MobCategory.CREATURE).setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(EpicSharkoLayOnSideEntity::new)

					.sized(0.7f, 0.6f));
	public static final RegistryObject<EntityType<TobyLayOnSideEntity>> TOBY_LAY_ON_SIDE = register("toby_lay_on_side",
			EntityType.Builder.<TobyLayOnSideEntity>of(TobyLayOnSideEntity::new, MobCategory.CREATURE).setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(TobyLayOnSideEntity::new)

					.sized(0.7f, 0.6f));
	public static final RegistryObject<EntityType<MarshalLayOnSideEntity>> MARSHAL_LAY_ON_SIDE = register("marshal_lay_on_side",
			EntityType.Builder.<MarshalLayOnSideEntity>of(MarshalLayOnSideEntity::new, MobCategory.CREATURE).setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(MarshalLayOnSideEntity::new)

					.sized(0.7f, 0.6f));
	public static final RegistryObject<EntityType<TigerLayOnSideEntity>> TIGER_LAY_ON_SIDE = register("tiger_lay_on_side",
			EntityType.Builder.<TigerLayOnSideEntity>of(TigerLayOnSideEntity::new, MobCategory.CREATURE).setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(TigerLayOnSideEntity::new)

					.sized(0.7f, 0.6f));
	public static final RegistryObject<EntityType<LouisLayOnSideEntity>> LOUIS_LAY_ON_SIDE = register("louis_lay_on_side",
			EntityType.Builder.<LouisLayOnSideEntity>of(LouisLayOnSideEntity::new, MobCategory.CREATURE).setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(LouisLayOnSideEntity::new)

					.sized(0.7f, 0.6f));
	public static final RegistryObject<EntityType<BuddyLayOnSideEntity>> BUDDY_LAY_ON_SIDE = register("buddy_lay_on_side",
			EntityType.Builder.<BuddyLayOnSideEntity>of(BuddyLayOnSideEntity::new, MobCategory.CREATURE).setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(BuddyLayOnSideEntity::new)

					.sized(0.7f, 0.6f));
	public static final RegistryObject<EntityType<ApolloLayOnSideEntity>> APOLLO_LAY_ON_SIDE = register("apollo_lay_on_side",
			EntityType.Builder.<ApolloLayOnSideEntity>of(ApolloLayOnSideEntity::new, MobCategory.CREATURE).setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(ApolloLayOnSideEntity::new)

					.sized(0.7f, 0.6f));
	public static final RegistryObject<EntityType<AtlasLayOnSideEntity>> ATLAS_LAY_ON_SIDE = register("atlas_lay_on_side",
			EntityType.Builder.<AtlasLayOnSideEntity>of(AtlasLayOnSideEntity::new, MobCategory.CREATURE).setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(AtlasLayOnSideEntity::new)

					.sized(0.7f, 0.6f));
	public static final RegistryObject<EntityType<CBELayOnSideEntity>> CBE_LAY_ON_SIDE = register("cbe_lay_on_side",
			EntityType.Builder.<CBELayOnSideEntity>of(CBELayOnSideEntity::new, MobCategory.CREATURE).setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CBELayOnSideEntity::new)

					.sized(0.7f, 0.6f));
	public static final RegistryObject<EntityType<PBELayOnSideEntity>> PBE_LAY_ON_SIDE = register("pbe_lay_on_side",
			EntityType.Builder.<PBELayOnSideEntity>of(PBELayOnSideEntity::new, MobCategory.CREATURE).setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(PBELayOnSideEntity::new)

					.sized(0.7f, 0.6f));
	public static final RegistryObject<EntityType<Bothan2netLayOnSideEntity>> BOTHAN_2NET_LAY_ON_SIDE = register("bothan_2net_lay_on_side",
			EntityType.Builder.<Bothan2netLayOnSideEntity>of(Bothan2netLayOnSideEntity::new, MobCategory.CREATURE).setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(Bothan2netLayOnSideEntity::new)

					.sized(0.7f, 0.6f));
	public static final RegistryObject<EntityType<FinneganLayOnSideEntity>> FINNEGAN_LAY_ON_SIDE = register("finnegan_lay_on_side",
			EntityType.Builder.<FinneganLayOnSideEntity>of(FinneganLayOnSideEntity::new, MobCategory.CREATURE).setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(FinneganLayOnSideEntity::new)

					.sized(0.7f, 0.6f));
	public static final RegistryObject<EntityType<ChampLayOnSideEntity>> CHAMP_LAY_ON_SIDE = register("champ_lay_on_side",
			EntityType.Builder.<ChampLayOnSideEntity>of(ChampLayOnSideEntity::new, MobCategory.CREATURE).setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(ChampLayOnSideEntity::new)
	...
	public static final RegistryObject<EntityType<DistortedEntity>> DISTORTED = register("distorted", EntityType.Builder.<DistortedEntity>of(DistortedEntity::new, MobCategory.MONSTER).setShouldReceiveVelocityUpdates(true).setTrackingRange(500)
			.setUpdateInterval(3).setCustomClientFactory(DistortedEntity::new).fireImmune().sized(0.6f, 1.95f));
	public static final RegistryObject<EntityType<TheRealEngieGamesEntity>> THE_REAL_ENGIE_GAMES = register("the_real_engie_games",
			EntityType.Builder.<TheRealEngieGamesEntity>of(TheRealEngieGamesEntity::new, MobCategory.CREATURE).setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(TheRealEngieGamesEntity::new)
					...
					.sized(0.6f, 1.95f));
	public static final RegistryObject<EntityType<AlienEngieSharkoEntity>> ALIEN_ENGIE_SHARKO = register("alien_engie_sharko",
			EntityType.Builder.<AlienEngieSharkoEntity>of(AlienEngieSharkoEntity::new, MobCategory.CREATURE).setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(AlienEngieSharkoEntity::new)

					.sized(0.7f, 0.9f));
	public static final RegistryObject<EntityType<AlienEngieSharkoTamedEntity>> ALIEN_ENGIE_SHARKO_TAMED = register("alien_engie_sharko_tamed",
			EntityType.Builder.<AlienEngieSharkoTamedEntity>of(AlienEngieSharkoTamedEntity::new, MobCategory.CREATURE).setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3)
					.setCustomClientFactory(AlienEngieSharkoTamedEntity::new)

					.sized(0.7f, 0.9f));
	public static final RegistryObject<EntityType<RockyEntity>> ROCKY = register("rocky",
			EntityType.Builder.<RockyEntity>of(RockyEntity::new, MobCategory.CREATURE).setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(RockyEntity::new)

					.sized(0.7f, 0.9f));
	public static final RegistryObject<EntityType<RockyLayEntity>> ROCKY_LAY = register("rocky_lay",
			EntityType.Builder.<RockyLayEntity>of(RockyLayEntity::new, MobCategory.CREATURE).setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(RockyLayEntity::new)

					.sized(0.7f, 0.6f));
	public static final RegistryObject<EntityType<RockySleepEntity>> ROCKY_SLEEP = register("rocky_sleep",
			EntityType.Builder.<RockySleepEntity>of(RockySleepEntity::new, MobCategory.CREATURE).setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(RockySleepEntity::new)

					.sized(0.7f, 0.6f));
	public static final RegistryObject<EntityType<AlienEngieSharkoLayEntity>> ALIEN_ENGIE_SHARKO_LAY = register("alien_engie_sharko_lay",
	...
	public static void init(FMLCommonSetupEvent event) {
		event.enqueueWork(() -> {
			...
			ChampEntity.init();
			ChampLayEntity.init();
			ChampSleepEntity.init();
			ChampZoomiesEntity.init();
			ChampZoomiesTiredEntity.init();
			SharkoSitEntity.init();
			AlbinoSharkoSitEntity.init();
			RareSharkoSitEntity.init();
			LegendarySharkoSitEntity.init();
			MythicSharkoSitEntity.init();
			ExoticSharkoSitEntity.init();
			EngieSharkoSitEntity.init();
			EngieSharkoRareSitEntity.init();
			EngieSharkoRare2SitEntity.init();
			TobySitEntity.init();
			MarshalSitEntity.init();
			TigerSitEntity.init();
			LouisSitEntity.init();
			BuddySitEntity.init();
			ApolloSitEntity.init();
			AtlasSitEntity.init();
			CBESitEntity.init();
			PBESitEntity.init();
			Bothan2netSitEntity.init();
			EpicSharkoSitEntity.init();
			FinneganSitEntity.init();
			ChampSitEntity.init();
			SharkoLayOnSideEntity.init();
			AlbinoSharkoLayOnSideEntity.init();
			RareSharkoLayOnSideEntity.init();
			LegendarySharkoLayOnSideEntity.init();
			MythicSharkoLayOnSideEntity.init();
			ExoticSharkoLayOnSideEntity.init();
			EngieSharkoLayOnSideEntity.init();
			EngieSharkoRareLayOnSideEntity.init();
			EngieSharkoRare2LayOnSideEntity.init();
			EpicSharkoLayOnSideEntity.init();
			TobyLayOnSideEntity.init();
			MarshalLayOnSideEntity.init();
			TigerLayOnSideEntity.init();
			LouisLayOnSideEntity.init();
			BuddyLayOnSideEntity.init();
			ApolloLayOnSideEntity.init();
			AtlasLayOnSideEntity.init();
			CBELayOnSideEntity.init();
			PBELayOnSideEntity.init();
			Bothan2netLayOnSideEntity.init();
			FinneganLayOnSideEntity.init();
			ChampLayOnSideEntity.init();
			DistortedEntity.init();
			TheRealEngieGamesEntity.init();
			AlienEngieSharkoEntity.init();
			AlienEngieSharkoTamedEntity.init();
			RockyEntity.init();
			RockyLayEntity.init();
