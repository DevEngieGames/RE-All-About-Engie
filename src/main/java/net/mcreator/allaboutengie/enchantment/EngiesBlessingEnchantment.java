...
public class EngiesBlessingEnchantment extends Enchantment {
	private static final EnchantmentCategory ENCHANTMENT_CATEGORY = EnchantmentCategory.create("allaboutengie_engies_blessing", item -> Ingredient.of(new ItemStack(AllaboutengieModItems.ECHDEATH.get()),
			new ItemStack(AllaboutengieModItems.ECHDEATH_PIXEL.get()), new ItemStack(AllaboutengieModItems.ENGIES_SCYTHE.get()), new ItemStack(AllaboutengieModItems.ENGIES_SCYTHE_PIXEL.get()),
			new ItemStack(AllaboutengieModItems.MINI_BAN_HAMMER.get()), new ItemStack(AllaboutengieModItems.BAN_HAMMER.get()), new ItemStack(AllaboutengieModItems.BIG_BAN_HAMMER.get()), new ItemStack(AllaboutengieModItems.LARGE_BAN_HAMMER.get()),
			new ItemStack(AllaboutengieModItems.HUGE_BAN_HAMMER.get()), new ItemStack(AllaboutengieModItems.MINI_BAN_HAMMER_PIXEL.get()), new ItemStack(AllaboutengieModItems.ENORMOUS_BAN_HAMMER.get()),
			new ItemStack(AllaboutengieModItems.GIGANTIC_BAN_HAMMER.get()), new ItemStack(AllaboutengieModItems.MASSIVE_BAN_HAMMER.get()), new ItemStack(AllaboutengieModItems.BAN_HAMMER_PIXEL.get()),
			new ItemStack(AllaboutengieModItems.BIG_BAN_HAMMER_PIXEL.get()), new ItemStack(AllaboutengieModItems.LARGE_BAN_HAMMER_PIXEL.get()), new ItemStack(AllaboutengieModItems.HUGE_BAN_HAMMER_PIXEL.get()),
			new ItemStack(AllaboutengieModItems.ENORMOUS_BAN_HAMMER_PIXEL.get()), new ItemStack(AllaboutengieModItems.GIGANTIC_BAN_HAMMER_PIXEL.get()), new ItemStack(AllaboutengieModItems.MASSIVE_BAN_HAMMER_PIXEL.get()),
			new ItemStack(AllaboutengieModItems.CODE_REDEEMERS_HAMMER.get()), new ItemStack(AllaboutengieModItems.CODE_REDEEMERS_HAMMER_PIXEL.get()), new ItemStack(AllaboutengieModItems.COMMON_SWORD.get()),
			new ItemStack(AllaboutengieModItems.UNCOMMON_SWORD.get()), new ItemStack(AllaboutengieModItems.RARE_SWORD.get()), new ItemStack(AllaboutengieModItems.EPIC_SWORD.get()), new ItemStack(AllaboutengieModItems.LEGENDARY_SWORD.get()),
			new ItemStack(AllaboutengieModItems.MYTHIC_SWORD.get()), new ItemStack(AllaboutengieModItems.EXOTIC_SWORD.get()), new ItemStack(AllaboutengieModItems.UNOBTAINIUM_SWORD.get()),
			new ItemStack(AllaboutengieModItems.BIBLICALLY_ACCURATE_ENGIE_BAN_HAMMER.get()), new ItemStack(AllaboutengieModItems.BIBLICALLY_ACCURATE_ENGIE_BAN_HAMMER_PIXEL.get()), new ItemStack(AllaboutengieModItems.MONSTROSITY_BAN_HAMMER.get()),
			new ItemStack(AllaboutengieModItems.MONSTROSITY_BAN_HAMMER_PIXEL.get()), new ItemStack(AllaboutengieModItems.HWG_SCYTHE.get()), new ItemStack(AllaboutengieModItems.DOOMSDAY_SCYTHE.get()),
			new ItemStack(AllaboutengieModItems.SUPER_DOOMSDAY_SCYTHE.get()), new ItemStack(AllaboutengieModItems.THE_END_SCYTHE.get()), new ItemStack(AllaboutengieModItems.ENGIE_SCYTHE.get()), new ItemStack(AllaboutengieModItems.MINI_SCYTHE.get()),
			new ItemStack(AllaboutengieModItems.SCYTHE.get()), new ItemStack(AllaboutengieModItems.BIG_SCYTHE.get()), new ItemStack(AllaboutengieModItems.LARGE_SCYTHE.get()), new ItemStack(AllaboutengieModItems.HUGE_SCYTHE.get()),
			new ItemStack(AllaboutengieModItems.ENORMOUS_SCYTHE.get()), new ItemStack(AllaboutengieModItems.GIGANTIC_SCYTHE.get()), new ItemStack(AllaboutengieModItems.MASSIVE_SCYTHE.get()),
			...
			new ItemStack(AllaboutengieModItems.A_REAL_BAN_HAMMER.get()), new ItemStack(AllaboutengieModItems.A_REAL_BAN_HAMMER_PIXEL.get()), new ItemStack(Items.WOODEN_SWORD), new ItemStack(Items.STONE_SWORD), new ItemStack(Items.IRON_SWORD),
			new ItemStack(Items.DIAMOND_SWORD), new ItemStack(Items.NETHERITE_SWORD), new ItemStack(AllaboutengieModItems.OPERATORS_HELMET.get()), new ItemStack(AllaboutengieModItems.OPERATORS_CHESTPLATE.get()),
			...
			new ItemStack(Items.LEATHER_LEGGINGS), new ItemStack(Items.LEATHER_BOOTS), new ItemStack(Items.CHAINMAIL_HELMET), new ItemStack(Items.CHAINMAIL_CHESTPLATE), new ItemStack(Items.CHAINMAIL_LEGGINGS), new ItemStack(Items.CHAINMAIL_BOOTS),
			new ItemStack(Items.TURTLE_HELMET), new ItemStack(Items.IRON_HELMET), new ItemStack(Items.IRON_CHESTPLATE), new ItemStack(Items.IRON_LEGGINGS), new ItemStack(Items.IRON_BOOTS), new ItemStack(Items.GOLDEN_HELMET),
			new ItemStack(Items.GOLDEN_CHESTPLATE), new ItemStack(Items.GOLDEN_LEGGINGS), new ItemStack(Items.GOLDEN_BOOTS), new ItemStack(Items.DIAMOND_HELMET), new ItemStack(Items.DIAMOND_CHESTPLATE), new ItemStack(Items.DIAMOND_LEGGINGS),
			new ItemStack(Items.DIAMOND_BOOTS), new ItemStack(Items.NETHERITE_HELMET), new ItemStack(Items.NETHERITE_CHESTPLATE), new ItemStack(Items.NETHERITE_LEGGINGS), new ItemStack(Items.NETHERITE_BOOTS)).test(new ItemStack(item)));
