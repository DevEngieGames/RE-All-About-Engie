...
public class EngieBlessingBlockBreaking15Procedure {
	public static void execute(LevelAccessor world, double x, double y, double z) {
		if ((world.getBlockState(BlockPos.containing(x, y, z))).getBlock() == AllaboutengieModBlocks.ENGIE_ORE.get() || (world.getBlockState(BlockPos.containing(x, y, z))).getBlock() == AllaboutengieModBlocks.DEEPSLATE_ENGIE_ORE.get()) {
			if (Math.random() <= 0.15) {
		...
		} else if ((world.getBlockState(BlockPos.containing(x, y, z))).getBlock() == AllaboutengieModBlocks.UNOBTAINIUM_ORE.get()
				|| (world.getBlockState(BlockPos.containing(x, y, z))).getBlock() == AllaboutengieModBlocks.DEEPSLATE_UNOBTAINIUM_ORE.get()) {
			if (Math.random() <= 0.15) {
				if (world instanceof ServerLevel _level) {
		...
		} else if ((world.getBlockState(BlockPos.containing(x, y, z))).getBlock() == Blocks.DIAMOND_ORE || (world.getBlockState(BlockPos.containing(x, y, z))).getBlock() == Blocks.DIAMOND_ORE) {
			if (Math.random() <= 0.15) {
				if (world instanceof ServerLevel _level) {
		...
		} else if ((world.getBlockState(BlockPos.containing(x, y, z))).getBlock() == AllaboutengieModBlocks.CYBER_ORE.get()) {
			if (Math.random() <= 0.15) {
				if (Math.random() <= 0.49) {
					if (world instanceof ServerLevel _level) {
		...
		} else if ((world.getBlockState(BlockPos.containing(x, y, z))).getBlock() == AllaboutengieModBlocks.BLOOD_ORE.get()) {
			if (Math.random() <= 0.15) {
				if (Math.random() <= 0.49) {
					if (world instanceof ServerLevel _level) {
