...
public class AntimatterDoomsdayTradeButtonClickedProcedure {
	public static void execute(LevelAccessor world, Entity entity) {
		...
		if ((entity instanceof Player _plrSlotItem && _plrSlotItem.containerMenu instanceof AllaboutengieModMenus.MenuAccessor _menu0 ? _menu0.getSlots().get(2).getItem() : ItemStack.EMPTY)
				.getItem() == AllaboutengieModItems.ANTIMATTER_DOOMSDAY_CRUCIFIX.get()) {
			...
			AllaboutengieMod.queueServerWork(1, () -> {
				...
				.getItem() == AllaboutengieModItems.ANTIMATTER_DOOMSDAY_SCYTHE.get()
				|| (entity instanceof Player _plrSlotItem && _plrSlotItem.containerMenu instanceof AllaboutengieModMenus.MenuAccessor _menu9 ? _menu9.getSlots().get(2).getItem() : ItemStack.EMPTY)
						.getItem() == AllaboutengieModItems.ANTIMATTER_DOOMSDAY_BAN_HAMMER.get()) {
			if ((entity instanceof Player _entity11 && _entity11.containerMenu instanceof AllaboutengieModMenus.MenuAccessor _menu11) ? _menu11.getMenuState(1, "scythetrade", false) : false) {
				...
				.getItem() == AllaboutengieModItems.ANTIMATTER_DOOMSDAYS_BOOTS.get()) {
			if (entity instanceof Player _player && _player.containerMenu instanceof AllaboutengieModMenus.MenuAccessor _menu) {
				_menu.getSlots().get(0).remove(64);
				_player.containerMenu.broadcastChanges();
			}
			...
			AllaboutengieMod.queueServerWork(1, () -> {
				...
				.getItem() == AllaboutengieModItems.ANTIMATTER_DOOMSDAYS_LEGGINGS.get()) {
			if (entity instanceof Player _player && _player.containerMenu instanceof AllaboutengieModMenus.MenuAccessor _menu) {
				_menu.getSlots().get(0).remove(64);
				_player.containerMenu.broadcastChanges();
			}
			...
			AllaboutengieMod.queueServerWork(1, () -> {
				...
				.getItem() == AllaboutengieModItems.ANTIMATTER_DOOMSDAYS_CHESTPLATE.get()) {
			if (entity instanceof Player _player && _player.containerMenu instanceof AllaboutengieModMenus.MenuAccessor _menu) {
				_menu.getSlots().get(0).remove(64);
				_player.containerMenu.broadcastChanges();
			}
			...
			AllaboutengieMod.queueServerWork(1, () -> {
				...
				.getItem() == AllaboutengieModItems.ANTIMATTER_DOOMSDAY_HOE.get()) {
			if (entity instanceof Player _player && _player.containerMenu instanceof AllaboutengieModMenus.MenuAccessor _menu) {
			...
			AllaboutengieMod.queueServerWork(1, () -> {
				...
				.getItem() == AllaboutengieModItems.ANTIMATTER_DOOMSDAY_SHOVEL.get()) {
			if (entity instanceof Player _player && _player.containerMenu instanceof AllaboutengieModMenus.MenuAccessor _menu) {
			...
			AllaboutengieMod.queueServerWork(1, () -> {
				...
				.getItem() == AllaboutengieModItems.ANTIMATTER_DOOMSDAY_AXE.get()) {
			if (entity instanceof Player _player && _player.containerMenu instanceof AllaboutengieModMenus.MenuAccessor _menu) {
			...
			AllaboutengieMod.queueServerWork(1, () -> {
				...
				.getItem() == AllaboutengieModItems.ANTIMATTER_DOOMSDAY_PICKAXE.get()) {
			if (entity instanceof Player _player && _player.containerMenu instanceof AllaboutengieModMenus.MenuAccessor _menu) {
			...
			AllaboutengieMod.queueServerWork(1, () -> {
				...
				.getItem() == AllaboutengieModItems.ANTIMATTER_DOOMSDAY_SWORD.get()) {
			if (entity instanceof Player _player && _player.containerMenu instanceof AllaboutengieModMenus.MenuAccessor _menu) {
