...
public class RareTameRCProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity, Entity sourceentity) {
		...
		if ((sourceentity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getItem() == Items.COOKIE) {
			...
			AllaboutengieMod.queueServerWork(1, () -> {
				if ((findEntityInWorldRange(world, RareSharkoSitEntity.class, x, y, z, 1)) instanceof RareSharkoSitEntity) {
					if (!(entity.getDisplayName().getString()).equals("Rare Sharko")) {
						(findEntityInWorldRange(world, RareSharkoSitEntity.class, x, y, z, 1)).setCustomName(Component.literal((entity.getDisplayName().getString())));
					}
				}
				if ((findEntityInWorldRange(world, RareSharkoSitEntity.class, x, y, z, 1)) instanceof LivingEntity _entity)
