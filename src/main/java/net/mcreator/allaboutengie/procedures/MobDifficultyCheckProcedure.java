...
public class MobDifficultyCheckProcedure {
	...
	private static void execute(@Nullable Event event, LevelAccessor world, Advancement advancement) {
		...
		if (world instanceof Level _lvl0 && _lvl0.getServer() != null && _lvl0.getServer().getAdvancements().getAdvancement(ResourceLocation.parse("allaboutengie:big_ban_obtain")).equals(advancement)) {
		...
		} else if (world instanceof Level _lvl1 && _lvl1.getServer() != null && _lvl1.getServer().getAdvancements().getAdvancement(ResourceLocation.parse("allaboutengie:large_ban_obtain")).equals(advancement)) {
		...
		} else if (world instanceof Level _lvl2 && _lvl2.getServer() != null && _lvl2.getServer().getAdvancements().getAdvancement(ResourceLocation.parse("allaboutengie:huge_ban_obtain")).equals(advancement)) {
		...
		} else if (world instanceof Level _lvl3 && _lvl3.getServer() != null && _lvl3.getServer().getAdvancements().getAdvancement(ResourceLocation.parse("allaboutengie:enormous_ban_obtain")).equals(advancement)) {
		...
		} else if (world instanceof Level _lvl4 && _lvl4.getServer() != null && _lvl4.getServer().getAdvancements().getAdvancement(ResourceLocation.parse("allaboutengie:gigantic_ban_obtain")).equals(advancement)) {
		...
		} else if (world instanceof Level _lvl5 && _lvl5.getServer() != null && _lvl5.getServer().getAdvancements().getAdvancement(ResourceLocation.parse("allaboutengie:massive_ban_obtain")).equals(advancement)) {
		...
		} else if (world instanceof Level _lvl6 && _lvl6.getServer() != null && _lvl6.getServer().getAdvancements().getAdvancement(ResourceLocation.parse("allaboutengie:biblically_accurate_ban_obtain")).equals(advancement)) {
		...
		} else if (world instanceof Level _lvl7 && _lvl7.getServer() != null && _lvl7.getServer().getAdvancements().getAdvancement(ResourceLocation.parse("allaboutengie:monstrosity_ban_obtain")).equals(advancement)) {
		...
		} else if (world instanceof Level _lvl8 && _lvl8.getServer() != null && _lvl8.getServer().getAdvancements().getAdvancement(ResourceLocation.parse("allaboutengie:doomsday_ban_scythe_obtain")).equals(advancement)) {
		...
		} else if (world instanceof Level _lvl9 && _lvl9.getServer() != null && _lvl9.getServer().getAdvancements().getAdvancement(ResourceLocation.parse("allaboutengie:super_doomsday_ban_scythe_obtain")).equals(advancement)) {
		...
		} else if (world instanceof Level _lvl10 && _lvl10.getServer() != null && _lvl10.getServer().getAdvancements().getAdvancement(ResourceLocation.parse("allaboutengie:the_end_ban_scythe_obtain")).equals(advancement)) {
		...
		} else if (world instanceof Level _lvl11 && _lvl11.getServer() != null && _lvl11.getServer().getAdvancements().getAdvancement(ResourceLocation.parse("allaboutengie:engies_ban_scythe_obtain")).equals(advancement)) {
		...
		} else if (world instanceof Level _lvl12 && _lvl12.getServer() != null && _lvl12.getServer().getAdvancements().getAdvancement(ResourceLocation.parse("allaboutengie:mindscape_ban_scythe_obtain")).equals(advancement)) {
