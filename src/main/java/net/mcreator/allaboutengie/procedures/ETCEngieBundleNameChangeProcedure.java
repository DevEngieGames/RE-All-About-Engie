...
public class ETCEngieBundleNameChangeProcedure {
	public static void execute(Entity entity, HashMap guistate) {
		...
		if ((entity instanceof LivingEntity _livEnt ? _livEnt.getOffhandItem() : ItemStack.EMPTY).getItem() == AllaboutengieModItems.DEVELOPER_ENGIE_BUNDLE.get()) {
			...
			new ItemStack(AllaboutengieModItems.DEVELOPER_ENGIE_BUNDLE.get()).setHoverName(Component.literal((guistate.containsKey("text:ChangeBundleName") ? ((EditBox) guistate.get("text:ChangeBundleName")).getValue() : "")));
			new ItemStack(AllaboutengieModItems.IDEAGIVER_ENGIE_BUNDLE.get()).setHoverName(Component.literal((guistate.containsKey("text:ChangeBundleName") ? ((EditBox) guistate.get("text:ChangeBundleName")).getValue() : "")));
			new ItemStack(AllaboutengieModItems.TESTER_ENGIE_BUNDLE.get()).setHoverName(Component.literal((guistate.containsKey("text:ChangeBundleName") ? ((EditBox) guistate.get("text:ChangeBundleName")).getValue() : "")));
			new ItemStack(AllaboutengieModItems.CONTENT_CREATOR_ENGIE_BUNDLE.get()).setHoverName(Component.literal((guistate.containsKey("text:ChangeBundleName") ? ((EditBox) guistate.get("text:ChangeBundleName")).getValue() : "")));
		}
	}
}
