...
public class CongratsProcedure {
	...
	private static void execute(@Nullable Event event, LevelAccessor world, Entity entity) {
																													...
																													if (entity instanceof ServerPlayer _plr27 && _plr27.level() instanceof ServerLevel
																														...
																														if (entity instanceof ServerPlayer _plr28 && _plr28.level() instanceof ServerLevel
																																&& _plr28.getAdvancements().getOrStartProgress(
																																		...
																																		.isDone()) {
																															if ((world instanceof ServerLevel _serverLevelGR29
																																	&& _serverLevelGR29.getGameRules().getBoolean(AllaboutengieModGameRules.DOOMSDAY_TOGGLE)) == true) {
																																if (entity instanceof ServerPlayer _plr30 && _plr30.level() instanceof ServerLevel
																																		&& _plr30.getAdvancements()
																																				.getOrStartProgress(
																																						_plr30.server.getAdvancements().get(ResourceLocation.parse("allaboutengie:conqueror")))
																																				.isDone()) {
																																	if (entity instanceof ServerPlayer _plr31 && _plr31.level() instanceof ServerLevel
																																			&& _plr31.getAdvancements()
																																					.getOrStartProgress(_plr31.server.getAdvancements().get(ResourceLocation.parse("allaboutengie:rise")))
																																					.isDone()) {
																																		if (entity instanceof ServerPlayer _plr32 && _plr32.level() instanceof ServerLevel
																																				&& _plr32.getAdvancements().getOrStartProgress(
																																						_plr32.server.getAdvancements().get(ResourceLocation.parse("allaboutengie:sdday_conqueror")))
																																						.isDone()) {
																																			if (!(entity instanceof ServerPlayer _plr33 && _plr33.level() instanceof ServerLevel
																																					&& _plr33.getAdvancements()
																																							.getOrStartProgress(
																																									_plr33.server.getAdvancements().get(ResourceLocation.parse("allaboutengie:all_done")))
																																							.isDone())) {
																																				if (entity instanceof ServerPlayer _player) {
																																					AdvancementHolder _adv = _player.server.getAdvancements()
																																							.get(ResourceLocation.parse("allaboutengie:all_done"));
																																					if (_adv != null) {
																																			...
																																			if (entity instanceof ServerPlayer _plr35 && _plr35.level() instanceof ServerLevel
																																				...
																																				if (!(entity instanceof ServerPlayer _plr36 && _plr36.level() instanceof ServerLevel
																																						&& _plr36.getAdvancements().getOrStartProgress(_plr36.server.getAdvancements()
																																								.get(ResourceLocation.parse("allaboutengie:all_fully_done"))).isDone())) {
																																					if (entity instanceof ServerPlayer _player) {
																																						AdvancementHolder _adv = _player.server.getAdvancements()
																																								.get(ResourceLocation.parse("allaboutengie:all_fully_done"));
																																						if (_adv != null) {
																																							AdvancementProgress _ap = _player.getAdvancements().getOrStartProgress(_adv);
																																							if (!_ap.isDone()) {
																																								for (String criteria : _ap.getRemainingCriteria())
																																	...
																																	&& (world instanceof ServerLevel _serverLevelGR38
																																			&& _serverLevelGR38.getGameRules().getBoolean(AllaboutengieModGameRules.DOOMSDAY_TOGGLE)) == true) {
																																if (entity instanceof ServerPlayer _plr39 && _plr39.level() instanceof ServerLevel
																																		&& _plr39.getAdvancements().getOrStartProgress(
																																				_plr39.server.getAdvancements().get(ResourceLocation.parse("allaboutengie:mini_ban_challenge_obtain")))
																																				.isDone()) {
																																	if (entity instanceof ServerPlayer _plr40 && _plr40.level() instanceof ServerLevel
																																			&& _plr40.getAdvancements().getOrStartProgress(
																																					_plr40.server.getAdvancements().get(ResourceLocation.parse("allaboutengie:ban_challenge_obtain")))
																																					.isDone()) {
																																		if (entity instanceof ServerPlayer _plr41
																																				&& _plr41
																																						.level() instanceof ServerLevel
																																				&& _plr41.getAdvancements().getOrStartProgress(_plr41.server.getAdvancements()
																																						.get(ResourceLocation.parse("allaboutengie:big_ban_challenge_obtain"))).isDone()) {
																																			if (entity instanceof ServerPlayer _plr42
																																					&& _plr42
																																							.level() instanceof ServerLevel
																																					&& _plr42.getAdvancements().getOrStartProgress(_plr42.server.getAdvancements()
																																							.get(ResourceLocation.parse("allaboutengie:large_ban_challenge_obtain"))).isDone()) {
																																				if (entity instanceof ServerPlayer _plr43 && _plr43.level() instanceof ServerLevel
																																						&& _plr43.getAdvancements()
																																								.getOrStartProgress(_plr43.server.getAdvancements()
																																										.get(ResourceLocation.parse("allaboutengie:huge_ban_challenge_obtain")))
																																								.isDone()) {
																																					if (entity instanceof ServerPlayer _plr44 && _plr44.level() instanceof ServerLevel
																																							&& _plr44.getAdvancements()
																																									.getOrStartProgress(_plr44.server.getAdvancements()
																																											.get(ResourceLocation.parse("allaboutengie:enormous_ban_challenge_obtain")))
																																									.isDone()) {
																																						if (entity instanceof ServerPlayer _plr45 && _plr45.level() instanceof ServerLevel
																																								&& _plr45.getAdvancements()
																																										.getOrStartProgress(_plr45.server.getAdvancements().get(
																																							...
																																							if (entity instanceof ServerPlayer _plr46 && _plr46.level() instanceof ServerLevel
																																									&& _plr46.getAdvancements()
																																											.getOrStartProgress(_plr46.server.getAdvancements().get(
																																								...
																																								if (entity instanceof ServerPlayer _plr47 && _plr47.level() instanceof ServerLevel
																																										&& _plr47.getAdvancements()
																																												.getOrStartProgress(_plr47.server.getAdvancements().get(ResourceLocation
																																										...
																																										if (entity instanceof ServerPlayer _plr49 && _plr49.level() instanceof ServerLevel
																																											...
																																											if (entity instanceof ServerPlayer _plr51
																																													...
																																													&& _plr51.getAdvancements()
																																															.getOrStartProgress(_plr51.server.getAdvancements().get(
																																																	ResourceLocation.parse("allaboutengie:conqueror")))
																																															.isDone()) {
																																												if (entity instanceof ServerPlayer _plr52
																																														&& _plr52.level() instanceof ServerLevel
																																														&& _plr52.getAdvancements()
																																																.getOrStartProgress(_plr52.server.getAdvancements().get(
																																															...
																																															if (!(entity instanceof ServerPlayer _plr57
																																																...
																																																if (entity instanceof ServerPlayer _player) {
																																																	AdvancementHolder _adv = _player.server
																																																			.getAdvancements().get(ResourceLocation.parse(
																																																					"allaboutengie:all_fully_done"));
																																																	if (_adv != null) {
																																	...
																																	&& (world instanceof ServerLevel _serverLevelGR59
																																			&& _serverLevelGR59.getGameRules().getBoolean(AllaboutengieModGameRules.DETECTIVE_MODE)) == true) {
																																if (entity instanceof ServerPlayer _plr60 && _plr60.level() instanceof ServerLevel
																																		&& _plr60.getAdvancements().getOrStartProgress(
																																				_plr60.server.getAdvancements().get(ResourceLocation.parse("allaboutengie:mini_ban_challenge_obtain")))
																																				.isDone()) {
																																	if (entity instanceof ServerPlayer _plr61 && _plr61.level() instanceof ServerLevel
																																			&& _plr61.getAdvancements().getOrStartProgress(
																																					_plr61.server.getAdvancements().get(ResourceLocation.parse("allaboutengie:ban_challenge_obtain")))
																																					.isDone()) {
																																		if (entity instanceof ServerPlayer _plr62
																																				&& _plr62
																																						.level() instanceof ServerLevel
																																				&& _plr62.getAdvancements().getOrStartProgress(_plr62.server.getAdvancements()
																																						.get(ResourceLocation.parse("allaboutengie:big_ban_challenge_obtain"))).isDone()) {
																																			if (entity instanceof ServerPlayer _plr63
																																					&& _plr63
																																							.level() instanceof ServerLevel
																																					&& _plr63.getAdvancements().getOrStartProgress(_plr63.server.getAdvancements()
																																							.get(ResourceLocation.parse("allaboutengie:large_ban_challenge_obtain"))).isDone()) {
																																										...
																																										if (entity instanceof ServerPlayer _plr70 && _plr70.level() instanceof ServerLevel
																																											...
																																											if (entity instanceof ServerPlayer _plr72
																																													...
																																													&& _plr72.getAdvancements()
																																															.getOrStartProgress(_plr72.server.getAdvancements().get(
																																																	ResourceLocation.parse("allaboutengie:found_engie")))
																																															.isDone()) {
																																												if (!(entity instanceof ServerPlayer _plr73
																																														&& _plr73.level() instanceof ServerLevel
																																														&& _plr73.getAdvancements()
																																																.getOrStartProgress(_plr73.server.getAdvancements().get(
																															...
																															} else if ((world instanceof ServerLevel _serverLevelGR78
																																	&& _serverLevelGR78.getGameRules().getBoolean(AllaboutengieModGameRules.DETECTIVE_MODE)) == true
																																	&& AllaboutengieModVariables.MapVariables.get(world).ChallengeToggle == true
																																	&& (world instanceof ServerLevel _serverLevelGR79
																																			&& _serverLevelGR79.getGameRules().getBoolean(AllaboutengieModGameRules.DOOMSDAY_TOGGLE)) == true) {
																																if (entity instanceof ServerPlayer _plr80 && _plr80.level() instanceof ServerLevel
																																		&& _plr80.getAdvancements().getOrStartProgress(
																																				_plr80.server.getAdvancements().get(ResourceLocation.parse("allaboutengie:mini_ban_challenge_obtain")))
																																				.isDone()) {
																																	if (entity instanceof ServerPlayer _plr81 && _plr81.level() instanceof ServerLevel
																																			&& _plr81.getAdvancements().getOrStartProgress(
																																					_plr81.server.getAdvancements().get(ResourceLocation.parse("allaboutengie:ban_challenge_obtain")))
																																					.isDone()) {
																																		if (entity instanceof ServerPlayer _plr82
																																				&& _plr82
																																						.level() instanceof ServerLevel
																																				&& _plr82.getAdvancements().getOrStartProgress(_plr82.server.getAdvancements()
																																						.get(ResourceLocation.parse("allaboutengie:big_ban_challenge_obtain"))).isDone()) {
																																			if (entity instanceof ServerPlayer _plr83
																																					&& _plr83
																																							.level() instanceof ServerLevel
																																					&& _plr83.getAdvancements().getOrStartProgress(_plr83.server.getAdvancements()
																																							.get(ResourceLocation.parse("allaboutengie:large_ban_challenge_obtain"))).isDone()) {
																																										...
																																										if (entity instanceof ServerPlayer _plr90 && _plr90.level() instanceof ServerLevel
																																											...
																																											if (entity instanceof ServerPlayer _plr92
																																													...
																																													&& _plr92.getAdvancements()
																																															.getOrStartProgress(_plr92.server.getAdvancements().get(
																																																	ResourceLocation.parse("allaboutengie:conqueror")))
																																															.isDone()) {
																																												if (entity instanceof ServerPlayer _plr93
																																														&& _plr93.level() instanceof ServerLevel
																																														&& _plr93.getAdvancements()
																																																.getOrStartProgress(_plr93.server.getAdvancements().get(
																																																		ResourceLocation.parse("allaboutengie:rise")))
																																																.isDone()) {
																																													if (entity instanceof ServerPlayer _plr94
																																														...
																																														if (entity instanceof ServerPlayer _plr95
																																															...
																																															if (!(entity instanceof ServerPlayer _plr96
																																																...
																																																if (entity instanceof ServerPlayer _player) {
																																																	AdvancementHolder _adv = _player.server
																																																			.getAdvancements().get(ResourceLocation
																																																					.parse("allaboutengie:all_done"));
																																																	if (_adv != null) {
																																																		AdvancementProgress _ap = _player
																																																				.getAdvancements()
																															...
																															} else if ((world instanceof ServerLevel _serverLevelGR101
																																	&& _serverLevelGR101.getGameRules().getBoolean(AllaboutengieModGameRules.DETECTIVE_MODE)) == true) {
																																if (entity instanceof ServerPlayer _plr102 && _plr102.level() instanceof ServerLevel
																																		&& _plr102.getAdvancements()
																																				.getOrStartProgress(
																																						_plr102.server.getAdvancements().get(ResourceLocation.parse("allaboutengie:found_engie")))
																																				.isDone()) {
																																	if (!(entity instanceof ServerPlayer _plr103 && _plr103.level() instanceof ServerLevel
																																			&& _plr103.getAdvancements()
																																					.getOrStartProgress(
																																							_plr103.server.getAdvancements().get(ResourceLocation.parse("allaboutengie:all_done")))
																																					.isDone())) {
																																		if (entity instanceof ServerPlayer _player) {
																																			AdvancementHolder _adv = _player.server.getAdvancements()
																																					.get(ResourceLocation.parse("allaboutengie:all_done"));
																																	...
																																	if (entity instanceof ServerPlayer _plr105
																																			&& _plr105
																																					.level() instanceof ServerLevel
																																			&& _plr105.getAdvancements().getOrStartProgress(_plr105.server.getAdvancements()
																																					.get(ResourceLocation.parse("allaboutengie:secret_advancements_completed"))).isDone()) {
																																		if (!(entity instanceof ServerPlayer _plr106 && _plr106.level() instanceof ServerLevel
																																				&& _plr106.getAdvancements().getOrStartProgress(
																																						_plr106.server.getAdvancements().get(ResourceLocation.parse("allaboutengie:all_fully_done")))
																																						.isDone())) {
																																			if (entity instanceof ServerPlayer _player) {
																																				AdvancementHolder _adv = _player.server.getAdvancements()
																																						.get(ResourceLocation.parse("allaboutengie:all_fully_done"));
																																...
																																if (!(entity instanceof ServerPlayer _plr108 && _plr108.level() instanceof ServerLevel
																																		&& _plr108.getAdvancements()
																																				.getOrStartProgress(
																																						_plr108.server.getAdvancements().get(ResourceLocation.parse("allaboutengie:all_done")))
																																				.isDone())) {
																																	if (entity instanceof ServerPlayer _player) {
																																		AdvancementHolder _adv = _player.server.getAdvancements().get(ResourceLocation.parse("allaboutengie:all_done"));
																																		if (_adv != null) {
																																			AdvancementProgress _ap = _player.getAdvancements().getOrStartProgress(_adv);
																																			if (!_ap.isDone()) {
																																				for (String criteria : _ap.getRemainingCriteria())
																																...
																																if (entity instanceof ServerPlayer _plr110 && _plr110.level() instanceof ServerLevel
																																	...
																																	if (!(entity instanceof ServerPlayer _plr111 && _plr111.level() instanceof ServerLevel
																																			&& _plr111.getAdvancements()
																																					.getOrStartProgress(
																																							_plr111.server.getAdvancements().get(ResourceLocation.parse("allaboutengie:all_fully_done")))
																																					.isDone())) {
																																		if (entity instanceof ServerPlayer _player) {
																																			AdvancementHolder _adv = _player.server.getAdvancements()
																																					.get(ResourceLocation.parse("allaboutengie:all_fully_done"));
		...
		if (entity instanceof ServerPlayer _plr113 && _plr113.level() instanceof ServerLevel
				&& _plr113.getAdvancements().getOrStartProgress(_plr113.server.getAdvancements().get(ResourceLocation.parse("allaboutengie:mad_engie_plush_obtained"))).isDone()) {
			if (entity instanceof ServerPlayer _plr114 && _plr114.level() instanceof ServerLevel
					&& _plr114.getAdvancements().getOrStartProgress(_plr114.server.getAdvancements().get(ResourceLocation.parse("allaboutengie:angry_engie_plush_obtained"))).isDone()) {
				if (entity instanceof ServerPlayer _plr115 && _plr115.level() instanceof ServerLevel
						&& _plr115.getAdvancements().getOrStartProgress(_plr115.server.getAdvancements().get(ResourceLocation.parse("allaboutengie:gold_angry_engie_plush_obtained"))).isDone()) {
					if (entity instanceof ServerPlayer _plr116 && _plr116.level() instanceof ServerLevel
							&& _plr116.getAdvancements().getOrStartProgress(_plr116.server.getAdvancements().get(ResourceLocation.parse("allaboutengie:diamond_angry_engie_plush_obtained"))).isDone()) {
						if (entity instanceof ServerPlayer _plr117 && _plr117.level() instanceof ServerLevel
								&& _plr117.getAdvancements().getOrStartProgress(_plr117.server.getAdvancements().get(ResourceLocation.parse("allaboutengie:netherite_angry_engie_plush_obtained"))).isDone()) {
							if (entity instanceof ServerPlayer _plr118 && _plr118.level() instanceof ServerLevel
									&& _plr118.getAdvancements().getOrStartProgress(_plr118.server.getAdvancements().get(ResourceLocation.parse("allaboutengie:enraged_engie_plush_obtained"))).isDone()) {
								if (entity instanceof ServerPlayer _plr119 && _plr119.level() instanceof ServerLevel
										&& _plr119.getAdvancements().getOrStartProgress(_plr119.server.getAdvancements().get(ResourceLocation.parse("allaboutengie:gold_enraged_engie_plush_obtained"))).isDone()) {
									if (entity instanceof ServerPlayer _plr120 && _plr120.level() instanceof ServerLevel
											&& _plr120.getAdvancements().getOrStartProgress(_plr120.server.getAdvancements().get(ResourceLocation.parse("allaboutengie:diamond_enraged_engie_plush_obtained"))).isDone()) {
										if (entity instanceof ServerPlayer _plr121 && _plr121.level() instanceof ServerLevel
												&& _plr121.getAdvancements().getOrStartProgress(_plr121.server.getAdvancements().get(ResourceLocation.parse("allaboutengie:netherite_enraged_engie_plush_obtained"))).isDone()) {
											if (entity instanceof ServerPlayer _plr122 && _plr122.level() instanceof ServerLevel
													&& _plr122.getAdvancements().getOrStartProgress(_plr122.server.getAdvancements().get(ResourceLocation.parse("allaboutengie:outraged_engie_plush_obtained"))).isDone()) {
												if (entity instanceof ServerPlayer _plr123 && _plr123.level() instanceof ServerLevel
														&& _plr123.getAdvancements().getOrStartProgress(_plr123.server.getAdvancements().get(ResourceLocation.parse("allaboutengie:gold_outraged_engie_plush_obtained"))).isDone()) {
													if (entity instanceof ServerPlayer _plr124 && _plr124.level() instanceof ServerLevel
															&& _plr124.getAdvancements().getOrStartProgress(_plr124.server.getAdvancements().get(ResourceLocation.parse("allaboutengie:diamond_outraged_engie_plush_obtained"))).isDone()) {
														if (entity instanceof ServerPlayer _plr125 && _plr125.level() instanceof ServerLevel
																&& _plr125.getAdvancements().getOrStartProgress(_plr125.server.getAdvancements().get(ResourceLocation.parse("allaboutengie:netherite_outraged_engie_plush_obtained"))).isDone()) {
															if (entity instanceof ServerPlayer _plr126 && _plr126.level() instanceof ServerLevel
																	&& _plr126.getAdvancements().getOrStartProgress(_plr126.server.getAdvancements().get(ResourceLocation.parse("allaboutengie:monstrosity_engie_plush_obtained"))).isDone()) {
																if (entity instanceof ServerPlayer _plr127 && _plr127.level() instanceof ServerLevel
																		&& _plr127.getAdvancements().getOrStartProgress(_plr127.server.getAdvancements().get(ResourceLocation.parse("allaboutengie:gold_monstrosity_engie_plush_obtained"))).isDone()) {
																	if (entity instanceof ServerPlayer _plr128 && _plr128.level() instanceof ServerLevel && _plr128.getAdvancements()
																			.getOrStartProgress(_plr128.server.getAdvancements().get(ResourceLocation.parse("allaboutengie:diamond_monstrosity_engie_plush_obtained"))).isDone()) {
																		if (entity instanceof ServerPlayer _plr129 && _plr129.level() instanceof ServerLevel && _plr129.getAdvancements()
																				.getOrStartProgress(_plr129.server.getAdvancements().get(ResourceLocation.parse("allaboutengie:netherite_monstrosity_engie_plush_obtained"))).isDone()) {
																			if (AllaboutengieModVariables.MapVariables.get(world).ChallengeToggle == true) {
																				if (entity instanceof ServerPlayer _plr130 && _plr130.level() instanceof ServerLevel && _plr130.getAdvancements()
																						.getOrStartProgress(_plr130.server.getAdvancements().get(ResourceLocation.parse("allaboutengie:insanity_engie_plush_obtained"))).isDone()) {
																					if (entity instanceof ServerPlayer _plr131 && _plr131.level() instanceof ServerLevel && _plr131.getAdvancements()
																							.getOrStartProgress(_plr131.server.getAdvancements().get(ResourceLocation.parse("allaboutengie:gold_insanity_engie_plush_obtained"))).isDone()) {
																						if (entity instanceof ServerPlayer _plr132 && _plr132.level() instanceof ServerLevel && _plr132.getAdvancements()
																								.getOrStartProgress(_plr132.server.getAdvancements().get(ResourceLocation.parse("allaboutengie:diamond_insanity_engie_plush_obtained"))).isDone()) {
																							if (entity instanceof ServerPlayer _plr133 && _plr133.level() instanceof ServerLevel && _plr133.getAdvancements()
																									.getOrStartProgress(_plr133.server.getAdvancements().get(ResourceLocation.parse("allaboutengie:netherite_insanity_engie_plush_obtained"))).isDone()) {
																								if (entity instanceof ServerPlayer _plr134 && _plr134.level() instanceof ServerLevel
																										&& _plr134.getAdvancements()
																												.getOrStartProgress(_plr134.server.getAdvancements().get(ResourceLocation.parse("allaboutengie:enraged_insanity_engie_plush_obtained")))
																												.isDone()) {
																									if (entity instanceof ServerPlayer _plr135 && _plr135.level() instanceof ServerLevel
																											&& _plr135.getAdvancements()
																													.getOrStartProgress(_plr135.server.getAdvancements().get(ResourceLocation.parse("allaboutengie:pure_insanity_engie_plush_obtained")))
																													.isDone()) {
																										if (entity instanceof ServerPlayer _plr136 && _plr136.level() instanceof ServerLevel && _plr136.getAdvancements()
																												.getOrStartProgress(_plr136.server.getAdvancements().get(ResourceLocation.parse("allaboutengie:wither_rose_secret_xxl"))).isDone()) {
																											if (entity instanceof ServerPlayer _plr137 && _plr137.level() instanceof ServerLevel
																													&& _plr137.getAdvancements()
																															.getOrStartProgress(
																																	_plr137.server.getAdvancements().get(ResourceLocation.parse("allaboutengie:all_about_engie_plaque_obtained")))
																															.isDone()) {
																												if (entity instanceof ServerPlayer _plr138 && _plr138.level() instanceof ServerLevel
																														&& _plr138.getAdvancements()
																																.getOrStartProgress(_plr138.server.getAdvancements().get(ResourceLocation.parse("allaboutengie:items_plaque_obtained")))
																																.isDone()) {
																													if (entity instanceof ServerPlayer _plr139 && _plr139.level() instanceof ServerLevel
																															&& _plr139.getAdvancements()
																																	.getOrStartProgress(
																																			_plr139.server.getAdvancements().get(ResourceLocation.parse("allaboutengie:mobs_plaque_obtained")))
																																	.isDone()) {
																														if (entity instanceof ServerPlayer _plr140 && _plr140.level() instanceof ServerLevel
																																&& _plr140.getAdvancements()
																																		.getOrStartProgress(
																																				_plr140.server.getAdvancements().get(ResourceLocation.parse("allaboutengie:sharkos_plaque_obtained")))
																																		.isDone()) {
																															if (entity instanceof ServerPlayer _plr141 && _plr141.level() instanceof ServerLevel
																																	&& _plr141.getAdvancements().getOrStartProgress(
																																			_plr141.server.getAdvancements().get(ResourceLocation.parse("allaboutengie:dimensions_plaque_obtained")))
																																			.isDone()) {
																																if (entity instanceof ServerPlayer _plr142 && _plr142.level() instanceof ServerLevel
																																		&& _plr142.getAdvancements().getOrStartProgress(_plr142.server.getAdvancements()
																																	...
																																	if (entity instanceof ServerPlayer _plr143 && _plr143.level() instanceof ServerLevel
																																			&& _plr143.getAdvancements().getOrStartProgress(
																																					_plr143.server.getAdvancements().get(ResourceLocation.parse("allaboutengie:extras_plaque_obtained")))
																																					.isDone()) {
																																		if (entity instanceof ServerPlayer _plr144 && _plr144.level() instanceof ServerLevel
																																			...
																																			if (entity instanceof ServerPlayer _plr145
																																					&& _plr145
																																							.level() instanceof ServerLevel
																																					&& _plr145.getAdvancements().getOrStartProgress(_plr145.server.getAdvancements()
																																				...
																																				if (entity instanceof ServerPlayer _plr146 && _plr146.level() instanceof ServerLevel
																																					...
																																					if (!(entity instanceof ServerPlayer _plr147 && _plr147.level() instanceof ServerLevel
																																							&& _plr147.getAdvancements()
																																									.getOrStartProgress(_plr147.server.getAdvancements()
																																											.get(ResourceLocation.parse("allaboutengie:secret_advancements_completed")))
																																									.isDone())) {
																																						if (entity instanceof ServerPlayer _player) {
																																							AdvancementHolder _adv = _player.server.getAdvancements()
																				...
																				if (entity instanceof ServerPlayer _plr149 && _plr149.level() instanceof ServerLevel
																						&& _plr149.getAdvancements().getOrStartProgress(_plr149.server.getAdvancements().get(ResourceLocation.parse("allaboutengie:wither_rose_secret_xxl"))).isDone()) {
																					if (entity instanceof ServerPlayer _plr150 && _plr150.level() instanceof ServerLevel && _plr150.getAdvancements()
																							.getOrStartProgress(_plr150.server.getAdvancements().get(ResourceLocation.parse("allaboutengie:all_about_engie_plaque_obtained"))).isDone()) {
																						if (entity instanceof ServerPlayer _plr151 && _plr151.level() instanceof ServerLevel && _plr151.getAdvancements()
																								.getOrStartProgress(_plr151.server.getAdvancements().get(ResourceLocation.parse("allaboutengie:items_plaque_obtained"))).isDone()) {
																							if (entity instanceof ServerPlayer _plr152 && _plr152.level() instanceof ServerLevel && _plr152.getAdvancements()
																									.getOrStartProgress(_plr152.server.getAdvancements().get(ResourceLocation.parse("allaboutengie:mobs_plaque_obtained"))).isDone()) {
																								if (entity instanceof ServerPlayer _plr153 && _plr153.level() instanceof ServerLevel && _plr153.getAdvancements()
																										.getOrStartProgress(_plr153.server.getAdvancements().get(ResourceLocation.parse("allaboutengie:sharkos_plaque_obtained"))).isDone()) {
																									if (entity instanceof ServerPlayer _plr154 && _plr154.level() instanceof ServerLevel && _plr154.getAdvancements()
																											.getOrStartProgress(_plr154.server.getAdvancements().get(ResourceLocation.parse("allaboutengie:dimensions_plaque_obtained"))).isDone()) {
																										if (entity instanceof ServerPlayer _plr155 && _plr155.level() instanceof ServerLevel
																												&& _plr155.getAdvancements()
																														.getOrStartProgress(_plr155.server.getAdvancements().get(ResourceLocation.parse("allaboutengie:enraged_zombies_plaque_obtained")))
																														.isDone()) {
																											if (entity instanceof ServerPlayer _plr156 && _plr156.level() instanceof ServerLevel && _plr156.getAdvancements()
																													.getOrStartProgress(_plr156.server.getAdvancements().get(ResourceLocation.parse("allaboutengie:extras_plaque_obtained"))).isDone()) {
																												if (entity instanceof ServerPlayer _plr157 && _plr157.level() instanceof ServerLevel
																														&& _plr157.getAdvancements()
																																.getOrStartProgress(_plr157.server.getAdvancements().get(ResourceLocation.parse("allaboutengie:engie_plaque_obtained")))
																																.isDone()) {
																													if (entity instanceof ServerPlayer _plr158 && _plr158.level() instanceof ServerLevel
																															&& _plr158.getAdvancements()
																																	.getOrStartProgress(
																																			_plr158.server.getAdvancements().get(ResourceLocation.parse("allaboutengie:engie_plush_obtained")))
																																	.isDone()) {
																														if (entity instanceof ServerPlayer _plr159 && _plr159.level() instanceof ServerLevel
																																&& _plr159.getAdvancements()
																																		.getOrStartProgress(
																																				_plr159.server.getAdvancements().get(ResourceLocation.parse("allaboutengie:dev_engie_plush_obtained")))
																																		.isDone()) {
																															if (!(entity instanceof ServerPlayer _plr160 && _plr160.level() instanceof ServerLevel
																																	&& _plr160.getAdvancements().getOrStartProgress(
																																			_plr160.server.getAdvancements().get(ResourceLocation.parse("allaboutengie:secret_advancements_completed")))
																																			.isDone())) {
																																if (entity instanceof ServerPlayer _player) {
																																	AdvancementHolder _adv = _player.server.getAdvancements()
																																			.get(ResourceLocation.parse("allaboutengie:secret_advancements_completed"));
