		...
		if (AllaboutengieModVariables.WorldVariables.get(world).yeah == false) {
			if (entity instanceof Player _playerHasItem ? _playerHasItem.getInventory().contains(new ItemStack(AllaboutengieModItems.ENGIES_SCYTHE_PIXEL.get())) : false) {
				AllaboutengieMod.queueServerWork(1, () -> {
					new ItemStack(AllaboutengieModItems.ENGIES_SCYTHE.get()).setDamageValue(new ItemStack(AllaboutengieModItems.ENGIES_SCYTHE_PIXEL.get()).getDamageValue());
				});
				if (entity instanceof Player _player) {
					ItemStack _setstack = new ItemStack(AllaboutengieModItems.ENGIES_SCYTHE.get()).copy();
			...
			if (entity instanceof Player _playerHasItem ? _playerHasItem.getInventory().contains(new ItemStack(AllaboutengieModItems.CRUCIFIX_PIXEL.get())) : false) {
				AllaboutengieMod.queueServerWork(1, () -> {
					new ItemStack(AllaboutengieModItems.CRUCIFIX.get()).setDamageValue(new ItemStack(AllaboutengieModItems.CRUCIFIX_PIXEL.get()).getDamageValue());
				});
				if (entity instanceof Player _player) {
			...
			if (entity instanceof Player _playerHasItem ? _playerHasItem.getInventory().contains(new ItemStack(AllaboutengieModItems.DOOMS_DAY_CRUCIFIX_PIXEL.get())) : false) {
				AllaboutengieMod.queueServerWork(1, () -> {
					new ItemStack(AllaboutengieModItems.DOOMS_DAY_CRUCIFIX.get()).setDamageValue(new ItemStack(AllaboutengieModItems.DOOMS_DAY_CRUCIFIX_PIXEL.get()).getDamageValue());
				});
				if (entity instanceof Player _player) {
					ItemStack _setstack = new ItemStack(AllaboutengieModItems.DOOMS_DAY_CRUCIFIX.get()).copy();
					_setstack.setCount(1);
					ItemHandlerHelper.giveItemToPlayer(_player, _setstack);
				}
				if (entity instanceof Player _player) {
					ItemStack _stktoremove = new ItemStack(AllaboutengieModItems.DOOMS_DAY_CRUCIFIX_PIXEL.get());
					_player.getInventory().clearOrCountMatchingItems(p -> _stktoremove.getItem() == p.getItem(), 1, _player.inventoryMenu.getCraftSlots());
				}
			}
			if (entity instanceof Player _playerHasItem ? _playerHasItem.getInventory().contains(new ItemStack(AllaboutengieModItems.SUPER_DOOMS_DAY_CRUCIFIX_PIXEL.get())) : false) {
				AllaboutengieMod.queueServerWork(1, () -> {
					new ItemStack(AllaboutengieModItems.SUPER_DOOMS_DAY_CRUCIFIX.get()).setDamageValue(new ItemStack(AllaboutengieModItems.SUPER_DOOMS_DAY_CRUCIFIX_PIXEL.get()).getDamageValue());
				});
				if (entity instanceof Player _player) {
				...
				if (entity instanceof Player _player) {
					ItemStack _stktoremove = new ItemStack(AllaboutengieModItems.SUPER_DOOMS_DAY_CRUCIFIX_PIXEL.get());
					_player.getInventory().clearOrCountMatchingItems(p -> _stktoremove.getItem() == p.getItem(), 1, _player.inventoryMenu.getCraftSlots());
				}
			}
			if (entity instanceof Player _playerHasItem ? _playerHasItem.getInventory().contains(new ItemStack(AllaboutengieModItems.THE_END_CRUCIFIX_PIXEL.get())) : false) {
				AllaboutengieMod.queueServerWork(1, () -> {
					new ItemStack(AllaboutengieModItems.THE_END_CRUCIFIX.get()).setDamageValue(new ItemStack(AllaboutengieModItems.THE_END_CRUCIFIX_PIXEL.get()).getDamageValue());
				});
				if (entity instanceof Player _player) {
				...
				if (entity instanceof Player _player) {
					ItemStack _stktoremove = new ItemStack(AllaboutengieModItems.THE_END_CRUCIFIX_PIXEL.get());
					_player.getInventory().clearOrCountMatchingItems(p -> _stktoremove.getItem() == p.getItem(), 1, _player.inventoryMenu.getCraftSlots());
				}
			}
			if (entity instanceof Player _playerHasItem ? _playerHasItem.getInventory().contains(new ItemStack(AllaboutengieModItems.ENGIE_CRUCIFIX_PIXEL.get())) : false) {
				AllaboutengieMod.queueServerWork(1, () -> {
					new ItemStack(AllaboutengieModItems.ENGIE_CRUCIFIX.get()).setDamageValue(new ItemStack(AllaboutengieModItems.ENGIE_CRUCIFIX_PIXEL.get()).getDamageValue());
				});
				if (entity instanceof Player _player) {
				...
				if (entity instanceof Player _player) {
					ItemStack _stktoremove = new ItemStack(AllaboutengieModItems.ENGIE_CRUCIFIX_PIXEL.get());
					_player.getInventory().clearOrCountMatchingItems(p -> _stktoremove.getItem() == p.getItem(), 1, _player.inventoryMenu.getCraftSlots());
				}
			}
			if (entity instanceof Player _playerHasItem ? _playerHasItem.getInventory().contains(new ItemStack(AllaboutengieModItems.MINI_BAN_HAMMER_PIXEL.get())) : false) {
				AllaboutengieMod.queueServerWork(1, () -> {
					new ItemStack(AllaboutengieModItems.MINI_BAN_HAMMER.get()).setDamageValue(new ItemStack(AllaboutengieModItems.MINI_BAN_HAMMER_PIXEL.get()).getDamageValue());
				});
				if (entity instanceof Player _player) {
			...
			if (entity instanceof Player _playerHasItem ? _playerHasItem.getInventory().contains(new ItemStack(AllaboutengieModItems.BAN_HAMMER_PIXEL.get())) : false) {
				AllaboutengieMod.queueServerWork(1, () -> {
					new ItemStack(AllaboutengieModItems.BAN_HAMMER.get()).setDamageValue(new ItemStack(AllaboutengieModItems.BAN_HAMMER_PIXEL.get()).getDamageValue());
				});
				if (entity instanceof Player _player) {
			...
			if (entity instanceof Player _playerHasItem ? _playerHasItem.getInventory().contains(new ItemStack(AllaboutengieModItems.BIG_BAN_HAMMER_PIXEL.get())) : false) {
				AllaboutengieMod.queueServerWork(1, () -> {
					new ItemStack(AllaboutengieModItems.BIG_BAN_HAMMER.get()).setDamageValue(new ItemStack(AllaboutengieModItems.BIG_BAN_HAMMER_PIXEL.get()).getDamageValue());
				});
				if (entity instanceof Player _player) {
			...
			if (entity instanceof Player _playerHasItem ? _playerHasItem.getInventory().contains(new ItemStack(AllaboutengieModItems.LARGE_BAN_HAMMER_PIXEL.get())) : false) {
				AllaboutengieMod.queueServerWork(1, () -> {
					new ItemStack(AllaboutengieModItems.LARGE_BAN_HAMMER.get()).setDamageValue(new ItemStack(AllaboutengieModItems.LARGE_BAN_HAMMER_PIXEL.get()).getDamageValue());
				});
				if (entity instanceof Player _player) {
			...
			if (entity instanceof Player _playerHasItem ? _playerHasItem.getInventory().contains(new ItemStack(AllaboutengieModItems.HUGE_BAN_HAMMER_PIXEL.get())) : false) {
				AllaboutengieMod.queueServerWork(1, () -> {
					new ItemStack(AllaboutengieModItems.HUGE_BAN_HAMMER.get()).setDamageValue(new ItemStack(AllaboutengieModItems.HUGE_BAN_HAMMER_PIXEL.get()).getDamageValue());
				});
				if (entity instanceof Player _player) {
			...
			if (entity instanceof Player _playerHasItem ? _playerHasItem.getInventory().contains(new ItemStack(AllaboutengieModItems.ENORMOUS_BAN_HAMMER_PIXEL.get())) : false) {
				AllaboutengieMod.queueServerWork(1, () -> {
					new ItemStack(AllaboutengieModItems.ENORMOUS_BAN_HAMMER.get()).setDamageValue(new ItemStack(AllaboutengieModItems.ENORMOUS_BAN_HAMMER_PIXEL.get()).getDamageValue());
				});
				if (entity instanceof Player _player) {
			...
			if (entity instanceof Player _playerHasItem ? _playerHasItem.getInventory().contains(new ItemStack(AllaboutengieModItems.GIGANTIC_BAN_HAMMER_PIXEL.get())) : false) {
				AllaboutengieMod.queueServerWork(1, () -> {
					new ItemStack(AllaboutengieModItems.GIGANTIC_BAN_HAMMER.get()).setDamageValue(new ItemStack(AllaboutengieModItems.GIGANTIC_BAN_HAMMER_PIXEL.get()).getDamageValue());
				});
				if (entity instanceof Player _player) {
			...
			if (entity instanceof Player _playerHasItem ? _playerHasItem.getInventory().contains(new ItemStack(AllaboutengieModItems.MASSIVE_BAN_HAMMER_PIXEL.get())) : false) {
				AllaboutengieMod.queueServerWork(1, () -> {
					new ItemStack(AllaboutengieModItems.MASSIVE_BAN_HAMMER.get()).setDamageValue(new ItemStack(AllaboutengieModItems.MASSIVE_BAN_HAMMER_PIXEL.get()).getDamageValue());
				});
				if (entity instanceof Player _player) {
			...
			if (entity instanceof Player _playerHasItem ? _playerHasItem.getInventory().contains(new ItemStack(AllaboutengieModItems.BIBLICALLY_ACCURATE_ENGIE_BAN_HAMMER_PIXEL.get())) : false) {
				AllaboutengieMod.queueServerWork(1, () -> {
					new ItemStack(AllaboutengieModItems.BIBLICALLY_ACCURATE_ENGIE_BAN_HAMMER.get()).setDamageValue(new ItemStack(AllaboutengieModItems.BIBLICALLY_ACCURATE_ENGIE_BAN_HAMMER_PIXEL.get()).getDamageValue());
				});
				if (entity instanceof Player _player) {
			...
			if (entity instanceof Player _playerHasItem ? _playerHasItem.getInventory().contains(new ItemStack(AllaboutengieModItems.MONSTROSITY_BAN_HAMMER_PIXEL.get())) : false) {
				AllaboutengieMod.queueServerWork(1, () -> {
					new ItemStack(AllaboutengieModItems.MONSTROSITY_BAN_HAMMER.get()).setDamageValue(new ItemStack(AllaboutengieModItems.MONSTROSITY_BAN_HAMMER_PIXEL.get()).getDamageValue());
				});
				if (entity instanceof Player _player) {
			...
			if (entity instanceof Player _playerHasItem ? _playerHasItem.getInventory().contains(new ItemStack(AllaboutengieModItems.COMICALLY_MASSIVE_BAN_HAMMER_PIXEL.get())) : false) {
				AllaboutengieMod.queueServerWork(1, () -> {
					new ItemStack(AllaboutengieModItems.COMICALLY_MASSIVE_BAN_HAMMER.get()).setDamageValue(new ItemStack(AllaboutengieModItems.COMICALLY_MASSIVE_BAN_HAMMER_PIXEL.get()).getDamageValue());
				});
				if (entity instanceof Player _player) {
					ItemStack _setstack = new ItemStack(AllaboutengieModItems.COMICALLY_MASSIVE_BAN_HAMMER.get()).copy();
					_setstack.setCount(1);
					ItemHandlerHelper.giveItemToPlayer(_player, _setstack);
				}
				if (entity instanceof Player _player) {
			...
			if (entity instanceof Player _playerHasItem ? _playerHasItem.getInventory().contains(new ItemStack(AllaboutengieModItems.ECHDEATH_PIXEL.get())) : false) {
				AllaboutengieMod.queueServerWork(1, () -> {
					new ItemStack(AllaboutengieModItems.ECHDEATH.get()).setDamageValue(new ItemStack(AllaboutengieModItems.ECHDEATH_PIXEL.get()).getDamageValue());
				});
				if (entity instanceof Player _player) {
					ItemStack _setstack = new ItemStack(AllaboutengieModItems.ECHDEATH.get()).copy();
					_setstack.setCount(1);
					ItemHandlerHelper.giveItemToPlayer(_player, _setstack);
				}
				if (entity instanceof Player _player) {
