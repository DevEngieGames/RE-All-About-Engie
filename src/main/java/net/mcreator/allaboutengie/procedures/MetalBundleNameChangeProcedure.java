...
public class MetalBundleNameChangeProcedure {
	public static void execute(Entity entity) {
		if (entity == null)
			return;
		if ((entity instanceof LivingEntity _livEnt ? _livEnt.getOffhandItem() : ItemStack.EMPTY).getItem() == AllaboutengieModItems.ENGIE_BUNDLE.get()) {
		...
		} else if ((entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getItem() == AllaboutengieModItems.ENGIE_BUNDLE.get()) {
			...
			new ItemStack(AllaboutengieModItems.ENGIE_BUNDLE.get()).set(DataComponents.CUSTOM_NAME,
