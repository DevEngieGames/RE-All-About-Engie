	...
	public static void execute(LevelAccessor world, Entity entity) {
		...
		if ((entity instanceof Player _plrSlotItem && _plrSlotItem.containerMenu instanceof AllaboutengieModMenus.MenuAccessor _menu0 ? _menu0.getSlots().get(3).getItem() : ItemStack.EMPTY).getItem() == AllaboutengieModItems.ENGIE_GAMES_CRUCIFIX
			...
			AllaboutengieMod.queueServerWork(1, () -> {
				...
				.getItem() == AllaboutengieModItems.ENGIE_GAMES_PICKAXE.get()) {
			if (entity instanceof Player _player && _player.containerMenu instanceof AllaboutengieModMenus.MenuAccessor _menu) {
				_menu.getSlots().get(0).remove(64);
				_player.containerMenu.broadcastChanges();
			}
		...
		} else if ((entity instanceof Player _plrSlotItem && _plrSlotItem.containerMenu instanceof AllaboutengieModMenus.MenuAccessor _menu29 ? _menu29.getSlots().get(3).getItem() : ItemStack.EMPTY).getItem() == AllaboutengieModItems.ENGIE_GAMES_AXE
				.get()) {
			if (entity instanceof Player _player && _player.containerMenu instanceof AllaboutengieModMenus.MenuAccessor _menu) {
				_menu.getSlots().get(0).remove(64);
				_player.containerMenu.broadcastChanges();
			...
			AllaboutengieMod.queueServerWork(1, () -> {
				...
				.getItem() == AllaboutengieModItems.ENGIE_GAMES_SHOVEL.get()) {
			if (entity instanceof Player _player && _player.containerMenu instanceof AllaboutengieModMenus.MenuAccessor _menu) {
				_menu.getSlots().get(0).remove(64);
				_player.containerMenu.broadcastChanges();
			}
		...
		} else if ((entity instanceof Player _plrSlotItem && _plrSlotItem.containerMenu instanceof AllaboutengieModMenus.MenuAccessor _menu45 ? _menu45.getSlots().get(3).getItem() : ItemStack.EMPTY).getItem() == AllaboutengieModItems.ENGIE_GAMES_HOE
				.get()) {
			if (entity instanceof Player _player && _player.containerMenu instanceof AllaboutengieModMenus.MenuAccessor _menu) {
				_menu.getSlots().get(0).remove(64);
				_player.containerMenu.broadcastChanges();
			...
			AllaboutengieMod.queueServerWork(1, () -> {
				...
				.getItem() == AllaboutengieModItems.THE_REAL_ENGIE_GAMESS_HELMET.get()) {
			if (entity instanceof Player _player && _player.containerMenu instanceof AllaboutengieModMenus.MenuAccessor _menu) {
				_menu.getSlots().get(0).remove(64);
				_player.containerMenu.broadcastChanges();
			}
			...
			AllaboutengieMod.queueServerWork(1, () -> {
				...
				.getItem() == AllaboutengieModItems.THE_REAL_ENGIE_GAMESS_CHESTPLATE.get()) {
			if (entity instanceof Player _player && _player.containerMenu instanceof AllaboutengieModMenus.MenuAccessor _menu) {
				_menu.getSlots().get(0).remove(64);
				_player.containerMenu.broadcastChanges();
			}
			...
			AllaboutengieMod.queueServerWork(1, () -> {
				...
				.getItem() == AllaboutengieModItems.THE_REAL_ENGIE_GAMESS_LEGGINGS.get()) {
			if (entity instanceof Player _player && _player.containerMenu instanceof AllaboutengieModMenus.MenuAccessor _menu) {
				_menu.getSlots().get(0).remove(64);
				_player.containerMenu.broadcastChanges();
			}
			...
			AllaboutengieMod.queueServerWork(1, () -> {
				...
				.getItem() == AllaboutengieModItems.THE_REAL_ENGIE_GAMESS_BOOTS.get()) {
			if (entity instanceof Player _player && _player.containerMenu instanceof AllaboutengieModMenus.MenuAccessor _menu) {
				_menu.getSlots().get(0).remove(64);
				_player.containerMenu.broadcastChanges();
			}
